...
var (
	pattern_Invoice_GetInvoice_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"v1", "date"}, "read"))

	pattern_Invoice_ExportInvoiceFile_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"v1", "date"}, "export"))
)
