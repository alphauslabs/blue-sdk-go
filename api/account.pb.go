...
var file_api_account_proto_rawDesc = []byte{
	...
	0x22, 0x3a, 0x0a, 0x11, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64,
	0x61, 0x74, 0x61, 0x56, 0x31, 0x12, 0x25, 0x0a, 0x02, 0x6b, 0x76, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x15, 0x2e, 0x62, 0x6c, 0x75, 0x65, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x4b, 0x65, 0x79, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x02, 0x6b, 0x76, 0x42, 0x54, 0x0a, 0x19,
	0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x75, 0x73, 0x2e, 0x62, 0x6c,
	0x75, 0x65, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x70, 0x69, 0x42, 0x0f, 0x41, 0x70, 0x69, 0x41, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x5a, 0x26, 0x67, 0x69, 0x74, 0x68,
...
var file_api_account_proto_goTypes = []interface{}{
	...
	(*AccountMetadataV1)(nil), // 1: blueapi.api.AccountMetadataV1
	(*anypb.Any)(nil),         // 2: google.protobuf.Any
	(*KeyValue)(nil),          // 3: blueapi.api.KeyValue
}
var file_api_account_proto_depIdxs = []int32{
	2, // 0: blueapi.api.Account.metadata:type_name -> google.protobuf.Any
	3, // 1: blueapi.api.AccountMetadataV1.kv:type_name -> blueapi.api.KeyValue
...
func file_api_account_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_account_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AccountMetadataV1); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
