...
const file_api_azure_cost_proto_rawDesc = "" +
	"\n" +
	"\x14api/azure/cost.proto\x12\x11blueapi.api.azure\"\xbe\x06\n" +
	"\x04Cost\x12\x18\n" +
	...
	"\n" +
	"chargeType\x18\a \x01(\tR\n" +
	"chargeType\x12 \n" +
	"\vdescription\x18\b \x01(\tR\vdescription\x12*\n" +
	"\x10billableQuantity\x18\t \x01(\x01R\x10billableQuantity\x12.\n" +
	"\x12effectiveUnitPrice\x18\n" +
	" \x01(\x01R\x12effectiveUnitPrice\x12\x12\n" +
	"\x04cost\x18\v \x01(\x01R\x04cost\x12\"\n" +
	"\fbaseCurrency\x18\f \x01(\tR\fbaseCurrency\x12\"\n" +
	"\fexchangeRate\x18\r \x01(\x01R\fexchangeRate\x12\x1e\n" +
	"\n" +
	"targetCost\x18\x0e \x01(\x01R\n" +
	"targetCost\x12&\n" +
	"\x0etargetCurrency\x18\x0f \x01(\tR\x0etargetCurrency\x12\"\n" +
	"\ftimeInterval\x18\x10 \x01(\tR\ftimeInterval\x12 \n" +
	"\vbillingType\x18\x11 \x01(\tR\vbillingType\x12 \n" +
	"\valternateId\x18\x12 \x01(\tR\valternateId\x12\x1e\n" +
	"\n" +
	"domainName\x18\x13 \x01(\tR\n" +
	"domainName\x12\x1c\n" +
	"\toperation\x18\x14 \x01(\tR\toperation\x12\x1c\n" +
	"\tusageType\x18\x15 \x01(\tR\tusageType\x12\"\n" +
	"\finstanceType\x18\x16 \x01(\tR\finstanceType\x12\x1a\n" +
	"\bcategory\x18\x17 \x01(\tR\bcategory\x12&\n" +
	"\x0esubscriptionId\x18\x18 \x01(\tR\x0esubscriptionId\x12$\n" +
	"\rentitlementId\x18\x19 \x01(\tR\rentitlementId\"\xe5\x02\n" +
	"\rCostAttribute\x12\x1e\n" +
	"\n" +
	"customerId\x18\x01 \x01(\tR\n" +
	"customerId\x12&\n" +
	"\x0esubscriptionId\x18\x02 \x01(\tR\x0esubscriptionId\x12$\n" +
	"\rentitlementId\x18\x03 \x01(\tR\rentitlementId\x12\x18\n" +
	"\agroupId\x18\x04 \x01(\tR\agroupId\x12\x1c\n" +
	"\tproductId\x18\x05 \x01(\tR\tproductId\x12 \n" +
	"\vproductName\x18\x06 \x01(\tR\vproductName\x12\x14\n" +
	"\x05skuId\x18\a \x01(\tR\x05skuId\x12\x18\n" +
	"\askuName\x18\b \x01(\tR\askuName\x12 \n" +
	...
	"domainNameBb\n" +
	"\x1fcloud.alphaus.blueapi.api.azureB\x11ApiAzureCostProtoZ,github.com/alphauslabs/blue-sdk-go/api/azureb\x06proto3"
