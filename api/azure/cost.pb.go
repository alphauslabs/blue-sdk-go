...
type CostAttribute struct {
	...
	Descriptiom    string `protobuf:"bytes,9,opt,name=descriptiom,proto3" json:"descriptiom,omitempty"`
...
func (x *CostAttribute) GetDescriptiom() string {
	if x != nil {
		return x.Descriptiom
	}
	return ""
}
...
var file_api_azure_cost_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6d, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72,
	0x69, 0x70, 0x74, 0x69, 0x6f, 0x6d, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f,
...
func file_api_azure_cost_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_azure_cost_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Cost); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_azure_cost_proto_msgTypes[1].Exporter = func(v any, i int) any {
