...
const file_api_aws_breakeven_proto_rawDesc = "" +
	"\n" +
	"\x17api/aws/breakeven.proto\x12\x0fblueapi.api.aws\"\xfe\x01\n" +
	"\x10AwsCostBreakeven\x12\x10\n" +
	"\x03arn\x18\x01 \x01(\tR\x03arn\x12\x1c\n" +
	"\tstartDate\x18\x02 \x01(\tR\tstartDate\x12\x18\n" +
	"\aendDate\x18\x03 \x01(\tR\aendDate\x12&\n" +
	"\x0ebreakEvenPoint\x18\x04 \x01(\tR\x0ebreakEvenPoint\x12\x1e\n" +
	"\n" +
	"upperRatio\x18\x05 \x01(\x01R\n" +
	"upperRatio\x12\x1e\n" +
	"\n" +
	"lowerRatio\x18\x06 \x01(\x01R\n" +
	"lowerRatio\x128\n" +
	"\tchartData\x18\a \x03(\v2\x1a.blueapi.api.aws.ChartDataR\tchartData\"\x89\x01\n" +
	"\tChartData\x12\x12\n" +
	"\x04date\x18\x01 \x01(\tR\x04date\x12&\n" +
	"\x0eactualOndemand\x18\x02 \x01(\x01R\x0eactualOndemand\x12\x1e\n" +
	"\n" +
	"actualCost\x18\x03 \x01(\x01R\n" +
	"actualCost\x12 \n" +
	"\vutilization\x18\x04 \x01(\x01R\vutilizationBa\n" +
	"\x1dcloud.alphaus.blueapi.api.awsB\x14ApiAwsBreakevenProtoZ*github.com/alphauslabs/blue-sdk-go/api/awsb\x06proto3"
