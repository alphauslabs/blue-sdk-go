...
const file_api_rbac_proto_rawDesc = "" +
	"\n" +
	"\x0eapi/rbac.proto\x12\vblueapi.api\"b\n" +
	"\x06Policy\x12\x16\n" +
	"\x06action\x18\x01 \x01(\tR\x06action\x12\x16\n" +
	"\x06effect\x18\x02 \x01(\tR\x06effect\x12\x10\n" +
	...
	"\bpolicies\x18\x03 \x03(\v2\x13.blueapi.api.PolicyR\bpolicies\"\x8b\x01\n" +
	"\x04Role\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1c\n" +
	"\tnamespace\x18\x02 \x01(\tR\tnamespace\x12 \n" +
	"\vpermissions\x18\x03 \x03(\tR\vpermissions\x12/\n" +
	"\bpolicies\x18\x04 \x03(\v2\x13.blueapi.api.PolicyR\bpolicies\"\x91\x01\n" +
	"\x0fUserRoleMapping\x12\x1a\n" +
	"\brootUser\x18\x01 \x01(\tR\brootUser\x12\x18\n" +
	"\asubUser\x18\x02 \x01(\tR\asubUser\x12\x1c\n" +
	"\tnamespace\x18\x03 \x01(\tR\tnamespace\x12\x12\n" +
	"\x04role\x18\x04 \x01(\tR\x04role\x12\x16\n" +
	"\x06filter\x18\x05 \x01(\tR\x06filterBQ\n" +
	"\x19cloud.alphaus.blueapi.apiB\fApiRbacProtoZ&github.com/alphauslabs/blue-sdk-go/apib\x06proto3"

var (
	file_api_rbac_proto_rawDescOnce sync.Once
	file_api_rbac_proto_rawDescData []byte
)

func file_api_rbac_proto_rawDescGZIP() []byte {
	file_api_rbac_proto_rawDescOnce.Do(func() {
		file_api_rbac_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_rbac_proto_rawDesc), len(file_api_rbac_proto_rawDesc)))
	})
...
func file_api_rbac_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_rbac_proto_rawDesc), len(file_api_rbac_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
