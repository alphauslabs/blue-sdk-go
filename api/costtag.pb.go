...
type CostTag struct {
	...
	Tags []*KeyValue `protobuf:"bytes,5,rep,name=tags,proto3" json:"tags,omitempty"`
}
...
var file_api_costtag_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa0, 0x01, 0x0a, 0x07, 0x43, 0x6f, 0x73, 0x74, 0x54, 0x61, 0x67,
	...
	,
...
var file_api_costtag_proto_goTypes = []interface{}{
...
func file_api_costtag_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_costtag_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CostTag); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
