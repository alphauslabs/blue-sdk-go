...
var file_api_ripple_billinggroup_proto_rawDesc = []byte{
	...
	0x70, 0x6c, 0x65, 0x22, 0xe8, 0x02, 0x0a, 0x10, 0x42, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x47,
	...
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x71, 0x72, 0x43, 0x6f, 0x64, 0x65, 0x42, 0x71,
	...
	0x6c, 0x65, 0x42, 0x1e, 0x41, 0x70, 0x69, 0x52, 0x69, 0x70, 0x70, 0x6c, 0x65, 0x42, 0x69, 0x6c,
	0x6c, 0x69, 0x6e, 0x67, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x6e, 0x66, 0x6f, 0x50, 0x72, 0x6f,
...
var file_api_ripple_billinggroup_proto_goTypes = []interface{}{
...
func file_api_ripple_billinggroup_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_ripple_billinggroup_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BillingGroupInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
