...
var file_api_ripple_payer_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x92, 0x01, 0x0a, 0x05, 0x50, 0x61, 0x79, 0x65, 0x72, 0x12, 0x0e, 0x0a,
	...
	0x64, 0x61, 0x74, 0x61, 0x12, 0x32, 0x0a, 0x09, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
	0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x62, 0x6c, 0x75, 0x65, 0x61, 0x70,
	0x69, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x09, 0x63,
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x42, 0x66, 0x0a, 0x20, 0x63, 0x6c, 0x6f, 0x75,
	0x64, 0x2e, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x75, 0x73, 0x2e, 0x62, 0x6c, 0x75, 0x65, 0x61, 0x70,
	0x69, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x72, 0x69, 0x70, 0x70, 0x6c, 0x65, 0x42, 0x13, 0x41, 0x70,
	0x69, 0x52, 0x69, 0x70, 0x70, 0x6c, 0x65, 0x50, 0x61, 0x79, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74,
...
var (
	...
	file_api_ripple_payer_proto_rawDescData = file_api_ripple_payer_proto_rawDesc
)

func file_api_ripple_payer_proto_rawDescGZIP() []byte {
	file_api_ripple_payer_proto_rawDescOnce.Do(func() {
		file_api_ripple_payer_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_ripple_payer_proto_rawDescData)
	})
	return file_api_ripple_payer_proto_rawDescData
}

var file_api_ripple_payer_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_api_ripple_payer_proto_goTypes = []interface{}{
...
var file_api_ripple_payer_proto_depIdxs = []int32{
	...
	2, // 1: blueapi.api.ripple.Payer.customers:type_name -> blueapi.api.Account
...
func file_api_ripple_payer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_ripple_payer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Payer); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_ripple_payer_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_api_ripple_payer_proto_rawDesc = nil
