...
func file_api_ripple_exchangerate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_ripple_exchangerate_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BillingGroupExchangeRate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_ripple_exchangerate_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PayerExchangeRate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_ripple_exchangerate_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CommonExchangeRate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_ripple_exchangerate_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VendorPayerExchangeRate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
