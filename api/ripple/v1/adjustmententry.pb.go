...
const file_api_ripple_v1_adjustmententry_proto_rawDesc = "" +
	"\n" +
	"#api/ripple/v1/adjustmententry.proto\x12\x15blueapi.api.ripple.v1\"\x8d\x02\n" +
	"\x0fAdjustmentEntry\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12K\n" +
	"\aaccount\x18\x03 \x01(\v21.blueapi.api.ripple.v1.AdjustmentEntryAccountInfoR\aaccount\x12@\n" +
	"\x05entry\x18\x04 \x01(\v2*.blueapi.api.ripple.v1.AdjustmentEntryInfoR\x05entry\x12G\n" +
	"\asetting\x18\x05 \x01(\v2-.blueapi.api.ripple.v1.AdjustmentEntrySettingR\asetting\"\xf6\x01\n" +
	"\x1aAdjustmentEntryAccountInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x16\n" +
	"\x06vendor\x18\x03 \x01(\tR\x06vendor\x12,\n" +
	"\x11billingInternalId\x18\x04 \x01(\tR\x11billingInternalId\x12&\n" +
	"\x0ebillingGroupId\x18\x05 \x01(\tR\x0ebillingGroupId\x12*\n" +
	"\x10billingGroupName\x18\x06 \x01(\tR\x10billingGroupName\x12\x1a\n" +
	"\bcurrency\x18\a \x01(\tR\bcurrency\"\xcf\x02\n" +
	"\x13AdjustmentEntryInfo\x12(\n" +
	"\x0fcalculationType\x18\x01 \x01(\tR\x0fcalculationType\x120\n" +
	"\x13adjustmentEntryType\x18\x02 \x01(\tR\x13adjustmentEntryType\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12 \n" +
	"\vproductCode\x18\x04 \x01(\tR\vproductCode\x12 \n" +
	"\vproductName\x18\x05 \x01(\tR\vproductName\x12\x1a\n" +
	"\bcurrency\x18\x06 \x01(\tR\bcurrency\x12\x16\n" +
	"\x06amount\x18\a \x01(\x01R\x06amount\x12\"\n" +
	"\ftimeInterval\x18\b \x01(\tR\ftimeInterval\x12\x1e\n" +
	"\n" +
	"usageStart\x18\t \x01(\tR\n" +
	"usageStart\"\xfe\x01\n" +
	"\x16AdjustmentEntrySetting\x12\x14\n" +
	"\x05apply\x18\x01 \x01(\bR\x05apply\x12\"\n" +
	"\fexchangeRate\x18\x02 \x01(\x01R\fexchangeRate\x12\x18\n" +
	"\ataxFree\x18\x03 \x01(\bR\ataxFree\x12\"\n" +
	"\fallocateType\x18\x04 \x01(\tR\fallocateType\x12\x1c\n" +
	"\tsplitType\x18\x05 \x01(\tR\tsplitType\x12\x1e\n" +
	"\n" +
	"originalId\x18\x06 \x01(\tR\n" +
	"originalId\x12\x1a\n" +
	"\bsplitted\x18\a \x01(\bR\bsplitted\x12\x12\n" +
	"\x04term\x18\b \x01(\x05R\x04termBv\n" +
	"#cloud.alphaus.blueapi.api.ripple.v1B\x1dApiRippleAdjustmentEntryProtoZ0github.com/alphauslabs/blue-sdk-go/api/ripple/v1b\x06proto3"
