...
const file_api_accountgroup_proto_rawDesc = "" +
	"\n" +
	"\x16api/accountgroup.proto\x12\vblueapi.api\x1a\x12api/keyvalue.proto\x1a\x11api/account.proto\"\x97\x01\n" +
	"\fAccountGroup\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x121\n" +
	"\bmetadata\x18\x03 \x03(\v2\x15.blueapi.api.KeyValueR\bmetadata\x120\n" +
	"\baccounts\x18\x04 \x03(\v2\x14.blueapi.api.AccountR\baccountsBY\n" +
	"\x19cloud.alphaus.blueapi.apiB\x14ApiAccountGroupProtoZ&github.com/alphauslabs/blue-sdk-go/apib\x06proto3"

var (
	file_api_accountgroup_proto_rawDescOnce sync.Once
	file_api_accountgroup_proto_rawDescData []byte
)

func file_api_accountgroup_proto_rawDescGZIP() []byte {
	file_api_accountgroup_proto_rawDescOnce.Do(func() {
		file_api_accountgroup_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_accountgroup_proto_rawDesc), len(file_api_accountgroup_proto_rawDesc)))
	})
...
func file_api_accountgroup_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_accountgroup_proto_rawDesc), len(file_api_accountgroup_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
