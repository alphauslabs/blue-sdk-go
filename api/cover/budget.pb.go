...
type BudgetData struct {
	...
	GranularBudget []*GranularBudgetData   `protobuf:"bytes,7,rep,name=granularBudget,proto3" json:"granularBudget,omitempty"` // budget per month
	CostGroup      *AlertCostGroup         `protobuf:"bytes,8,opt,name=costGroup,proto3" json:"costGroup,omitempty"`
	Threshold      []*Threshold            `protobuf:"bytes,9,rep,name=threshold,proto3" json:"threshold,omitempty"`            // threshold and its respective channel(s) to alert
	ForecastedData []*GranularForecastData `protobuf:"bytes,10,rep,name=forecastedData,proto3" json:"forecastedData,omitempty"` // forecast data record of an expired budget
	SpendingData   []*GranularSpendingData `protobuf:"bytes,11,rep,name=spendingData,proto3" json:"spendingData,omitempty"`     // spending data record of an expired budget
	Expired        bool                    `protobuf:"varint,12,opt,name=expired,proto3" json:"expired,omitempty"`              // true if budget has expired
	Draft          bool                    `protobuf:"varint,13,opt,name=draft,proto3" json:"draft,omitempty"`                  // true if the current budget set is still a draft
...
type Threshold struct {
	...
	Channels *AlertChannels `protobuf:"bytes,3,opt,name=channels,proto3" json:"channels,omitempty"`
}
...
func (x *Threshold) GetChannels() *AlertChannels {
	if x != nil {
		return x.Channels
	}
	return nil
...
var file_api_cover_budget_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xbe, 0x05, 0x0a, 0x0a, 0x42, 0x75, 0x64, 0x67, 0x65, 0x74, 0x44, 0x61, 0x74,
	...
	0x74, 0x12, 0x4d, 0x0a, 0x0e, 0x67, 0x72, 0x61, 0x6e, 0x75, 0x6c, 0x61, 0x72, 0x42, 0x75, 0x64,
	0x67, 0x65, 0x74, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x62, 0x6c, 0x75, 0x65,
	0x61, 0x70, 0x69, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x2e, 0x47, 0x72,
	0x61, 0x6e, 0x75, 0x6c, 0x61, 0x72, 0x42, 0x75, 0x64, 0x67, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61,
	0x52, 0x0e, 0x67, 0x72, 0x61, 0x6e, 0x75, 0x6c, 0x61, 0x72, 0x42, 0x75, 0x64, 0x67, 0x65, 0x74,
	0x12, 0x3f, 0x0a, 0x09, 0x63, 0x6f, 0x73, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x18, 0x08, 0x20,
	...
	0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x09, 0x63, 0x6f, 0x73, 0x74, 0x47, 0x72, 0x6f, 0x75,
	0x70, 0x12, 0x3a, 0x0a, 0x09, 0x74, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x18, 0x09,
	...
	,
	...
	,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x73, 0x0a, 0x09, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f,
	...
	0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x3c, 0x0a, 0x08,
	0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20,
	...
	0x52, 0x08, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x73, 0x42, 0x64, 0x0a, 0x1f, 0x63, 0x6c,
...
var file_api_cover_budget_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_api_cover_budget_proto_goTypes = []interface{}{
	...
	(*Threshold)(nil),            // 4: blueapi.api.cover.Threshold
	(*AlertCostGroup)(nil),       // 5: blueapi.api.cover.AlertCostGroup
	(*AlertChannels)(nil),        // 6: blueapi.api.cover.AlertChannels
}
var file_api_cover_budget_proto_depIdxs = []int32{
	...
	5, // 1: blueapi.api.cover.BudgetData.costGroup:type_name -> blueapi.api.cover.AlertCostGroup
	4, // 2: blueapi.api.cover.BudgetData.threshold:type_name -> blueapi.api.cover.Threshold
	...
	6, // 5: blueapi.api.cover.Threshold.channels:type_name -> blueapi.api.cover.AlertChannels
