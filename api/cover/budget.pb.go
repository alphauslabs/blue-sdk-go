...
type BudgetData struct {
	...
	CreatedBy      string                  `protobuf:"bytes,13,opt,name=createdBy,proto3" json:"createdBy,omitempty"`          // not required
	CreatedAt      string                  `protobuf:"bytes,14,opt,name=createdAt,proto3" json:"createdAt,omitempty"`          // not required
	UpdatedBy      string                  `protobuf:"bytes,15,opt,name=updatedBy,proto3" json:"updatedBy,omitempty"`          // not required
	UpdatedAt      string                  `protobuf:"bytes,16,opt,name=updatedAt,proto3" json:"updatedAt,omitempty"`          // not required
}
...
var file_api_cover_budget_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x9c, 0x05, 0x0a, 0x0a, 0x42, 0x75, 0x64, 0x67, 0x65, 0x74, 0x44, 0x61, 0x74,
	...
	0x74, 0x22, 0x40, 0x0a, 0x12, 0x47, 0x72, 0x61, 0x6e, 0x75, 0x6c, 0x61, 0x72, 0x42, 0x75, 0x64,
