...
func file_api_cover_asset_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_cover_asset_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Asset); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_cover_asset_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_api_cover_asset_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Tag); i {
			case 0:
				return &v.state
			case 1:
