...
var file_api_cover_optimizationrecommendation_proto_rawDesc = []byte{
	...
	0x69, 0x66, 0x79, 0x52, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x22, 0xfd, 0x04, 0x0a, 0x11, 0x43, 0x75, 0x72,
	...
	0x66, 0x66, 0x69, 0x63, 0x44, 0x61, 0x74, 0x61, 0x22, 0x96, 0x02, 0x0a, 0x1e, 0x45, 0x43, 0x32,
	...
	0x79, 0x22, 0x3b, 0x0a, 0x0f, 0x55, 0x74, 0x69, 0x6c, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e,
...
var file_api_cover_optimizationrecommendation_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_api_cover_optimizationrecommendation_proto_goTypes = []any{
	...
	(*LambdaDetails)(nil),                          // 18: blueapi.api.cover.LambdaDetails
	(*APNDetails)(nil),                             // 19: blueapi.api.cover.APNDetails
	(*CostCalculation)(nil),                        // 20: blueapi.api.cover.CostCalculation
	(*UpgradeRecommendationDetails)(nil),           // 21: blueapi.api.cover.UpgradeRecommendationDetails
	(*UpgradeEC2Details)(nil),                      // 22: blueapi.api.cover.UpgradeEC2Details
	(*EC2UpgadeDetails)(nil),                       // 23: blueapi.api.cover.EC2UpgadeDetails
	(*UpgradeEBSDetails)(nil),                      // 24: blueapi.api.cover.UpgradeEBSDetails
	(*UpgradeEBSRecommendationDetails)(nil),        // 25: blueapi.api.cover.UpgradeEBSRecommendationDetails
	(*CurrentEBSDetails)(nil),                      // 26: blueapi.api.cover.CurrentEBSDetails
	(*APS1EBSDetails)(nil),                         // 27: blueapi.api.cover.APS1EBSDetails
	(*MigrateRecommendationDetails)(nil),           // 28: blueapi.api.cover.MigrateRecommendationDetails
	(*MigrateEC2Details)(nil),                      // 29: blueapi.api.cover.MigrateEC2Details
}
var file_api_cover_optimizationrecommendation_proto_depIdxs = []int32{
	...
	21, // 3: blueapi.api.cover.AWSRecommendations.upgradeRecommendationDetails:type_name -> blueapi.api.cover.UpgradeRecommendationDetails
	28, // 4: blueapi.api.cover.AWSRecommendations.migrateRecommendationDetails:type_name -> blueapi.api.cover.MigrateRecommendationDetails
	...
	16, // 17: blueapi.api.cover.CurrentEC2Details.eC2CpuUtilization:type_name -> blueapi.api.cover.UtilizationData
	16, // 18: blueapi.api.cover.CurrentEC2Details.eC2DiskUtilization:type_name -> blueapi.api.cover.UtilizationData
	16, // 19: blueapi.api.cover.CurrentEC2Details.eC2MemoryUtilization:type_name -> blueapi.api.cover.UtilizationData
	16, // 20: blueapi.api.cover.CurrentEC2Details.networkTrafficData:type_name -> blueapi.api.cover.UtilizationData
	18, // 21: blueapi.api.cover.LambdaRightSizingRecommendationDetails.lambdaCurrentConfiguration:type_name -> blueapi.api.cover.LambdaDetails
	18, // 22: blueapi.api.cover.LambdaRightSizingRecommendationDetails.lambdaRecommendedConfiguration:type_name -> blueapi.api.cover.LambdaDetails
	20, // 23: blueapi.api.cover.LambdaDetails.costCalculation:type_name -> blueapi.api.cover.CostCalculation
	19, // 24: blueapi.api.cover.LambdaDetails.apn1LambdaGBUsage:type_name -> blueapi.api.cover.APNDetails
	19, // 25: blueapi.api.cover.LambdaDetails.apn1RequestUsage:type_name -> blueapi.api.cover.APNDetails
	22, // 26: blueapi.api.cover.UpgradeRecommendationDetails.upgradeEC2Details:type_name -> blueapi.api.cover.UpgradeEC2Details
	24, // 27: blueapi.api.cover.UpgradeRecommendationDetails.upgradeEBSDetails:type_name -> blueapi.api.cover.UpgradeEBSDetails
	23, // 28: blueapi.api.cover.UpgradeEC2Details.eC2CurrentDetails:type_name -> blueapi.api.cover.EC2UpgadeDetails
	23, // 29: blueapi.api.cover.UpgradeEC2Details.ugradeEC2RecommendationDetails:type_name -> blueapi.api.cover.EC2UpgadeDetails
	20, // 30: blueapi.api.cover.UpgradeEC2Details.currentCostCalculation:type_name -> blueapi.api.cover.CostCalculation
	20, // 31: blueapi.api.cover.UpgradeEC2Details.estimatedCostCalculation:type_name -> blueapi.api.cover.CostCalculation
	26, // 32: blueapi.api.cover.UpgradeEBSDetails.currentEBSDetails:type_name -> blueapi.api.cover.CurrentEBSDetails
	25, // 33: blueapi.api.cover.UpgradeEBSDetails.upgradeEBSDetails:type_name -> blueapi.api.cover.UpgradeEBSRecommendationDetails
	20, // 34: blueapi.api.cover.UpgradeEBSRecommendationDetails.EstcostCalculation:type_name -> blueapi.api.cover.CostCalculation
	27, // 35: blueapi.api.cover.UpgradeEBSRecommendationDetails.volumeUsageGP3:type_name -> blueapi.api.cover.APS1EBSDetails
	27, // 36: blueapi.api.cover.UpgradeEBSRecommendationDetails.volumeIopsGP3:type_name -> blueapi.api.cover.APS1EBSDetails
	27, // 37: blueapi.api.cover.UpgradeEBSRecommendationDetails.volumeThroughputGP3:type_name -> blueapi.api.cover.APS1EBSDetails
	20, // 38: blueapi.api.cover.CurrentEBSDetails.costCalculation:type_name -> blueapi.api.cover.CostCalculation
	27, // 39: blueapi.api.cover.CurrentEBSDetails.volumeUsage:type_name -> blueapi.api.cover.APS1EBSDetails
	29, // 40: blueapi.api.cover.MigrateRecommendationDetails.migrateEC2Details:type_name -> blueapi.api.cover.MigrateEC2Details
	23, // 41: blueapi.api.cover.MigrateEC2Details.eC2CurrentDetails:type_name -> blueapi.api.cover.EC2UpgadeDetails
	23, // 42: blueapi.api.cover.MigrateEC2Details.ugradeEC2RecommendationDetails:type_name -> blueapi.api.cover.EC2UpgadeDetails
	20, // 43: blueapi.api.cover.MigrateEC2Details.currentCostCalculation:type_name -> blueapi.api.cover.CostCalculation
	20, // 44: blueapi.api.cover.MigrateEC2Details.estCostCalculation:type_name -> blueapi.api.cover.CostCalculation
