...
func file_api_cover_applyrecommendation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_cover_applyrecommendation_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*EC2); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_cover_applyrecommendation_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Lambda); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_cover_applyrecommendation_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*EBS); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_cover_applyrecommendation_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*AWS); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_cover_applyrecommendation_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*GCP); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_cover_applyrecommendation_proto_msgTypes[5].Exporter = func(v any, i int) any {
