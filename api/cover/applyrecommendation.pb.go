...
var file_api_cover_applyrecommendation_proto_goTypes = []interface{}{
...
func file_api_cover_applyrecommendation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_cover_applyrecommendation_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EC2); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_cover_applyrecommendation_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Lambda); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_cover_applyrecommendation_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EBS); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_cover_applyrecommendation_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AWS); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_cover_applyrecommendation_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GCP); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_cover_applyrecommendation_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AzureCSP); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
