...
type AwsCostForecast struct {
	...
	LowerBound float32 `protobuf:"fixed32,5,opt,name=lowerBound,proto3" json:"lowerBound,omitempty"`
	UpperBound float32 `protobuf:"fixed32,6,opt,name=upperBound,proto3" json:"upperBound,omitempty"`
	// Forcasted cost based on unblended cost
	UnblendedCost       float32 `protobuf:"fixed32,7,opt,name=unblendedCost,proto3" json:"unblendedCost,omitempty"`
	UnblendedLowerBound float32 `protobuf:"fixed32,8,opt,name=unblendedLowerBound,proto3" json:"unblendedLowerBound,omitempty"`
	UnblendedUpperBound float32 `protobuf:"fixed32,9,opt,name=unblendedUpperBound,proto3" json:"unblendedUpperBound,omitempty"`
}
...
func (x *AwsCostForecast) GetCost() float32 {
	if x != nil {
		return x.Cost
	}
	return 0
...
func (x *AwsCostForecast) GetLowerBound() float32 {
	if x != nil {
		return x.LowerBound
	}
	return 0
...
func (x *AwsCostForecast) GetUpperBound() float32 {
	if x != nil {
		return x.UpperBound
	}
	return 0
...
func (x *AwsCostForecast) GetUnblendedCost() float32 {
	if x != nil {
...
func (x *AwsCostForecast) GetUnblendedLowerBound() float32 {
	if x != nil {
...
func (x *AwsCostForecast) GetUnblendedUpperBound() float32 {
	if x != nil {
...
var file_api_cover_costforecast_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x02, 0x52, 0x04, 0x63, 0x6f, 0x73, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x6c, 0x6f, 0x77,
	0x65, 0x72, 0x42, 0x6f, 0x75, 0x6e, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0a, 0x6c,
	0x6f, 0x77, 0x65, 0x72, 0x42, 0x6f, 0x75, 0x6e, 0x64, 0x12, 0x1e, 0x0a, 0x0a, 0x75, 0x70, 0x70,
	0x65, 0x72, 0x42, 0x6f, 0x75, 0x6e, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0a, 0x75,
	0x70, 0x70, 0x65, 0x72, 0x42, 0x6f, 0x75, 0x6e, 0x64, 0x12, 0x24, 0x0a, 0x0d, 0x75, 0x6e, 0x62,
	0x6c, 0x65, 0x6e, 0x64, 0x65, 0x64, 0x43, 0x6f, 0x73, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x02,
	...
	0x72, 0x42, 0x6f, 0x75, 0x6e, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x02, 0x52, 0x13, 0x75, 0x6e,
	...
	0x70, 0x65, 0x72, 0x42, 0x6f, 0x75, 0x6e, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x02, 0x52, 0x13,
