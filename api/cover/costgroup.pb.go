...
var file_api_cover_costgroup_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x08, 0x74, 0x61, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x4f, 0x0a, 0x07,
	...
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x42, 0x67, 0x0a,
	...
	0x42, 0x16, 0x41, 0x70, 0x69, 0x43, 0x6f, 0x76, 0x65, 0x72, 0x43, 0x6f, 0x73, 0x74, 0x47, 0x72,
	0x6f, 0x75, 0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_api_cover_costgroup_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_api_cover_costgroup_proto_goTypes = []interface{}{
	...
	(*Account)(nil),        // 2: blueapi.api.cover.Account
	(*MemberUserData)(nil), // 3: blueapi.api.cover.MemberUserData
}
var file_api_cover_costgroup_proto_depIdxs = []int32{
	3, // 0: blueapi.api.cover.CostGroupData.members:type_name -> blueapi.api.cover.MemberUserData
	1, // 1: blueapi.api.cover.CostGroupData.combinations:type_name -> blueapi.api.cover.Combinations
	3, // 2: blueapi.api.cover.CostGroupData.createdBy:type_name -> blueapi.api.cover.MemberUserData
