...
func (x *SharedResources) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *SharedResources) GetDistribution() map[string]float64 {
	if x != nil {
		return x.Distribution
	}
	return nil
...
var file_api_cover_unitcost_proto_rawDesc = []byte{
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x43, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x22, 0xf0, 0x01, 0x0a, 0x0f, 0x53, 0x68, 0x61, 0x72, 0x65, 0x64, 0x52, 0x65,
	...
	0x28, 0x09, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x58, 0x0a, 0x0c, 0x64,
	...
	0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x44, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x69,
...
var file_api_cover_unitcost_proto_goTypes = []any{
	...
	nil,                              // 4: blueapi.api.cover.SharedResources.DistributionEntry
...
var file_api_cover_unitcost_proto_depIdxs = []int32{
	...
	4, // 3: blueapi.api.cover.SharedResources.distribution:type_name -> blueapi.api.cover.SharedResources.DistributionEntry
