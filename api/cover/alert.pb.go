...
type AlertChannels struct {
	...
	Slack   []string `protobuf:"bytes,2,rep,name=slack,proto3" json:"slack,omitempty"`
	Msteams []string `protobuf:"bytes,3,rep,name=msteams,proto3" json:"msteams,omitempty"`
}
...
func (x *AlertChannels) GetEmail() []string {
	if x != nil {
		return x.Email
	}
	return nil
...
func (x *AlertChannels) GetSlack() []string {
	if x != nil {
		return x.Slack
	}
	return nil
...
func (x *AlertChannels) GetMsteams() []string {
	if x != nil {
		return x.Msteams
	}
	return nil
...
var file_api_cover_alert_proto_rawDesc = []byte{
	...
	,
...
var file_api_cover_alert_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
