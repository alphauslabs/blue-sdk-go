...
var file_api_cover_recommendation_octogcp_proto_rawDesc = string([]byte{
...
var (
	...
	file_api_cover_recommendation_octogcp_proto_rawDescData []byte
)
...
func file_api_cover_recommendation_octogcp_proto_rawDescGZIP() []byte {
	file_api_cover_recommendation_octogcp_proto_rawDescOnce.Do(func() {
		file_api_cover_recommendation_octogcp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_cover_recommendation_octogcp_proto_rawDesc), len(file_api_cover_recommendation_octogcp_proto_rawDesc)))
	})
...
func file_api_cover_recommendation_octogcp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_cover_recommendation_octogcp_proto_rawDesc), len(file_api_cover_recommendation_octogcp_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
