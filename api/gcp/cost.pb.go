...
type Cost struct {
	...
	UsagePricingUnit string `protobuf:"bytes,12,opt,name=usagePricingUnit,proto3" json:"usagePricingUnit,omitempty"`
	// The usage.amount_in_pricing_units of the lineitem, if applicable.
	UsagePricingAmount float64 `protobuf:"fixed64,13,opt,name=usagePricingAmount,proto3" json:"usagePricingAmount,omitempty"`
...
func (x *Cost) GetUsagePricingUnit() string {
	if x != nil {
...
func (x *Cost) GetUsagePricingAmount() float64 {
	if x != nil {
...
var file_api_gcp_cost_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x75, 0x73, 0x61, 0x67, 0x65, 0x50,
	...
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x01, 0x52, 0x12, 0x75, 0x73, 0x61, 0x67, 0x65, 0x50, 0x72, 0x69,
