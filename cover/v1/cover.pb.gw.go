...
var (
	...
	pattern_Cover_UpdateRiSpExpirationAlert_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"v1", "alerts", "expire", "risp", "orgId", "type"}, ""))

	pattern_Cover_GetRiSpExpirationAlert_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"v1", "alerts", "expire", "risp", "orgId", "type"}, ""))
)
