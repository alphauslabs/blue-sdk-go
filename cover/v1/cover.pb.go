...
var file_cover_v1_cover_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x2a, 0x3f, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0b, 0x0a,
	...
	0x45, 0x44, 0x10, 0x03, 0x32, 0x83, 0x9b, 0x01, 0x0a, 0x05, 0x43, 0x6f, 0x76, 0x65, 0x72, 0x12,
...
var file_cover_v1_cover_proto_msgTypes = make([]protoimpl.MessageInfo, 254)
var file_cover_v1_cover_proto_goTypes = []interface{}{
	...
	nil,                                             // 252: blueapi.cover.v1.ListAssetsFilters.AndFiltersEntry
	nil,                                             // 253: blueapi.cover.v1.ReadCostsRequestOptionsFilters.AndFiltersEntry
	nil,                                             // 254: blueapi.cover.v1.Criteria.AndEntry
	(*cover.UserData)(nil),                          // 255: blueapi.api.cover.UserData
	(*cover.MemberCostGroup)(nil),                   // 256: blueapi.api.cover.MemberCostGroup
	(*cover.ViewData)(nil),                          // 257: blueapi.api.cover.ViewData
	(*cover.ViewList)(nil),                          // 258: blueapi.api.cover.ViewList
	(*cover.Favorites)(nil),                         // 259: blueapi.api.cover.Favorites
	(*cover.WidgetData)(nil),                        // 260: blueapi.api.cover.WidgetData
	(*cover.ViewLayout)(nil),                        // 261: blueapi.api.cover.ViewLayout
	(*structpb.Struct)(nil),                         // 262: google.protobuf.Struct
	(*cover.LayoutRequests)(nil),                    // 263: blueapi.api.cover.LayoutRequests
	(*cover.SideMenuState)(nil),                     // 264: blueapi.api.cover.SideMenuState
	(*cover.Combinations)(nil),                      // 265: blueapi.api.cover.Combinations
	(*cover.CostGroupData)(nil),                     // 266: blueapi.api.cover.CostGroupData
	(*cover.RegistrationStatus)(nil),                // 267: blueapi.api.cover.RegistrationStatus
	(*cover.Account)(nil),                           // 268: blueapi.api.cover.Account
	(*cover.IncludeForecast)(nil),                   // 269: blueapi.api.cover.IncludeForecast
	(*cover.AwsCostForecast)(nil),                   // 270: blueapi.api.cover.AwsCostForecast
	(*cover.ResourceData)(nil),                      // 271: blueapi.api.cover.ResourceData
	(*cover.TagData)(nil),                           // 272: blueapi.api.cover.TagData
	(*cover.GcpOptions)(nil),                        // 273: blueapi.api.cover.GcpOptions
	(*cover.AzureOptions)(nil),                      // 274: blueapi.api.cover.AzureOptions
	(*cover.AwsOptions)(nil),                        // 275: blueapi.api.cover.AwsOptions
	(*cover.Result)(nil),                            // 276: blueapi.api.cover.Result
	(*cover.Category)(nil),                          // 277: blueapi.api.cover.Category
	(*cover.AlertData)(nil),                         // 278: blueapi.api.cover.AlertData
	(*cover.ChannelData)(nil),                       // 279: blueapi.api.cover.ChannelData
	(*cover.AwsInputs)(nil),                         // 280: blueapi.api.cover.AwsInputs
	(*cover.AzureInputs)(nil),                       // 281: blueapi.api.cover.AzureInputs
	(*cover.GcpInputs)(nil),                         // 282: blueapi.api.cover.GcpInputs
	(*cover.AwsDiscountRecommendations)(nil),        // 283: blueapi.api.cover.AwsDiscountRecommendations
	(*cover.AzureDiscountRecommendations)(nil),      // 284: blueapi.api.cover.AzureDiscountRecommendations
	(*cover.GcpDiscountRecommendations)(nil),        // 285: blueapi.api.cover.GcpDiscountRecommendations
	(*cover.AlertCostGroup)(nil),                    // 286: blueapi.api.cover.AlertCostGroup
	(*cover.AlertChannels)(nil),                     // 287: blueapi.api.cover.AlertChannels
	(*cover.BudgetData)(nil),                        // 288: blueapi.api.cover.BudgetData
	(*cover.ExecutiveSummary)(nil),                  // 289: blueapi.api.cover.ExecutiveSummary
	(*cover.OptimizationRecommendationSummary)(nil), // 290: blueapi.api.cover.OptimizationRecommendationSummary
	(*cover.SavingsSummary)(nil),                    // 291: blueapi.api.cover.SavingsSummary
	(*cover.AWSRecommendations)(nil),                // 292: blueapi.api.cover.AWSRecommendations
	(*cover.AWS)(nil),                               // 293: blueapi.api.cover.AWS
	(*cover.GCP)(nil),                               // 294: blueapi.api.cover.GCP
	(*cover.AzureCSP)(nil),                          // 295: blueapi.api.cover.AzureCSP
	(*cover.CostGroupSpendingData)(nil),             // 296: blueapi.api.cover.CostGroupSpendingData
	(*cover.NoOfExecutedRecommendation)(nil),        // 297: blueapi.api.cover.NoOfExecutedRecommendation
...
var file_cover_v1_cover_proto_depIdxs = []int32{
	255, // 0: blueapi.cover.v1.OnboardOrgResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 1: blueapi.cover.v1.ActivateUserResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 2: blueapi.cover.v1.CreateMemberResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 3: blueapi.cover.v1.GetMembersResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 4: blueapi.cover.v1.GetMemberDetailsResponse.userData:type_name -> blueapi.api.cover.UserData
	256, // 5: blueapi.cover.v1.GetMemberCostGroupResponse.costGroups:type_name -> blueapi.api.cover.MemberCostGroup
	255, // 6: blueapi.cover.v1.UpdateMemberPermissionResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 7: blueapi.cover.v1.GetUserDetailsResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 8: blueapi.cover.v1.UpdateUserAvatarResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 9: blueapi.cover.v1.UpdateUserIconResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 10: blueapi.cover.v1.UpdateUserColorThemeResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 11: blueapi.cover.v1.UpdateUserNameResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 12: blueapi.cover.v1.UpdateUserEmailResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 13: blueapi.cover.v1.UpdateUserMainViewResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 14: blueapi.cover.v1.ResetUserPasswordResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 15: blueapi.cover.v1.UpdateUserLocaleResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 16: blueapi.cover.v1.UpdateUserAppThemeResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 17: blueapi.cover.v1.UpdateUserTimezoneResponse.userData:type_name -> blueapi.api.cover.UserData
	255, // 18: blueapi.cover.v1.UpdateUserAttributesResponse.userData:type_name -> blueapi.api.cover.UserData
	257, // 19: blueapi.cover.v1.CreateViewResponse.viewData:type_name -> blueapi.api.cover.ViewData
	258, // 20: blueapi.cover.v1.GetViewsResponse.viewList:type_name -> blueapi.api.cover.ViewList
	257, // 21: blueapi.cover.v1.GetCurrentViewResponse.viewData:type_name -> blueapi.api.cover.ViewData
	259, // 22: blueapi.cover.v1.GetFavoriteViewsResponse.favorites:type_name -> blueapi.api.cover.Favorites
	260, // 23: blueapi.cover.v1.UpdateViewLayoutRequest.layout:type_name -> blueapi.api.cover.WidgetData
	261, // 24: blueapi.cover.v1.UpdateViewLayoutResponse.layout:type_name -> blueapi.api.cover.ViewLayout
	262, // 25: blueapi.cover.v1.UpdateViewWidgetRequest.options:type_name -> google.protobuf.Struct
	263, // 26: blueapi.cover.v1.UpdateViewWidgetRequest.requests:type_name -> blueapi.api.cover.LayoutRequests
	260, // 27: blueapi.cover.v1.UpdateViewWidgetResponse.widgetData:type_name -> blueapi.api.cover.WidgetData
	257, // 28: blueapi.cover.v1.UpdateViewColorThemeResponse.viewData:type_name -> blueapi.api.cover.ViewData
	264, // 29: blueapi.cover.v1.UpdateSideMenuStateRequest.sidemenustate:type_name -> blueapi.api.cover.SideMenuState
	265, // 30: blueapi.cover.v1.CreateCostGroupRequest.combinations:type_name -> blueapi.api.cover.Combinations
	266, // 31: blueapi.cover.v1.CreateCostGroupResponse.costGroupData:type_name -> blueapi.api.cover.CostGroupData
	266, // 32: blueapi.cover.v1.GetCostGroupsResponse.costGroupData:type_name -> blueapi.api.cover.CostGroupData
	266, // 33: blueapi.cover.v1.GetCostGroupDetailsResponse.costGroupData:type_name -> blueapi.api.cover.CostGroupData
	265, // 34: blueapi.cover.v1.UpdateCostGroupCombinationsRequest.combinations:type_name -> blueapi.api.cover.Combinations
	265, // 35: blueapi.cover.v1.UpdateCostGroupCombinationsResponse.combinations:type_name -> blueapi.api.cover.Combinations
	267, // 36: blueapi.cover.v1.AccountAccess.registrationStatus:type_name -> blueapi.api.cover.RegistrationStatus
	...
	252, // 39: blueapi.cover.v1.ListAssetsFilters.andFilters:type_name -> blueapi.cover.v1.ListAssetsFilters.AndFiltersEntry
	...
	268, // 43: blueapi.cover.v1.ResolveCostGroupCombinationsResponse.accounts:type_name -> blueapi.api.cover.Account
	...
	269, // 49: blueapi.cover.v1.GetCostUsageRequest.includeForecast:type_name -> blueapi.api.cover.IncludeForecast
	...
	253, // 61: blueapi.cover.v1.ReadCostsRequestOptionsFilters.andFilters:type_name -> blueapi.cover.v1.ReadCostsRequestOptionsFilters.AndFiltersEntry
	270, // 62: blueapi.cover.v1.CostItem.forecast:type_name -> blueapi.api.cover.AwsCostForecast
	271, // 63: blueapi.cover.v1.GetRightSizingRecommendationResponse.resource:type_name -> blueapi.api.cover.ResourceData
	0,   // 64: blueapi.cover.v1.UploadChargeCodeResponse.status:type_name -> blueapi.cover.v1.Status
	272, // 65: blueapi.cover.v1.GetTagsResponse.tagData:type_name -> blueapi.api.cover.TagData
	254, // 66: blueapi.cover.v1.Criteria.and:type_name -> blueapi.cover.v1.Criteria.AndEntry
	...
	262, // 73: blueapi.cover.v1.ProxyCreateCompletionRequest.params:type_name -> google.protobuf.Struct
	273, // 74: blueapi.cover.v1.DataAccess.gcpOptions:type_name -> blueapi.api.cover.GcpOptions
	274, // 75: blueapi.cover.v1.DataAccess.azureOptions:type_name -> blueapi.api.cover.AzureOptions
	275, // 76: blueapi.cover.v1.DataAccess.awsOptions:type_name -> blueapi.api.cover.AwsOptions
	273, // 77: blueapi.cover.v1.RegisterDataAccessRequest.gcpOptions:type_name -> blueapi.api.cover.GcpOptions
	274, // 78: blueapi.cover.v1.RegisterDataAccessRequest.azureOptions:type_name -> blueapi.api.cover.AzureOptions
	275, // 79: blueapi.cover.v1.RegisterDataAccessRequest.awsOptions:type_name -> blueapi.api.cover.AwsOptions
	273, // 80: blueapi.cover.v1.UpdateDataAccessRequest.gcpOptions:type_name -> blueapi.api.cover.GcpOptions
	274, // 81: blueapi.cover.v1.UpdateDataAccessRequest.azureOptions:type_name -> blueapi.api.cover.AzureOptions
	275, // 82: blueapi.cover.v1.UpdateDataAccessRequest.awsOptions:type_name -> blueapi.api.cover.AwsOptions
	276, // 83: blueapi.cover.v1.GetCostGroupAttributeResponse.result:type_name -> blueapi.api.cover.Result
	272, // 84: blueapi.cover.v1.GetCostGroupAttributeResponse.tagData:type_name -> blueapi.api.cover.TagData
	277, // 85: blueapi.cover.v1.GetCategoriesResponse.category:type_name -> blueapi.api.cover.Category
	278, // 86: blueapi.cover.v1.GetAlertsResponse.alertData:type_name -> blueapi.api.cover.AlertData
	278, // 87: blueapi.cover.v1.CreateAlertResponse.alertData:type_name -> blueapi.api.cover.AlertData
	278, // 88: blueapi.cover.v1.GetAlertDetailsResponse.alertData:type_name -> blueapi.api.cover.AlertData
	278, // 89: blueapi.cover.v1.UpdateAlertDetailsResponse.alertData:type_name -> blueapi.api.cover.AlertData
	279, // 90: blueapi.cover.v1.GetChannelsResponse.channelData:type_name -> blueapi.api.cover.ChannelData
	279, // 91: blueapi.cover.v1.CreateChannelResponse.channelData:type_name -> blueapi.api.cover.ChannelData
	279, // 92: blueapi.cover.v1.GetChannelDetailsResponse.channelData:type_name -> blueapi.api.cover.ChannelData
	279, // 93: blueapi.cover.v1.UpdateChannelDetailsResponse.channelData:type_name -> blueapi.api.cover.ChannelData
	280, // 94: blueapi.cover.v1.GetDiscountRecommendationsRequest.awsInputs:type_name -> blueapi.api.cover.AwsInputs
	281, // 95: blueapi.cover.v1.GetDiscountRecommendationsRequest.azureInputs:type_name -> blueapi.api.cover.AzureInputs
	282, // 96: blueapi.cover.v1.GetDiscountRecommendationsRequest.gcpInputs:type_name -> blueapi.api.cover.GcpInputs
	283, // 97: blueapi.cover.v1.GetDiscountRecommendationsResponse.awsRecommendations:type_name -> blueapi.api.cover.AwsDiscountRecommendations
	284, // 98: blueapi.cover.v1.GetDiscountRecommendationsResponse.azureRecommendations:type_name -> blueapi.api.cover.AzureDiscountRecommendations
	285, // 99: blueapi.cover.v1.GetDiscountRecommendationsResponse.gcpRecommendations:type_name -> blueapi.api.cover.GcpDiscountRecommendations
	286, // 100: blueapi.cover.v1.DiscountExpiryAlertData.costGroups:type_name -> blueapi.api.cover.AlertCostGroup
	287, // 101: blueapi.cover.v1.DiscountExpiryAlertData.channels:type_name -> blueapi.api.cover.AlertChannels
	286, // 102: blueapi.cover.v1.AnomalyAlertData.costGroupId:type_name -> blueapi.api.cover.AlertCostGroup
	287, // 103: blueapi.cover.v1.AnomalyAlertData.channels:type_name -> blueapi.api.cover.AlertChannels
	288, // 104: blueapi.cover.v1.ListBudgetsResponse.budgetData:type_name -> blueapi.api.cover.BudgetData
	288, // 105: blueapi.cover.v1.GetBudgetResponse.budgetData:type_name -> blueapi.api.cover.BudgetData
	288, // 106: blueapi.cover.v1.CreateBudgetRequest.budgetData:type_name -> blueapi.api.cover.BudgetData
	288, // 107: blueapi.cover.v1.CreateBudgetResponse.budgetData:type_name -> blueapi.api.cover.BudgetData
	288, // 108: blueapi.cover.v1.UpdateBudgetRequest.budgetData:type_name -> blueapi.api.cover.BudgetData
	288, // 109: blueapi.cover.v1.UpdateBudgetResponse.budgetData:type_name -> blueapi.api.cover.BudgetData
	289, // 110: blueapi.cover.v1.GetReportSummaryResponse.executiveSummary:type_name -> blueapi.api.cover.ExecutiveSummary
	290, // 111: blueapi.cover.v1.GetReportSummaryResponse.optimizationRecommendationSummary:type_name -> blueapi.api.cover.OptimizationRecommendationSummary
	291, // 112: blueapi.cover.v1.GetReportSummaryResponse.savingsSummary:type_name -> blueapi.api.cover.SavingsSummary
	292, // 113: blueapi.cover.v1.GetRecommendationResponse.recommendationData:type_name -> blueapi.api.cover.AWSRecommendations
	293, // 114: blueapi.cover.v1.ExecuteOptimizationRequest.awsOptions:type_name -> blueapi.api.cover.AWS
	294, // 115: blueapi.cover.v1.ExecuteOptimizationRequest.gcpOptions:type_name -> blueapi.api.cover.GCP
	295, // 116: blueapi.cover.v1.ExecuteOptimizationRequest.azureCspOptions:type_name -> blueapi.api.cover.AzureCSP
	296, // 117: blueapi.cover.v1.OptimizationHistoryResponse.costGroupSpendingData:type_name -> blueapi.api.cover.CostGroupSpendingData
	297, // 118: blueapi.cover.v1.OptimizationHistoryResponse.noOfExecutedRecommendation:type_name -> blueapi.api.cover.NoOfExecutedRecommendation
	298, // 119: blueapi.cover.v1.OptimizationHistoryResponse.executedRecommendationDetails:type_name -> blueapi.api.cover.ExecutedRecommendationDetails
	299, // 120: blueapi.cover.v1.SetCostGroupEventIndicatorResponse.eventIndicator:type_name -> blueapi.api.cover.EventIndicator
	300, // 121: blueapi.cover.v1.SetCostGroupAnomalyOptionsResponse.anomalyOptions:type_name -> blueapi.api.cover.AnomalyOptions
	...
	179, // 300: blueapi.cover.v1.Cover.GetCategories:output_type -> blueapi.cover.v1.GetCategoriesResponse
	...
	116, // 308: blueapi.cover.v1.Cover.ResolveCostGroupCombinations:output_type -> blueapi.cover.v1.ResolveCostGroupCombinationsResponse
	...
	168, // 315: blueapi.cover.v1.Cover.GetDataAccess:output_type -> blueapi.cover.v1.DataAccess
	301, // 316: blueapi.cover.v1.Cover.DeleteDataAccess:output_type -> google.protobuf.Empty
	...
	302, // 319: blueapi.cover.v1.Cover.UpdateAccountAccess:output_type -> protos.Operation
	107, // 320: blueapi.cover.v1.Cover.DeleteAccountAccess:output_type -> blueapi.cover.v1.DeleteAccountAccessResponse
	301, // 321: blueapi.cover.v1.Cover.RegisterAccount:output_type -> google.protobuf.Empty
	301, // 322: blueapi.cover.v1.Cover.RegisterDataAccess:output_type -> google.protobuf.Empty
	301, // 323: blueapi.cover.v1.Cover.AddBillingAccount:output_type -> google.protobuf.Empty
	168, // 324: blueapi.cover.v1.Cover.ListDataAccess:output_type -> blueapi.cover.v1.DataAccess
	301, // 325: blueapi.cover.v1.Cover.UpdateDataAccess:output_type -> google.protobuf.Empty
	111, // 326: blueapi.cover.v1.Cover.ListAssets:output_type -> blueapi.cover.v1.Resource
	113, // 327: blueapi.cover.v1.Cover.GetAssetsSummary:output_type -> blueapi.cover.v1.GetAssetsSummaryResponse
	124, // 328: blueapi.cover.v1.Cover.GetCostUsage:output_type -> blueapi.cover.v1.CostItem
	126, // 329: blueapi.cover.v1.Cover.GetRightSizingRecommendation:output_type -> blueapi.cover.v1.GetRightSizingRecommendationResponse
	128, // 330: blueapi.cover.v1.Cover.ModifyResourceType:output_type -> blueapi.cover.v1.ModifyResourceTypeResponse
	130, // 331: blueapi.cover.v1.Cover.TerminateResource:output_type -> blueapi.cover.v1.TerminateResourceResponse
	132, // 332: blueapi.cover.v1.Cover.UploadChargeCode:output_type -> blueapi.cover.v1.UploadChargeCodeResponse
	134, // 333: blueapi.cover.v1.Cover.AssignPayer:output_type -> blueapi.cover.v1.AssignPayerResponse
	136, // 334: blueapi.cover.v1.Cover.GetPayers:output_type -> blueapi.cover.v1.GetPayersResponse
	138, // 335: blueapi.cover.v1.Cover.GetAccounts:output_type -> blueapi.cover.v1.GetAccountsResponse
	140, // 336: blueapi.cover.v1.Cover.GetServices:output_type -> blueapi.cover.v1.GetServicesResponse
	142, // 337: blueapi.cover.v1.Cover.GetRegions:output_type -> blueapi.cover.v1.GetRegionsResponse
	144, // 338: blueapi.cover.v1.Cover.GetTags:output_type -> blueapi.cover.v1.GetTagsResponse
	146, // 339: blueapi.cover.v1.Cover.ListFees:output_type -> blueapi.cover.v1.FeeDetails
	146, // 340: blueapi.cover.v1.Cover.RestoreFee:output_type -> blueapi.cover.v1.FeeDetails
	149, // 341: blueapi.cover.v1.Cover.GetCostGroupFee:output_type -> blueapi.cover.v1.FeeItem
	152, // 342: blueapi.cover.v1.Cover.ListAllocators:output_type -> blueapi.cover.v1.CostAllocatorDetails
	152, // 343: blueapi.cover.v1.Cover.CreateAllocator:output_type -> blueapi.cover.v1.CostAllocatorDetails
	152, // 344: blueapi.cover.v1.Cover.UpdateAllocator:output_type -> blueapi.cover.v1.CostAllocatorDetails
	301, // 345: blueapi.cover.v1.Cover.DeleteAllocator:output_type -> google.protobuf.Empty
	158, // 346: blueapi.cover.v1.Cover.ProxyCreateCompletion:output_type -> blueapi.cover.v1.ProxyCreateCompletionResponse
	146, // 347: blueapi.cover.v1.Cover.SimulateFeeAllocator:output_type -> blueapi.cover.v1.FeeDetails
	159, // 348: blueapi.cover.v1.Cover.ListAccountUsage:output_type -> blueapi.cover.v1.AccountUsageDetails
	159, // 349: blueapi.cover.v1.Cover.RestoreAccountUsage:output_type -> blueapi.cover.v1.AccountUsageDetails
	159, // 350: blueapi.cover.v1.Cover.SimulateAccountUsage:output_type -> blueapi.cover.v1.AccountUsageDetails
	163, // 351: blueapi.cover.v1.Cover.ListSavings:output_type -> blueapi.cover.v1.SavingsDetails
	163, // 352: blueapi.cover.v1.Cover.RestoreSavings:output_type -> blueapi.cover.v1.SavingsDetails
	163, // 353: blueapi.cover.v1.Cover.SimulateSavings:output_type -> blueapi.cover.v1.SavingsDetails
	165, // 354: blueapi.cover.v1.Cover.GetCostGroupAllocation:output_type -> blueapi.cover.v1.AllocationItem
	167, // 355: blueapi.cover.v1.Cover.ProcessAuth0User:output_type -> blueapi.cover.v1.ProcessAuth0UserResponse
	301, // 356: blueapi.cover.v1.Cover.AddPartnerCenterCredentials:output_type -> google.protobuf.Empty
	301, // 357: blueapi.cover.v1.Cover.AddMpnSetting:output_type -> google.protobuf.Empty
	177, // 358: blueapi.cover.v1.Cover.GetCostGroupAttribute:output_type -> blueapi.cover.v1.GetCostGroupAttributeResponse
	181, // 359: blueapi.cover.v1.Cover.GetAlerts:output_type -> blueapi.cover.v1.GetAlertsResponse
	183, // 360: blueapi.cover.v1.Cover.CreateAlert:output_type -> blueapi.cover.v1.CreateAlertResponse
	185, // 361: blueapi.cover.v1.Cover.GetAlertDetails:output_type -> blueapi.cover.v1.GetAlertDetailsResponse
	187, // 362: blueapi.cover.v1.Cover.DeleteAlert:output_type -> blueapi.cover.v1.DeleteAlertResponse
	189, // 363: blueapi.cover.v1.Cover.UpdateAlertDetails:output_type -> blueapi.cover.v1.UpdateAlertDetailsResponse
	191, // 364: blueapi.cover.v1.Cover.GetChannels:output_type -> blueapi.cover.v1.GetChannelsResponse
	193, // 365: blueapi.cover.v1.Cover.CreateChannel:output_type -> blueapi.cover.v1.CreateChannelResponse
	195, // 366: blueapi.cover.v1.Cover.GetChannelDetails:output_type -> blueapi.cover.v1.GetChannelDetailsResponse
	197, // 367: blueapi.cover.v1.Cover.DeleteChannel:output_type -> blueapi.cover.v1.DeleteChannelResponse
	199, // 368: blueapi.cover.v1.Cover.UpdateChannelDetails:output_type -> blueapi.cover.v1.UpdateChannelDetailsResponse
	201, // 369: blueapi.cover.v1.Cover.GetDiscountRecommendations:output_type -> blueapi.cover.v1.GetDiscountRecommendationsResponse
	203, // 370: blueapi.cover.v1.Cover.GetAnomalyinCostGroup:output_type -> blueapi.cover.v1.AnomalyData
	301, // 371: blueapi.cover.v1.Cover.CreateDiscountExpirationAlert:output_type -> google.protobuf.Empty
	301, // 372: blueapi.cover.v1.Cover.UpdateDiscountExpirationAlert:output_type -> google.protobuf.Empty
	207, // 373: blueapi.cover.v1.Cover.GetDiscountExpirationAlert:output_type -> blueapi.cover.v1.DiscountExpiryAlertData
	207, // 374: blueapi.cover.v1.Cover.ListDiscountExpirationAlert:output_type -> blueapi.cover.v1.DiscountExpiryAlertData
	301, // 375: blueapi.cover.v1.Cover.DeleteDiscountExpirationAlert:output_type -> google.protobuf.Empty
	301, // 376: blueapi.cover.v1.Cover.CreateAnomalyAlert:output_type -> google.protobuf.Empty
	301, // 377: blueapi.cover.v1.Cover.DeleteAnomalyAlert:output_type -> google.protobuf.Empty
	211, // 378: blueapi.cover.v1.Cover.ListAnomalyAlert:output_type -> blueapi.cover.v1.AnomalyAlertData
	211, // 379: blueapi.cover.v1.Cover.GetAnomalyAlert:output_type -> blueapi.cover.v1.AnomalyAlertData
	301, // 380: blueapi.cover.v1.Cover.UpdateAnomalyAlert:output_type -> google.protobuf.Empty
	215, // 381: blueapi.cover.v1.Cover.RegisterNewUser:output_type -> blueapi.cover.v1.RegisterNewUserResponse
	217, // 382: blueapi.cover.v1.Cover.GetUserProfile:output_type -> blueapi.cover.v1.GetUserProfileResponse
	219, // 383: blueapi.cover.v1.Cover.ListBudgets:output_type -> blueapi.cover.v1.ListBudgetsResponse
	221, // 384: blueapi.cover.v1.Cover.GetBudget:output_type -> blueapi.cover.v1.GetBudgetResponse
	223, // 385: blueapi.cover.v1.Cover.CreateBudget:output_type -> blueapi.cover.v1.CreateBudgetResponse
	225, // 386: blueapi.cover.v1.Cover.DeleteBudget:output_type -> blueapi.cover.v1.DeleteBudgetResponse
	227, // 387: blueapi.cover.v1.Cover.UpdateBudget:output_type -> blueapi.cover.v1.UpdateBudgetResponse
	229, // 388: blueapi.cover.v1.Cover.ResolveAWSMarketplaceTokenForOnboarding:output_type -> blueapi.cover.v1.ResolveAWSMarketplaceTokenForOnboardingResponse
	231, // 389: blueapi.cover.v1.Cover.GetCustomerSubscriptionStatus:output_type -> blueapi.cover.v1.GetCustomerSubscriptionStatusResponse
	233, // 390: blueapi.cover.v1.Cover.CreateProfiling:output_type -> blueapi.cover.v1.CreateProfilingResponse
	235, // 391: blueapi.cover.v1.Cover.AddInfotoMarketplace:output_type -> blueapi.cover.v1.AddInfotoMarketplaceResponse
	237, // 392: blueapi.cover.v1.Cover.GetReportSummary:output_type -> blueapi.cover.v1.GetReportSummaryResponse
	239, // 393: blueapi.cover.v1.Cover.ListRecommendations:output_type -> blueapi.cover.v1.ListRecommendationResponse
	241, // 394: blueapi.cover.v1.Cover.GetRecommendation:output_type -> blueapi.cover.v1.GetRecommendationResponse
	243, // 395: blueapi.cover.v1.Cover.ExecuteOptimization:output_type -> blueapi.cover.v1.ExecuteOptimizationResponse
	245, // 396: blueapi.cover.v1.Cover.MarkAsExecuted:output_type -> blueapi.cover.v1.MarkAsExecutedResponse
	247, // 397: blueapi.cover.v1.Cover.OptimizationHistory:output_type -> blueapi.cover.v1.OptimizationHistoryResponse
	249, // 398: blueapi.cover.v1.Cover.SetCostGroupEventIndicator:output_type -> blueapi.cover.v1.SetCostGroupEventIndicatorResponse
	251, // 399: blueapi.cover.v1.Cover.SetCostGroupAnomalyOptions:output_type -> blueapi.cover.v1.SetCostGroupAnomalyOptionsResponse
	261, // [261:400] is the sub-list for method output_type
	122, // [122:261] is the sub-list for method input_type
