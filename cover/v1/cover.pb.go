...
type CreateUnitMetricRequest struct {
	...
	Description       string                 `protobuf:"bytes,4,opt,name=description,proto3" json:"description,omitempty"`
	CostgroupId       string                 `protobuf:"bytes,5,opt,name=costgroupId,proto3" json:"costgroupId,omitempty"`
	CsvInfo           *cover.CsvInfo         `protobuf:"bytes,6,opt,name=csvInfo,proto3" json:"csvInfo,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *CreateUnitMetricRequest) GetCsvInfo() *cover.CsvInfo {
	if x != nil {
		return x.CsvInfo
	}
	return nil
...
type UpdateUnitMetricRequest struct {
	...
	CostgroupId string `protobuf:"bytes,6,opt,name=costgroupId,proto3" json:"costgroupId,omitempty"`
	// Optional
	CsvInfo       *cover.CsvInfo `protobuf:"bytes,7,opt,name=csvInfo,proto3" json:"csvInfo,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateUnitMetricRequest) GetCsvInfo() *cover.CsvInfo {
	if x != nil {
		return x.CsvInfo
	}
	return nil
...
func (*ListRecommendationV2Request_RateSettings) Descriptor() ([]byte, []int) {
	return file_cover_v1_cover_proto_rawDescGZIP(), []int{261, 0}
}
...
func (*ListRecommendationResponse_PurchaseOption) Descriptor() ([]byte, []int) {
	return file_cover_v1_cover_proto_rawDescGZIP(), []int{262, 0}
}
...
func (*ExecuteOptimizationResponse_AWSOption) Descriptor() ([]byte, []int) {
	return file_cover_v1_cover_proto_rawDescGZIP(), []int{266, 0}
}
...
func (*ExecuteOptimizationResponse_GCPOption) Descriptor() ([]byte, []int) {
	return file_cover_v1_cover_proto_rawDescGZIP(), []int{266, 1}
}
...
func (*ExecuteOptimizationResponse_AzureCSPOption) Descriptor() ([]byte, []int) {
	return file_cover_v1_cover_proto_rawDescGZIP(), []int{266, 2}
}

var File_cover_v1_cover_proto protoreflect.FileDescriptor

const file_cover_v1_cover_proto_rawDesc = "" +
	"\n" +
	"\x14cover/v1/cover.proto\x12\x10blueapi.cover.v1\x1a*api/cover/optimizationrecommendation.proto\x1a-api/cover/recommendation/recommendation.proto\x1a\x19api/cover/attribute.proto\x1a\x14api/cover/user.proto\x1a\x14api/cover/view.proto\x1a\x18api/cover/unitcost.proto\x1a\x19api/cover/costgroup.proto\x1a\x1dapi/cover/accountaccess.proto\x1a\x1capi/cover/costforecast.proto\x1a&api/cover/discountrecommendation.proto\x1a)api/cover/rightsizingrecommendation.proto\x1a\x15api/cover/alert.proto\x1a\x16api/cover/budget.proto\x1a\x1dapi/cover/insightreport.proto\x1a\x16protos/operation.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x1b\n" +
	"\x19GetExecutionStatusRequest\"z\n" +
	"\x1aGetExecutionStatusResponse\x12*\n" +
	"\x10recommendationId\x18\x01 \x01(\tR\x10recommendationId\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\"H\n" +
	"\x16VerifyAPIAccessRequest\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12\x16\n" +
	"\x06target\x18\x02 \x01(\tR\x06target\"1\n" +
	"\x17VerifyAPIAccessResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\bR\x06result\"\x8e\x01\n" +
	"\x1aGetRecommendationV2Request\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12 \n" +
	"\vcostGroupId\x18\x02 \x01(\tR\vcostGroupId\x12\"\n" +
	"\fperiodOption\x18\x03 \x01(\tR\fperiodOption\x12\x1a\n" +
	"\bcurrency\x18\x04 \x01(\tR\bcurrency\"g\n" +
	"\x1bGetRecommendationV2Response\x12H\n" +
	"\x04data\x18\x01 \x01(\v24.blueapi.api.cover.recommendation.RecommendationDataR\x04data\"o\n" +
	"\x11OnboardOrgRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x14\n" +
	"\x05orgId\x18\x04 \x01(\tR\x05orgId\"M\n" +
	"\x12OnboardOrgResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"m\n" +
	"\x13InviteMemberRequest\x12\x14\n" +
	"\x05email\x18\x01 \x03(\tR\x05email\x12\x1a\n" +
	"\bisResend\x18\x02 \x01(\bR\bisResend\x12$\n" +
	"\rinviteAsAdmin\x18\x03 \x01(\bR\rinviteAsAdmin\",\n" +
	"\x14InviteMemberResponse\x12\x14\n" +
	"\x05email\x18\x01 \x03(\tR\x05email\"\xf3\x01\n" +
	"\x13ActivateUserRequest\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\tR\x06userId\x12*\n" +
	"\x10previousPassword\x18\x02 \x01(\tR\x10previousPassword\x12\x1a\n" +
	...
	"\aisAuth0\x18\a \x01(\bR\aisAuth0\x12 \n" +
	"\vauth0UserId\x18\b \x01(\tR\vauth0UserId\"O\n" +
	"\x14ActivateUserResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"{\n" +
	"\x13CreateMemberRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x1e\n" +
	"\n" +
	"costgroups\x18\x04 \x03(\tR\n" +
	"costgroups\"O\n" +
	"\x14CreateMemberResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"\x13\n" +
	"\x11GetMembersRequest\"M\n" +
	"\x12GetMembersResponse\x127\n" +
	"\buserData\x18\x01 \x03(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"1\n" +
	"\x17GetMemberDetailsRequest\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\tR\x06userId\"S\n" +
	"\x18GetMemberDetailsResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"3\n" +
	"\x19GetMemberCostGroupRequest\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\tR\x06userId\"`\n" +
	"\x1aGetMemberCostGroupResponse\x12B\n" +
	"\n" +
	"costGroups\x18\x01 \x03(\v2\".blueapi.api.cover.MemberCostGroupR\n" +
	"costGroups\"Q\n" +
	"\x1dUpdateMemberPermissionRequest\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\tR\x06userId\x12\x18\n" +
	"\aisAdmin\x18\x02 \x01(\bR\aisAdmin\"Y\n" +
	"\x1eUpdateMemberPermissionResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"\x17\n" +
	"\x15GetUserDetailsRequest\"Q\n" +
	"\x16GetUserDetailsResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"1\n" +
	"\x17UpdateUserAvatarRequest\x12\x16\n" +
	"\x06avatar\x18\x01 \x01(\tR\x06avatar\"S\n" +
	"\x18UpdateUserAvatarResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"+\n" +
	"\x15UpdateUserIconRequest\x12\x12\n" +
	"\x04icon\x18\x01 \x01(\tR\x04icon\"Q\n" +
	"\x16UpdateUserIconResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"=\n" +
	"\x1bUpdateUserColorThemeRequest\x12\x1e\n" +
	"\n" +
	"colorTheme\x18\x01 \x01(\tR\n" +
	"colorTheme\"W\n" +
	"\x1cUpdateUserColorThemeResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"+\n" +
	"\x15UpdateUserNameRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"Q\n" +
	"\x16UpdateUserNameResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\".\n" +
	"\x16UpdateUserEmailRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\"R\n" +
	"\x17UpdateUserEmailResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"3\n" +
	"\x19UpdateUserMainViewRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\"U\n" +
	"\x1aUpdateUserMainViewResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"h\n" +
	"\x18ResetUserPasswordRequest\x12*\n" +
	"\x10previousPassword\x18\x01 \x01(\tR\x10previousPassword\x12 \n" +
	"\vnewPassword\x18\x02 \x01(\tR\vnewPassword\"T\n" +
	"\x19ResetUserPasswordResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"1\n" +
	"\x17UpdateUserLocaleRequest\x12\x16\n" +
	"\x06locale\x18\x01 \x01(\tR\x06locale\"S\n" +
	"\x18UpdateUserLocaleResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"7\n" +
	"\x19UpdateUserAppThemeRequest\x12\x1a\n" +
	"\bappTheme\x18\x01 \x01(\tR\bappTheme\"U\n" +
	"\x1aUpdateUserAppThemeResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"[\n" +
	"\x19UpdateUserTimezoneRequest\x12\x1a\n" +
	"\btimeZone\x18\x01 \x01(\tR\btimeZone\x12\"\n" +
	"\fautoTimeZone\x18\x02 \x01(\bR\fautoTimeZone\"U\n" +
	"\x1aUpdateUserTimezoneResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"=\n" +
	"\x1bUpdateUserAttributesRequest\x12\x1e\n" +
	"\n" +
	"attributes\x18\x01 \x03(\tR\n" +
	"attributes\"W\n" +
	"\x1cUpdateUserAttributesResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"-\n" +
	"\x13DeleteMemberRequest\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\tR\x06userId\".\n" +
	"\x14DeleteMemberResponse\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\tR\x06userId\".\n" +
	"\x14ResetPasswordRequest\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\tR\x06userId\"/\n" +
	"\x15ResetPasswordResponse\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\tR\x06userId\"\x9b\x02\n" +
	"\x11CreateViewRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x1c\n" +
	"\tisPrivate\x18\x03 \x01(\bR\tisPrivate\x12\x1e\n" +
	"\n" +
	"isEditable\x18\x04 \x01(\bR\n" +
	"isEditable\x12\x12\n" +
	...
	"reportType\x12\x1e\n" +
	"\n" +
	"colorTheme\x18\a \x01(\tR\n" +
	"colorTheme\x12\"\n" +
	"\freportPeriod\x18\b \x01(\tR\freportPeriod\x12\x1a\n" +
	"\bcurrency\x18\t \x01(\tR\bcurrency\"M\n" +
	"\x12CreateViewResponse\x127\n" +
	"\bviewData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.ViewDataR\bviewData\"\x11\n" +
	"\x0fGetViewsRequest\"K\n" +
	"\x10GetViewsResponse\x127\n" +
	"\bviewList\x18\x01 \x03(\v2\x1b.blueapi.api.cover.ViewListR\bviewList\"/\n" +
	"\x15GetCurrentViewRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\"Q\n" +
	"\x16GetCurrentViewResponse\x127\n" +
	"\bviewData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.ViewDataR\bviewData\"\x19\n" +
	"\x17GetFavoriteViewsRequest\"V\n" +
	"\x18GetFavoriteViewsResponse\x12:\n" +
	"\tfavorites\x18\x01 \x03(\v2\x1c.blueapi.api.cover.FavoritesR\tfavorites\",\n" +
	"\x12PublishViewRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\"'\n" +
	"\x13PublishViewResponse\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\",\n" +
	"\x12AddFavoriteRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\"-\n" +
	"\x13AddFavoriteResponse\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\"/\n" +
	"\x15RemoveFavoriteRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\"0\n" +
	"\x16RemoveFavoriteResponse\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\"\xd3\x01\n" +
	"\x11UpdateViewRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x12\n" +
	"\x04icon\x18\x04 \x01(\tR\x04icon\x12\x1c\n" +
	"\tisPrivate\x18\x05 \x01(\bR\tisPrivate\x12\x1e\n" +
	"\n" +
	"isEditable\x18\x06 \x01(\bR\n" +
	"isEditable\x12\x1e\n" +
	"\n" +
	"colorTheme\x18\a \x01(\tR\n" +
	"colorTheme\",\n" +
	"\x12UpdateViewResponse\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\"h\n" +
	"\x17UpdateViewLayoutRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\x125\n" +
	"\x06layout\x18\x02 \x03(\v2\x1d.blueapi.api.cover.WidgetDataR\x06layout\"Q\n" +
	"\x18UpdateViewLayoutResponse\x125\n" +
	"\x06layout\x18\x01 \x03(\v2\x1d.blueapi.api.cover.ViewLayoutR\x06layout\"\xbf\x01\n" +
	"\x17UpdateViewWidgetRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\x12\x1a\n" +
	"\bwidgetId\x18\x02 \x01(\tR\bwidgetId\x121\n" +
	"\aoptions\x18\x03 \x01(\v2\x17.google.protobuf.StructR\aoptions\x12=\n" +
	"\brequests\x18\x04 \x03(\v2!.blueapi.api.cover.LayoutRequestsR\brequests\"u\n" +
	"\x18UpdateViewWidgetResponse\x12\x1a\n" +
	"\bwidgetId\x18\x01 \x01(\tR\bwidgetId\x12=\n" +
	"\n" +
	"widgetData\x18\x02 \x01(\v2\x1d.blueapi.api.cover.WidgetDataR\n" +
	"widgetData\"U\n" +
	"\x1bUpdateViewColorThemeRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\x12\x1e\n" +
	"\n" +
	"colorTheme\x18\x02 \x01(\tR\n" +
	"colorTheme\"W\n" +
	"\x1cUpdateViewColorThemeResponse\x127\n" +
	"\bviewData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.ViewDataR\bviewData\"O\n" +
	"\x19UpdateViewCurrencyRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\x12\x1a\n" +
	"\bcurrency\x18\x02 \x01(\tR\bcurrency\"U\n" +
	"\x1aUpdateViewCurrencyResponse\x127\n" +
	"\bviewData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.ViewDataR\bviewData\"E\n" +
	"\x1bSetOrgUpdateCurrencyRequest\x12&\n" +
	"\x0eupdateCurrency\x18\x01 \x01(\x03R\x0eupdateCurrency\"F\n" +
	"\x1cSetOrgUpdateCurrencyResponse\x12&\n" +
	"\x0eupdateCurrency\x18\x01 \x01(\x03R\x0eupdateCurrency\"\x1d\n" +
	"\x1bGetOrgUpdateCurrencyRequest\"|\n" +
	"\x1cGetOrgUpdateCurrencyResponse\x12\x14\n" +
	"\x05orgId\x18\x01 \x01(\tR\x05orgId\x12&\n" +
	"\x0eupdateCurrency\x18\x02 \x01(\x03R\x0eupdateCurrency\x12\x1e\n" +
	"\n" +
	"lastUpdate\x18\x03 \x01(\tR\n" +
	"lastUpdate\"R\n" +
	"\x18ListExchangeRatesRequest\x12\x1c\n" +
	"\tstartDate\x18\x01 \x01(\tR\tstartDate\x12\x18\n" +
	"\aendDate\x18\x02 \x01(\tR\aendDate\"x\n" +
	"\x19ListExchangeRatesResponse\x12\x14\n" +
	"\x05orgId\x18\x01 \x01(\tR\x05orgId\x12E\n" +
	"\rexchangeRates\x18\x02 \x03(\v2\x1f.blueapi.cover.v1.ExchangeRatesR\rexchangeRates\"]\n" +
	"\rExchangeRates\x12\x14\n" +
	"\x05month\x18\x01 \x01(\tR\x05month\x12\"\n" +
	"\fexchangeRate\x18\x02 \x01(\x02R\fexchangeRate\x12\x12\n" +
	"\x04date\x18\x03 \x01(\tR\x04date\"+\n" +
	"\x11DeleteViewRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\",\n" +
	"\x12DeleteViewResponse\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\"|\n" +
	"\x1aUpdateSideMenuStateRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\x12F\n" +
	"\rsidemenustate\x18\x02 \x03(\v2 .blueapi.api.cover.SideMenuStateR\rsidemenustate\"5\n" +
	"\x1bUpdateSideMenuStateResponse\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\"T\n" +
	"\x1aAddSideMenuFavoriteRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\x12\x1e\n" +
	"\n" +
	"menuItemId\x18\x02 \x01(\tR\n" +
	"menuItemId\"5\n" +
	"\x1bAddSideMenuFavoriteResponse\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\"W\n" +
	"\x1dRemoveSideMenuFavoriteRequest\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\x12\x1e\n" +
	"\n" +
	"menuItemId\x18\x02 \x01(\tR\n" +
	"menuItemId\"8\n" +
	"\x1eRemoveSideMenuFavoriteResponse\x12\x16\n" +
	"\x06viewId\x18\x01 \x01(\tR\x06viewId\"\xdd\x01\n" +
	"\x16CreateCostGroupRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x14\n" +
	"\x05image\x18\x03 \x01(\tR\x05image\x12\x12\n" +
	"\x04icon\x18\x04 \x01(\tR\x04icon\x12\x1e\n" +
	"\n" +
	"colorTheme\x18\x05 \x01(\tR\n" +
	"colorTheme\x12C\n" +
	"\fcombinations\x18\x06 \x01(\v2\x1f.blueapi.api.cover.CombinationsR\fcombinations\"a\n" +
	"\x17CreateCostGroupResponse\x12F\n" +
	"\rcostGroupData\x18\x01 \x01(\v2 .blueapi.api.cover.CostGroupDataR\rcostGroupData\"\x16\n" +
	"\x14GetCostGroupsRequest\"_\n" +
	"\x15GetCostGroupsResponse\x12F\n" +
	"\rcostGroupData\x18\x01 \x03(\v2 .blueapi.api.cover.CostGroupDataR\rcostGroupData\">\n" +
	"\x1aGetCostGroupDetailsRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\"e\n" +
	"\x1bGetCostGroupDetailsResponse\x12F\n" +
	"\rcostGroupData\x18\x01 \x01(\v2 .blueapi.api.cover.CostGroupDataR\rcostGroupData\"R\n" +
	"\x1aUpdateCostGroupNameRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"1\n" +
	"\x1bUpdateCostGroupNameResponse\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"g\n" +
	"!UpdateCostGroupDescriptionRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\"F\n" +
	"\"UpdateCostGroupDescriptionResponse\x12 \n" +
	"\vdescription\x18\x01 \x01(\tR\vdescription\"U\n" +
	"\x1bUpdateCostGroupImageRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x14\n" +
	"\x05image\x18\x02 \x01(\tR\x05image\"4\n" +
	"\x1cUpdateCostGroupImageResponse\x12\x14\n" +
	"\x05image\x18\x01 \x01(\tR\x05image\"R\n" +
	"\x1aUpdateCostGroupIconRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x12\n" +
	"\x04icon\x18\x02 \x01(\tR\x04icon\"1\n" +
	"\x1bUpdateCostGroupIconResponse\x12\x12\n" +
	"\x04icon\x18\x01 \x01(\tR\x04icon\"d\n" +
	" UpdateCostGroupColorThemeRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x1e\n" +
	"\n" +
	"colorTheme\x18\x02 \x01(\tR\n" +
	"colorTheme\"C\n" +
	"!UpdateCostGroupColorThemeResponse\x12\x1e\n" +
	"\n" +
	"colorTheme\x18\x01 \x01(\tR\n" +
	"colorTheme\"\x8b\x01\n" +
	"\"UpdateCostGroupCombinationsRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12C\n" +
	"\fcombinations\x18\x02 \x01(\v2\x1f.blueapi.api.cover.CombinationsR\fcombinations\"j\n" +
	"#UpdateCostGroupCombinationsResponse\x12C\n" +
	"\fcombinations\x18\x01 \x01(\v2\x1f.blueapi.api.cover.CombinationsR\fcombinations\"X\n" +
	"\x1cAssignCostGroupMemberRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x16\n" +
	"\x06userId\x18\x02 \x01(\tR\x06userId\"Y\n" +
	"\x1dAssignCostGroupMemberResponse\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x16\n" +
	"\x06userId\x18\x02 \x01(\tR\x06userId\"X\n" +
	"\x1cRemoveCostGroupMemberRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x16\n" +
	"\x06userId\x18\x02 \x01(\tR\x06userId\"Y\n" +
	"\x1dRemoveCostGroupMemberResponse\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x16\n" +
	"\x06userId\x18\x02 \x01(\tR\x06userId\":\n" +
	"\x16DeleteCostGroupRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\";\n" +
	"\x17DeleteCostGroupResponse\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\"8\n" +
	"\"GetAccountAccessTemplateUrlRequest\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\"\xc1\x01\n" +
	"#GetAccountAccessTemplateUrlResponse\x12\x1c\n" +
	...
	"externalId\"\x1a\n" +
	"\x18ListAccountAccessRequest\"1\n" +
	"\x17GetAccountAccessRequest\x12\x16\n" +
	"\x06target\x18\x01 \x01(\tR\x06target\"\x86\x04\n" +
	"\rAccountAccess\x12\x16\n" +
	...
	"\apayerId\x18\x04 \x01(\tR\apayerId\x12\x18\n" +
	"\aroleArn\x18\x05 \x01(\tR\aroleArn\x12\x1e\n" +
	"\n" +
	"externalId\x18\x06 \x01(\tR\n" +
	"externalId\x12\x18\n" +
	"\astackId\x18\a \x01(\tR\astackId\x12 \n" +
	"\vstackRegion\x18\b \x01(\tR\vstackRegion\x12 \n" +
	"\vtemplateUrl\x18\t \x01(\tR\vtemplateUrl\x12\x1e\n" +
	"\n" +
	"bucketName\x18\n" +
	" \x01(\tR\n" +
	"bucketName\x12\x16\n" +
	"\x06prefix\x18\v \x01(\tR\x06prefix\x12\x1e\n" +
	"\n" +
	"reportName\x18\f \x01(\tR\n" +
	"reportName\x12U\n" +
	"\x12registrationStatus\x18\r \x01(\v2%.blueapi.api.cover.RegistrationStatusR\x12registrationStatus\x12\x16\n" +
	"\x06status\x18\x0e \x01(\tR\x06status\x12 \n" +
	"\vlastUpdated\x18\x0f \x01(\tR\vlastUpdated\"Z\n" +
	"\x1aCreateAccountAccessRequest\x12\x16\n" +
	"\x06target\x18\x01 \x01(\tR\x06target\x12$\n" +
	"\rfromTerraform\x18\x02 \x01(\bR\rfromTerraform\"T\n" +
	"\"CreateAccountAccessStacksetRequest\x12\x16\n" +
	"\x06target\x18\x01 \x01(\tR\x06target\x12\x16\n" +
	"\x06region\x18\x02 \x01(\tR\x06region\"4\n" +
	"\x1aUpdateAccountAccessRequest\x12\x16\n" +
	"\x06target\x18\x01 \x01(\tR\x06target\"L\n" +
	"\x1aDeleteAccountAccessRequest\x12\x16\n" +
	"\x06target\x18\x01 \x01(\tR\x06target\x12\x16\n" +
	"\x06vendor\x18\x02 \x01(\tR\x06vendor\"9\n" +
	"\x1bDeleteAccountAccessResponse\x12\x1a\n" +
	"\btargetId\x18\x01 \x01(\tR\btargetId\"p\n" +
	"\x16RegisterAccountRequest\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12\x1c\n" +
	"\taccountId\x18\x02 \x01(\tR\taccountId\x12 \n" +
	"\vaccountName\x18\x03 \x01(\tR\vaccountName\"\xbf\x02\n" +
	"\x11ListAssetsRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x1e\n" +
	"\n" +
	"startMonth\x18\x02 \x01(\tR\n" +
	"startMonth\x12\x1a\n" +
	"\bendMonth\x18\x03 \x01(\tR\bendMonth\x12.\n" +
	"\x12withRecommendation\x18\x04 \x01(\bR\x12withRecommendation\x12C\n" +
	"\n" +
	"awsOptions\x18\x05 \x03(\v2#.blueapi.cover.v1.ListAssetsFiltersR\n" +
	"awsOptions\x12W\n" +
	"\x14awsPropertiesOptions\x18\x06 \x03(\v2#.blueapi.cover.v1.ListAssetsFiltersR\x14awsPropertiesOptions\"\xa7\x01\n" +
	"\x11ListAssetsFilters\x12S\n" +
	"\n" +
	"andFilters\x18\x01 \x03(\v23.blueapi.cover.v1.ListAssetsFilters.AndFiltersEntryR\n" +
	"andFilters\x1a=\n" +
	...
	"\x05orgId\x18\x02 \x01(\tR\x05orgId\x12\x16\n" +
	"\x06vendor\x18\x03 \x01(\tR\x06vendor\x12\x18\n" +
	"\aaccount\x18\x04 \x01(\tR\aaccount\x12\x18\n" +
	"\aservice\x18\x05 \x01(\tR\aservice\x12\x1e\n" +
	"\n" +
	"resourceId\x18\x06 \x01(\tR\n" +
	"resourceId\x12\"\n" +
	"\fresourceType\x18\a \x01(\tR\fresourceType\x12\x12\n" +
	"\x04cost\x18\b \x01(\x01R\x04cost\x12\x1e\n" +
	"\n" +
	"properties\x18\t \x01(\tR\n" +
	"properties\x12&\n" +
	"\x0erecommendation\x18\n" +
	" \x01(\tR\x0erecommendation\"\xb9\x02\n" +
	"\x17GetAssetsSummaryRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x1e\n" +
	"\n" +
	"startMonth\x18\x02 \x01(\tR\n" +
	"startMonth\x12\x1a\n" +
	"\bendMonth\x18\x03 \x01(\tR\bendMonth\x12\"\n" +
	"\fcombineDates\x18\x04 \x01(\bR\fcombineDates\x12C\n" +
	"\n" +
	"awsOptions\x18\x05 \x03(\v2#.blueapi.cover.v1.ListAssetsFiltersR\n" +
	"awsOptions\x12W\n" +
	"\x14awsPropertiesOptions\x18\x06 \x03(\v2#.blueapi.cover.v1.ListAssetsFiltersR\x14awsPropertiesOptions\"\x8b\x01\n" +
	"\x18GetAssetsSummaryResponse\x129\n" +
	"\asummary\x18\x01 \x03(\v2\x1f.blueapi.cover.v1.AssetsSummaryR\asummary\x124\n" +
	"\x15recommendationSummary\x18\x02 \x01(\tR\x15recommendationSummary\"\x81\x01\n" +
	"\rAssetsSummary\x12\x12\n" +
	"\x04date\x18\x01 \x01(\tR\x04date\x12\x16\n" +
	"\x06vendor\x18\x02 \x01(\tR\x06vendor\x12&\n" +
	"\x0etotalResources\x18\x03 \x01(\x03R\x0etotalResources\x12\x1c\n" +
	"\ttotalCost\x18\x04 \x01(\x01R\ttotalCost\"G\n" +
	"#ResolveCostGroupCombinationsRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\"\x80\x01\n" +
	"$ResolveCostGroupCombinationsResponse\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x126\n" +
	"\baccounts\x18\x02 \x03(\v2\x1a.blueapi.api.cover.AccountR\baccounts\"\x82\x06\n" +
	"\x13GetCostUsageRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x1c\n" +
	"\tstartTime\x18\x02 \x01(\tR\tstartTime\x12\x18\n" +
	"\aendTime\x18\x03 \x01(\tR\aendTime\x12\"\n" +
	"\fgroupByMonth\x18\x04 \x01(\bR\fgroupByMonth\x12\x14\n" +
	"\x05limit\x18\x05 \x01(\x03R\x05limit\x12\x1a\n" +
	"\bcategory\x18\x06 \x01(\tR\bcategory\x12\x18\n" +
	"\agroupBy\x18\a \x01(\tR\agroupBy\x12(\n" +
	"\x0fincludeZeroCost\x18\b \x01(\bR\x0fincludeZeroCost\x12O\n" +
	"\n" +
	"awsOptions\x18\t \x01(\v2/.blueapi.cover.v1.GetCostUsageRequestAwsOptionsR\n" +
	"awsOptions\x12U\n" +
	"\fazureOptions\x18\n" +
	" \x01(\v21.blueapi.cover.v1.GetCostUsageRequestAzureOptionsR\fazureOptions\x12O\n" +
	"\n" +
	"gcpOptions\x18\v \x01(\v2/.blueapi.cover.v1.GetCostUsageRequestGcpOptionsR\n" +
	"gcpOptions\x12^\n" +
	"\x0fazurecspOptions\x18\f \x01(\v24.blueapi.cover.v1.GetCostUsageRequestAzureCspOptionsR\x0fazurecspOptions\x12X\n" +
	"\rcustomOptions\x18\r \x01(\v22.blueapi.cover.v1.GetCostUsageRequestCustomOptionsR\rcustomOptions\x12(\n" +
	"\x0fincludeForecast\x18\x0e \x01(\bR\x0fincludeForecast\x12\x1a\n" +
	"\bcurrency\x18\x0f \x01(\tR\bcurrency\"\xa3\x02\n" +
	"\x1dGetCostUsageRequestAwsOptions\x12&\n" +
	"\x0egroupByColumns\x18\x01 \x01(\tR\x0egroupByColumns\x12$\n" +
	"\rgroupAccounts\x18\x02 \x01(\bR\rgroupAccounts\x12J\n" +
	"\afilters\x18\x03 \x03(\v20.blueapi.cover.v1.ReadCostsRequestOptionsFiltersR\afilters\x12P\n" +
	"\n" +
	"tagFilters\x18\x04 \x03(\v20.blueapi.cover.v1.ReadCostsRequestOptionsFiltersR\n" +
	"tagFilters\x12\x16\n" +
	"\x06tagKey\x18\x05 \x01(\tR\x06tagKey\"\x8d\x02\n" +
	"\x1fGetCostUsageRequestAzureOptions\x12&\n" +
	"\x0egroupByColumns\x18\x01 \x01(\tR\x0egroupByColumns\x12$\n" +
	"\rgroupAccounts\x18\x02 \x01(\bR\rgroupAccounts\x12J\n" +
	"\afilters\x18\x03 \x03(\v20.blueapi.cover.v1.ReadCostsRequestOptionsFiltersR\afilters\x12P\n" +
	"\n" +
	"tagFilters\x18\x04 \x03(\v20.blueapi.cover.v1.ReadCostsRequestOptionsFiltersR\n" +
	"tagFilters\"\xdd\x03\n" +
	"\x1dGetCostUsageRequestGcpOptions\x12&\n" +
	"\x0egroupByColumns\x18\x01 \x01(\tR\x0egroupByColumns\x12$\n" +
	"\rgroupAccounts\x18\x02 \x01(\bR\rgroupAccounts\x12J\n" +
	"\afilters\x18\x03 \x03(\v20.blueapi.cover.v1.ReadCostsRequestOptionsFiltersR\afilters\x12P\n" +
	"\n" +
	"tagFilters\x18\x04 \x03(\v20.blueapi.cover.v1.ReadCostsRequestOptionsFiltersR\n" +
	"tagFilters\x12T\n" +
	"\flabelFilters\x18\x05 \x03(\v20.blueapi.cover.v1.ReadCostsRequestOptionsFiltersR\flabelFilters\x12b\n" +
	"\x13projectLabelFilters\x18\x06 \x03(\v20.blueapi.cover.v1.ReadCostsRequestOptionsFiltersR\x13projectLabelFilters\x12\x16\n" +
	"\x06tagKey\x18\a \x01(\tR\x06tagKey\"\xa8\x02\n" +
	"\"GetCostUsageRequestAzureCspOptions\x12&\n" +
	"\x0egroupByColumns\x18\x01 \x01(\tR\x0egroupByColumns\x12$\n" +
	"\rgroupAccounts\x18\x02 \x01(\bR\rgroupAccounts\x12J\n" +
	"\afilters\x18\x03 \x03(\v20.blueapi.cover.v1.ReadCostsRequestOptionsFiltersR\afilters\x12P\n" +
	"\n" +
	"tagFilters\x18\x04 \x03(\v20.blueapi.cover.v1.ReadCostsRequestOptionsFiltersR\n" +
	"tagFilters\x12\x16\n" +
	"\x06tagKey\x18\x05 \x01(\tR\x06tagKey\"\xe0\x03\n" +
	" GetCostUsageRequestCustomOptions\x12&\n" +
	"\x0egroupByColumns\x18\x01 \x01(\tR\x0egroupByColumns\x12$\n" +
	"\rgroupAccounts\x18\x02 \x01(\bR\rgroupAccounts\x12J\n" +
	"\afilters\x18\x03 \x03(\v20.blueapi.cover.v1.ReadCostsRequestOptionsFiltersR\afilters\x12P\n" +
	"\n" +
	...
	"\flabelFilters\x18\x05 \x03(\v20.blueapi.cover.v1.ReadCostsRequestOptionsFiltersR\flabelFilters\x12b\n" +
	"\x13projectLabelFilters\x18\x06 \x03(\v20.blueapi.cover.v1.ReadCostsRequestOptionsFiltersR\x13projectLabelFilters\x12\x16\n" +
	"\x06tagKey\x18\a \x01(\tR\x06tagKey\"\xc1\x01\n" +
	"\x1eReadCostsRequestOptionsFilters\x12`\n" +
	"\n" +
	"andFilters\x18\x01 \x03(\v2@.blueapi.cover.v1.ReadCostsRequestOptionsFilters.AndFiltersEntryR\n" +
	"andFilters\x1a=\n" +
	"\x0fAndFiltersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\tusageType\x18\x10 \x01(\tR\tusageType\x12\x12\n" +
	"\x04cost\x18\x05 \x01(\x01R\x04cost\x12\x18\n" +
	"\adetails\x18\x06 \x01(\tR\adetails\x12>\n" +
	"\bforecast\x18\a \x01(\v2\".blueapi.api.cover.AwsCostForecastR\bforecast\x12\x16\n" +
	"\x06region\x18\b \x01(\tR\x06region\x12&\n" +
	"\x0ebillingAccount\x18\t \x01(\tR\x0ebillingAccount\x12\x1a\n" +
	"\btagValue\x18\n" +
	" \x01(\tR\btagValue\x12\x1e\n" +
	"\n" +
	"lastUpdate\x18\v \x01(\tR\n" +
	"lastUpdate\x12\x12\n" +
	"\x04unit\x18\f \x01(\tR\x04unit\x12\x1a\n" +
	"\bcategory\x18\r \x01(\tR\bcategory\x12\x16\n" +
	"\x06tagged\x18\x0e \x01(\bR\x06tagged\x12V\n" +
	"\x0eunitcostmetric\x18\x0f \x03(\v2..blueapi.cover.v1.CostItem.UnitcostmetricEntryR\x0eunitcostmetric\x1aA\n" +
	"\x13UnitcostmetricEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\"G\n" +
	"#GetRightSizingRecommendationRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\"c\n" +
	"$GetRightSizingRecommendationResponse\x12;\n" +
	"\bresource\x18\x01 \x03(\v2\x1f.blueapi.api.cover.ResourceDataR\bresource\"\xad\x01\n" +
	"\x19ModifyResourceTypeRequest\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12\x1c\n" +
	...
	"\x06region\x18\x05 \x01(\tR\x06region\"\x96\x01\n" +
	"\x1aModifyResourceTypeResponse\x12\x1c\n" +
	"\taccountId\x18\x01 \x01(\tR\taccountId\x12\x1e\n" +
	"\n" +
	"resourceId\x18\x02 \x01(\tR\n" +
	"resourceId\x12\"\n" +
	"\fresourceType\x18\x03 \x01(\tR\fresourceType\x12\x16\n" +
	"\x06region\x18\x04 \x01(\tR\x06region\"\x88\x01\n" +
	"\x18TerminateResourceRequest\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12\x1c\n" +
	"\taccountId\x18\x02 \x01(\tR\taccountId\x12\x1e\n" +
	"\n" +
	"resourceId\x18\x03 \x01(\tR\n" +
	"resourceId\x12\x16\n" +
	"\x06region\x18\x04 \x01(\tR\x06region\"q\n" +
	"\x19TerminateResourceResponse\x12\x1c\n" +
	"\taccountId\x18\x01 \x01(\tR\taccountId\x12\x1e\n" +
	"\n" +
	"resourceId\x18\x02 \x01(\tR\n" +
	"resourceId\x12\x16\n" +
	"\x06region\x18\x03 \x01(\tR\x06region\"U\n" +
	"\x17UploadChargeCodeRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x12\n" +
	"\x04file\x18\x03 \x01(\fR\x04file\"`\n" +
	"\x18UploadChargeCodeResponse\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x120\n" +
	"\x06status\x18\x02 \x01(\x0e2\x18.blueapi.cover.v1.StatusR\x06status\"d\n" +
	"\x12AssignPayerRequest\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12\x1c\n" +
	"\taccountId\x18\x02 \x01(\tR\taccountId\x12\x18\n" +
	"\apayerId\x18\x03 \x01(\tR\apayerId\"M\n" +
	"\x13AssignPayerResponse\x12\x1c\n" +
	"\taccountId\x18\x01 \x01(\tR\taccountId\x12\x18\n" +
	"\apayerId\x18\x02 \x01(\tR\apayerId\"*\n" +
	"\x10GetPayersRequest\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\"+\n" +
	"\x11GetPayersResponse\x12\x16\n" +
	"\x06payers\x18\x01 \x03(\tR\x06payers\"N\n" +
	"\x12GetAccountsRequest\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12 \n" +
	"\vcostGroupId\x18\x02 \x01(\tR\vcostGroupId\"1\n" +
	"\x13GetAccountsResponse\x12\x1a\n" +
	"\baccounts\x18\x01 \x03(\tR\baccounts\"N\n" +
	"\x12GetServicesRequest\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12 \n" +
	"\vcostGroupId\x18\x02 \x01(\tR\vcostGroupId\"1\n" +
	"\x13GetServicesResponse\x12\x1a\n" +
	"\bservices\x18\x01 \x03(\tR\bservices\"M\n" +
	"\x11GetRegionsRequest\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12 \n" +
	"\vcostGroupId\x18\x02 \x01(\tR\vcostGroupId\".\n" +
	"\x12GetRegionsResponse\x12\x18\n" +
	"\aregions\x18\x01 \x03(\tR\aregions\"J\n" +
	"\x0eGetTagsRequest\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12 \n" +
	"\vcostGroupId\x18\x02 \x01(\tR\vcostGroupId\"G\n" +
	"\x0fGetTagsResponse\x124\n" +
	"\atagData\x18\x01 \x03(\v2\x1a.blueapi.api.cover.TagDataR\atagData\"'\n" +
	"\x0fListFeesRequest\x12\x14\n" +
	"\x05month\x18\x01 \x01(\tR\x05month\"\xb6\x04\n" +
	"\n" +
	"FeeDetails\x12\x0e\n" +
	...
	"\x05month\x18\x05 \x01(\tR\x05month\x12\x1a\n" +
	"\blineType\x18\x06 \x01(\tR\blineType\x12\x18\n" +
	"\afeeType\x18\a \x01(\tR\afeeType\x12 \n" +
	"\vproductCode\x18\b \x01(\tR\vproductCode\x12 \n" +
	"\vdescription\x18\t \x01(\tR\vdescription\x12\x18\n" +
	"\astarted\x18\n" +
	" \x01(\tR\astarted\x12\"\n" +
	"\ftimeInterval\x18\v \x01(\tR\ftimeInterval\x12 \n" +
	"\vproductName\x18\f \x01(\tR\vproductName\x12\x1a\n" +
	"\bcurrency\x18\r \x01(\tR\bcurrency\x12 \n" +
	"\vsplitStatus\x18\x0e \x01(\tR\vsplitStatus\x12 \n" +
	"\visAllocated\x18\x0f \x01(\bR\visAllocated\x12\x1c\n" +
	"\tisApplied\x18\x10 \x01(\bR\tisApplied\x12$\n" +
	"\runblendedCost\x18\x11 \x01(\x01R\runblendedCost\x12\x1c\n" +
	"\tsourceFee\x18\x12 \x01(\tR\tsourceFee\x12\x1e\n" +
	"\n" +
	"lastUpdate\x18\x13 \x01(\tR\n" +
	"lastUpdate\")\n" +
	"\x11RestoreFeeRequest\x12\x14\n" +
	"\x05feeId\x18\x01 \x01(\tR\x05feeId\"r\n" +
	"\x16GetCostGroupFeeRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x1c\n" +
	"\tstartTime\x18\x02 \x01(\tR\tstartTime\x12\x18\n" +
	"\aendTime\x18\x03 \x01(\tR\aendTime\"\x93\x01\n" +
	"\aFeeItem\x12\x16\n" +
	...
	"\x04cost\x18\x06 \x01(\x01R\x04cost\"g\n" +
	"\tAllocator\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x12\x18\n" +
	"\aformula\x18\x03 \x01(\tR\aformula\x12\x16\n" +
	"\x06months\x18\x04 \x01(\x03R\x06months\"y\n" +
	"\bCriteria\x125\n" +
	"\x03and\x18\x01 \x03(\v2#.blueapi.cover.v1.Criteria.AndEntryR\x03and\x1a6\n" +
	"\bAndEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x98\x03\n" +
	"\x14CostAllocatorDetails\x12\x0e\n" +
	...
	"expiration\x12\x1e\n" +
	"\n" +
	"startMonth\x18\x04 \x01(\tR\n" +
	"startMonth\x12&\n" +
	"\x0edefaultAccount\x18\x05 \x01(\tR\x0edefaultAccount\x12;\n" +
	"\bcriteria\x18\x06 \x01(\v2\x1f.blueapi.api.cover.CombinationsR\bcriteria\x129\n" +
	"\tallocator\x18\a \x03(\v2\x1b.blueapi.cover.v1.AllocatorR\tallocator\x12\x1e\n" +
	"\n" +
	...
	"\x04name\x18\n" +
	" \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\v \x01(\tR\vdescription\"\xd8\x02\n" +
	"\x14CostAllocatorRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\bcategory\x18\x02 \x01(\tR\bcategory\x12\x1e\n" +
	"\n" +
	"expiration\x18\x03 \x01(\x03R\n" +
	...
	"\x0edefaultAccount\x18\x05 \x01(\tR\x0edefaultAccount\x12;\n" +
	"\bcriteria\x18\x06 \x01(\v2\x1f.blueapi.api.cover.CombinationsR\bcriteria\x129\n" +
	"\tallocator\x18\a \x03(\v2\x1b.blueapi.cover.v1.AllocatorR\tallocator\x12\x12\n" +
	"\x04name\x18\b \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\t \x01(\tR\vdescription\"\x17\n" +
	"\x15ListAllocatorsRequest\"\xca\x02\n" +
	"\x16CreateAllocatorRequest\x12\x1a\n" +
	"\bcategory\x18\x01 \x01(\tR\bcategory\x12\x1e\n" +
	"\n" +
	"expiration\x18\x02 \x01(\x03R\n" +
	"expiration\x12\x1e\n" +
	"\n" +
	"startMonth\x18\x03 \x01(\tR\n" +
	"startMonth\x12&\n" +
	"\x0edefaultAccount\x18\x04 \x01(\tR\x0edefaultAccount\x12;\n" +
	"\bcriteria\x18\x05 \x01(\v2\x1f.blueapi.api.cover.CombinationsR\bcriteria\x129\n" +
	"\tallocator\x18\x06 \x03(\v2\x1b.blueapi.cover.v1.AllocatorR\tallocator\x12\x12\n" +
	"\x04name\x18\a \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\b \x01(\tR\vdescription\"<\n" +
	"\x1eGetAllocationAttributesRequest\x12\x1a\n" +
	"\bcategory\x18\x01 \x01(\tR\bcategory\"\xcb\x01\n" +
	"\x1fGetAllocationAttributesResponse\x12c\n" +
	"\tattribute\x18\x01 \x03(\v2E.blueapi.cover.v1.GetAllocationAttributesResponse.AllocationAttributeR\tattribute\x1aC\n" +
	"\x13AllocationAttribute\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x18\n" +
	"\aservice\x18\x02 \x03(\tR\aservice\"(\n" +
	"\x16DeleteAllocatorRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"O\n" +
	"\x1cProxyCreateCompletionRequest\x12/\n" +
	"\x06params\x18\x01 \x01(\v2\x17.google.protobuf.StructR\x06params\"3\n" +
	"\x1dProxyCreateCompletionResponse\x12\x12\n" +
	"\x04line\x18\x01 \x01(\tR\x04line\"\xab\a\n" +
	"\x13AccountUsageDetails\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05orgId\x18\x02 \x01(\tR\x05orgId\x12\x16\n" +
	"\x06vendor\x18\x03 \x01(\tR\x06vendor\x12\x18\n" +
	"\aaccount\x18\x04 \x01(\tR\aaccount\x12\x12\n" +
	"\x04date\x18\x05 \x01(\tR\x04date\x12 \n" +
	"\vproductCode\x18\x06 \x01(\tR\vproductCode\x12 \n" +
	"\vserviceCode\x18\a \x01(\tR\vserviceCode\x12\x16\n" +
	"\x06region\x18\b \x01(\tR\x06region\x12\x12\n" +
	"\x04zone\x18\t \x01(\tR\x04zone\x12\x1c\n" +
	"\tusageType\x18\n" +
	" \x01(\tR\tusageType\x12\"\n" +
	"\finstanceType\x18\v \x01(\tR\finstanceType\x12\x1c\n" +
	"\toperation\x18\f \x01(\tR\toperation\x12\x1c\n" +
	"\tinvoiceId\x18\r \x01(\tR\tinvoiceId\x12 \n" +
	"\vdescription\x18\x0e \x01(\tR\vdescription\x12\x1e\n" +
	"\n" +
	"resourceId\x18\x0f \x01(\tR\n" +
	"resourceId\x12\x12\n" +
	"\x04tags\x18\x10 \x01(\tR\x04tags\x12&\n" +
	"\x0ecostCategories\x18\x11 \x01(\tR\x0ecostCategories\x12 \n" +
	"\vusageAmount\x18\x12 \x01(\x01R\vusageAmount\x12,\n" +
	"\x11trueUnblendedCost\x18\x13 \x01(\x01R\x11trueUnblendedCost\x12$\n" +
	"\runblendedCost\x18\x14 \x01(\x01R\runblendedCost\x12$\n" +
	"\reffectiveCost\x18\x15 \x01(\x01R\reffectiveCost\x12$\n" +
	"\ramortizedCost\x18\x16 \x01(\x01R\ramortizedCost\x12.\n" +
	"\x12publicOnDemandCost\x18\x17 \x01(\x01R\x12publicOnDemandCost\x120\n" +
	"\x13unusedAmortizedCost\x18\x18 \x01(\x01R\x13unusedAmortizedCost\x12\x1e\n" +
	"\n" +
	"lastUpdate\x18\x19 \x01(\tR\n" +
	"lastUpdate\x12 \n" +
	"\vsplitStatus\x18\x1a \x01(\tR\vsplitStatus\x12 \n" +
	"\visAllocated\x18\x1b \x01(\bR\visAllocated\x12\x1c\n" +
	"\tisApplied\x18\x1c \x01(\bR\tisApplied\x12\x16\n" +
	"\x06source\x18\x1d \x01(\tR\x06source\"Q\n" +
	"\x17ListAccountUsageRequest\x12\x1c\n" +
	"\tstartDate\x18\x01 \x01(\tR\tstartDate\x12\x18\n" +
	"\aendDate\x18\x02 \x01(\tR\aendDate\"@\n" +
	"\x1aRestoreAccountUsageRequest\x12\"\n" +
	"\fallocationId\x18\x01 \x01(\tR\fallocationId\"'\n" +
	"\x15RestoreSavingsRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"\xdc\x03\n" +
	"\x0eSavingsDetails\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05orgId\x18\x02 \x01(\tR\x05orgId\x12\x16\n" +
	"\x06vendor\x18\x03 \x01(\tR\x06vendor\x12\x18\n" +
	"\aaccount\x18\x04 \x01(\tR\aaccount\x12\x14\n" +
	...
	"\x03arn\x18\a \x01(\tR\x03arn\x12 \n" +
	"\vproductCode\x18\b \x01(\tR\vproductCode\x12\x1e\n" +
	"\n" +
	"offerClass\x18\t \x01(\tR\n" +
	"offerClass\x12\x1a\n" +
	"\bondemand\x18\n" +
	" \x01(\x01R\bondemand\x12$\n" +
	"\reffectiveCost\x18\v \x01(\x01R\reffectiveCost\x12\x18\n" +
	"\asavings\x18\f \x01(\x01R\asavings\x12 \n" +
	"\vsplitStatus\x18\r \x01(\tR\vsplitStatus\x12 \n" +
	"\visAllocated\x18\x0e \x01(\bR\visAllocated\x12\x1c\n" +
	"\tisApplied\x18\x0f \x01(\bR\tisApplied\x12\x16\n" +
	"\x06source\x18\x10 \x01(\tR\x06source\x12\x1e\n" +
	"\n" +
	"lastUpdate\x18\x11 \x01(\tR\n" +
	"lastUpdate\"\x95\x01\n" +
	"\x1dGetCostGroupAllocationRequest\x12\x1a\n" +
	"\bcategory\x18\x01 \x01(\tR\bcategory\x12 \n" +
	"\vcostGroupId\x18\x02 \x01(\tR\vcostGroupId\x12\x1c\n" +
	"\tstartDate\x18\x03 \x01(\tR\tstartDate\x12\x18\n" +
	"\aendDate\x18\x04 \x01(\tR\aendDate\"\x9a\x01\n" +
	"\x0eAllocationItem\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12\x14\n" +
	"\x05month\x18\x02 \x01(\tR\x05month\x12\x18\n" +
	"\aproduct\x18\x03 \x01(\tR\aproduct\x12\x18\n" +
	"\aaccount\x18\x04 \x01(\tR\aaccount\x12\x12\n" +
	"\x04type\x18\x05 \x01(\tR\x04type\x12\x12\n" +
	"\x04cost\x18\x06 \x01(\x01R\x04cost\"\x85\x01\n" +
	"\x17ProcessAuth0UserRequest\x12\x16\n" +
	"\x06source\x18\x01 \x01(\tR\x06source\x12\x1e\n" +
	"\n" +
	"customerId\x18\x02 \x01(\tR\n" +
	"customerId\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12\x1c\n" +
	"\tsubuserId\x18\x04 \x01(\tR\tsubuserId\">\n" +
	"\x18ProcessAuth0UserResponse\x12\"\n" +
	"\fisAuthorized\x18\x01 \x01(\bR\fisAuthorized\"\xf7\x02\n" +
	"\n" +
	"DataAccess\x12\x16\n" +
	"\x06target\x18\x01 \x01(\tR\x06target\x12\x14\n" +
	"\x05orgId\x18\x02 \x01(\tR\x05orgId\x12=\n" +
	"\n" +
	"gcpOptions\x18\x03 \x01(\v2\x1d.blueapi.api.cover.GcpOptionsR\n" +
	"gcpOptions\x12C\n" +
	"\fazureOptions\x18\x04 \x01(\v2\x1f.blueapi.api.cover.AzureOptionsR\fazureOptions\x12=\n" +
	"\n" +
	"awsOptions\x18\x05 \x01(\v2\x1d.blueapi.api.cover.AwsOptionsR\n" +
	"awsOptions\x12 \n" +
	"\vaccountType\x18\x06 \x01(\tR\vaccountType\x12\x1e\n" +
	"\n" +
	"lastUpdate\x18\a \x01(\tR\n" +
	"lastUpdate\x12\x1e\n" +
	"\n" +
	"createTime\x18\b \x01(\tR\n" +
	"createTime\x12\x16\n" +
	"\x06vendor\x18\t \x01(\tR\x06vendor\"\xb0\x02\n" +
	"\x19RegisterDataAccessRequest\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12\x16\n" +
	"\x06target\x18\x02 \x01(\tR\x06target\x12 \n" +
	"\vaccountType\x18\x03 \x01(\tR\vaccountType\x12=\n" +
	"\n" +
	"gcpOptions\x18\x04 \x01(\v2\x1d.blueapi.api.cover.GcpOptionsR\n" +
	"gcpOptions\x12C\n" +
	"\fazureOptions\x18\x05 \x01(\v2\x1f.blueapi.api.cover.AzureOptionsR\fazureOptions\x12=\n" +
	"\n" +
	"awsOptions\x18\x06 \x01(\v2\x1d.blueapi.api.cover.AwsOptionsR\n" +
	"awsOptions\"\xae\x02\n" +
	"\x17UpdateDataAccessRequest\x12\x16\n" +
	"\x06target\x18\x01 \x01(\tR\x06target\x12\x16\n" +
	"\x06vendor\x18\x02 \x01(\tR\x06vendor\x12=\n" +
	"\n" +
	"gcpOptions\x18\x03 \x01(\v2\x1d.blueapi.api.cover.GcpOptionsR\n" +
	...
	"awsOptions\x18\x05 \x01(\v2\x1d.blueapi.api.cover.AwsOptionsR\n" +
	"awsOptions\x12 \n" +
	"\vaccountType\x18\x06 \x01(\tR\vaccountType\"\x17\n" +
	"\x15ListDataAccessRequest\"!\n" +
	"\x1fListUnregisteredAccountsRequest\"\x8b\x01\n" +
	" ListUnregisteredAccountsResponse\x12\x14\n" +
	"\x05orgId\x18\x01 \x01(\tR\x05orgId\x12Q\n" +
	"\x11unregisteredAccts\x18\x02 \x03(\v2#.blueapi.cover.v1.UnregisteredAcctsR\x11unregisteredAccts\"u\n" +
	"\x11UnregisteredAccts\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x18\n" +
	"\apayerId\x18\x02 \x01(\tR\apayerId\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status\x12\x1e\n" +
	"\n" +
	"lastUpdate\x18\x04 \x01(\tR\n" +
	"lastUpdate\"\xb9\x01\n" +
	"\x15BillingAccountRequest\x12\x1c\n" +
	"\tbillingId\x18\x01 \x01(\tR\tbillingId\x12\x1c\n" +
	"\tdatasetId\x18\x02 \x01(\tR\tdatasetId\x12$\n" +
	"\rdatasetRegion\x18\x03 \x01(\tR\rdatasetRegion\x12\x1c\n" +
	"\tprojectId\x18\x04 \x01(\tR\tprojectId\x12 \n" +
	"\vbillingName\x18\x05 \x01(\tR\vbillingName\"q\n" +
	"\x1dGetAndDeleteDataAccessRequest\x12\x16\n" +
	"\x06target\x18\x01 \x01(\tR\x06target\x12\x16\n" +
	"\x06vendor\x18\x02 \x01(\tR\x06vendor\x12 \n" +
	"\vaccountType\x18\x03 \x01(\tR\vaccountType\"\x86\x01\n" +
	"\"AddPartnerCenterCredentialsRequest\x12\x1c\n" +
	"\taccountId\x18\x01 \x01(\tR\taccountId\x12$\n" +
	"\rapplicationId\x18\x02 \x01(\tR\rapplicationId\x12\x1c\n" +
	"\tsecretKey\x18\x03 \x01(\tR\tsecretKey\",\n" +
	"\x14AddMpnSettingRequest\x12\x14\n" +
	"\x05mpnId\x18\x01 \x01(\tR\x05mpnId\"\xa4\x02\n" +
	"\x1cGetCostGroupAttributeRequest\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\x12$\n" +
	"\rattributeType\x18\x02 \x01(\tR\rattributeType\x12 \n" +
	"\vcostGroupId\x18\x03 \x01(\tR\vcostGroupId\x12S\n" +
	"\x14existingCombinations\x18\x04 \x03(\v2\x1f.blueapi.api.cover.CombinationsR\x14existingCombinations\x12O\n" +
	"\x12currentCombination\x18\x05 \x01(\v2\x1f.blueapi.api.cover.CombinationsR\x12currentCombination\"\x88\x01\n" +
	"\x1dGetCostGroupAttributeResponse\x121\n" +
	"\x06result\x18\x01 \x03(\v2\x19.blueapi.api.cover.ResultR\x06result\x124\n" +
	"\atagData\x18\x02 \x03(\v2\x1a.blueapi.api.cover.TagDataR\atagData\".\n" +
	"\x14GetCategoriesRequest\x12\x16\n" +
	"\x06vendor\x18\x01 \x01(\tR\x06vendor\"P\n" +
	"\x15GetCategoriesResponse\x127\n" +
	"\bcategory\x18\x01 \x03(\v2\x1b.blueapi.api.cover.CategoryR\bcategory\"\x12\n" +
	"\x10GetAlertsRequest\"O\n" +
	"\x11GetAlertsResponse\x12:\n" +
	"\talertData\x18\x01 \x01(\v2\x1c.blueapi.api.cover.AlertDataR\talertData\"\xc8\x01\n" +
	"\x12CreateAlertRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vfixedAmount\x18\x02 \x01(\x02R\vfixedAmount\x12\x1e\n" +
	"\n" +
	"percentage\x18\x03 \x01(\x02R\n" +
	"percentage\x12 \n" +
	"\vgranularity\x18\x04 \x01(\tR\vgranularity\x12\x1e\n" +
	"\n" +
	"costGroups\x18\x05 \x03(\tR\n" +
	"costGroups\x12\x1a\n" +
	"\bchannels\x18\x06 \x03(\tR\bchannels\"Q\n" +
	"\x13CreateAlertResponse\x12:\n" +
	"\talertData\x18\x01 \x01(\v2\x1c.blueapi.api.cover.AlertDataR\talertData\"(\n" +
	"\x16GetAlertDetailsRequest\x12\x0e\n" +
	...
	"\x19UpdateAlertDetailsRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vfixedAmount\x18\x03 \x01(\x02R\vfixedAmount\x12\x1e\n" +
	"\n" +
	"percentage\x18\x04 \x01(\x02R\n" +
	"percentage\x12 \n" +
	"\vgranularity\x18\x05 \x01(\tR\vgranularity\x12\x1e\n" +
	"\n" +
	"costGroups\x18\x06 \x03(\tR\n" +
	"costGroups\x12\x1a\n" +
	"\bchannels\x18\a \x03(\tR\bchannels\"X\n" +
	"\x1aUpdateAlertDetailsResponse\x12:\n" +
	"\talertData\x18\x01 \x01(\v2\x1c.blueapi.api.cover.AlertDataR\talertData\"(\n" +
	"\x12GetChannelsRequest\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\"W\n" +
	"\x13GetChannelsResponse\x12@\n" +
	"\vchannelData\x18\x01 \x01(\v2\x1e.blueapi.api.cover.ChannelDataR\vchannelData\"^\n" +
	"\x14CreateChannelRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x1e\n" +
	"\n" +
	"webhookUrl\x18\x03 \x01(\tR\n" +
	"webhookUrl\"Y\n" +
	"\x15CreateChannelResponse\x12@\n" +
	"\vchannelData\x18\x01 \x01(\v2\x1e.blueapi.api.cover.ChannelDataR\vchannelData\"*\n" +
	"\x18GetChannelDetailsRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"]\n" +
	"\x19GetChannelDetailsResponse\x12@\n" +
	"\vchannelData\x18\x01 \x01(\v2\x1e.blueapi.api.cover.ChannelDataR\vchannelData\"&\n" +
	"\x14DeleteChannelRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"'\n" +
	"\x15DeleteChannelResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"u\n" +
	"\x1bUpdateChannelDetailsRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	...
	"webhookUrl\"`\n" +
	"\x1cUpdateChannelDetailsResponse\x12@\n" +
	"\vchannelData\x18\x01 \x01(\v2\x1e.blueapi.api.cover.ChannelDataR\vchannelData\"\xff\x01\n" +
	"!GetDiscountRecommendationsRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12:\n" +
	"\tawsInputs\x18\x02 \x01(\v2\x1c.blueapi.api.cover.AwsInputsR\tawsInputs\x12@\n" +
	"\vazureInputs\x18\x03 \x01(\v2\x1e.blueapi.api.cover.AzureInputsR\vazureInputs\x12:\n" +
	"\tgcpInputs\x18\x04 \x01(\v2\x1c.blueapi.api.cover.GcpInputsR\tgcpInputs\"\xc7\x02\n" +
	"\"GetDiscountRecommendationsResponse\x12]\n" +
	"\x12awsRecommendations\x18\x01 \x01(\v2-.blueapi.api.cover.AwsDiscountRecommendationsR\x12awsRecommendations\x12c\n" +
	"\x14azureRecommendations\x18\x02 \x01(\v2/.blueapi.api.cover.AzureDiscountRecommendationsR\x14azureRecommendations\x12]\n" +
	"\x12gcpRecommendations\x18\x03 \x01(\v2-.blueapi.api.cover.GcpDiscountRecommendationsR\x12gcpRecommendations\"x\n" +
	"\x1cGetAnomalyinCostGroupRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x1c\n" +
	"\tstartDate\x18\x02 \x01(\tR\tstartDate\x12\x18\n" +
	"\aendDate\x18\x03 \x01(\tR\aendDate\"\xdd\x02\n" +
	"\vAnomalyData\x12\x18\n" +
	"\aaccount\x18\x01 \x01(\tR\aaccount\x12 \n" +
	"\vcostGroupId\x18\x02 \x01(\tR\vcostGroupId\x12\x16\n" +
	"\x06vendor\x18\x03 \x01(\tR\x06vendor\x12\x18\n" +
	"\aproduct\x18\x04 \x01(\tR\aproduct\x12\x12\n" +
	"\x04date\x18\x05 \x01(\tR\x04date\x12\x1c\n" +
	"\ttotalCost\x18\x06 \x01(\x02R\ttotalCost\x12\x1c\n" +
	"\tisAnomaly\x18\a \x01(\bR\tisAnomaly\x12\x1e\n" +
	"\n" +
	"lowerLimit\x18\b \x01(\x02R\n" +
	"lowerLimit\x12\x1e\n" +
	"\n" +
	"upperLimit\x18\t \x01(\x02R\n" +
	"upperLimit\x12 \n" +
	"\vanomalyCost\x18\n" +
	" \x01(\x02R\vanomalyCost\x12.\n" +
	"\x12anomalyProbability\x18\v \x01(\x02R\x12anomalyProbability\"\xbc\x01\n" +
	"$CreateDiscountExpirationAlertRequest\x12 \n" +
	"\vfrequencies\x18\x01 \x03(\x03R\vfrequencies\x12\x1e\n" +
	"\n" +
	"costGroups\x18\x02 \x03(\tR\n" +
	"costGroups\x12\"\n" +
	"\falertEnabled\x18\x03 \x01(\bR\falertEnabled\x12\x1a\n" +
	"\bchannels\x18\x04 \x03(\tR\bchannels\x12\x12\n" +
	"\x04name\x18\x05 \x01(\tR\x04name\":\n" +
	"(ManipulateDiscountExpirationAlertRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"\xcc\x01\n" +
	"$UpdateDiscountExpirationAlertRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\"\n" +
	"\falertEnabled\x18\x02 \x01(\bR\falertEnabled\x12\x1a\n" +
	"\bchannels\x18\x03 \x03(\tR\bchannels\x12 \n" +
	"\vfrequencies\x18\x04 \x03(\x03R\vfrequencies\x12\x1e\n" +
	"\n" +
	"costGroups\x18\x05 \x03(\tR\n" +
	"costGroups\x12\x12\n" +
	"\x04name\x18\x06 \x01(\tR\x04name\"\xb4\x02\n" +
	"\x17DiscountExpiryAlertData\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05orgId\x18\x02 \x01(\tR\x05orgId\x12\"\n" +
	"\falertEnabled\x18\x03 \x01(\bR\falertEnabled\x12 \n" +
	"\vfrequencies\x18\x04 \x03(\x03R\vfrequencies\x12A\n" +
	"\n" +
	"costGroups\x18\x05 \x03(\v2!.blueapi.api.cover.AlertCostGroupR\n" +
	"costGroups\x12\x18\n" +
	"\adetails\x18\x06 \x01(\tR\adetails\x12<\n" +
	"\bchannels\x18\a \x01(\v2 .blueapi.api.cover.AlertChannelsR\bchannels\x12\x12\n" +
	"\x04name\x18\b \x01(\tR\x04name\"$\n" +
	"\"ListDiscountExpirationAlertRequest\"\xc7\x01\n" +
	"\x19CreateAnomalyAlertRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\"\n" +
	"\falertEnabled\x18\x02 \x01(\bR\falertEnabled\x12\x1c\n" +
	"\tfrequency\x18\x03 \x01(\tR\tfrequency\x12 \n" +
	"\vcostGroupId\x18\x04 \x01(\tR\vcostGroupId\x122\n" +
	"\x14notificationChannels\x18\x05 \x03(\tR\x14notificationChannels\"/\n" +
	"\x1dManipulateAnomalyAlertRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"\x91\x02\n" +
	"\x10AnomalyAlertData\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05orgId\x18\x02 \x01(\tR\x05orgId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\"\n" +
	"\falertEnabled\x18\x04 \x01(\bR\falertEnabled\x12\x1c\n" +
	"\tfrequency\x18\x05 \x01(\tR\tfrequency\x12C\n" +
	"\vcostGroupId\x18\x06 \x01(\v2!.blueapi.api.cover.AlertCostGroupR\vcostGroupId\x12<\n" +
	"\bchannels\x18\a \x01(\v2 .blueapi.api.cover.AlertChannelsR\bchannels\"\x19\n" +
	"\x17ListAnomalyAlertRequest\"\xd7\x01\n" +
	"\x19UpdateAnomalyAlertRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\"\n" +
	"\falertEnabled\x18\x03 \x01(\bR\falertEnabled\x122\n" +
	"\x14notificationChannels\x18\x04 \x03(\tR\x14notificationChannels\x12\x1c\n" +
	"\tfrequency\x18\x05 \x01(\tR\tfrequency\x12 \n" +
	"\vcostGroupId\x18\x06 \x01(\tR\vcostGroupId\"\xc2\x01\n" +
	"\x16RegisterNewUserRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\x12\x12\n" +
	...
	"\tintention\x18\a \x01(\tR\tintention\"=\n" +
	"\x17RegisterNewUserResponse\x12\"\n" +
	"\fisAuthorized\x18\x01 \x01(\bR\fisAuthorized\"-\n" +
	"\x15GetUserProfileRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\"\xbc\x02\n" +
	"\x16GetUserProfileResponse\x12,\n" +
	"\x11hasCreatedProfile\x18\x01 \x01(\bR\x11hasCreatedProfile\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04role\x18\x03 \x01(\tR\x04role\x12\x14\n" +
	"\x05usage\x18\x04 \x01(\tR\x05usage\x12\x1c\n" +
	"\tintention\x18\x05 \x01(\tR\tintention\x12 \n" +
	"\vcompanyName\x18\x06 \x01(\tR\vcompanyName\x12\"\n" +
	"\femailAddress\x18\a \x01(\tR\femailAddress\x12\x1e\n" +
	"\n" +
	"linkSource\x18\b \x01(\tR\n" +
	"linkSource\x122\n" +
	"\x14hasSubscribedUpdates\x18\t \x01(\bR\x14hasSubscribedUpdates\"\x82\x02\n" +
	...
	"\n" +
	"linkSource\x18\a \x01(\tR\n" +
	"linkSource\x122\n" +
	"\x14hasSubscribedUpdates\x18\b \x01(\bR\x14hasSubscribedUpdates\"\x83\x02\n" +
	"\x19UpdateUserProfileResponse\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04role\x18\x03 \x01(\tR\x04role\x12\x14\n" +
	"\x05usage\x18\x04 \x01(\tR\x05usage\x12\x1c\n" +
	...
	"linkSource\x18\a \x01(\tR\n" +
	"linkSource\x122\n" +
	"\x14hasSubscribedUpdates\x18\b \x01(\bR\x14hasSubscribedUpdates\"l\n" +
	"\x12ListBudgetsRequest\x128\n" +
	"\x17includeSpendAndForecast\x18\x01 \x01(\bR\x17includeSpendAndForecast\x12\x1c\n" +
	"\tcostGroup\x18\x02 \x01(\tR\tcostGroup\"T\n" +
	"\x13ListBudgetsResponse\x12=\n" +
	"\n" +
	"budgetData\x18\x01 \x01(\v2\x1d.blueapi.api.cover.BudgetDataR\n" +
	"budgetData\"\"\n" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\"&\n" +
	"\x14DeleteBudgetResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"d\n" +
	"\x13UpdateBudgetRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12=\n" +
	"\n" +
	"budgetData\x18\x02 \x01(\v2\x1d.blueapi.api.cover.BudgetDataR\n" +
	"budgetData\"U\n" +
	"\x14UpdateBudgetResponse\x12=\n" +
	"\n" +
	"budgetData\x18\x01 \x01(\v2\x1d.blueapi.api.cover.BudgetDataR\n" +
	"budgetData\"^\n" +
	".ResolveAWSMarketplaceTokenForOnboardingRequest\x12,\n" +
	"\x11registrationToken\x18\x01 \x01(\tR\x11registrationToken\"\x81\x01\n" +
	"/ResolveAWSMarketplaceTokenForOnboardingResponse\x12.\n" +
	"\x12isAllowedToOnboard\x18\x01 \x01(\bR\x12isAllowedToOnboard\x12\x1e\n" +
	"\n" +
	"customerId\x18\x02 \x01(\tR\n" +
	"customerId\"&\n" +
	"$GetCustomerSubscriptionStatusRequest\"\xed\x02\n" +
	"%GetCustomerSubscriptionStatusResponse\x12&\n" +
	"\x0edateRegistered\x18\x01 \x01(\tR\x0edateRegistered\x12.\n" +
	"\x12subscriptionExpiry\x18\x02 \x01(\tR\x12subscriptionExpiry\x12\x1a\n" +
	"\bdaysLeft\x18\x03 \x01(\x05R\bdaysLeft\x12\"\n" +
	"\fisSubscribed\x18\x04 \x01(\bR\fisSubscribed\x12\x1c\n" +
	"\tisExpired\x18\x05 \x01(\bR\tisExpired\x12\x12\n" +
	"\x04plan\x18\x06 \x01(\tR\x04plan\x12\x16\n" +
	"\x06amount\x18\a \x01(\tR\x06amount\x12$\n" +
	"\rpaymentOption\x18\b \x01(\tR\rpaymentOption\x12$\n" +
	"\rpaymentMethod\x18\t \x01(\tR\rpaymentMethod\x12\x16\n" +
	"\x06credit\x18\n" +
	" \x01(\x01R\x06credit\"\x8e\x02\n" +
	"\x16CreateProfilingRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04role\x18\x02 \x01(\tR\x04role\x12\x14\n" +
	"\x05usage\x18\x03 \x01(\tR\x05usage\x12\x1c\n" +
	"\tintention\x18\x04 \x01(\tR\tintention\x12 \n" +
	"\vcompanyName\x18\x05 \x01(\tR\vcompanyName\x12\"\n" +
	"\femailAddress\x18\x06 \x01(\tR\femailAddress\x12\x1e\n" +
	"\n" +
	"linkSource\x18\a \x01(\tR\n" +
	"linkSource\x122\n" +
	"\x14hasSubscribedUpdates\x18\b \x01(\bR\x14hasSubscribedUpdates\"\x19\n" +
	"\x17CreateProfilingResponse\"M\n" +
	"\x1bAddInfotoMarketplaceRequest\x12.\n" +
	"\x12customerIdentifier\x18\x01 \x01(\tR\x12customerIdentifier\"\x1e\n" +
	"\x1cAddInfotoMarketplaceResponse\"\xaf\x01\n" +
	"\x17GetReportSummaryRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x1c\n" +
	"\tstartDate\x18\x02 \x01(\tR\tstartDate\x12\x18\n" +
	"\aendDate\x18\x03 \x01(\tR\aendDate\x12\x1e\n" +
	"\n" +
	"reportType\x18\x04 \x01(\tR\n" +
	"reportType\x12\x1a\n" +
	"\bcurrency\x18\x05 \x01(\tR\bcurrency\"\x95\x03\n" +
	"\x18GetReportSummaryResponse\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x1c\n" +
	"\tstartDate\x18\x02 \x01(\tR\tstartDate\x12\x18\n" +
	"\aendDate\x18\x03 \x01(\tR\aendDate\x12O\n" +
	"\x10executiveSummary\x18\x04 \x01(\v2#.blueapi.api.cover.ExecutiveSummaryR\x10executiveSummary\x12\x82\x01\n" +
	"!optimizationRecommendationSummary\x18\x05 \x01(\v24.blueapi.api.cover.OptimizationRecommendationSummaryR!optimizationRecommendationSummary\x12I\n" +
	"\x0esavingsSummary\x18\x06 \x01(\v2!.blueapi.api.cover.SavingsSummaryR\x0esavingsSummary\"\xc9\x03\n" +
	"\x19ListRecommendationRequest\x12 \n" +
	"\vcostgroupId\x18\x01 \x01(\tR\vcostgroupId\x12&\n" +
	"\x0edateRangeStart\x18\x02 \x01(\tR\x0edateRangeStart\x12\"\n" +
	"\fdateRangeEnd\x18\x03 \x01(\tR\fdateRangeEnd\x12\x16\n" +
	"\x06vendor\x18\x04 \x01(\tR\x06vendor\x12\x16\n" +
	"\x06source\x18\x05 \x01(\tR\x06source\x12.\n" +
	"\x12optimizationStatus\x18\a \x01(\tR\x12optimizationStatus\x12\x12\n" +
	"\x04type\x18\b \x01(\tR\x04type\x12\x16\n" +
	"\x06spType\x18\t \x01(\tR\x06spType\x12\x1c\n" +
	"\trateModel\x18\n" +
	" \x01(\tR\trateModel\x12$\n" +
	"\rpaymentOption\x18\v \x01(\tR\rpaymentOption\x12\x12\n" +
	"\x04term\x18\f \x01(\tR\x04term\x12\x18\n" +
	"\aservice\x18\r \x01(\tR\aservice\x12$\n" +
	"\rofferingClass\x18\x0e \x01(\tR\rofferingClass\x12\x1a\n" +
	"\bcurrency\x18\x0f \x01(\tR\bcurrency\"\xe0\x03\n" +
	"\x1bListRecommendationV2Request\x12 \n" +
	"\vcostgroupId\x18\x01 \x01(\tR\vcostgroupId\x12&\n" +
	"\x0edateRangeStart\x18\x02 \x01(\tR\x0edateRangeStart\x12\"\n" +
	"\fdateRangeEnd\x18\x03 \x01(\tR\fdateRangeEnd\x12^\n" +
	"\frateSettings\x18\x04 \x01(\v2:.blueapi.cover.v1.ListRecommendationV2Request.RateSettingsR\frateSettings\x12\x1a\n" +
	"\bcurrency\x18\x05 \x01(\tR\bcurrency\x1a\xd6\x01\n" +
	"\fRateSettings\x12\x16\n" +
	"\x06spType\x18\x01 \x01(\tR\x06spType\x12\x1c\n" +
	"\trateModel\x18\x02 \x01(\tR\trateModel\x12$\n" +
	"\rpaymentOption\x18\x03 \x01(\tR\rpaymentOption\x12\x12\n" +
	"\x04term\x18\x04 \x01(\tR\x04term\x12\x18\n" +
	"\aservice\x18\x05 \x01(\tR\aservice\x12$\n" +
	"\rofferingClass\x18\x06 \x01(\tR\rofferingClass\x12\x16\n" +
	"\x06vendor\x18\a \x01(\tR\x06vendor\"\xb0\n" +
	"\n" +
	"\x1aListRecommendationResponse\x12*\n" +
	"\x10recommendationId\x18\x01 \x01(\tR\x10recommendationId\x12&\n" +
	"\x0erecommendation\x18\x02 \x01(\tR\x0erecommendation\x12\x18\n" +
	"\aservice\x18\x03 \x01(\tR\aservice\x126\n" +
	"\x16estimatedMonthlySaving\x18\x04 \x01(\x01R\x16estimatedMonthlySaving\x122\n" +
	"\x14estimatedMonthlyCost\x18\x05 \x01(\x01R\x14estimatedMonthlyCost\x12\x18\n" +
	"\ascoring\x18\x06 \x01(\tR\ascoring\x12\x16\n" +
	"\x06vendor\x18\a \x01(\tR\x06vendor\x12\x1a\n" +
	"\bcategory\x18\b \x01(\tR\bcategory\x12.\n" +
	"\x12optimizationStatus\x18\t \x01(\tR\x12optimizationStatus\x12\"\n" +
	"\ferrorMessage\x18\n" +
	" \x01(\tR\ferrorMessage\x12\x1c\n" +
	"\taccountId\x18\v \x01(\tR\taccountId\x12 \n" +
	"\vaccountName\x18\f \x01(\tR\vaccountName\x12\"\n" +
	"\finstanceName\x18\r \x01(\tR\finstanceName\x12\x1e\n" +
	"\n" +
	"instanceId\x18\x0e \x01(\tR\n" +
	"instanceId\x12\"\n" +
	"\finstanceType\x18\x0f \x01(\tR\finstanceType\x12\x16\n" +
	"\x06region\x18\x10 \x01(\tR\x06region\x12\x1e\n" +
	"\n" +
	"commitment\x18\x11 \x01(\x01R\n" +
	"commitment\x12\x16\n" +
	"\x06spType\x18\x12 \x01(\tR\x06spType\x12*\n" +
	"\x10numberToPurchase\x18\x13 \x01(\x03R\x10numberToPurchase\x12\x16\n" +
	"\x06riType\x18\x14 \x01(\tR\x06riType\x12\x12\n" +
	"\x04type\x18\x15 \x01(\tR\x04type\x12\x16\n" +
	"\x06source\x18\x16 \x01(\tR\x06source\x12(\n" +
	"\x0fdateRecommended\x18\x17 \x01(\tR\x0fdateRecommended\x120\n" +
	"\x13recommendationGroup\x18\x18 \x01(\tR\x13recommendationGroup\x12$\n" +
	"\rlastUpdatedAt\x18\x19 \x01(\tR\rlastUpdatedAt\x12c\n" +
	"\x0epurchaseOption\x18\x1a \x01(\v2;.blueapi.cover.v1.ListRecommendationResponse.PurchaseOptionR\x0epurchaseOption\x1a\xc6\x02\n" +
	"\x0ePurchaseOption\x12\x16\n" +
	"\x06spType\x18\x01 \x01(\tR\x06spType\x12$\n" +
	"\rofferingClass\x18\x02 \x01(\tR\rofferingClass\x12\x1e\n" +
	"\n" +
	"commitment\x18\x03 \x01(\x01R\n" +
	"commitment\x12*\n" +
	"\x10numberToPurchase\x18\x04 \x01(\x03R\x10numberToPurchase\x12$\n" +
	"\rpaymentOption\x18\x05 \x01(\tR\rpaymentOption\x12\x12\n" +
	"\x04term\x18\x06 \x01(\tR\x04term\x12,\n" +
	"\x11currentGeneration\x18\a \x01(\bR\x11currentGeneration\x12 \n" +
	"\vserviceType\x18\b \x01(\tR\vserviceType\x12 \n" +
	"\vupfrontCost\x18\t \x01(\x01R\vupfrontCost\"p\n" +
	"\x18GetRecommendationRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12 \n" +
	"\vcostGroupId\x18\x02 \x01(\tR\vcostGroupId\x12\"\n" +
	"\fperiodOption\x18\x03 \x01(\tR\fperiodOption\"r\n" +
	"\x19GetRecommendationResponse\x12U\n" +
	"\x12recommendationData\x18\x01 \x01(\v2%.blueapi.api.cover.AWSRecommendationsR\x12recommendationData\"\\\n" +
	"\x1aExecuteOptimizationRequest\x12*\n" +
	"\x10recommendationId\x18\x01 \x01(\tR\x10recommendationId\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\"\xf0\x03\n" +
	"\x1bExecuteOptimizationResponse\x12W\n" +
	"\tawsOption\x18\x01 \x01(\v27.blueapi.cover.v1.ExecuteOptimizationResponse.AWSOptionH\x00R\tawsOption\x12W\n" +
	"\tgcpOption\x18\x02 \x01(\v27.blueapi.cover.v1.ExecuteOptimizationResponse.GCPOptionH\x00R\tgcpOption\x12f\n" +
	"\x0eazureCspOption\x18\x03 \x01(\v2<.blueapi.cover.v1.ExecuteOptimizationResponse.AzureCSPOptionH\x00R\x0eazureCspOption\x1a\x8d\x01\n" +
	"\tAWSOption\x12.\n" +
	"\x12approveTemplateUrl\x18\x01 \x01(\tR\x12approveTemplateUrl\x12*\n" +
	"\x10recommendationId\x18\x02 \x01(\tR\x10recommendationId\x12$\n" +
	"\rcurrentStatus\x18\x03 \x01(\tR\rcurrentStatus\x1a\v\n" +
	"\tGCPOption\x1a\x10\n" +
	"\x0eAzureCSPOptionB\b\n" +
	"\x06Vendor\"'\n" +
	"\x15MarkAsExecutedRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x03(\tR\x02id\"\x18\n" +
	"\x16MarkAsExecutedResponse\"3\n" +
	"!UndoExecutedRecommendationRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x03(\tR\x02id\"$\n" +
	"\"UndoExecutedRecommendationResponse\"\xfa\x01\n" +
	"\x1aOptimizationHistoryRequest\x12 \n" +
	"\vcostgroupId\x18\x01 \x01(\tR\vcostgroupId\x12&\n" +
	"\x0edateRangeStart\x18\x02 \x01(\tR\x0edateRangeStart\x12\"\n" +
	"\fdateRangeEnd\x18\x03 \x01(\tR\fdateRangeEnd\x12\x16\n" +
	"\x06vendor\x18\x04 \x01(\tR\x06vendor\x12\x16\n" +
	"\x06source\x18\x05 \x01(\tR\x06source\x12\"\n" +
	"\fperiodOption\x18\x06 \x01(\tR\fperiodOption\x12\x1a\n" +
	"\bcurrency\x18\a \x01(\tR\bcurrency\"\x95\x01\n" +
	"\x1bOptimizationHistoryResponse\x12v\n" +
	"\x1dexecutedRecommendationDetails\x18\x02 \x03(\v20.blueapi.api.cover.ExecutedRecommendationDetailsR\x1dexecutedRecommendationDetails\"\x85\x01\n" +
	"!SetCostGroupEventIndicatorRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x18\n" +
	"\aanomaly\x18\x02 \x01(\bR\aanomaly\x12$\n" +
	"\rvisualBuilder\x18\x03 \x01(\bR\rvisualBuilder\"\x91\x01\n" +
	"\"SetCostGroupEventIndicatorResponse\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12I\n" +
	"\x0eeventIndicator\x18\x02 \x01(\v2!.blueapi.api.cover.EventIndicatorR\x0eeventIndicator\"\xb3\x01\n" +
	"!SetCostGroupAnomalyOptionsRequest\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12\x1c\n" +
	"\tthreshold\x18\x02 \x01(\x02R\tthreshold\x12\"\n" +
	"\fisPercentage\x18\x03 \x01(\bR\fisPercentage\x12*\n" +
	"\x10pastDataInMonths\x18\x04 \x01(\x03R\x10pastDataInMonths\"\x91\x01\n" +
	"\"SetCostGroupAnomalyOptionsResponse\x12 \n" +
	"\vcostGroupId\x18\x01 \x01(\tR\vcostGroupId\x12I\n" +
	"\x0eanomalyOptions\x18\x02 \x01(\v2!.blueapi.api.cover.AnomalyOptionsR\x0eanomalyOptions\"<\n" +
	"\x18SetOrgFiscalMonthRequest\x12 \n" +
	"\vfiscalMonth\x18\x01 \x01(\tR\vfiscalMonth\"=\n" +
	"\x19SetOrgFiscalMonthResponse\x12 \n" +
	"\vfiscalMonth\x18\x01 \x01(\tR\vfiscalMonth\"\x1a\n" +
	"\x18GetOrgFiscalMonthRequest\"e\n" +
	"\x19GetOrgFiscalMonthResponse\x12 \n" +
	"\vfiscalMonth\x18\x01 \x01(\tR\vfiscalMonth\x12&\n" +
	"\x0edateRegistered\x18\x02 \x01(\tR\x0edateRegistered\"y\n" +
	"\x1bTransferOrganizationRequest\x12\x16\n" +
	"\x06target\x18\x01 \x01(\tR\x06target\x12\x16\n" +
	"\x06region\x18\x02 \x01(\tR\x06region\x12\x14\n" +
	"\x05payer\x18\x03 \x01(\tR\x05payer\x12\x14\n" +
	"\x05orgId\x18\x04 \x01(\tR\x05orgId\"6\n" +
	"\x1cTransferOrganizationResponse\x12\x16\n" +
	"\x06target\x18\x01 \x01(\tR\x06target\"`\n" +
	" UpdateCostGroupCreationUIRequest\x12<\n" +
	"\x19useNewCostGroupCreationUI\x18\x01 \x01(\bR\x19useNewCostGroupCreationUI\"\\\n" +
	"!UpdateCostGroupCreationUIResponse\x127\n" +
	"\buserData\x18\x01 \x01(\v2\x1b.blueapi.api.cover.UserDataR\buserData\"\x16\n" +
	"\x14ListUnitTypesRequest\"\\\n" +
	"\x15ListUnitTypesResponse\x12C\n" +
	"\funitCostData\x18\x01 \x03(\v2\x1f.blueapi.api.cover.UnitCostDataR\funitCostData\"\xe9\x01\n" +
	"\x15CreateUnitTypeRequest\x12\x1a\n" +
	"\bunitName\x18\x01 \x01(\tR\bunitName\x129\n" +
	"\tunitItems\x18\x02 \x03(\v2\x1b.blueapi.api.cover.UnitItemR\tunitItems\x12W\n" +
	"\x0fsharedResources\x18\x03 \x03(\v2-.blueapi.api.cover.SharedResourcesCombinationR\x0fsharedResources\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\"]\n" +
	"\x16CreateUnitTypeResponse\x12C\n" +
	"\funitCostData\x18\x01 \x01(\v2\x1f.blueapi.api.cover.UnitCostDataR\funitCostData\"$\n" +
	"\x12GetUnitTypeRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"Z\n" +
	"\x13GetUnitTypeResponse\x12C\n" +
	"\funitCostData\x18\x01 \x01(\v2\x1f.blueapi.api.cover.UnitCostDataR\funitCostData\"\xf9\x01\n" +
	"\x15UpdateUnitTypeRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\bunitName\x18\x02 \x01(\tR\bunitName\x129\n" +
	"\tunitItems\x18\x03 \x03(\v2\x1b.blueapi.api.cover.UnitItemR\tunitItems\x12W\n" +
	"\x0fsharedResources\x18\x04 \x03(\v2-.blueapi.api.cover.SharedResourcesCombinationR\x0fsharedResources\x12 \n" +
	"\vdescription\x18\x05 \x01(\tR\vdescription\"]\n" +
	"\x16UpdateUnitTypeResponse\x12C\n" +
	"\funitCostData\x18\x01 \x01(\v2\x1f.blueapi.api.cover.UnitCostDataR\funitCostData\"'\n" +
	"\x15DeleteUnitTypeRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"(\n" +
	"\x16DeleteUnitTypeResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"s\n" +
	"\x11MergeUnitsRequest\x12 \n" +
	"\vunitCostIds\x18\x01 \x03(\tR\vunitCostIds\x12\x1a\n" +
	"\bunitName\x18\x02 \x01(\tR\bunitName\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\"]\n" +
	"\x12MergeUnitsResponse\x12G\n" +
	"\x0emergedUnitCost\x18\x01 \x01(\v2\x1f.blueapi.api.cover.UnitCostDataR\x0emergedUnitCost\"\x1b\n" +
	"\x19ListSuggestedUnitsRequest\"f\n" +
	"\x1aListSuggestedUnitsResponse\x12H\n" +
	"\x0esuggestedUnits\x18\x01 \x03(\v2 .blueapi.api.cover.SuggestedUnitR\x0esuggestedUnits\"\xa8\x01\n" +
	"\x1aMergeSuggestedUnitsRequest\x12*\n" +
	"\x10suggestedUnitIds\x18\x01 \x03(\tR\x10suggestedUnitIds\x12 \n" +
	"\vunitItemIds\x18\x02 \x03(\tR\vunitItemIds\x12\x1a\n" +
	"\bunitName\x18\x03 \x01(\tR\bunitName\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\"s\n" +
	"\x1bMergeSuggestedUnitsResponse\x12T\n" +
	"\x14mergedSuggestedUnits\x18\x01 \x01(\v2 .blueapi.api.cover.SuggestedUnitR\x14mergedSuggestedUnits\"L\n" +
	"\x1eCreateUnitFromSuggestedRequest\x12*\n" +
	"\x10suggestedUnitIds\x18\x01 \x03(\tR\x10suggestedUnitIds\"C\n" +
	"\x1fCreateUnitFromSuggestedResponse\x12 \n" +
	"\vunitCostIds\x18\x01 \x03(\tR\vunitCostIds\"\x1c\n" +
	"\x1aListSharedResourcesRequest\"v\n" +
	"\x1bListSharedResourcesResponse\x12W\n" +
	"\x0fsharedResources\x18\x01 \x03(\v2-.blueapi.api.cover.SharedResourcesCombinationR\x0fsharedResources\"\xc3\x03\n" +
	"\x1cCreateSharedResourcesRequest\x12.\n" +
	"\x12sharedResourceName\x18\x01 \x01(\tR\x12sharedResourceName\x12j\n" +
	"\x1bsharedResourcesCombinations\x18\x02 \x01(\v2(.blueapi.api.cover.ResourcesCombinationsR\x1bsharedResourcesCombinations\x12d\n" +
	"\fdistribution\x18\x03 \x03(\v2@.blueapi.cover.v1.CreateSharedResourcesRequest.DistributionEntryR\fdistribution\x12\x1c\n" +
	"\tallocated\x18\x04 \x01(\x01R\tallocated\x12 \n" +
	"\vunallocated\x18\x05 \x01(\x01R\vunallocated\x12 \n" +
	"\vdescription\x18\x06 \x01(\tR\vdescription\x1a?\n" +
	"\x11DistributionEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\"x\n" +
	"\x1dCreateSharedResourcesResponse\x12W\n" +
	"\x0fsharedResources\x18\x01 \x01(\v2-.blueapi.api.cover.SharedResourcesCombinationR\x0fsharedResources\"+\n" +
	"\x19GetSharedResourcesRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"u\n" +
	"\x1aGetSharedResourcesResponse\x12W\n" +
	"\x0fsharedResources\x18\x01 \x01(\v2-.blueapi.api.cover.SharedResourcesCombinationR\x0fsharedResources\"\xd3\x03\n" +
	"\x1cUpdateSharedResourcesRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12.\n" +
	"\x12sharedResourceName\x18\x02 \x01(\tR\x12sharedResourceName\x12j\n" +
	"\x1bsharedResourcesCombinations\x18\x03 \x01(\v2(.blueapi.api.cover.ResourcesCombinationsR\x1bsharedResourcesCombinations\x12d\n" +
	"\fdistribution\x18\x04 \x03(\v2@.blueapi.cover.v1.UpdateSharedResourcesRequest.DistributionEntryR\fdistribution\x12\x1c\n" +
	"\tallocated\x18\x05 \x01(\x01R\tallocated\x12 \n" +
	"\vunallocated\x18\x06 \x01(\x01R\vunallocated\x12 \n" +
	"\vdescription\x18\a \x01(\tR\vdescription\x1a?\n" +
	"\x11DistributionEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\"x\n" +
	"\x1dUpdateSharedResourcesResponse\x12W\n" +
	"\x0fsharedResources\x18\x01 \x01(\v2-.blueapi.api.cover.SharedResourcesCombinationR\x0fsharedResources\".\n" +
	"\x1cDeleteSharedResourcesRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"/\n" +
	"\x1dDeleteSharedResourcesResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"~\n" +
	"\x16ListUnitMetricsRequest\x12,\n" +
	"\x11aggregationMethod\x18\x01 \x01(\tR\x11aggregationMethod\x12\x1e\n" +
	"\n" +
	"dataSource\x18\x02 \x01(\tR\n" +
	"dataSource\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status\"Z\n" +
	"\x17ListUnitMetricsResponse\x12?\n" +
	"\vunitMetrics\x18\x01 \x03(\v2\x1d.blueapi.api.cover.UnitMetricR\vunitMetrics\"\x81\x02\n" +
	"\x17CreateUnitMetricRequest\x12\x1e\n" +
	"\n" +
	"metricName\x18\x01 \x01(\tR\n" +
	"metricName\x12,\n" +
	"\x11aggregationMethod\x18\x02 \x01(\tR\x11aggregationMethod\x12\x1e\n" +
	"\n" +
	"dataSource\x18\x03 \x01(\tR\n" +
	"dataSource\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12 \n" +
	"\vcostgroupId\x18\x05 \x01(\tR\vcostgroupId\x124\n" +
	"\acsvInfo\x18\x06 \x01(\v2\x1a.blueapi.api.cover.CsvInfoR\acsvInfo\"Y\n" +
	"\x18CreateUnitMetricResponse\x12=\n" +
	"\n" +
	"unitMetric\x18\x01 \x01(\v2\x1d.blueapi.api.cover.UnitMetricR\n" +
	"unitMetric\"&\n" +
	"\x14GetUnitMetricRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"V\n" +
	"\x15GetUnitMetricResponse\x12=\n" +
	"\n" +
	"unitMetric\x18\x01 \x01(\v2\x1d.blueapi.api.cover.UnitMetricR\n" +
	"unitMetric\"\x91\x02\n" +
	"\x17UpdateUnitMetricRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1e\n" +
	"\n" +
	"metricName\x18\x02 \x01(\tR\n" +
	"metricName\x12,\n" +
	"\x11aggregationMethod\x18\x03 \x01(\tR\x11aggregationMethod\x12\x1e\n" +
	"\n" +
	"dataSource\x18\x04 \x01(\tR\n" +
	"dataSource\x12 \n" +
	"\vdescription\x18\x05 \x01(\tR\vdescription\x12 \n" +
	"\vcostgroupId\x18\x06 \x01(\tR\vcostgroupId\x124\n" +
	"\acsvInfo\x18\a \x01(\v2\x1a.blueapi.api.cover.CsvInfoR\acsvInfo\"Y\n" +
	"\x18UpdateUnitMetricResponse\x12=\n" +
	"\n" +
	"unitMetric\x18\x01 \x01(\v2\x1d.blueapi.api.cover.UnitMetricR\n" +
	"unitMetric\")\n" +
	"\x17DeleteUnitMetricRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"*\n" +
	"\x18DeleteUnitMetricResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id*?\n" +
	"\x06Status\x12\v\n" +
	...
	"\n" +
	"\x06FAILED\x10\x032\x93\xc5\x01\n" +
	"\x05Cover\x12w\n" +
	"\n" +
	"OnboardOrg\x12#.blueapi.cover.v1.OnboardOrgRequest\x1a$.blueapi.cover.v1.OnboardOrgResponse\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/v1/members/onboard\x12|\n" +
	"\fInviteMember\x12%.blueapi.cover.v1.InviteMemberRequest\x1a&.blueapi.cover.v1.InviteMemberResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/v1/members/invite\x12~\n" +
	"\fActivateUser\x12%.blueapi.cover.v1.ActivateUserRequest\x1a&.blueapi.cover.v1.ActivateUserResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/v1/members/activate\x12u\n" +
	"\fCreateMember\x12%.blueapi.cover.v1.CreateMemberRequest\x1a&.blueapi.cover.v1.CreateMemberResponse\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/v1/members\x12l\n" +
	"\n" +
	"GetMembers\x12#.blueapi.cover.v1.GetMembersRequest\x1a$.blueapi.cover.v1.GetMembersResponse\"\x13\x82\xd3\xe4\x93\x02\r\x12\v/v1/members\x12\x87\x01\n" +
	...
	"\x16UpdateMemberPermission\x12/.blueapi.cover.v1.UpdateMemberPermissionRequest\x1a0.blueapi.cover.v1.UpdateMemberPermissionResponse\"'\x82\xd3\xe4\x93\x02!:\x01*\x1a\x1c/v1/members/{userId}/isadmin\x12s\n" +
	"\x0eGetUserDetails\x12'.blueapi.cover.v1.GetUserDetailsRequest\x1a(.blueapi.cover.v1.GetUserDetailsResponse\"\x0e\x82\xd3\xe4\x93\x02\b\x12\x06/v1/me\x12\x83\x01\n" +
	"\x10UpdateUserAvatar\x12).blueapi.cover.v1.UpdateUserAvatarRequest\x1a*.blueapi.cover.v1.UpdateUserAvatarResponse\"\x18\x82\xd3\xe4\x93\x02\x12:\x01*\x1a\r/v1/me/avatar\x12{\n" +
	"\x0eUpdateUserIcon\x12'.blueapi.cover.v1.UpdateUserIconRequest\x1a(.blueapi.cover.v1.UpdateUserIconResponse\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\x1a\v/v1/me/icon\x12\x93\x01\n" +
	"\x14UpdateUserColorTheme\x12-.blueapi.cover.v1.UpdateUserColorThemeRequest\x1a..blueapi.cover.v1.UpdateUserColorThemeResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\x1a\x11/v1/me/colortheme\x12{\n" +
	"\x0eUpdateUserName\x12'.blueapi.cover.v1.UpdateUserNameRequest\x1a(.blueapi.cover.v1.UpdateUserNameResponse\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\x1a\v/v1/me/name\x12\x7f\n" +
	"\x0fUpdateUserEmail\x12(.blueapi.cover.v1.UpdateUserEmailRequest\x1a).blueapi.cover.v1.UpdateUserEmailResponse\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\x1a\f/v1/me/email\x12\x8b\x01\n" +
	"\x12UpdateUserMainView\x12+.blueapi.cover.v1.UpdateUserMainViewRequest\x1a,.blueapi.cover.v1.UpdateUserMainViewResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\x1a\x0f/v1/me/mainview\x12\x88\x01\n" +
	"\x11ResetUserPassword\x12*.blueapi.cover.v1.ResetUserPasswordRequest\x1a+.blueapi.cover.v1.ResetUserPasswordResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/me/password\x12\x83\x01\n" +
	"\x10UpdateUserLocale\x12).blueapi.cover.v1.UpdateUserLocaleRequest\x1a*.blueapi.cover.v1.UpdateUserLocaleResponse\"\x18\x82\xd3\xe4\x93\x02\x12:\x01*\x1a\r/v1/me/locale\x12\x8b\x01\n" +
	"\x12UpdateUserAppTheme\x12+.blueapi.cover.v1.UpdateUserAppThemeRequest\x1a,.blueapi.cover.v1.UpdateUserAppThemeResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\x1a\x0f/v1/me/apptheme\x12\x8b\x01\n" +
	"\x12UpdateUserTimezone\x12+.blueapi.cover.v1.UpdateUserTimezoneRequest\x1a,.blueapi.cover.v1.UpdateUserTimezoneResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\x1a\x0f/v1/me/timezone\x12\x93\x01\n" +
	"\x14UpdateUserAttributes\x12-.blueapi.cover.v1.UpdateUserAttributesRequest\x1a..blueapi.cover.v1.UpdateUserAttributesResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\x1a\x11/v1/me/attributes\x12{\n" +
	"\fDeleteMember\x12%.blueapi.cover.v1.DeleteMemberRequest\x1a&.blueapi.cover.v1.DeleteMemberResponse\"\x1c\x82\xd3\xe4\x93\x02\x16*\x14/v1/members/{userId}\x12\x86\x01\n" +
	"\rResetPassword\x12&.blueapi.cover.v1.ResetPasswordRequest\x1a'.blueapi.cover.v1.ResetPasswordResponse\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/v1/members/resetpassword\x12m\n" +
	"\n" +
	"CreateView\x12#.blueapi.cover.v1.CreateViewRequest\x1a$.blueapi.cover.v1.CreateViewResponse\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/views\x12d\n" +
	"\bGetViews\x12!.blueapi.cover.v1.GetViewsRequest\x1a\".blueapi.cover.v1.GetViewsResponse\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/v1/views\x12\x7f\n" +
	...
	"\vPublishView\x12$.blueapi.cover.v1.PublishViewRequest\x1a%.blueapi.cover.v1.PublishViewResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11/v1/views/publish\x12}\n" +
	"\vAddFavorite\x12$.blueapi.cover.v1.AddFavoriteRequest\x1a%.blueapi.cover.v1.AddFavoriteResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\x1a\x16/v1/views/favorite/add\x12\x89\x01\n" +
	"\x0eRemoveFavorite\x12'.blueapi.cover.v1.RemoveFavoriteRequest\x1a(.blueapi.cover.v1.RemoveFavoriteResponse\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\x1a\x19/v1/views/favorite/remove\x12v\n" +
	"\n" +
	"UpdateView\x12#.blueapi.cover.v1.UpdateViewRequest\x1a$.blueapi.cover.v1.UpdateViewResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\x1a\x12/v1/views/{viewId}\x12\x8f\x01\n" +
	"\x10UpdateViewLayout\x12).blueapi.cover.v1.UpdateViewLayoutRequest\x1a*.blueapi.cover.v1.UpdateViewLayoutResponse\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\x1a\x19/v1/views/layout/{viewId}\x12\x9a\x01\n" +
	"\x10UpdateViewWidget\x12).blueapi.cover.v1.UpdateViewWidgetRequest\x1a*.blueapi.cover.v1.UpdateViewWidgetResponse\"/\x82\xd3\xe4\x93\x02):\x01*\x1a$/v1/views/layout/{viewId}/{widgetId}\x12\x9f\x01\n" +
	"\x14UpdateViewColorTheme\x12-.blueapi.cover.v1.UpdateViewColorThemeRequest\x1a..blueapi.cover.v1.UpdateViewColorThemeResponse\"(\x82\xd3\xe4\x93\x02\":\x01*\x1a\x1d/v1/views/{viewId}/colortheme\x12\x97\x01\n" +
	"\x12UpdateViewCurrency\x12+.blueapi.cover.v1.UpdateViewCurrencyRequest\x1a,.blueapi.cover.v1.UpdateViewCurrencyResponse\"&\x82\xd3\xe4\x93\x02 :\x01*\x1a\x1b/v1/views/{viewId}/currency\x12\x9c\x01\n" +
	"\x14SetOrgUpdateCurrency\x12-.blueapi.cover.v1.SetOrgUpdateCurrencyRequest\x1a..blueapi.cover.v1.SetOrgUpdateCurrencyResponse\"%\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/v1/organizations/currency\x12\x99\x01\n" +
	...
	"\x13UpdateSideMenuState\x12,.blueapi.cover.v1.UpdateSideMenuStateRequest\x1a-.blueapi.cover.v1.UpdateSideMenuStateResponse\"+\x82\xd3\xe4\x93\x02%:\x01*\x1a /v1/views/{viewId}/sidemenustate\x12\xa2\x01\n" +
	"\x13AddSideMenuFavorite\x12,.blueapi.cover.v1.AddSideMenuFavoriteRequest\x1a-.blueapi.cover.v1.AddSideMenuFavoriteResponse\".\x82\xd3\xe4\x93\x02(:\x01*\"#/v1/views/{viewId}/sidemenufavorite\x12\xad\x01\n" +
	"\x16RemoveSideMenuFavorite\x12/.blueapi.cover.v1.RemoveSideMenuFavoriteRequest\x1a0.blueapi.cover.v1.RemoveSideMenuFavoriteResponse\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/v1/views/{viewId}/sidemenuunfavorite\x12\x81\x01\n" +
	"\x0fCreateCostGroup\x12(.blueapi.cover.v1.CreateCostGroupRequest\x1a).blueapi.cover.v1.CreateCostGroupResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/costgroups\x12x\n" +
	...
	"\x13UpdateCostGroupName\x12,.blueapi.cover.v1.UpdateCostGroupNameRequest\x1a-.blueapi.cover.v1.UpdateCostGroupNameResponse\",\x82\xd3\xe4\x93\x02&:\x01*\x1a!/v1/costgroups/{costGroupId}/name\x12\xbc\x01\n" +
	"\x1aUpdateCostGroupDescription\x123.blueapi.cover.v1.UpdateCostGroupDescriptionRequest\x1a4.blueapi.cover.v1.UpdateCostGroupDescriptionResponse\"3\x82\xd3\xe4\x93\x02-:\x01*\x1a(/v1/costgroups/{costGroupId}/description\x12\xa4\x01\n" +
	"\x14UpdateCostGroupImage\x12-.blueapi.cover.v1.UpdateCostGroupImageRequest\x1a..blueapi.cover.v1.UpdateCostGroupImageResponse\"-\x82\xd3\xe4\x93\x02':\x01*\x1a\"/v1/costgroups/{costGroupId}/image\x12\xa0\x01\n" +
	"\x13UpdateCostGroupIcon\x12,.blueapi.cover.v1.UpdateCostGroupIconRequest\x1a-.blueapi.cover.v1.UpdateCostGroupIconResponse\",\x82\xd3\xe4\x93\x02&:\x01*\x1a!/v1/costgroups/{costGroupId}/icon\x12\xb8\x01\n" +
	"\x19UpdateCostGroupColorTheme\x122.blueapi.cover.v1.UpdateCostGroupColorThemeRequest\x1a3.blueapi.cover.v1.UpdateCostGroupColorThemeResponse\"2\x82\xd3\xe4\x93\x02,:\x01*\x1a'/v1/costgroups/{costGroupId}/colortheme\x12\xc0\x01\n" +
	"\x1bUpdateCostGroupCombinations\x124.blueapi.cover.v1.UpdateCostGroupCombinationsRequest\x1a5.blueapi.cover.v1.UpdateCostGroupCombinationsResponse\"4\x82\xd3\xe4\x93\x02.:\x01*\x1a)/v1/costgroups/{costGroupId}/combinations\x12\xbb\x01\n" +
	"\x1cResolveCostGroupCombinations\x125.blueapi.cover.v1.ResolveCostGroupCombinationsRequest\x1a6.blueapi.cover.v1.ResolveCostGroupCombinationsResponse\",\x82\xd3\xe4\x93\x02&\x12$/v1/costgroups/resolve/{costGroupId}\x12\xac\x01\n" +
	"\x15AssignCostGroupMember\x12..blueapi.cover.v1.AssignCostGroupMemberRequest\x1a/.blueapi.cover.v1.AssignCostGroupMemberResponse\"2\x82\xd3\xe4\x93\x02,:\x01*\"'/v1/costgroups/{costGroupId}/member/add\x12\xaf\x01\n" +
	"\x15RemoveCostGroupMember\x12..blueapi.cover.v1.RemoveCostGroupMemberRequest\x1a/.blueapi.cover.v1.RemoveCostGroupMemberResponse\"5\x82\xd3\xe4\x93\x02/:\x01*\"*/v1/costgroups/{costGroupId}/member/remove\x12\x8c\x01\n" +
	"\x0fDeleteCostGroup\x12(.blueapi.cover.v1.DeleteCostGroupRequest\x1a).blueapi.cover.v1.DeleteCostGroupResponse\"$\x82\xd3\xe4\x93\x02\x1e*\x1c/v1/costgroups/{costGroupId}\x12\xa6\x01\n" +
	"\x1bGetAccountAccessTemplateUrl\x124.blueapi.cover.v1.GetAccountAccessTemplateUrlRequest\x1a5.blueapi.cover.v1.GetAccountAccessTemplateUrlResponse\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/v1/aws/acctaccess\x12\x8a\x01\n" +
	"\x11ListAccountAccess\x12*.blueapi.cover.v1.ListAccountAccessRequest\x1a\x1f.blueapi.cover.v1.AccountAccess\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/aws/acctaccess/all:read0\x01\x12\x83\x01\n" +
	...
	"\x10DeleteDataAccess\x12/.blueapi.cover.v1.GetAndDeleteDataAccessRequest\x1a\x16.google.protobuf.Empty\"\x1c\x82\xd3\xe4\x93\x02\x16*\x14/v1/account/{target}\x12\x83\x01\n" +
	"\x13CreateAccountAccess\x12,.blueapi.cover.v1.CreateAccountAccessRequest\x1a\x1f.blueapi.cover.v1.AccountAccess\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/v1/aws/acctaccess\x12\x9c\x01\n" +
	"\x1bCreateAccountAccessStackset\x124.blueapi.cover.v1.CreateAccountAccessStacksetRequest\x1a\x1f.blueapi.cover.v1.AccountAccess\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/aws/acctaccess/stackset\x12\x8a\x01\n" +
	"\x16CreateAccountAccessCur\x12,.blueapi.cover.v1.CreateAccountAccessRequest\x1a\x1f.blueapi.cover.v1.AccountAccess\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v1/aws/acctaccess/cur\x12{\n" +
	...
	"\x13DeleteAccountAccess\x12,.blueapi.cover.v1.DeleteAccountAccessRequest\x1a-.blueapi.cover.v1.DeleteAccountAccessResponse\"\x1f\x82\xd3\xe4\x93\x02\x19*\x17/v1/acctaccess/{target}\x12t\n" +
	"\x0fRegisterAccount\x12(.blueapi.cover.v1.RegisterAccountRequest\x1a\x16.google.protobuf.Empty\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/v1/{vendor}/account\x12q\n" +
	"\x12RegisterDataAccess\x12+.blueapi.cover.v1.RegisterDataAccessRequest\x1a\x16.google.protobuf.Empty\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/v1/account\x12p\n" +
	"\x11AddBillingAccount\x12'.blueapi.cover.v1.BillingAccountRequest\x1a\x16.google.protobuf.Empty\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/billingacct\x12w\n" +
	...
	"\x18ListUnregisteredAccounts\x121.blueapi.cover.v1.ListUnregisteredAccountsRequest\x1a2.blueapi.cover.v1.ListUnregisteredAccountsResponse\"%\x82\xd3\xe4\x93\x02\x1f\"\x1d/v1/account/unregistered:read\x12v\n" +
	"\x10UpdateDataAccess\x12).blueapi.cover.v1.UpdateDataAccessRequest\x1a\x16.google.protobuf.Empty\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\x1a\x14/v1/account/{target}\x12k\n" +
	"\n" +
	"ListAssets\x12#.blueapi.cover.v1.ListAssetsRequest\x1a\x1a.blueapi.cover.v1.Resource\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/assets:read0\x01\x12\x93\x01\n" +
	...
	"\fGetCostUsage\x12%.blueapi.cover.v1.GetCostUsageRequest\x1a\x1a.blueapi.cover.v1.CostItem\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/v1/costusage:read0\x01\x12\xc2\x01\n" +
	"\x1cGetRightSizingRecommendation\x125.blueapi.cover.v1.GetRightSizingRecommendationRequest\x1a6.blueapi.cover.v1.GetRightSizingRecommendationResponse\"3\x82\xd3\xe4\x93\x02-\x12+/v1/rightsizingrecommendation/{costGroupId}\x12\x98\x01\n" +
	"\x12ModifyResourceType\x12+.blueapi.cover.v1.ModifyResourceTypeRequest\x1a,.blueapi.cover.v1.ModifyResourceTypeResponse\"'\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/v1/{vendor}/resource/modify\x12\x98\x01\n" +
	"\x11TerminateResource\x12*.blueapi.cover.v1.TerminateResourceRequest\x1a+.blueapi.cover.v1.TerminateResourceResponse\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/v1/{vendor}/resource/terminate\x12\x8d\x01\n" +
	"\x10UploadChargeCode\x12).blueapi.cover.v1.UploadChargeCodeRequest\x1a*.blueapi.cover.v1.UploadChargeCodeResponse\" \x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/v1/chargecode/upload(\x01\x12z\n" +
	"\vAssignPayer\x12$.blueapi.cover.v1.AssignPayerRequest\x1a%.blueapi.cover.v1.AssignPayerResponse\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/v1/{vendor}/payers\x12q\n" +
	...
	"\vGetAccounts\x12$.blueapi.cover.v1.GetAccountsRequest\x1a%.blueapi.cover.v1.GetAccountsResponse\"+\x82\xd3\xe4\x93\x02%\x12#/v1/{vendor}/accounts/{costGroupId}\x12\x87\x01\n" +
	"\vGetServices\x12$.blueapi.cover.v1.GetServicesRequest\x1a%.blueapi.cover.v1.GetServicesResponse\"+\x82\xd3\xe4\x93\x02%\x12#/v1/{vendor}/services/{costGroupId}\x12\x83\x01\n" +
	"\n" +
	...
	"\aGetTags\x12 .blueapi.cover.v1.GetTagsRequest\x1a!.blueapi.cover.v1.GetTagsResponse\"'\x82\xd3\xe4\x93\x02!\x12\x1f/v1/{vendor}/tags/{costGroupId}\x12w\n" +
	"\bListFees\x12!.blueapi.cover.v1.ListFeesRequest\x1a\x1c.blueapi.cover.v1.FeeDetails\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/v1/allocations/fees/all:read0\x01\x12z\n" +
	"\n" +
	"RestoreFee\x12#.blueapi.cover.v1.RestoreFeeRequest\x1a\x1c.blueapi.cover.v1.FeeDetails\"'\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/v1/allocations/fees/restore0\x01\x12~\n" +
	"\x0fGetCostGroupFee\x12(.blueapi.cover.v1.GetCostGroupFeeRequest\x1a\x19.blueapi.cover.v1.FeeItem\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/v1/allocations/fees:read0\x01\x12{\n" +
	...
	"\x0fCreateAllocator\x12(.blueapi.cover.v1.CreateAllocatorRequest\x1a&.blueapi.cover.v1.CostAllocatorDetails\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/allocators\x12\xa0\x01\n" +
	"\x17GetAllocationAttributes\x120.blueapi.cover.v1.GetAllocationAttributesRequest\x1a1.blueapi.cover.v1.GetAllocationAttributesResponse\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/v1/allocators/attribute\x12\x81\x01\n" +
	"\x0fUpdateAllocator\x12&.blueapi.cover.v1.CostAllocatorRequest\x1a&.blueapi.cover.v1.CostAllocatorDetails\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\x1a\x13/v1/allocators/{id}\x12p\n" +
	"\x0fDeleteAllocator\x12(.blueapi.cover.v1.DeleteAllocatorRequest\x1a\x16.google.protobuf.Empty\"\x1b\x82\xd3\xe4\x93\x02\x15*\x13/v1/allocators/{id}\x12\x90\x01\n" +
	"\x15ProxyCreateCompletion\x12..blueapi.cover.v1.ProxyCreateCompletionRequest\x1a/.blueapi.cover.v1.ProxyCreateCompletionResponse\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/x/pcc0\x01\x12\x8a\x01\n" +
	"\x14SimulateFeeAllocator\x12(.blueapi.cover.v1.CreateAllocatorRequest\x1a\x1c.blueapi.cover.v1.FeeDetails\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/v1/allocations/fees/simulate0\x01\x12\x98\x01\n" +
	"\x10ListAccountUsage\x12).blueapi.cover.v1.ListAccountUsageRequest\x1a%.blueapi.cover.v1.AccountUsageDetails\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/v1/allocations/accountusage/all:read0\x01\x12\x9d\x01\n" +
	"\x13RestoreAccountUsage\x12,.blueapi.cover.v1.RestoreAccountUsageRequest\x1a%.blueapi.cover.v1.AccountUsageDetails\"/\x82\xd3\xe4\x93\x02):\x01*\"$/v1/allocations/accountusage/restore0\x01\x12\x9b\x01\n" +
	"\x14SimulateAccountUsage\x12(.blueapi.cover.v1.CreateAllocatorRequest\x1a%.blueapi.cover.v1.AccountUsageDetails\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/v1/allocations/accountusage/simulate0\x01\x12\x81\x01\n" +
	"\vListSavings\x12!.blueapi.cover.v1.ListFeesRequest\x1a .blueapi.cover.v1.SavingsDetails\"+\x82\xd3\xe4\x93\x02%:\x01*\" /v1/allocations/savings/all:read0\x01\x12\x89\x01\n" +
	"\x0eRestoreSavings\x12'.blueapi.cover.v1.RestoreSavingsRequest\x1a .blueapi.cover.v1.SavingsDetails\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/v1/allocations/savings/restore0\x01\x12\x8c\x01\n" +
	"\x0fSimulateSavings\x12(.blueapi.cover.v1.CreateAllocatorRequest\x1a .blueapi.cover.v1.SavingsDetails\"+\x82\xd3\xe4\x93\x02%:\x01*\" /v1/allocations/savings/simulate0\x01\x12\x8e\x01\n" +
	"\x16GetCostGroupAllocation\x12/.blueapi.cover.v1.GetCostGroupAllocationRequest\x1a .blueapi.cover.v1.AllocationItem\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/v1/allocations:read0\x01\x12\x87\x01\n" +
	"\x10ProcessAuth0User\x12).blueapi.cover.v1.ProcessAuth0UserRequest\x1a*.blueapi.cover.v1.ProcessAuth0UserResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11/v1/members/auth0\x12\x9b\x01\n" +
	"\x1bAddPartnerCenterCredentials\x124.blueapi.cover.v1.AddPartnerCenterCredentialsRequest\x1a\x16.google.protobuf.Empty\".\x82\xd3\xe4\x93\x02(:\x01*\"#/v1/azure/credentials/partnercenter\x12u\n" +
	"\rAddMpnSetting\x12&.blueapi.cover.v1.AddMpnSettingRequest\x1a\x16.google.protobuf.Empty\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/v1/azure/credentials/mpn\x12\x93\x01\n" +
	"\x15GetCostGroupAttribute\x12..blueapi.cover.v1.GetCostGroupAttributeRequest\x1a/.blueapi.cover.v1.GetCostGroupAttributeResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/attributes\x12o\n" +
	...
	"\vCreateAlert\x12$.blueapi.cover.v1.CreateAlertRequest\x1a%.blueapi.cover.v1.CreateAlertResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/alerts/cost\x12\x84\x01\n" +
	...
	"\vDeleteAlert\x12$.blueapi.cover.v1.DeleteAlertRequest\x1a%.blueapi.cover.v1.DeleteAlertResponse\"\x1c\x82\xd3\xe4\x93\x02\x16*\x14/v1/alerts/cost/{id}\x12\x90\x01\n" +
	"\x12UpdateAlertDetails\x12+.blueapi.cover.v1.UpdateAlertDetailsRequest\x1a,.blueapi.cover.v1.UpdateAlertDetailsResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\x1a\x14/v1/alerts/cost/{id}\x12z\n" +
	"\vGetChannels\x12$.blueapi.cover.v1.GetChannelsRequest\x1a%.blueapi.cover.v1.GetChannelsResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11/v1/channels:read0\x01\x12y\n" +
	"\rCreateChannel\x12&.blueapi.cover.v1.CreateChannelRequest\x1a'.blueapi.cover.v1.CreateChannelResponse\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/v1/channels\x12\x87\x01\n" +
	...
	"\x14UpdateChannelDetails\x12-.blueapi.cover.v1.UpdateChannelDetailsRequest\x1a..blueapi.cover.v1.UpdateChannelDetailsResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\x1a\x11/v1/channels/{id}\x12\xa0\x01\n" +
	"\x1aGetDiscountRecommendations\x123.blueapi.cover.v1.GetDiscountRecommendationsRequest\x1a4.blueapi.cover.v1.GetDiscountRecommendationsResponse\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/v1/discount\x12\x80\x01\n" +
	"\x15GetAnomalyinCostGroup\x12..blueapi.cover.v1.GetAnomalyinCostGroupRequest\x1a\x1d.blueapi.cover.v1.AnomalyData\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/v1/anomaly0\x01\x12\x96\x01\n" +
	"\x1dCreateDiscountExpirationAlert\x126.blueapi.cover.v1.CreateDiscountExpirationAlertRequest\x1a\x16.google.protobuf.Empty\"%\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/v1/alerts/expire/discount\x12\x9b\x01\n" +
	"\x1dUpdateDiscountExpirationAlert\x126.blueapi.cover.v1.UpdateDiscountExpirationAlertRequest\x1a\x16.google.protobuf.Empty\"*\x82\xd3\xe4\x93\x02$:\x01*\x1a\x1f/v1/alerts/expire/discount/{id}\x12\xac\x01\n" +
	...
	"\x1bListDiscountExpirationAlert\x124.blueapi.cover.v1.ListDiscountExpirationAlertRequest\x1a).blueapi.cover.v1.DiscountExpiryAlertData\"+\x82\xd3\xe4\x93\x02%\"#/v1/alerts/expire/discount/all:read0\x01\x12\x9c\x01\n" +
	"\x1dDeleteDiscountExpirationAlert\x12:.blueapi.cover.v1.ManipulateDiscountExpirationAlertRequest\x1a\x16.google.protobuf.Empty\"'\x82\xd3\xe4\x93\x02!*\x1f/v1/alerts/expire/discount/{id}\x12x\n" +
	"\x12CreateAnomalyAlert\x12+.blueapi.cover.v1.CreateAnomalyAlertRequest\x1a\x16.google.protobuf.Empty\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/v1/alerts/anomaly\x12~\n" +
	"\x12DeleteAnomalyAlert\x12/.blueapi.cover.v1.ManipulateAnomalyAlertRequest\x1a\x16.google.protobuf.Empty\"\x1f\x82\xd3\xe4\x93\x02\x19*\x17/v1/alerts/anomaly/{id}\x12\x88\x01\n" +
	...
	"\x12UpdateAnomalyAlert\x12+.blueapi.cover.v1.UpdateAnomalyAlertRequest\x1a\x16.google.protobuf.Empty\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*\x1a\x17/v1/alerts/anomaly/{id}\x12\x87\x01\n" +
	"\x0fRegisterNewUser\x12(.blueapi.cover.v1.RegisterNewUserRequest\x1a).blueapi.cover.v1.RegisterNewUserResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/v1/members/register\x12\x88\x01\n" +
	...
	"\x11UpdateUserProfile\x12*.blueapi.cover.v1.UpdateUserProfileRequest\x1a+.blueapi.cover.v1.UpdateUserProfileResponse\"&\x82\xd3\xe4\x93\x02 :\x01*\x1a\x1b/v1/members/profile/{email}\x12x\n" +
	"\vListBudgets\x12$.blueapi.cover.v1.ListBudgetsRequest\x1a%.blueapi.cover.v1.ListBudgetsResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/budget:read0\x01\x12m\n" +
	...
	"\fCreateBudget\x12%.blueapi.cover.v1.CreateBudgetRequest\x1a&.blueapi.cover.v1.CreateBudgetResponse\"\x15\x82\xd3\xe4\x93\x02\x0f:\x01*\"\n" +
	"/v1/budget\x12v\n" +
	"\fDeleteBudget\x12%.blueapi.cover.v1.DeleteBudgetRequest\x1a&.blueapi.cover.v1.DeleteBudgetResponse\"\x17\x82\xd3\xe4\x93\x02\x11*\x0f/v1/budget/{id}\x12y\n" +
	"\fUpdateBudget\x12%.blueapi.cover.v1.UpdateBudgetRequest\x1a&.blueapi.cover.v1.UpdateBudgetResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\x1a\x0f/v1/budget/{id}\x12\xd7\x01\n" +
	"'ResolveAWSMarketplaceTokenForOnboarding\x12@.blueapi.cover.v1.ResolveAWSMarketplaceTokenForOnboardingRequest\x1aA.blueapi.cover.v1.ResolveAWSMarketplaceTokenForOnboardingResponse\"'\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/v1/members/aws/subscription\x12\xac\x01\n" +
	"\x1dGetCustomerSubscriptionStatus\x126.blueapi.cover.v1.GetCustomerSubscriptionStatusRequest\x1a7.blueapi.cover.v1.GetCustomerSubscriptionStatusResponse\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/v1/billing/status\x12\x86\x01\n" +
	"\x0fCreateProfiling\x12(.blueapi.cover.v1.CreateProfilingRequest\x1a).blueapi.cover.v1.CreateProfilingResponse\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/v1/members/profile\x12\x96\x01\n" +
	"\x14AddInfotoMarketplace\x12-.blueapi.cover.v1.AddInfotoMarketplaceRequest\x1a..blueapi.cover.v1.AddInfotoMarketplaceResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/v1/marketplace/info\x12\x9c\x01\n" +
	...
	"\x15ListRecommendationsV2\x12-.blueapi.cover.v1.ListRecommendationV2Request\x1a,.blueapi.cover.v1.ListRecommendationResponse\"'\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/v1/recommendations/all:read0\x01\x12\x9b\x01\n" +
	...
	"\x13ExecuteOptimization\x12,.blueapi.cover.v1.ExecuteOptimizationRequest\x1a-.blueapi.cover.v1.ExecuteOptimizationResponse\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/recommendations/execute\x12\x9d\x01\n" +
	...
	"\x0eMarkAsExecuted\x12'.blueapi.cover.v1.MarkAsExecutedRequest\x1a(.blueapi.cover.v1.MarkAsExecutedResponse\"4\x82\xd3\xe4\x93\x02.:\x01*\")/v1/recommendations/optimization/executed\x12\xb9\x01\n" +
	"\x1aUndoExecutedRecommendation\x123.blueapi.cover.v1.UndoExecutedRecommendationRequest\x1a4.blueapi.cover.v1.UndoExecutedRecommendationResponse\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/v1/recommendations/optimization/undo\x12\xa4\x01\n" +
	...
	"\x1aSetCostGroupEventIndicator\x123.blueapi.cover.v1.SetCostGroupEventIndicatorRequest\x1a4.blueapi.cover.v1.SetCostGroupEventIndicatorResponse\"6\x82\xd3\xe4\x93\x020:\x01*\"+/v1/costgroups/{costGroupId}/eventIndicator\x12\xb8\x01\n" +
	"\x1aSetCostGroupAnomalyOptions\x123.blueapi.cover.v1.SetCostGroupAnomalyOptionsRequest\x1a4.blueapi.cover.v1.SetCostGroupAnomalyOptionsResponse\"/\x82\xd3\xe4\x93\x02):\x01*\"$/v1/costgroups/{costGroupId}/anomaly\x12\x90\x01\n" +
	"\x11SetOrgFiscalMonth\x12*.blueapi.cover.v1.SetOrgFiscalMonthRequest\x1a+.blueapi.cover.v1.SetOrgFiscalMonthResponse\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*\"\x17/v1/reports/fiscalmonth\x12\x8d\x01\n" +
	...
	"\x19UpdateCostGroupCreationUI\x122.blueapi.cover.v1.UpdateCostGroupCreationUIRequest\x1a3.blueapi.cover.v1.UpdateCostGroupCreationUIResponse\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\x1a\x18/v1/me/costgroupcreation\x12v\n" +
	"\rListUnitTypes\x12&.blueapi.cover.v1.ListUnitTypesRequest\x1a'.blueapi.cover.v1.ListUnitTypesResponse\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\f/v1/unitcost\x12|\n" +
	"\x0eCreateUnitType\x12'.blueapi.cover.v1.CreateUnitTypeRequest\x1a(.blueapi.cover.v1.CreateUnitTypeResponse\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/v1/unitcost\x12u\n" +
	"\vGetUnitType\x12$.blueapi.cover.v1.GetUnitTypeRequest\x1a%.blueapi.cover.v1.GetUnitTypeResponse\"\x19\x82\xd3\xe4\x93\x02\x13\x12\x11/v1/unitcost/{id}\x12\x81\x01\n" +
	"\x0eUpdateUnitType\x12'.blueapi.cover.v1.UpdateUnitTypeRequest\x1a(.blueapi.cover.v1.UpdateUnitTypeResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\x1a\x11/v1/unitcost/{id}\x12~\n" +
	"\x0eDeleteUnitType\x12'.blueapi.cover.v1.DeleteUnitTypeRequest\x1a(.blueapi.cover.v1.DeleteUnitTypeResponse\"\x19\x82\xd3\xe4\x93\x02\x13*\x11/v1/unitcost/{id}\x12v\n" +
	"\n" +
	"MergeUnits\x12#.blueapi.cover.v1.MergeUnitsRequest\x1a$.blueapi.cover.v1.MergeUnitsResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/v1/unitcost/merge\x12\x91\x01\n" +
	...
	"\x13MergeSuggestedUnits\x12,.blueapi.cover.v1.MergeSuggestedUnitsRequest\x1a-.blueapi.cover.v1.MergeSuggestedUnitsResponse\")\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/v1/unitcost/autosuggest/merge\x12\xaa\x01\n" +
	"\x17CreateUnitFromSuggested\x120.blueapi.cover.v1.CreateUnitFromSuggestedRequest\x1a1.blueapi.cover.v1.CreateUnitFromSuggestedResponse\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/v1/unitcost/autosuggest/create\x12\x98\x01\n" +
	...
	"\x14CreateSharedResource\x12..blueapi.cover.v1.CreateSharedResourcesRequest\x1a/.blueapi.cover.v1.CreateSharedResourcesResponse\"'\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/v1/unitcost/sharedresources\x12\x99\x01\n" +
	...
	"\x14UpdateSharedResource\x12..blueapi.cover.v1.UpdateSharedResourcesRequest\x1a/.blueapi.cover.v1.UpdateSharedResourcesResponse\",\x82\xd3\xe4\x93\x02&:\x01*\x1a!/v1/unitcost/sharedresources/{id}\x12\xa2\x01\n" +
	"\x14DeleteSharedResource\x12..blueapi.cover.v1.DeleteSharedResourcesRequest\x1a/.blueapi.cover.v1.DeleteSharedResourcesResponse\")\x82\xd3\xe4\x93\x02#*!/v1/unitcost/sharedresources/{id}\x12\x84\x01\n" +
	...
	"\x10CreateUnitMetric\x12).blueapi.cover.v1.CreateUnitMetricRequest\x1a*.blueapi.cover.v1.CreateUnitMetricResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/v1/unitcost/metrics\x12\x83\x01\n" +
	...
	"\x10UpdateUnitMetric\x12).blueapi.cover.v1.UpdateUnitMetricRequest\x1a*.blueapi.cover.v1.UpdateUnitMetricResponse\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\x1a\x19/v1/unitcost/metrics/{id}\x12\x8c\x01\n" +
	"\x10DeleteUnitMetric\x12).blueapi.cover.v1.DeleteUnitMetricRequest\x1a*.blueapi.cover.v1.DeleteUnitMetricResponse\"!\x82\xd3\xe4\x93\x02\x1b*\x19/v1/unitcost/metrics/{id}\x12\x84\x01\n" +
	"\x0fVerifyAPIAccess\x12(.blueapi.cover.v1.VerifyAPIAccessRequest\x1a).blueapi.cover.v1.VerifyAPIAccessResponse\"\x1c\x82\xd3\xe4\x93\x02\x16\x12\x14/v1/apiaccess/verify\x1a\x98\x01\x92A\x94\x01\x12C(ALPHA) Cover API. Base URL: https://api.alphaus.cloud/m/blue/cover\x1aM\n" +
	"\x12Service definition\x127https://github.com/alphauslabs/blueapi/tree/main/cover/BK\n" +
	"\x17cloud.alphaus.api.coverB\n" +
...
var file_cover_v1_cover_proto_msgTypes = make([]protoimpl.MessageInfo, 335)
var file_cover_v1_cover_proto_goTypes = []any{
	...
	(*ListUnregisteredAccountsRequest)(nil),                     // 190: blueapi.cover.v1.ListUnregisteredAccountsRequest
	(*ListUnregisteredAccountsResponse)(nil),                    // 191: blueapi.cover.v1.ListUnregisteredAccountsResponse
	(*UnregisteredAccts)(nil),                                   // 192: blueapi.cover.v1.UnregisteredAccts
	(*BillingAccountRequest)(nil),                               // 193: blueapi.cover.v1.BillingAccountRequest
	(*GetAndDeleteDataAccessRequest)(nil),                       // 194: blueapi.cover.v1.GetAndDeleteDataAccessRequest
	(*AddPartnerCenterCredentialsRequest)(nil),                  // 195: blueapi.cover.v1.AddPartnerCenterCredentialsRequest
	(*AddMpnSettingRequest)(nil),                                // 196: blueapi.cover.v1.AddMpnSettingRequest
	(*GetCostGroupAttributeRequest)(nil),                        // 197: blueapi.cover.v1.GetCostGroupAttributeRequest
	(*GetCostGroupAttributeResponse)(nil),                       // 198: blueapi.cover.v1.GetCostGroupAttributeResponse
	(*GetCategoriesRequest)(nil),                                // 199: blueapi.cover.v1.GetCategoriesRequest
	(*GetCategoriesResponse)(nil),                               // 200: blueapi.cover.v1.GetCategoriesResponse
	(*GetAlertsRequest)(nil),                                    // 201: blueapi.cover.v1.GetAlertsRequest
	(*GetAlertsResponse)(nil),                                   // 202: blueapi.cover.v1.GetAlertsResponse
	(*CreateAlertRequest)(nil),                                  // 203: blueapi.cover.v1.CreateAlertRequest
	(*CreateAlertResponse)(nil),                                 // 204: blueapi.cover.v1.CreateAlertResponse
	(*GetAlertDetailsRequest)(nil),                              // 205: blueapi.cover.v1.GetAlertDetailsRequest
	(*GetAlertDetailsResponse)(nil),                             // 206: blueapi.cover.v1.GetAlertDetailsResponse
	(*DeleteAlertRequest)(nil),                                  // 207: blueapi.cover.v1.DeleteAlertRequest
	(*DeleteAlertResponse)(nil),                                 // 208: blueapi.cover.v1.DeleteAlertResponse
	(*UpdateAlertDetailsRequest)(nil),                           // 209: blueapi.cover.v1.UpdateAlertDetailsRequest
	(*UpdateAlertDetailsResponse)(nil),                          // 210: blueapi.cover.v1.UpdateAlertDetailsResponse
	(*GetChannelsRequest)(nil),                                  // 211: blueapi.cover.v1.GetChannelsRequest
	(*GetChannelsResponse)(nil),                                 // 212: blueapi.cover.v1.GetChannelsResponse
	(*CreateChannelRequest)(nil),                                // 213: blueapi.cover.v1.CreateChannelRequest
	(*CreateChannelResponse)(nil),                               // 214: blueapi.cover.v1.CreateChannelResponse
	(*GetChannelDetailsRequest)(nil),                            // 215: blueapi.cover.v1.GetChannelDetailsRequest
	(*GetChannelDetailsResponse)(nil),                           // 216: blueapi.cover.v1.GetChannelDetailsResponse
	(*DeleteChannelRequest)(nil),                                // 217: blueapi.cover.v1.DeleteChannelRequest
	(*DeleteChannelResponse)(nil),                               // 218: blueapi.cover.v1.DeleteChannelResponse
	(*UpdateChannelDetailsRequest)(nil),                         // 219: blueapi.cover.v1.UpdateChannelDetailsRequest
	(*UpdateChannelDetailsResponse)(nil),                        // 220: blueapi.cover.v1.UpdateChannelDetailsResponse
	(*GetDiscountRecommendationsRequest)(nil),                   // 221: blueapi.cover.v1.GetDiscountRecommendationsRequest
	(*GetDiscountRecommendationsResponse)(nil),                  // 222: blueapi.cover.v1.GetDiscountRecommendationsResponse
	(*GetAnomalyinCostGroupRequest)(nil),                        // 223: blueapi.cover.v1.GetAnomalyinCostGroupRequest
	(*AnomalyData)(nil),                                         // 224: blueapi.cover.v1.AnomalyData
	(*CreateDiscountExpirationAlertRequest)(nil),                // 225: blueapi.cover.v1.CreateDiscountExpirationAlertRequest
	(*ManipulateDiscountExpirationAlertRequest)(nil),            // 226: blueapi.cover.v1.ManipulateDiscountExpirationAlertRequest
	(*UpdateDiscountExpirationAlertRequest)(nil),                // 227: blueapi.cover.v1.UpdateDiscountExpirationAlertRequest
	(*DiscountExpiryAlertData)(nil),                             // 228: blueapi.cover.v1.DiscountExpiryAlertData
	(*ListDiscountExpirationAlertRequest)(nil),                  // 229: blueapi.cover.v1.ListDiscountExpirationAlertRequest
	(*CreateAnomalyAlertRequest)(nil),                           // 230: blueapi.cover.v1.CreateAnomalyAlertRequest
	(*ManipulateAnomalyAlertRequest)(nil),                       // 231: blueapi.cover.v1.ManipulateAnomalyAlertRequest
	(*AnomalyAlertData)(nil),                                    // 232: blueapi.cover.v1.AnomalyAlertData
	(*ListAnomalyAlertRequest)(nil),                             // 233: blueapi.cover.v1.ListAnomalyAlertRequest
	(*UpdateAnomalyAlertRequest)(nil),                           // 234: blueapi.cover.v1.UpdateAnomalyAlertRequest
	(*RegisterNewUserRequest)(nil),                              // 235: blueapi.cover.v1.RegisterNewUserRequest
	(*RegisterNewUserResponse)(nil),                             // 236: blueapi.cover.v1.RegisterNewUserResponse
	(*GetUserProfileRequest)(nil),                               // 237: blueapi.cover.v1.GetUserProfileRequest
	(*GetUserProfileResponse)(nil),                              // 238: blueapi.cover.v1.GetUserProfileResponse
	(*UpdateUserProfileRequest)(nil),                            // 239: blueapi.cover.v1.UpdateUserProfileRequest
	(*UpdateUserProfileResponse)(nil),                           // 240: blueapi.cover.v1.UpdateUserProfileResponse
	(*ListBudgetsRequest)(nil),                                  // 241: blueapi.cover.v1.ListBudgetsRequest
	(*ListBudgetsResponse)(nil),                                 // 242: blueapi.cover.v1.ListBudgetsResponse
	(*GetBudgetRequest)(nil),                                    // 243: blueapi.cover.v1.GetBudgetRequest
	(*GetBudgetResponse)(nil),                                   // 244: blueapi.cover.v1.GetBudgetResponse
	(*CreateBudgetRequest)(nil),                                 // 245: blueapi.cover.v1.CreateBudgetRequest
	(*CreateBudgetResponse)(nil),                                // 246: blueapi.cover.v1.CreateBudgetResponse
	(*DeleteBudgetRequest)(nil),                                 // 247: blueapi.cover.v1.DeleteBudgetRequest
	(*DeleteBudgetResponse)(nil),                                // 248: blueapi.cover.v1.DeleteBudgetResponse
	(*UpdateBudgetRequest)(nil),                                 // 249: blueapi.cover.v1.UpdateBudgetRequest
	(*UpdateBudgetResponse)(nil),                                // 250: blueapi.cover.v1.UpdateBudgetResponse
	(*ResolveAWSMarketplaceTokenForOnboardingRequest)(nil),      // 251: blueapi.cover.v1.ResolveAWSMarketplaceTokenForOnboardingRequest
	(*ResolveAWSMarketplaceTokenForOnboardingResponse)(nil),     // 252: blueapi.cover.v1.ResolveAWSMarketplaceTokenForOnboardingResponse
	(*GetCustomerSubscriptionStatusRequest)(nil),                // 253: blueapi.cover.v1.GetCustomerSubscriptionStatusRequest
	(*GetCustomerSubscriptionStatusResponse)(nil),               // 254: blueapi.cover.v1.GetCustomerSubscriptionStatusResponse
	(*CreateProfilingRequest)(nil),                              // 255: blueapi.cover.v1.CreateProfilingRequest
	(*CreateProfilingResponse)(nil),                             // 256: blueapi.cover.v1.CreateProfilingResponse
	(*AddInfotoMarketplaceRequest)(nil),                         // 257: blueapi.cover.v1.AddInfotoMarketplaceRequest
	(*AddInfotoMarketplaceResponse)(nil),                        // 258: blueapi.cover.v1.AddInfotoMarketplaceResponse
	(*GetReportSummaryRequest)(nil),                             // 259: blueapi.cover.v1.GetReportSummaryRequest
	(*GetReportSummaryResponse)(nil),                            // 260: blueapi.cover.v1.GetReportSummaryResponse
	(*ListRecommendationRequest)(nil),                           // 261: blueapi.cover.v1.ListRecommendationRequest
	(*ListRecommendationV2Request)(nil),                         // 262: blueapi.cover.v1.ListRecommendationV2Request
	(*ListRecommendationResponse)(nil),                          // 263: blueapi.cover.v1.ListRecommendationResponse
	(*GetRecommendationRequest)(nil),                            // 264: blueapi.cover.v1.GetRecommendationRequest
	(*GetRecommendationResponse)(nil),                           // 265: blueapi.cover.v1.GetRecommendationResponse
	(*ExecuteOptimizationRequest)(nil),                          // 266: blueapi.cover.v1.ExecuteOptimizationRequest
	(*ExecuteOptimizationResponse)(nil),                         // 267: blueapi.cover.v1.ExecuteOptimizationResponse
	(*MarkAsExecutedRequest)(nil),                               // 268: blueapi.cover.v1.MarkAsExecutedRequest
	(*MarkAsExecutedResponse)(nil),                              // 269: blueapi.cover.v1.MarkAsExecutedResponse
	(*UndoExecutedRecommendationRequest)(nil),                   // 270: blueapi.cover.v1.UndoExecutedRecommendationRequest
	(*UndoExecutedRecommendationResponse)(nil),                  // 271: blueapi.cover.v1.UndoExecutedRecommendationResponse
	(*OptimizationHistoryRequest)(nil),                          // 272: blueapi.cover.v1.OptimizationHistoryRequest
	(*OptimizationHistoryResponse)(nil),                         // 273: blueapi.cover.v1.OptimizationHistoryResponse
	(*SetCostGroupEventIndicatorRequest)(nil),                   // 274: blueapi.cover.v1.SetCostGroupEventIndicatorRequest
	(*SetCostGroupEventIndicatorResponse)(nil),                  // 275: blueapi.cover.v1.SetCostGroupEventIndicatorResponse
	(*SetCostGroupAnomalyOptionsRequest)(nil),                   // 276: blueapi.cover.v1.SetCostGroupAnomalyOptionsRequest
	(*SetCostGroupAnomalyOptionsResponse)(nil),                  // 277: blueapi.cover.v1.SetCostGroupAnomalyOptionsResponse
	(*SetOrgFiscalMonthRequest)(nil),                            // 278: blueapi.cover.v1.SetOrgFiscalMonthRequest
	(*SetOrgFiscalMonthResponse)(nil),                           // 279: blueapi.cover.v1.SetOrgFiscalMonthResponse
	(*GetOrgFiscalMonthRequest)(nil),                            // 280: blueapi.cover.v1.GetOrgFiscalMonthRequest
	(*GetOrgFiscalMonthResponse)(nil),                           // 281: blueapi.cover.v1.GetOrgFiscalMonthResponse
	(*TransferOrganizationRequest)(nil),                         // 282: blueapi.cover.v1.TransferOrganizationRequest
	(*TransferOrganizationResponse)(nil),                        // 283: blueapi.cover.v1.TransferOrganizationResponse
	(*UpdateCostGroupCreationUIRequest)(nil),                    // 284: blueapi.cover.v1.UpdateCostGroupCreationUIRequest
	(*UpdateCostGroupCreationUIResponse)(nil),                   // 285: blueapi.cover.v1.UpdateCostGroupCreationUIResponse
	(*ListUnitTypesRequest)(nil),                                // 286: blueapi.cover.v1.ListUnitTypesRequest
	(*ListUnitTypesResponse)(nil),                               // 287: blueapi.cover.v1.ListUnitTypesResponse
	(*CreateUnitTypeRequest)(nil),                               // 288: blueapi.cover.v1.CreateUnitTypeRequest
	(*CreateUnitTypeResponse)(nil),                              // 289: blueapi.cover.v1.CreateUnitTypeResponse
	(*GetUnitTypeRequest)(nil),                                  // 290: blueapi.cover.v1.GetUnitTypeRequest
	(*GetUnitTypeResponse)(nil),                                 // 291: blueapi.cover.v1.GetUnitTypeResponse
	(*UpdateUnitTypeRequest)(nil),                               // 292: blueapi.cover.v1.UpdateUnitTypeRequest
	(*UpdateUnitTypeResponse)(nil),                              // 293: blueapi.cover.v1.UpdateUnitTypeResponse
	(*DeleteUnitTypeRequest)(nil),                               // 294: blueapi.cover.v1.DeleteUnitTypeRequest
	(*DeleteUnitTypeResponse)(nil),                              // 295: blueapi.cover.v1.DeleteUnitTypeResponse
	(*MergeUnitsRequest)(nil),                                   // 296: blueapi.cover.v1.MergeUnitsRequest
	(*MergeUnitsResponse)(nil),                                  // 297: blueapi.cover.v1.MergeUnitsResponse
	(*ListSuggestedUnitsRequest)(nil),                           // 298: blueapi.cover.v1.ListSuggestedUnitsRequest
	(*ListSuggestedUnitsResponse)(nil),                          // 299: blueapi.cover.v1.ListSuggestedUnitsResponse
	(*MergeSuggestedUnitsRequest)(nil),                          // 300: blueapi.cover.v1.MergeSuggestedUnitsRequest
	(*MergeSuggestedUnitsResponse)(nil),                         // 301: blueapi.cover.v1.MergeSuggestedUnitsResponse
	(*CreateUnitFromSuggestedRequest)(nil),                      // 302: blueapi.cover.v1.CreateUnitFromSuggestedRequest
	(*CreateUnitFromSuggestedResponse)(nil),                     // 303: blueapi.cover.v1.CreateUnitFromSuggestedResponse
	(*ListSharedResourcesRequest)(nil),                          // 304: blueapi.cover.v1.ListSharedResourcesRequest
	(*ListSharedResourcesResponse)(nil),                         // 305: blueapi.cover.v1.ListSharedResourcesResponse
	(*CreateSharedResourcesRequest)(nil),                        // 306: blueapi.cover.v1.CreateSharedResourcesRequest
	(*CreateSharedResourcesResponse)(nil),                       // 307: blueapi.cover.v1.CreateSharedResourcesResponse
	(*GetSharedResourcesRequest)(nil),                           // 308: blueapi.cover.v1.GetSharedResourcesRequest
	(*GetSharedResourcesResponse)(nil),                          // 309: blueapi.cover.v1.GetSharedResourcesResponse
	(*UpdateSharedResourcesRequest)(nil),                        // 310: blueapi.cover.v1.UpdateSharedResourcesRequest
	(*UpdateSharedResourcesResponse)(nil),                       // 311: blueapi.cover.v1.UpdateSharedResourcesResponse
	(*DeleteSharedResourcesRequest)(nil),                        // 312: blueapi.cover.v1.DeleteSharedResourcesRequest
	(*DeleteSharedResourcesResponse)(nil),                       // 313: blueapi.cover.v1.DeleteSharedResourcesResponse
	(*ListUnitMetricsRequest)(nil),                              // 314: blueapi.cover.v1.ListUnitMetricsRequest
	(*ListUnitMetricsResponse)(nil),                             // 315: blueapi.cover.v1.ListUnitMetricsResponse
	(*CreateUnitMetricRequest)(nil),                             // 316: blueapi.cover.v1.CreateUnitMetricRequest
	(*CreateUnitMetricResponse)(nil),                            // 317: blueapi.cover.v1.CreateUnitMetricResponse
	(*GetUnitMetricRequest)(nil),                                // 318: blueapi.cover.v1.GetUnitMetricRequest
	(*GetUnitMetricResponse)(nil),                               // 319: blueapi.cover.v1.GetUnitMetricResponse
	(*UpdateUnitMetricRequest)(nil),                             // 320: blueapi.cover.v1.UpdateUnitMetricRequest
	(*UpdateUnitMetricResponse)(nil),                            // 321: blueapi.cover.v1.UpdateUnitMetricResponse
	(*DeleteUnitMetricRequest)(nil),                             // 322: blueapi.cover.v1.DeleteUnitMetricRequest
	(*DeleteUnitMetricResponse)(nil),                            // 323: blueapi.cover.v1.DeleteUnitMetricResponse
	nil,                                                         // 324: blueapi.cover.v1.ListAssetsFilters.AndFiltersEntry
	nil,                                                         // 325: blueapi.cover.v1.ReadCostsRequestOptionsFilters.AndFiltersEntry
	nil,                                                         // 326: blueapi.cover.v1.CostItem.UnitcostmetricEntry
	nil,                                                         // 327: blueapi.cover.v1.Criteria.AndEntry
	(*GetAllocationAttributesResponse_AllocationAttribute)(nil), // 328: blueapi.cover.v1.GetAllocationAttributesResponse.AllocationAttribute
	(*ListRecommendationV2Request_RateSettings)(nil),            // 329: blueapi.cover.v1.ListRecommendationV2Request.RateSettings
	(*ListRecommendationResponse_PurchaseOption)(nil),           // 330: blueapi.cover.v1.ListRecommendationResponse.PurchaseOption
	(*ExecuteOptimizationResponse_AWSOption)(nil),               // 331: blueapi.cover.v1.ExecuteOptimizationResponse.AWSOption
	(*ExecuteOptimizationResponse_GCPOption)(nil),               // 332: blueapi.cover.v1.ExecuteOptimizationResponse.GCPOption
	(*ExecuteOptimizationResponse_AzureCSPOption)(nil),          // 333: blueapi.cover.v1.ExecuteOptimizationResponse.AzureCSPOption
	nil, // 334: blueapi.cover.v1.CreateSharedResourcesRequest.DistributionEntry
	nil, // 335: blueapi.cover.v1.UpdateSharedResourcesRequest.DistributionEntry
	(*recommendation.RecommendationData)(nil),       // 336: blueapi.api.cover.recommendation.RecommendationData
	(*cover.UserData)(nil),                          // 337: blueapi.api.cover.UserData
	(*cover.MemberCostGroup)(nil),                   // 338: blueapi.api.cover.MemberCostGroup
	(*cover.ViewData)(nil),                          // 339: blueapi.api.cover.ViewData
	(*cover.ViewList)(nil),                          // 340: blueapi.api.cover.ViewList
	(*cover.Favorites)(nil),                         // 341: blueapi.api.cover.Favorites
	(*cover.WidgetData)(nil),                        // 342: blueapi.api.cover.WidgetData
	(*cover.ViewLayout)(nil),                        // 343: blueapi.api.cover.ViewLayout
	(*structpb.Struct)(nil),                         // 344: google.protobuf.Struct
	(*cover.LayoutRequests)(nil),                    // 345: blueapi.api.cover.LayoutRequests
	(*cover.SideMenuState)(nil),                     // 346: blueapi.api.cover.SideMenuState
	(*cover.Combinations)(nil),                      // 347: blueapi.api.cover.Combinations
	(*cover.CostGroupData)(nil),                     // 348: blueapi.api.cover.CostGroupData
	(*cover.RegistrationStatus)(nil),                // 349: blueapi.api.cover.RegistrationStatus
	(*cover.Account)(nil),                           // 350: blueapi.api.cover.Account
	(*cover.AwsCostForecast)(nil),                   // 351: blueapi.api.cover.AwsCostForecast
	(*cover.ResourceData)(nil),                      // 352: blueapi.api.cover.ResourceData
	(*cover.TagData)(nil),                           // 353: blueapi.api.cover.TagData
	(*cover.GcpOptions)(nil),                        // 354: blueapi.api.cover.GcpOptions
	(*cover.AzureOptions)(nil),                      // 355: blueapi.api.cover.AzureOptions
	(*cover.AwsOptions)(nil),                        // 356: blueapi.api.cover.AwsOptions
	(*cover.Result)(nil),                            // 357: blueapi.api.cover.Result
	(*cover.Category)(nil),                          // 358: blueapi.api.cover.Category
	(*cover.AlertData)(nil),                         // 359: blueapi.api.cover.AlertData
	(*cover.ChannelData)(nil),                       // 360: blueapi.api.cover.ChannelData
	(*cover.AwsInputs)(nil),                         // 361: blueapi.api.cover.AwsInputs
	(*cover.AzureInputs)(nil),                       // 362: blueapi.api.cover.AzureInputs
	(*cover.GcpInputs)(nil),                         // 363: blueapi.api.cover.GcpInputs
	(*cover.AwsDiscountRecommendations)(nil),        // 364: blueapi.api.cover.AwsDiscountRecommendations
	(*cover.AzureDiscountRecommendations)(nil),      // 365: blueapi.api.cover.AzureDiscountRecommendations
	(*cover.GcpDiscountRecommendations)(nil),        // 366: blueapi.api.cover.GcpDiscountRecommendations
	(*cover.AlertCostGroup)(nil),                    // 367: blueapi.api.cover.AlertCostGroup
	(*cover.AlertChannels)(nil),                     // 368: blueapi.api.cover.AlertChannels
	(*cover.BudgetData)(nil),                        // 369: blueapi.api.cover.BudgetData
	(*cover.ExecutiveSummary)(nil),                  // 370: blueapi.api.cover.ExecutiveSummary
	(*cover.OptimizationRecommendationSummary)(nil), // 371: blueapi.api.cover.OptimizationRecommendationSummary
	(*cover.SavingsSummary)(nil),                    // 372: blueapi.api.cover.SavingsSummary
	(*cover.AWSRecommendations)(nil),                // 373: blueapi.api.cover.AWSRecommendations
	(*cover.ExecutedRecommendationDetails)(nil),     // 374: blueapi.api.cover.ExecutedRecommendationDetails
	(*cover.EventIndicator)(nil),                    // 375: blueapi.api.cover.EventIndicator
	(*cover.AnomalyOptions)(nil),                    // 376: blueapi.api.cover.AnomalyOptions
	(*cover.UnitCostData)(nil),                      // 377: blueapi.api.cover.UnitCostData
	(*cover.UnitItem)(nil),                          // 378: blueapi.api.cover.UnitItem
	(*cover.SharedResourcesCombination)(nil),        // 379: blueapi.api.cover.SharedResourcesCombination
	(*cover.SuggestedUnit)(nil),                     // 380: blueapi.api.cover.SuggestedUnit
	(*cover.ResourcesCombinations)(nil),             // 381: blueapi.api.cover.ResourcesCombinations
	(*cover.UnitMetric)(nil),                        // 382: blueapi.api.cover.UnitMetric
	(*cover.CsvInfo)(nil),                           // 383: blueapi.api.cover.CsvInfo
	(*emptypb.Empty)(nil),                           // 384: google.protobuf.Empty
	(*protos.Operation)(nil),                        // 385: protos.Operation
}
var file_cover_v1_cover_proto_depIdxs = []int32{
	336, // 0: blueapi.cover.v1.GetRecommendationV2Response.data:type_name -> blueapi.api.cover.recommendation.RecommendationData
	337, // 1: blueapi.cover.v1.OnboardOrgResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 2: blueapi.cover.v1.ActivateUserResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 3: blueapi.cover.v1.CreateMemberResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 4: blueapi.cover.v1.GetMembersResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 5: blueapi.cover.v1.GetMemberDetailsResponse.userData:type_name -> blueapi.api.cover.UserData
	338, // 6: blueapi.cover.v1.GetMemberCostGroupResponse.costGroups:type_name -> blueapi.api.cover.MemberCostGroup
	337, // 7: blueapi.cover.v1.UpdateMemberPermissionResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 8: blueapi.cover.v1.GetUserDetailsResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 9: blueapi.cover.v1.UpdateUserAvatarResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 10: blueapi.cover.v1.UpdateUserIconResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 11: blueapi.cover.v1.UpdateUserColorThemeResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 12: blueapi.cover.v1.UpdateUserNameResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 13: blueapi.cover.v1.UpdateUserEmailResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 14: blueapi.cover.v1.UpdateUserMainViewResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 15: blueapi.cover.v1.ResetUserPasswordResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 16: blueapi.cover.v1.UpdateUserLocaleResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 17: blueapi.cover.v1.UpdateUserAppThemeResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 18: blueapi.cover.v1.UpdateUserTimezoneResponse.userData:type_name -> blueapi.api.cover.UserData
	337, // 19: blueapi.cover.v1.UpdateUserAttributesResponse.userData:type_name -> blueapi.api.cover.UserData
	339, // 20: blueapi.cover.v1.CreateViewResponse.viewData:type_name -> blueapi.api.cover.ViewData
	340, // 21: blueapi.cover.v1.GetViewsResponse.viewList:type_name -> blueapi.api.cover.ViewList
	339, // 22: blueapi.cover.v1.GetCurrentViewResponse.viewData:type_name -> blueapi.api.cover.ViewData
	341, // 23: blueapi.cover.v1.GetFavoriteViewsResponse.favorites:type_name -> blueapi.api.cover.Favorites
	342, // 24: blueapi.cover.v1.UpdateViewLayoutRequest.layout:type_name -> blueapi.api.cover.WidgetData
	343, // 25: blueapi.cover.v1.UpdateViewLayoutResponse.layout:type_name -> blueapi.api.cover.ViewLayout
	344, // 26: blueapi.cover.v1.UpdateViewWidgetRequest.options:type_name -> google.protobuf.Struct
	345, // 27: blueapi.cover.v1.UpdateViewWidgetRequest.requests:type_name -> blueapi.api.cover.LayoutRequests
	342, // 28: blueapi.cover.v1.UpdateViewWidgetResponse.widgetData:type_name -> blueapi.api.cover.WidgetData
	339, // 29: blueapi.cover.v1.UpdateViewColorThemeResponse.viewData:type_name -> blueapi.api.cover.ViewData
	339, // 30: blueapi.cover.v1.UpdateViewCurrencyResponse.viewData:type_name -> blueapi.api.cover.ViewData
	81,  // 31: blueapi.cover.v1.ListExchangeRatesResponse.exchangeRates:type_name -> blueapi.cover.v1.ExchangeRates
	346, // 32: blueapi.cover.v1.UpdateSideMenuStateRequest.sidemenustate:type_name -> blueapi.api.cover.SideMenuState
	347, // 33: blueapi.cover.v1.CreateCostGroupRequest.combinations:type_name -> blueapi.api.cover.Combinations
	348, // 34: blueapi.cover.v1.CreateCostGroupResponse.costGroupData:type_name -> blueapi.api.cover.CostGroupData
	348, // 35: blueapi.cover.v1.GetCostGroupsResponse.costGroupData:type_name -> blueapi.api.cover.CostGroupData
	348, // 36: blueapi.cover.v1.GetCostGroupDetailsResponse.costGroupData:type_name -> blueapi.api.cover.CostGroupData
	347, // 37: blueapi.cover.v1.UpdateCostGroupCombinationsRequest.combinations:type_name -> blueapi.api.cover.Combinations
	347, // 38: blueapi.cover.v1.UpdateCostGroupCombinationsResponse.combinations:type_name -> blueapi.api.cover.Combinations
	349, // 39: blueapi.cover.v1.AccountAccess.registrationStatus:type_name -> blueapi.api.cover.RegistrationStatus
	...
	324, // 42: blueapi.cover.v1.ListAssetsFilters.andFilters:type_name -> blueapi.cover.v1.ListAssetsFilters.AndFiltersEntry
	...
	350, // 46: blueapi.cover.v1.ResolveCostGroupCombinationsResponse.accounts:type_name -> blueapi.api.cover.Account
	...
	325, // 66: blueapi.cover.v1.ReadCostsRequestOptionsFilters.andFilters:type_name -> blueapi.cover.v1.ReadCostsRequestOptionsFilters.AndFiltersEntry
	351, // 67: blueapi.cover.v1.CostItem.forecast:type_name -> blueapi.api.cover.AwsCostForecast
	326, // 68: blueapi.cover.v1.CostItem.unitcostmetric:type_name -> blueapi.cover.v1.CostItem.UnitcostmetricEntry
	352, // 69: blueapi.cover.v1.GetRightSizingRecommendationResponse.resource:type_name -> blueapi.api.cover.ResourceData
	0,   // 70: blueapi.cover.v1.UploadChargeCodeResponse.status:type_name -> blueapi.cover.v1.Status
	353, // 71: blueapi.cover.v1.GetTagsResponse.tagData:type_name -> blueapi.api.cover.TagData
	327, // 72: blueapi.cover.v1.Criteria.and:type_name -> blueapi.cover.v1.Criteria.AndEntry
	347, // 73: blueapi.cover.v1.CostAllocatorDetails.criteria:type_name -> blueapi.api.cover.Combinations
	166, // 74: blueapi.cover.v1.CostAllocatorDetails.allocator:type_name -> blueapi.cover.v1.Allocator
	347, // 75: blueapi.cover.v1.CostAllocatorRequest.criteria:type_name -> blueapi.api.cover.Combinations
	166, // 76: blueapi.cover.v1.CostAllocatorRequest.allocator:type_name -> blueapi.cover.v1.Allocator
	347, // 77: blueapi.cover.v1.CreateAllocatorRequest.criteria:type_name -> blueapi.api.cover.Combinations
	166, // 78: blueapi.cover.v1.CreateAllocatorRequest.allocator:type_name -> blueapi.cover.v1.Allocator
	328, // 79: blueapi.cover.v1.GetAllocationAttributesResponse.attribute:type_name -> blueapi.cover.v1.GetAllocationAttributesResponse.AllocationAttribute
	344, // 80: blueapi.cover.v1.ProxyCreateCompletionRequest.params:type_name -> google.protobuf.Struct
	354, // 81: blueapi.cover.v1.DataAccess.gcpOptions:type_name -> blueapi.api.cover.GcpOptions
	355, // 82: blueapi.cover.v1.DataAccess.azureOptions:type_name -> blueapi.api.cover.AzureOptions
	356, // 83: blueapi.cover.v1.DataAccess.awsOptions:type_name -> blueapi.api.cover.AwsOptions
	354, // 84: blueapi.cover.v1.RegisterDataAccessRequest.gcpOptions:type_name -> blueapi.api.cover.GcpOptions
	355, // 85: blueapi.cover.v1.RegisterDataAccessRequest.azureOptions:type_name -> blueapi.api.cover.AzureOptions
	356, // 86: blueapi.cover.v1.RegisterDataAccessRequest.awsOptions:type_name -> blueapi.api.cover.AwsOptions
	354, // 87: blueapi.cover.v1.UpdateDataAccessRequest.gcpOptions:type_name -> blueapi.api.cover.GcpOptions
	355, // 88: blueapi.cover.v1.UpdateDataAccessRequest.azureOptions:type_name -> blueapi.api.cover.AzureOptions
	356, // 89: blueapi.cover.v1.UpdateDataAccessRequest.awsOptions:type_name -> blueapi.api.cover.AwsOptions
	192, // 90: blueapi.cover.v1.ListUnregisteredAccountsResponse.unregisteredAccts:type_name -> blueapi.cover.v1.UnregisteredAccts
	347, // 91: blueapi.cover.v1.GetCostGroupAttributeRequest.existingCombinations:type_name -> blueapi.api.cover.Combinations
	347, // 92: blueapi.cover.v1.GetCostGroupAttributeRequest.currentCombination:type_name -> blueapi.api.cover.Combinations
	357, // 93: blueapi.cover.v1.GetCostGroupAttributeResponse.result:type_name -> blueapi.api.cover.Result
	353, // 94: blueapi.cover.v1.GetCostGroupAttributeResponse.tagData:type_name -> blueapi.api.cover.TagData
	358, // 95: blueapi.cover.v1.GetCategoriesResponse.category:type_name -> blueapi.api.cover.Category
	359, // 96: blueapi.cover.v1.GetAlertsResponse.alertData:type_name -> blueapi.api.cover.AlertData
	359, // 97: blueapi.cover.v1.CreateAlertResponse.alertData:type_name -> blueapi.api.cover.AlertData
	359, // 98: blueapi.cover.v1.GetAlertDetailsResponse.alertData:type_name -> blueapi.api.cover.AlertData
	359, // 99: blueapi.cover.v1.UpdateAlertDetailsResponse.alertData:type_name -> blueapi.api.cover.AlertData
	360, // 100: blueapi.cover.v1.GetChannelsResponse.channelData:type_name -> blueapi.api.cover.ChannelData
	360, // 101: blueapi.cover.v1.CreateChannelResponse.channelData:type_name -> blueapi.api.cover.ChannelData
	360, // 102: blueapi.cover.v1.GetChannelDetailsResponse.channelData:type_name -> blueapi.api.cover.ChannelData
	360, // 103: blueapi.cover.v1.UpdateChannelDetailsResponse.channelData:type_name -> blueapi.api.cover.ChannelData
	361, // 104: blueapi.cover.v1.GetDiscountRecommendationsRequest.awsInputs:type_name -> blueapi.api.cover.AwsInputs
	362, // 105: blueapi.cover.v1.GetDiscountRecommendationsRequest.azureInputs:type_name -> blueapi.api.cover.AzureInputs
	363, // 106: blueapi.cover.v1.GetDiscountRecommendationsRequest.gcpInputs:type_name -> blueapi.api.cover.GcpInputs
	364, // 107: blueapi.cover.v1.GetDiscountRecommendationsResponse.awsRecommendations:type_name -> blueapi.api.cover.AwsDiscountRecommendations
	365, // 108: blueapi.cover.v1.GetDiscountRecommendationsResponse.azureRecommendations:type_name -> blueapi.api.cover.AzureDiscountRecommendations
	366, // 109: blueapi.cover.v1.GetDiscountRecommendationsResponse.gcpRecommendations:type_name -> blueapi.api.cover.GcpDiscountRecommendations
	367, // 110: blueapi.cover.v1.DiscountExpiryAlertData.costGroups:type_name -> blueapi.api.cover.AlertCostGroup
	368, // 111: blueapi.cover.v1.DiscountExpiryAlertData.channels:type_name -> blueapi.api.cover.AlertChannels
	367, // 112: blueapi.cover.v1.AnomalyAlertData.costGroupId:type_name -> blueapi.api.cover.AlertCostGroup
	368, // 113: blueapi.cover.v1.AnomalyAlertData.channels:type_name -> blueapi.api.cover.AlertChannels
	369, // 114: blueapi.cover.v1.ListBudgetsResponse.budgetData:type_name -> blueapi.api.cover.BudgetData
	369, // 115: blueapi.cover.v1.GetBudgetResponse.budgetData:type_name -> blueapi.api.cover.BudgetData
	369, // 116: blueapi.cover.v1.CreateBudgetRequest.budgetData:type_name -> blueapi.api.cover.BudgetData
	369, // 117: blueapi.cover.v1.CreateBudgetResponse.budgetData:type_name -> blueapi.api.cover.BudgetData
	369, // 118: blueapi.cover.v1.UpdateBudgetRequest.budgetData:type_name -> blueapi.api.cover.BudgetData
	369, // 119: blueapi.cover.v1.UpdateBudgetResponse.budgetData:type_name -> blueapi.api.cover.BudgetData
	370, // 120: blueapi.cover.v1.GetReportSummaryResponse.executiveSummary:type_name -> blueapi.api.cover.ExecutiveSummary
	371, // 121: blueapi.cover.v1.GetReportSummaryResponse.optimizationRecommendationSummary:type_name -> blueapi.api.cover.OptimizationRecommendationSummary
	372, // 122: blueapi.cover.v1.GetReportSummaryResponse.savingsSummary:type_name -> blueapi.api.cover.SavingsSummary
	329, // 123: blueapi.cover.v1.ListRecommendationV2Request.rateSettings:type_name -> blueapi.cover.v1.ListRecommendationV2Request.RateSettings
	330, // 124: blueapi.cover.v1.ListRecommendationResponse.purchaseOption:type_name -> blueapi.cover.v1.ListRecommendationResponse.PurchaseOption
	373, // 125: blueapi.cover.v1.GetRecommendationResponse.recommendationData:type_name -> blueapi.api.cover.AWSRecommendations
	331, // 126: blueapi.cover.v1.ExecuteOptimizationResponse.awsOption:type_name -> blueapi.cover.v1.ExecuteOptimizationResponse.AWSOption
	332, // 127: blueapi.cover.v1.ExecuteOptimizationResponse.gcpOption:type_name -> blueapi.cover.v1.ExecuteOptimizationResponse.GCPOption
	333, // 128: blueapi.cover.v1.ExecuteOptimizationResponse.azureCspOption:type_name -> blueapi.cover.v1.ExecuteOptimizationResponse.AzureCSPOption
	374, // 129: blueapi.cover.v1.OptimizationHistoryResponse.executedRecommendationDetails:type_name -> blueapi.api.cover.ExecutedRecommendationDetails
	375, // 130: blueapi.cover.v1.SetCostGroupEventIndicatorResponse.eventIndicator:type_name -> blueapi.api.cover.EventIndicator
	376, // 131: blueapi.cover.v1.SetCostGroupAnomalyOptionsResponse.anomalyOptions:type_name -> blueapi.api.cover.AnomalyOptions
	337, // 132: blueapi.cover.v1.UpdateCostGroupCreationUIResponse.userData:type_name -> blueapi.api.cover.UserData
	377, // 133: blueapi.cover.v1.ListUnitTypesResponse.unitCostData:type_name -> blueapi.api.cover.UnitCostData
	378, // 134: blueapi.cover.v1.CreateUnitTypeRequest.unitItems:type_name -> blueapi.api.cover.UnitItem
	379, // 135: blueapi.cover.v1.CreateUnitTypeRequest.sharedResources:type_name -> blueapi.api.cover.SharedResourcesCombination
	377, // 136: blueapi.cover.v1.CreateUnitTypeResponse.unitCostData:type_name -> blueapi.api.cover.UnitCostData
	377, // 137: blueapi.cover.v1.GetUnitTypeResponse.unitCostData:type_name -> blueapi.api.cover.UnitCostData
	378, // 138: blueapi.cover.v1.UpdateUnitTypeRequest.unitItems:type_name -> blueapi.api.cover.UnitItem
	379, // 139: blueapi.cover.v1.UpdateUnitTypeRequest.sharedResources:type_name -> blueapi.api.cover.SharedResourcesCombination
	377, // 140: blueapi.cover.v1.UpdateUnitTypeResponse.unitCostData:type_name -> blueapi.api.cover.UnitCostData
	377, // 141: blueapi.cover.v1.MergeUnitsResponse.mergedUnitCost:type_name -> blueapi.api.cover.UnitCostData
	380, // 142: blueapi.cover.v1.ListSuggestedUnitsResponse.suggestedUnits:type_name -> blueapi.api.cover.SuggestedUnit
	380, // 143: blueapi.cover.v1.MergeSuggestedUnitsResponse.mergedSuggestedUnits:type_name -> blueapi.api.cover.SuggestedUnit
	379, // 144: blueapi.cover.v1.ListSharedResourcesResponse.sharedResources:type_name -> blueapi.api.cover.SharedResourcesCombination
	381, // 145: blueapi.cover.v1.CreateSharedResourcesRequest.sharedResourcesCombinations:type_name -> blueapi.api.cover.ResourcesCombinations
	334, // 146: blueapi.cover.v1.CreateSharedResourcesRequest.distribution:type_name -> blueapi.cover.v1.CreateSharedResourcesRequest.DistributionEntry
	379, // 147: blueapi.cover.v1.CreateSharedResourcesResponse.sharedResources:type_name -> blueapi.api.cover.SharedResourcesCombination
	379, // 148: blueapi.cover.v1.GetSharedResourcesResponse.sharedResources:type_name -> blueapi.api.cover.SharedResourcesCombination
	381, // 149: blueapi.cover.v1.UpdateSharedResourcesRequest.sharedResourcesCombinations:type_name -> blueapi.api.cover.ResourcesCombinations
	335, // 150: blueapi.cover.v1.UpdateSharedResourcesRequest.distribution:type_name -> blueapi.cover.v1.UpdateSharedResourcesRequest.DistributionEntry
	379, // 151: blueapi.cover.v1.UpdateSharedResourcesResponse.sharedResources:type_name -> blueapi.api.cover.SharedResourcesCombination
	382, // 152: blueapi.cover.v1.ListUnitMetricsResponse.unitMetrics:type_name -> blueapi.api.cover.UnitMetric
	383, // 153: blueapi.cover.v1.CreateUnitMetricRequest.csvInfo:type_name -> blueapi.api.cover.CsvInfo
	382, // 154: blueapi.cover.v1.CreateUnitMetricResponse.unitMetric:type_name -> blueapi.api.cover.UnitMetric
	382, // 155: blueapi.cover.v1.GetUnitMetricResponse.unitMetric:type_name -> blueapi.api.cover.UnitMetric
	383, // 156: blueapi.cover.v1.UpdateUnitMetricRequest.csvInfo:type_name -> blueapi.api.cover.CsvInfo
	382, // 157: blueapi.cover.v1.UpdateUnitMetricResponse.unitMetric:type_name -> blueapi.api.cover.UnitMetric
	7,   // 158: blueapi.cover.v1.Cover.OnboardOrg:input_type -> blueapi.cover.v1.OnboardOrgRequest
	9,   // 159: blueapi.cover.v1.Cover.InviteMember:input_type -> blueapi.cover.v1.InviteMemberRequest
	11,  // 160: blueapi.cover.v1.Cover.ActivateUser:input_type -> blueapi.cover.v1.ActivateUserRequest
	13,  // 161: blueapi.cover.v1.Cover.CreateMember:input_type -> blueapi.cover.v1.CreateMemberRequest
	15,  // 162: blueapi.cover.v1.Cover.GetMembers:input_type -> blueapi.cover.v1.GetMembersRequest
	17,  // 163: blueapi.cover.v1.Cover.GetMemberDetails:input_type -> blueapi.cover.v1.GetMemberDetailsRequest
	19,  // 164: blueapi.cover.v1.Cover.GetMemberCostGroup:input_type -> blueapi.cover.v1.GetMemberCostGroupRequest
	21,  // 165: blueapi.cover.v1.Cover.UpdateMemberPermission:input_type -> blueapi.cover.v1.UpdateMemberPermissionRequest
	23,  // 166: blueapi.cover.v1.Cover.GetUserDetails:input_type -> blueapi.cover.v1.GetUserDetailsRequest
	25,  // 167: blueapi.cover.v1.Cover.UpdateUserAvatar:input_type -> blueapi.cover.v1.UpdateUserAvatarRequest
	27,  // 168: blueapi.cover.v1.Cover.UpdateUserIcon:input_type -> blueapi.cover.v1.UpdateUserIconRequest
	29,  // 169: blueapi.cover.v1.Cover.UpdateUserColorTheme:input_type -> blueapi.cover.v1.UpdateUserColorThemeRequest
	31,  // 170: blueapi.cover.v1.Cover.UpdateUserName:input_type -> blueapi.cover.v1.UpdateUserNameRequest
	33,  // 171: blueapi.cover.v1.Cover.UpdateUserEmail:input_type -> blueapi.cover.v1.UpdateUserEmailRequest
	35,  // 172: blueapi.cover.v1.Cover.UpdateUserMainView:input_type -> blueapi.cover.v1.UpdateUserMainViewRequest
	37,  // 173: blueapi.cover.v1.Cover.ResetUserPassword:input_type -> blueapi.cover.v1.ResetUserPasswordRequest
	39,  // 174: blueapi.cover.v1.Cover.UpdateUserLocale:input_type -> blueapi.cover.v1.UpdateUserLocaleRequest
	41,  // 175: blueapi.cover.v1.Cover.UpdateUserAppTheme:input_type -> blueapi.cover.v1.UpdateUserAppThemeRequest
	43,  // 176: blueapi.cover.v1.Cover.UpdateUserTimezone:input_type -> blueapi.cover.v1.UpdateUserTimezoneRequest
	45,  // 177: blueapi.cover.v1.Cover.UpdateUserAttributes:input_type -> blueapi.cover.v1.UpdateUserAttributesRequest
	47,  // 178: blueapi.cover.v1.Cover.DeleteMember:input_type -> blueapi.cover.v1.DeleteMemberRequest
	49,  // 179: blueapi.cover.v1.Cover.ResetPassword:input_type -> blueapi.cover.v1.ResetPasswordRequest
	51,  // 180: blueapi.cover.v1.Cover.CreateView:input_type -> blueapi.cover.v1.CreateViewRequest
	53,  // 181: blueapi.cover.v1.Cover.GetViews:input_type -> blueapi.cover.v1.GetViewsRequest
	55,  // 182: blueapi.cover.v1.Cover.GetCurrentView:input_type -> blueapi.cover.v1.GetCurrentViewRequest
	57,  // 183: blueapi.cover.v1.Cover.GetFavoriteViews:input_type -> blueapi.cover.v1.GetFavoriteViewsRequest
	59,  // 184: blueapi.cover.v1.Cover.PublishView:input_type -> blueapi.cover.v1.PublishViewRequest
	61,  // 185: blueapi.cover.v1.Cover.AddFavorite:input_type -> blueapi.cover.v1.AddFavoriteRequest
	63,  // 186: blueapi.cover.v1.Cover.RemoveFavorite:input_type -> blueapi.cover.v1.RemoveFavoriteRequest
	65,  // 187: blueapi.cover.v1.Cover.UpdateView:input_type -> blueapi.cover.v1.UpdateViewRequest
	67,  // 188: blueapi.cover.v1.Cover.UpdateViewLayout:input_type -> blueapi.cover.v1.UpdateViewLayoutRequest
	69,  // 189: blueapi.cover.v1.Cover.UpdateViewWidget:input_type -> blueapi.cover.v1.UpdateViewWidgetRequest
	71,  // 190: blueapi.cover.v1.Cover.UpdateViewColorTheme:input_type -> blueapi.cover.v1.UpdateViewColorThemeRequest
	73,  // 191: blueapi.cover.v1.Cover.UpdateViewCurrency:input_type -> blueapi.cover.v1.UpdateViewCurrencyRequest
	75,  // 192: blueapi.cover.v1.Cover.SetOrgUpdateCurrency:input_type -> blueapi.cover.v1.SetOrgUpdateCurrencyRequest
	77,  // 193: blueapi.cover.v1.Cover.GetOrgUpdateCurrency:input_type -> blueapi.cover.v1.GetOrgUpdateCurrencyRequest
	79,  // 194: blueapi.cover.v1.Cover.ListExchangeRates:input_type -> blueapi.cover.v1.ListExchangeRatesRequest
	82,  // 195: blueapi.cover.v1.Cover.DeleteView:input_type -> blueapi.cover.v1.DeleteViewRequest
	84,  // 196: blueapi.cover.v1.Cover.UpdateSideMenuState:input_type -> blueapi.cover.v1.UpdateSideMenuStateRequest
	86,  // 197: blueapi.cover.v1.Cover.AddSideMenuFavorite:input_type -> blueapi.cover.v1.AddSideMenuFavoriteRequest
	88,  // 198: blueapi.cover.v1.Cover.RemoveSideMenuFavorite:input_type -> blueapi.cover.v1.RemoveSideMenuFavoriteRequest
	90,  // 199: blueapi.cover.v1.Cover.CreateCostGroup:input_type -> blueapi.cover.v1.CreateCostGroupRequest
	92,  // 200: blueapi.cover.v1.Cover.GetCostGroups:input_type -> blueapi.cover.v1.GetCostGroupsRequest
	199, // 201: blueapi.cover.v1.Cover.GetCategories:input_type -> blueapi.cover.v1.GetCategoriesRequest
	94,  // 202: blueapi.cover.v1.Cover.GetCostGroupDetails:input_type -> blueapi.cover.v1.GetCostGroupDetailsRequest
	96,  // 203: blueapi.cover.v1.Cover.UpdateCostGroupName:input_type -> blueapi.cover.v1.UpdateCostGroupNameRequest
	98,  // 204: blueapi.cover.v1.Cover.UpdateCostGroupDescription:input_type -> blueapi.cover.v1.UpdateCostGroupDescriptionRequest
	100, // 205: blueapi.cover.v1.Cover.UpdateCostGroupImage:input_type -> blueapi.cover.v1.UpdateCostGroupImageRequest
	102, // 206: blueapi.cover.v1.Cover.UpdateCostGroupIcon:input_type -> blueapi.cover.v1.UpdateCostGroupIconRequest
	104, // 207: blueapi.cover.v1.Cover.UpdateCostGroupColorTheme:input_type -> blueapi.cover.v1.UpdateCostGroupColorThemeRequest
	106, // 208: blueapi.cover.v1.Cover.UpdateCostGroupCombinations:input_type -> blueapi.cover.v1.UpdateCostGroupCombinationsRequest
	131, // 209: blueapi.cover.v1.Cover.ResolveCostGroupCombinations:input_type -> blueapi.cover.v1.ResolveCostGroupCombinationsRequest
	108, // 210: blueapi.cover.v1.Cover.AssignCostGroupMember:input_type -> blueapi.cover.v1.AssignCostGroupMemberRequest
	110, // 211: blueapi.cover.v1.Cover.RemoveCostGroupMember:input_type -> blueapi.cover.v1.RemoveCostGroupMemberRequest
	112, // 212: blueapi.cover.v1.Cover.DeleteCostGroup:input_type -> blueapi.cover.v1.DeleteCostGroupRequest
	114, // 213: blueapi.cover.v1.Cover.GetAccountAccessTemplateUrl:input_type -> blueapi.cover.v1.GetAccountAccessTemplateUrlRequest
	116, // 214: blueapi.cover.v1.Cover.ListAccountAccess:input_type -> blueapi.cover.v1.ListAccountAccessRequest
	117, // 215: blueapi.cover.v1.Cover.GetAccountAccess:input_type -> blueapi.cover.v1.GetAccountAccessRequest
	194, // 216: blueapi.cover.v1.Cover.GetDataAccess:input_type -> blueapi.cover.v1.GetAndDeleteDataAccessRequest
	194, // 217: blueapi.cover.v1.Cover.DeleteDataAccess:input_type -> blueapi.cover.v1.GetAndDeleteDataAccessRequest
	119, // 218: blueapi.cover.v1.Cover.CreateAccountAccess:input_type -> blueapi.cover.v1.CreateAccountAccessRequest
	120, // 219: blueapi.cover.v1.Cover.CreateAccountAccessStackset:input_type -> blueapi.cover.v1.CreateAccountAccessStacksetRequest
	119, // 220: blueapi.cover.v1.Cover.CreateAccountAccessCur:input_type -> blueapi.cover.v1.CreateAccountAccessRequest
	121, // 221: blueapi.cover.v1.Cover.UpdateAccountAccess:input_type -> blueapi.cover.v1.UpdateAccountAccessRequest
	122, // 222: blueapi.cover.v1.Cover.DeleteAccountAccess:input_type -> blueapi.cover.v1.DeleteAccountAccessRequest
	124, // 223: blueapi.cover.v1.Cover.RegisterAccount:input_type -> blueapi.cover.v1.RegisterAccountRequest
	187, // 224: blueapi.cover.v1.Cover.RegisterDataAccess:input_type -> blueapi.cover.v1.RegisterDataAccessRequest
	193, // 225: blueapi.cover.v1.Cover.AddBillingAccount:input_type -> blueapi.cover.v1.BillingAccountRequest
	189, // 226: blueapi.cover.v1.Cover.ListDataAccess:input_type -> blueapi.cover.v1.ListDataAccessRequest
	190, // 227: blueapi.cover.v1.Cover.ListUnregisteredAccounts:input_type -> blueapi.cover.v1.ListUnregisteredAccountsRequest
	188, // 228: blueapi.cover.v1.Cover.UpdateDataAccess:input_type -> blueapi.cover.v1.UpdateDataAccessRequest
	125, // 229: blueapi.cover.v1.Cover.ListAssets:input_type -> blueapi.cover.v1.ListAssetsRequest
	128, // 230: blueapi.cover.v1.Cover.GetAssetsSummary:input_type -> blueapi.cover.v1.GetAssetsSummaryRequest
	133, // 231: blueapi.cover.v1.Cover.GetCostUsage:input_type -> blueapi.cover.v1.GetCostUsageRequest
	141, // 232: blueapi.cover.v1.Cover.GetRightSizingRecommendation:input_type -> blueapi.cover.v1.GetRightSizingRecommendationRequest
	143, // 233: blueapi.cover.v1.Cover.ModifyResourceType:input_type -> blueapi.cover.v1.ModifyResourceTypeRequest
	145, // 234: blueapi.cover.v1.Cover.TerminateResource:input_type -> blueapi.cover.v1.TerminateResourceRequest
	147, // 235: blueapi.cover.v1.Cover.UploadChargeCode:input_type -> blueapi.cover.v1.UploadChargeCodeRequest
	149, // 236: blueapi.cover.v1.Cover.AssignPayer:input_type -> blueapi.cover.v1.AssignPayerRequest
	151, // 237: blueapi.cover.v1.Cover.GetPayers:input_type -> blueapi.cover.v1.GetPayersRequest
	153, // 238: blueapi.cover.v1.Cover.GetAccounts:input_type -> blueapi.cover.v1.GetAccountsRequest
	155, // 239: blueapi.cover.v1.Cover.GetServices:input_type -> blueapi.cover.v1.GetServicesRequest
	157, // 240: blueapi.cover.v1.Cover.GetRegions:input_type -> blueapi.cover.v1.GetRegionsRequest
	159, // 241: blueapi.cover.v1.Cover.GetTags:input_type -> blueapi.cover.v1.GetTagsRequest
	161, // 242: blueapi.cover.v1.Cover.ListFees:input_type -> blueapi.cover.v1.ListFeesRequest
	163, // 243: blueapi.cover.v1.Cover.RestoreFee:input_type -> blueapi.cover.v1.RestoreFeeRequest
	164, // 244: blueapi.cover.v1.Cover.GetCostGroupFee:input_type -> blueapi.cover.v1.GetCostGroupFeeRequest
	170, // 245: blueapi.cover.v1.Cover.ListAllocators:input_type -> blueapi.cover.v1.ListAllocatorsRequest
	171, // 246: blueapi.cover.v1.Cover.CreateAllocator:input_type -> blueapi.cover.v1.CreateAllocatorRequest
	172, // 247: blueapi.cover.v1.Cover.GetAllocationAttributes:input_type -> blueapi.cover.v1.GetAllocationAttributesRequest
	169, // 248: blueapi.cover.v1.Cover.UpdateAllocator:input_type -> blueapi.cover.v1.CostAllocatorRequest
	174, // 249: blueapi.cover.v1.Cover.DeleteAllocator:input_type -> blueapi.cover.v1.DeleteAllocatorRequest
	175, // 250: blueapi.cover.v1.Cover.ProxyCreateCompletion:input_type -> blueapi.cover.v1.ProxyCreateCompletionRequest
	171, // 251: blueapi.cover.v1.Cover.SimulateFeeAllocator:input_type -> blueapi.cover.v1.CreateAllocatorRequest
	178, // 252: blueapi.cover.v1.Cover.ListAccountUsage:input_type -> blueapi.cover.v1.ListAccountUsageRequest
	179, // 253: blueapi.cover.v1.Cover.RestoreAccountUsage:input_type -> blueapi.cover.v1.RestoreAccountUsageRequest
	171, // 254: blueapi.cover.v1.Cover.SimulateAccountUsage:input_type -> blueapi.cover.v1.CreateAllocatorRequest
	161, // 255: blueapi.cover.v1.Cover.ListSavings:input_type -> blueapi.cover.v1.ListFeesRequest
	180, // 256: blueapi.cover.v1.Cover.RestoreSavings:input_type -> blueapi.cover.v1.RestoreSavingsRequest
	171, // 257: blueapi.cover.v1.Cover.SimulateSavings:input_type -> blueapi.cover.v1.CreateAllocatorRequest
	182, // 258: blueapi.cover.v1.Cover.GetCostGroupAllocation:input_type -> blueapi.cover.v1.GetCostGroupAllocationRequest
	184, // 259: blueapi.cover.v1.Cover.ProcessAuth0User:input_type -> blueapi.cover.v1.ProcessAuth0UserRequest
	195, // 260: blueapi.cover.v1.Cover.AddPartnerCenterCredentials:input_type -> blueapi.cover.v1.AddPartnerCenterCredentialsRequest
	196, // 261: blueapi.cover.v1.Cover.AddMpnSetting:input_type -> blueapi.cover.v1.AddMpnSettingRequest
	197, // 262: blueapi.cover.v1.Cover.GetCostGroupAttribute:input_type -> blueapi.cover.v1.GetCostGroupAttributeRequest
	201, // 263: blueapi.cover.v1.Cover.GetAlerts:input_type -> blueapi.cover.v1.GetAlertsRequest
	203, // 264: blueapi.cover.v1.Cover.CreateAlert:input_type -> blueapi.cover.v1.CreateAlertRequest
	205, // 265: blueapi.cover.v1.Cover.GetAlertDetails:input_type -> blueapi.cover.v1.GetAlertDetailsRequest
	207, // 266: blueapi.cover.v1.Cover.DeleteAlert:input_type -> blueapi.cover.v1.DeleteAlertRequest
	209, // 267: blueapi.cover.v1.Cover.UpdateAlertDetails:input_type -> blueapi.cover.v1.UpdateAlertDetailsRequest
	211, // 268: blueapi.cover.v1.Cover.GetChannels:input_type -> blueapi.cover.v1.GetChannelsRequest
	213, // 269: blueapi.cover.v1.Cover.CreateChannel:input_type -> blueapi.cover.v1.CreateChannelRequest
	215, // 270: blueapi.cover.v1.Cover.GetChannelDetails:input_type -> blueapi.cover.v1.GetChannelDetailsRequest
	217, // 271: blueapi.cover.v1.Cover.DeleteChannel:input_type -> blueapi.cover.v1.DeleteChannelRequest
	219, // 272: blueapi.cover.v1.Cover.UpdateChannelDetails:input_type -> blueapi.cover.v1.UpdateChannelDetailsRequest
	221, // 273: blueapi.cover.v1.Cover.GetDiscountRecommendations:input_type -> blueapi.cover.v1.GetDiscountRecommendationsRequest
	223, // 274: blueapi.cover.v1.Cover.GetAnomalyinCostGroup:input_type -> blueapi.cover.v1.GetAnomalyinCostGroupRequest
	225, // 275: blueapi.cover.v1.Cover.CreateDiscountExpirationAlert:input_type -> blueapi.cover.v1.CreateDiscountExpirationAlertRequest
	227, // 276: blueapi.cover.v1.Cover.UpdateDiscountExpirationAlert:input_type -> blueapi.cover.v1.UpdateDiscountExpirationAlertRequest
	226, // 277: blueapi.cover.v1.Cover.GetDiscountExpirationAlert:input_type -> blueapi.cover.v1.ManipulateDiscountExpirationAlertRequest
	229, // 278: blueapi.cover.v1.Cover.ListDiscountExpirationAlert:input_type -> blueapi.cover.v1.ListDiscountExpirationAlertRequest
	226, // 279: blueapi.cover.v1.Cover.DeleteDiscountExpirationAlert:input_type -> blueapi.cover.v1.ManipulateDiscountExpirationAlertRequest
	230, // 280: blueapi.cover.v1.Cover.CreateAnomalyAlert:input_type -> blueapi.cover.v1.CreateAnomalyAlertRequest
	231, // 281: blueapi.cover.v1.Cover.DeleteAnomalyAlert:input_type -> blueapi.cover.v1.ManipulateAnomalyAlertRequest
	233, // 282: blueapi.cover.v1.Cover.ListAnomalyAlert:input_type -> blueapi.cover.v1.ListAnomalyAlertRequest
	231, // 283: blueapi.cover.v1.Cover.GetAnomalyAlert:input_type -> blueapi.cover.v1.ManipulateAnomalyAlertRequest
	234, // 284: blueapi.cover.v1.Cover.UpdateAnomalyAlert:input_type -> blueapi.cover.v1.UpdateAnomalyAlertRequest
	235, // 285: blueapi.cover.v1.Cover.RegisterNewUser:input_type -> blueapi.cover.v1.RegisterNewUserRequest
	237, // 286: blueapi.cover.v1.Cover.GetUserProfile:input_type -> blueapi.cover.v1.GetUserProfileRequest
	239, // 287: blueapi.cover.v1.Cover.UpdateUserProfile:input_type -> blueapi.cover.v1.UpdateUserProfileRequest
	241, // 288: blueapi.cover.v1.Cover.ListBudgets:input_type -> blueapi.cover.v1.ListBudgetsRequest
	243, // 289: blueapi.cover.v1.Cover.GetBudget:input_type -> blueapi.cover.v1.GetBudgetRequest
	245, // 290: blueapi.cover.v1.Cover.CreateBudget:input_type -> blueapi.cover.v1.CreateBudgetRequest
	247, // 291: blueapi.cover.v1.Cover.DeleteBudget:input_type -> blueapi.cover.v1.DeleteBudgetRequest
	249, // 292: blueapi.cover.v1.Cover.UpdateBudget:input_type -> blueapi.cover.v1.UpdateBudgetRequest
	251, // 293: blueapi.cover.v1.Cover.ResolveAWSMarketplaceTokenForOnboarding:input_type -> blueapi.cover.v1.ResolveAWSMarketplaceTokenForOnboardingRequest
	253, // 294: blueapi.cover.v1.Cover.GetCustomerSubscriptionStatus:input_type -> blueapi.cover.v1.GetCustomerSubscriptionStatusRequest
	255, // 295: blueapi.cover.v1.Cover.CreateProfiling:input_type -> blueapi.cover.v1.CreateProfilingRequest
	257, // 296: blueapi.cover.v1.Cover.AddInfotoMarketplace:input_type -> blueapi.cover.v1.AddInfotoMarketplaceRequest
	259, // 297: blueapi.cover.v1.Cover.GetReportSummary:input_type -> blueapi.cover.v1.GetReportSummaryRequest
	261, // 298: blueapi.cover.v1.Cover.ListRecommendations:input_type -> blueapi.cover.v1.ListRecommendationRequest
	262, // 299: blueapi.cover.v1.Cover.ListRecommendationsV2:input_type -> blueapi.cover.v1.ListRecommendationV2Request
	264, // 300: blueapi.cover.v1.Cover.GetRecommendation:input_type -> blueapi.cover.v1.GetRecommendationRequest
	5,   // 301: blueapi.cover.v1.Cover.GetRecommendationV2:input_type -> blueapi.cover.v1.GetRecommendationV2Request
	266, // 302: blueapi.cover.v1.Cover.ExecuteOptimization:input_type -> blueapi.cover.v1.ExecuteOptimizationRequest
	1,   // 303: blueapi.cover.v1.Cover.GetExecutionStatus:input_type -> blueapi.cover.v1.GetExecutionStatusRequest
	268, // 304: blueapi.cover.v1.Cover.MarkAsExecuted:input_type -> blueapi.cover.v1.MarkAsExecutedRequest
	270, // 305: blueapi.cover.v1.Cover.UndoExecutedRecommendation:input_type -> blueapi.cover.v1.UndoExecutedRecommendationRequest
	272, // 306: blueapi.cover.v1.Cover.OptimizationHistory:input_type -> blueapi.cover.v1.OptimizationHistoryRequest
	274, // 307: blueapi.cover.v1.Cover.SetCostGroupEventIndicator:input_type -> blueapi.cover.v1.SetCostGroupEventIndicatorRequest
	276, // 308: blueapi.cover.v1.Cover.SetCostGroupAnomalyOptions:input_type -> blueapi.cover.v1.SetCostGroupAnomalyOptionsRequest
	278, // 309: blueapi.cover.v1.Cover.SetOrgFiscalMonth:input_type -> blueapi.cover.v1.SetOrgFiscalMonthRequest
	280, // 310: blueapi.cover.v1.Cover.GetOrgFiscalMonth:input_type -> blueapi.cover.v1.GetOrgFiscalMonthRequest
	282, // 311: blueapi.cover.v1.Cover.TransferOrganization:input_type -> blueapi.cover.v1.TransferOrganizationRequest
	284, // 312: blueapi.cover.v1.Cover.UpdateCostGroupCreationUI:input_type -> blueapi.cover.v1.UpdateCostGroupCreationUIRequest
	286, // 313: blueapi.cover.v1.Cover.ListUnitTypes:input_type -> blueapi.cover.v1.ListUnitTypesRequest
	288, // 314: blueapi.cover.v1.Cover.CreateUnitType:input_type -> blueapi.cover.v1.CreateUnitTypeRequest
	290, // 315: blueapi.cover.v1.Cover.GetUnitType:input_type -> blueapi.cover.v1.GetUnitTypeRequest
	292, // 316: blueapi.cover.v1.Cover.UpdateUnitType:input_type -> blueapi.cover.v1.UpdateUnitTypeRequest
	294, // 317: blueapi.cover.v1.Cover.DeleteUnitType:input_type -> blueapi.cover.v1.DeleteUnitTypeRequest
	296, // 318: blueapi.cover.v1.Cover.MergeUnits:input_type -> blueapi.cover.v1.MergeUnitsRequest
	298, // 319: blueapi.cover.v1.Cover.ListSuggestedUnits:input_type -> blueapi.cover.v1.ListSuggestedUnitsRequest
	300, // 320: blueapi.cover.v1.Cover.MergeSuggestedUnits:input_type -> blueapi.cover.v1.MergeSuggestedUnitsRequest
	302, // 321: blueapi.cover.v1.Cover.CreateUnitFromSuggested:input_type -> blueapi.cover.v1.CreateUnitFromSuggestedRequest
	304, // 322: blueapi.cover.v1.Cover.ListSharedResources:input_type -> blueapi.cover.v1.ListSharedResourcesRequest
	306, // 323: blueapi.cover.v1.Cover.CreateSharedResource:input_type -> blueapi.cover.v1.CreateSharedResourcesRequest
	308, // 324: blueapi.cover.v1.Cover.GetSharedResource:input_type -> blueapi.cover.v1.GetSharedResourcesRequest
	310, // 325: blueapi.cover.v1.Cover.UpdateSharedResource:input_type -> blueapi.cover.v1.UpdateSharedResourcesRequest
	312, // 326: blueapi.cover.v1.Cover.DeleteSharedResource:input_type -> blueapi.cover.v1.DeleteSharedResourcesRequest
	314, // 327: blueapi.cover.v1.Cover.ListUnitMetrics:input_type -> blueapi.cover.v1.ListUnitMetricsRequest
	316, // 328: blueapi.cover.v1.Cover.CreateUnitMetric:input_type -> blueapi.cover.v1.CreateUnitMetricRequest
	318, // 329: blueapi.cover.v1.Cover.GetUnitMetric:input_type -> blueapi.cover.v1.GetUnitMetricRequest
	320, // 330: blueapi.cover.v1.Cover.UpdateUnitMetric:input_type -> blueapi.cover.v1.UpdateUnitMetricRequest
	322, // 331: blueapi.cover.v1.Cover.DeleteUnitMetric:input_type -> blueapi.cover.v1.DeleteUnitMetricRequest
	3,   // 332: blueapi.cover.v1.Cover.VerifyAPIAccess:input_type -> blueapi.cover.v1.VerifyAPIAccessRequest
	8,   // 333: blueapi.cover.v1.Cover.OnboardOrg:output_type -> blueapi.cover.v1.OnboardOrgResponse
	10,  // 334: blueapi.cover.v1.Cover.InviteMember:output_type -> blueapi.cover.v1.InviteMemberResponse
	12,  // 335: blueapi.cover.v1.Cover.ActivateUser:output_type -> blueapi.cover.v1.ActivateUserResponse
	14,  // 336: blueapi.cover.v1.Cover.CreateMember:output_type -> blueapi.cover.v1.CreateMemberResponse
	16,  // 337: blueapi.cover.v1.Cover.GetMembers:output_type -> blueapi.cover.v1.GetMembersResponse
	18,  // 338: blueapi.cover.v1.Cover.GetMemberDetails:output_type -> blueapi.cover.v1.GetMemberDetailsResponse
	20,  // 339: blueapi.cover.v1.Cover.GetMemberCostGroup:output_type -> blueapi.cover.v1.GetMemberCostGroupResponse
	22,  // 340: blueapi.cover.v1.Cover.UpdateMemberPermission:output_type -> blueapi.cover.v1.UpdateMemberPermissionResponse
	24,  // 341: blueapi.cover.v1.Cover.GetUserDetails:output_type -> blueapi.cover.v1.GetUserDetailsResponse
	26,  // 342: blueapi.cover.v1.Cover.UpdateUserAvatar:output_type -> blueapi.cover.v1.UpdateUserAvatarResponse
	28,  // 343: blueapi.cover.v1.Cover.UpdateUserIcon:output_type -> blueapi.cover.v1.UpdateUserIconResponse
	30,  // 344: blueapi.cover.v1.Cover.UpdateUserColorTheme:output_type -> blueapi.cover.v1.UpdateUserColorThemeResponse
	32,  // 345: blueapi.cover.v1.Cover.UpdateUserName:output_type -> blueapi.cover.v1.UpdateUserNameResponse
	34,  // 346: blueapi.cover.v1.Cover.UpdateUserEmail:output_type -> blueapi.cover.v1.UpdateUserEmailResponse
	36,  // 347: blueapi.cover.v1.Cover.UpdateUserMainView:output_type -> blueapi.cover.v1.UpdateUserMainViewResponse
	38,  // 348: blueapi.cover.v1.Cover.ResetUserPassword:output_type -> blueapi.cover.v1.ResetUserPasswordResponse
	40,  // 349: blueapi.cover.v1.Cover.UpdateUserLocale:output_type -> blueapi.cover.v1.UpdateUserLocaleResponse
	42,  // 350: blueapi.cover.v1.Cover.UpdateUserAppTheme:output_type -> blueapi.cover.v1.UpdateUserAppThemeResponse
	44,  // 351: blueapi.cover.v1.Cover.UpdateUserTimezone:output_type -> blueapi.cover.v1.UpdateUserTimezoneResponse
	46,  // 352: blueapi.cover.v1.Cover.UpdateUserAttributes:output_type -> blueapi.cover.v1.UpdateUserAttributesResponse
	48,  // 353: blueapi.cover.v1.Cover.DeleteMember:output_type -> blueapi.cover.v1.DeleteMemberResponse
	50,  // 354: blueapi.cover.v1.Cover.ResetPassword:output_type -> blueapi.cover.v1.ResetPasswordResponse
	52,  // 355: blueapi.cover.v1.Cover.CreateView:output_type -> blueapi.cover.v1.CreateViewResponse
	54,  // 356: blueapi.cover.v1.Cover.GetViews:output_type -> blueapi.cover.v1.GetViewsResponse
	56,  // 357: blueapi.cover.v1.Cover.GetCurrentView:output_type -> blueapi.cover.v1.GetCurrentViewResponse
	58,  // 358: blueapi.cover.v1.Cover.GetFavoriteViews:output_type -> blueapi.cover.v1.GetFavoriteViewsResponse
	60,  // 359: blueapi.cover.v1.Cover.PublishView:output_type -> blueapi.cover.v1.PublishViewResponse
	62,  // 360: blueapi.cover.v1.Cover.AddFavorite:output_type -> blueapi.cover.v1.AddFavoriteResponse
	64,  // 361: blueapi.cover.v1.Cover.RemoveFavorite:output_type -> blueapi.cover.v1.RemoveFavoriteResponse
	66,  // 362: blueapi.cover.v1.Cover.UpdateView:output_type -> blueapi.cover.v1.UpdateViewResponse
	68,  // 363: blueapi.cover.v1.Cover.UpdateViewLayout:output_type -> blueapi.cover.v1.UpdateViewLayoutResponse
	70,  // 364: blueapi.cover.v1.Cover.UpdateViewWidget:output_type -> blueapi.cover.v1.UpdateViewWidgetResponse
	72,  // 365: blueapi.cover.v1.Cover.UpdateViewColorTheme:output_type -> blueapi.cover.v1.UpdateViewColorThemeResponse
	74,  // 366: blueapi.cover.v1.Cover.UpdateViewCurrency:output_type -> blueapi.cover.v1.UpdateViewCurrencyResponse
	76,  // 367: blueapi.cover.v1.Cover.SetOrgUpdateCurrency:output_type -> blueapi.cover.v1.SetOrgUpdateCurrencyResponse
	78,  // 368: blueapi.cover.v1.Cover.GetOrgUpdateCurrency:output_type -> blueapi.cover.v1.GetOrgUpdateCurrencyResponse
	80,  // 369: blueapi.cover.v1.Cover.ListExchangeRates:output_type -> blueapi.cover.v1.ListExchangeRatesResponse
	83,  // 370: blueapi.cover.v1.Cover.DeleteView:output_type -> blueapi.cover.v1.DeleteViewResponse
	85,  // 371: blueapi.cover.v1.Cover.UpdateSideMenuState:output_type -> blueapi.cover.v1.UpdateSideMenuStateResponse
	87,  // 372: blueapi.cover.v1.Cover.AddSideMenuFavorite:output_type -> blueapi.cover.v1.AddSideMenuFavoriteResponse
	89,  // 373: blueapi.cover.v1.Cover.RemoveSideMenuFavorite:output_type -> blueapi.cover.v1.RemoveSideMenuFavoriteResponse
	91,  // 374: blueapi.cover.v1.Cover.CreateCostGroup:output_type -> blueapi.cover.v1.CreateCostGroupResponse
	93,  // 375: blueapi.cover.v1.Cover.GetCostGroups:output_type -> blueapi.cover.v1.GetCostGroupsResponse
	200, // 376: blueapi.cover.v1.Cover.GetCategories:output_type -> blueapi.cover.v1.GetCategoriesResponse
	95,  // 377: blueapi.cover.v1.Cover.GetCostGroupDetails:output_type -> blueapi.cover.v1.GetCostGroupDetailsResponse
	97,  // 378: blueapi.cover.v1.Cover.UpdateCostGroupName:output_type -> blueapi.cover.v1.UpdateCostGroupNameResponse
	99,  // 379: blueapi.cover.v1.Cover.UpdateCostGroupDescription:output_type -> blueapi.cover.v1.UpdateCostGroupDescriptionResponse
	101, // 380: blueapi.cover.v1.Cover.UpdateCostGroupImage:output_type -> blueapi.cover.v1.UpdateCostGroupImageResponse
	103, // 381: blueapi.cover.v1.Cover.UpdateCostGroupIcon:output_type -> blueapi.cover.v1.UpdateCostGroupIconResponse
	105, // 382: blueapi.cover.v1.Cover.UpdateCostGroupColorTheme:output_type -> blueapi.cover.v1.UpdateCostGroupColorThemeResponse
	107, // 383: blueapi.cover.v1.Cover.UpdateCostGroupCombinations:output_type -> blueapi.cover.v1.UpdateCostGroupCombinationsResponse
	132, // 384: blueapi.cover.v1.Cover.ResolveCostGroupCombinations:output_type -> blueapi.cover.v1.ResolveCostGroupCombinationsResponse
	109, // 385: blueapi.cover.v1.Cover.AssignCostGroupMember:output_type -> blueapi.cover.v1.AssignCostGroupMemberResponse
	111, // 386: blueapi.cover.v1.Cover.RemoveCostGroupMember:output_type -> blueapi.cover.v1.RemoveCostGroupMemberResponse
	113, // 387: blueapi.cover.v1.Cover.DeleteCostGroup:output_type -> blueapi.cover.v1.DeleteCostGroupResponse
	115, // 388: blueapi.cover.v1.Cover.GetAccountAccessTemplateUrl:output_type -> blueapi.cover.v1.GetAccountAccessTemplateUrlResponse
	118, // 389: blueapi.cover.v1.Cover.ListAccountAccess:output_type -> blueapi.cover.v1.AccountAccess
	118, // 390: blueapi.cover.v1.Cover.GetAccountAccess:output_type -> blueapi.cover.v1.AccountAccess
	186, // 391: blueapi.cover.v1.Cover.GetDataAccess:output_type -> blueapi.cover.v1.DataAccess
	384, // 392: blueapi.cover.v1.Cover.DeleteDataAccess:output_type -> google.protobuf.Empty
	118, // 393: blueapi.cover.v1.Cover.CreateAccountAccess:output_type -> blueapi.cover.v1.AccountAccess
	118, // 394: blueapi.cover.v1.Cover.CreateAccountAccessStackset:output_type -> blueapi.cover.v1.AccountAccess
	118, // 395: blueapi.cover.v1.Cover.CreateAccountAccessCur:output_type -> blueapi.cover.v1.AccountAccess
	385, // 396: blueapi.cover.v1.Cover.UpdateAccountAccess:output_type -> protos.Operation
	123, // 397: blueapi.cover.v1.Cover.DeleteAccountAccess:output_type -> blueapi.cover.v1.DeleteAccountAccessResponse
	384, // 398: blueapi.cover.v1.Cover.RegisterAccount:output_type -> google.protobuf.Empty
	384, // 399: blueapi.cover.v1.Cover.RegisterDataAccess:output_type -> google.protobuf.Empty
	384, // 400: blueapi.cover.v1.Cover.AddBillingAccount:output_type -> google.protobuf.Empty
	186, // 401: blueapi.cover.v1.Cover.ListDataAccess:output_type -> blueapi.cover.v1.DataAccess
	191, // 402: blueapi.cover.v1.Cover.ListUnregisteredAccounts:output_type -> blueapi.cover.v1.ListUnregisteredAccountsResponse
	384, // 403: blueapi.cover.v1.Cover.UpdateDataAccess:output_type -> google.protobuf.Empty
	127, // 404: blueapi.cover.v1.Cover.ListAssets:output_type -> blueapi.cover.v1.Resource
	129, // 405: blueapi.cover.v1.Cover.GetAssetsSummary:output_type -> blueapi.cover.v1.GetAssetsSummaryResponse
	140, // 406: blueapi.cover.v1.Cover.GetCostUsage:output_type -> blueapi.cover.v1.CostItem
	142, // 407: blueapi.cover.v1.Cover.GetRightSizingRecommendation:output_type -> blueapi.cover.v1.GetRightSizingRecommendationResponse
	144, // 408: blueapi.cover.v1.Cover.ModifyResourceType:output_type -> blueapi.cover.v1.ModifyResourceTypeResponse
	146, // 409: blueapi.cover.v1.Cover.TerminateResource:output_type -> blueapi.cover.v1.TerminateResourceResponse
	148, // 410: blueapi.cover.v1.Cover.UploadChargeCode:output_type -> blueapi.cover.v1.UploadChargeCodeResponse
	150, // 411: blueapi.cover.v1.Cover.AssignPayer:output_type -> blueapi.cover.v1.AssignPayerResponse
	152, // 412: blueapi.cover.v1.Cover.GetPayers:output_type -> blueapi.cover.v1.GetPayersResponse
	154, // 413: blueapi.cover.v1.Cover.GetAccounts:output_type -> blueapi.cover.v1.GetAccountsResponse
	156, // 414: blueapi.cover.v1.Cover.GetServices:output_type -> blueapi.cover.v1.GetServicesResponse
	158, // 415: blueapi.cover.v1.Cover.GetRegions:output_type -> blueapi.cover.v1.GetRegionsResponse
	160, // 416: blueapi.cover.v1.Cover.GetTags:output_type -> blueapi.cover.v1.GetTagsResponse
	162, // 417: blueapi.cover.v1.Cover.ListFees:output_type -> blueapi.cover.v1.FeeDetails
	162, // 418: blueapi.cover.v1.Cover.RestoreFee:output_type -> blueapi.cover.v1.FeeDetails
	165, // 419: blueapi.cover.v1.Cover.GetCostGroupFee:output_type -> blueapi.cover.v1.FeeItem
	168, // 420: blueapi.cover.v1.Cover.ListAllocators:output_type -> blueapi.cover.v1.CostAllocatorDetails
	168, // 421: blueapi.cover.v1.Cover.CreateAllocator:output_type -> blueapi.cover.v1.CostAllocatorDetails
	173, // 422: blueapi.cover.v1.Cover.GetAllocationAttributes:output_type -> blueapi.cover.v1.GetAllocationAttributesResponse
	168, // 423: blueapi.cover.v1.Cover.UpdateAllocator:output_type -> blueapi.cover.v1.CostAllocatorDetails
	384, // 424: blueapi.cover.v1.Cover.DeleteAllocator:output_type -> google.protobuf.Empty
	176, // 425: blueapi.cover.v1.Cover.ProxyCreateCompletion:output_type -> blueapi.cover.v1.ProxyCreateCompletionResponse
	162, // 426: blueapi.cover.v1.Cover.SimulateFeeAllocator:output_type -> blueapi.cover.v1.FeeDetails
	177, // 427: blueapi.cover.v1.Cover.ListAccountUsage:output_type -> blueapi.cover.v1.AccountUsageDetails
	177, // 428: blueapi.cover.v1.Cover.RestoreAccountUsage:output_type -> blueapi.cover.v1.AccountUsageDetails
	177, // 429: blueapi.cover.v1.Cover.SimulateAccountUsage:output_type -> blueapi.cover.v1.AccountUsageDetails
	181, // 430: blueapi.cover.v1.Cover.ListSavings:output_type -> blueapi.cover.v1.SavingsDetails
	181, // 431: blueapi.cover.v1.Cover.RestoreSavings:output_type -> blueapi.cover.v1.SavingsDetails
	181, // 432: blueapi.cover.v1.Cover.SimulateSavings:output_type -> blueapi.cover.v1.SavingsDetails
	183, // 433: blueapi.cover.v1.Cover.GetCostGroupAllocation:output_type -> blueapi.cover.v1.AllocationItem
	185, // 434: blueapi.cover.v1.Cover.ProcessAuth0User:output_type -> blueapi.cover.v1.ProcessAuth0UserResponse
	384, // 435: blueapi.cover.v1.Cover.AddPartnerCenterCredentials:output_type -> google.protobuf.Empty
	384, // 436: blueapi.cover.v1.Cover.AddMpnSetting:output_type -> google.protobuf.Empty
	198, // 437: blueapi.cover.v1.Cover.GetCostGroupAttribute:output_type -> blueapi.cover.v1.GetCostGroupAttributeResponse
	202, // 438: blueapi.cover.v1.Cover.GetAlerts:output_type -> blueapi.cover.v1.GetAlertsResponse
	204, // 439: blueapi.cover.v1.Cover.CreateAlert:output_type -> blueapi.cover.v1.CreateAlertResponse
	206, // 440: blueapi.cover.v1.Cover.GetAlertDetails:output_type -> blueapi.cover.v1.GetAlertDetailsResponse
	208, // 441: blueapi.cover.v1.Cover.DeleteAlert:output_type -> blueapi.cover.v1.DeleteAlertResponse
	210, // 442: blueapi.cover.v1.Cover.UpdateAlertDetails:output_type -> blueapi.cover.v1.UpdateAlertDetailsResponse
	212, // 443: blueapi.cover.v1.Cover.GetChannels:output_type -> blueapi.cover.v1.GetChannelsResponse
	214, // 444: blueapi.cover.v1.Cover.CreateChannel:output_type -> blueapi.cover.v1.CreateChannelResponse
	216, // 445: blueapi.cover.v1.Cover.GetChannelDetails:output_type -> blueapi.cover.v1.GetChannelDetailsResponse
	218, // 446: blueapi.cover.v1.Cover.DeleteChannel:output_type -> blueapi.cover.v1.DeleteChannelResponse
	220, // 447: blueapi.cover.v1.Cover.UpdateChannelDetails:output_type -> blueapi.cover.v1.UpdateChannelDetailsResponse
	222, // 448: blueapi.cover.v1.Cover.GetDiscountRecommendations:output_type -> blueapi.cover.v1.GetDiscountRecommendationsResponse
	224, // 449: blueapi.cover.v1.Cover.GetAnomalyinCostGroup:output_type -> blueapi.cover.v1.AnomalyData
	384, // 450: blueapi.cover.v1.Cover.CreateDiscountExpirationAlert:output_type -> google.protobuf.Empty
	384, // 451: blueapi.cover.v1.Cover.UpdateDiscountExpirationAlert:output_type -> google.protobuf.Empty
	228, // 452: blueapi.cover.v1.Cover.GetDiscountExpirationAlert:output_type -> blueapi.cover.v1.DiscountExpiryAlertData
	228, // 453: blueapi.cover.v1.Cover.ListDiscountExpirationAlert:output_type -> blueapi.cover.v1.DiscountExpiryAlertData
	384, // 454: blueapi.cover.v1.Cover.DeleteDiscountExpirationAlert:output_type -> google.protobuf.Empty
	384, // 455: blueapi.cover.v1.Cover.CreateAnomalyAlert:output_type -> google.protobuf.Empty
	384, // 456: blueapi.cover.v1.Cover.DeleteAnomalyAlert:output_type -> google.protobuf.Empty
	232, // 457: blueapi.cover.v1.Cover.ListAnomalyAlert:output_type -> blueapi.cover.v1.AnomalyAlertData
	232, // 458: blueapi.cover.v1.Cover.GetAnomalyAlert:output_type -> blueapi.cover.v1.AnomalyAlertData
	384, // 459: blueapi.cover.v1.Cover.UpdateAnomalyAlert:output_type -> google.protobuf.Empty
	236, // 460: blueapi.cover.v1.Cover.RegisterNewUser:output_type -> blueapi.cover.v1.RegisterNewUserResponse
	238, // 461: blueapi.cover.v1.Cover.GetUserProfile:output_type -> blueapi.cover.v1.GetUserProfileResponse
	240, // 462: blueapi.cover.v1.Cover.UpdateUserProfile:output_type -> blueapi.cover.v1.UpdateUserProfileResponse
	242, // 463: blueapi.cover.v1.Cover.ListBudgets:output_type -> blueapi.cover.v1.ListBudgetsResponse
	244, // 464: blueapi.cover.v1.Cover.GetBudget:output_type -> blueapi.cover.v1.GetBudgetResponse
	246, // 465: blueapi.cover.v1.Cover.CreateBudget:output_type -> blueapi.cover.v1.CreateBudgetResponse
	248, // 466: blueapi.cover.v1.Cover.DeleteBudget:output_type -> blueapi.cover.v1.DeleteBudgetResponse
	250, // 467: blueapi.cover.v1.Cover.UpdateBudget:output_type -> blueapi.cover.v1.UpdateBudgetResponse
	252, // 468: blueapi.cover.v1.Cover.ResolveAWSMarketplaceTokenForOnboarding:output_type -> blueapi.cover.v1.ResolveAWSMarketplaceTokenForOnboardingResponse
	254, // 469: blueapi.cover.v1.Cover.GetCustomerSubscriptionStatus:output_type -> blueapi.cover.v1.GetCustomerSubscriptionStatusResponse
	256, // 470: blueapi.cover.v1.Cover.CreateProfiling:output_type -> blueapi.cover.v1.CreateProfilingResponse
	258, // 471: blueapi.cover.v1.Cover.AddInfotoMarketplace:output_type -> blueapi.cover.v1.AddInfotoMarketplaceResponse
	260, // 472: blueapi.cover.v1.Cover.GetReportSummary:output_type -> blueapi.cover.v1.GetReportSummaryResponse
	263, // 473: blueapi.cover.v1.Cover.ListRecommendations:output_type -> blueapi.cover.v1.ListRecommendationResponse
	263, // 474: blueapi.cover.v1.Cover.ListRecommendationsV2:output_type -> blueapi.cover.v1.ListRecommendationResponse
	265, // 475: blueapi.cover.v1.Cover.GetRecommendation:output_type -> blueapi.cover.v1.GetRecommendationResponse
	6,   // 476: blueapi.cover.v1.Cover.GetRecommendationV2:output_type -> blueapi.cover.v1.GetRecommendationV2Response
	267, // 477: blueapi.cover.v1.Cover.ExecuteOptimization:output_type -> blueapi.cover.v1.ExecuteOptimizationResponse
	2,   // 478: blueapi.cover.v1.Cover.GetExecutionStatus:output_type -> blueapi.cover.v1.GetExecutionStatusResponse
	269, // 479: blueapi.cover.v1.Cover.MarkAsExecuted:output_type -> blueapi.cover.v1.MarkAsExecutedResponse
	271, // 480: blueapi.cover.v1.Cover.UndoExecutedRecommendation:output_type -> blueapi.cover.v1.UndoExecutedRecommendationResponse
	273, // 481: blueapi.cover.v1.Cover.OptimizationHistory:output_type -> blueapi.cover.v1.OptimizationHistoryResponse
	275, // 482: blueapi.cover.v1.Cover.SetCostGroupEventIndicator:output_type -> blueapi.cover.v1.SetCostGroupEventIndicatorResponse
	277, // 483: blueapi.cover.v1.Cover.SetCostGroupAnomalyOptions:output_type -> blueapi.cover.v1.SetCostGroupAnomalyOptionsResponse
	279, // 484: blueapi.cover.v1.Cover.SetOrgFiscalMonth:output_type -> blueapi.cover.v1.SetOrgFiscalMonthResponse
	281, // 485: blueapi.cover.v1.Cover.GetOrgFiscalMonth:output_type -> blueapi.cover.v1.GetOrgFiscalMonthResponse
	283, // 486: blueapi.cover.v1.Cover.TransferOrganization:output_type -> blueapi.cover.v1.TransferOrganizationResponse
	285, // 487: blueapi.cover.v1.Cover.UpdateCostGroupCreationUI:output_type -> blueapi.cover.v1.UpdateCostGroupCreationUIResponse
	287, // 488: blueapi.cover.v1.Cover.ListUnitTypes:output_type -> blueapi.cover.v1.ListUnitTypesResponse
	289, // 489: blueapi.cover.v1.Cover.CreateUnitType:output_type -> blueapi.cover.v1.CreateUnitTypeResponse
	291, // 490: blueapi.cover.v1.Cover.GetUnitType:output_type -> blueapi.cover.v1.GetUnitTypeResponse
	293, // 491: blueapi.cover.v1.Cover.UpdateUnitType:output_type -> blueapi.cover.v1.UpdateUnitTypeResponse
	295, // 492: blueapi.cover.v1.Cover.DeleteUnitType:output_type -> blueapi.cover.v1.DeleteUnitTypeResponse
	297, // 493: blueapi.cover.v1.Cover.MergeUnits:output_type -> blueapi.cover.v1.MergeUnitsResponse
	299, // 494: blueapi.cover.v1.Cover.ListSuggestedUnits:output_type -> blueapi.cover.v1.ListSuggestedUnitsResponse
	301, // 495: blueapi.cover.v1.Cover.MergeSuggestedUnits:output_type -> blueapi.cover.v1.MergeSuggestedUnitsResponse
	303, // 496: blueapi.cover.v1.Cover.CreateUnitFromSuggested:output_type -> blueapi.cover.v1.CreateUnitFromSuggestedResponse
	305, // 497: blueapi.cover.v1.Cover.ListSharedResources:output_type -> blueapi.cover.v1.ListSharedResourcesResponse
	307, // 498: blueapi.cover.v1.Cover.CreateSharedResource:output_type -> blueapi.cover.v1.CreateSharedResourcesResponse
	309, // 499: blueapi.cover.v1.Cover.GetSharedResource:output_type -> blueapi.cover.v1.GetSharedResourcesResponse
	311, // 500: blueapi.cover.v1.Cover.UpdateSharedResource:output_type -> blueapi.cover.v1.UpdateSharedResourcesResponse
	313, // 501: blueapi.cover.v1.Cover.DeleteSharedResource:output_type -> blueapi.cover.v1.DeleteSharedResourcesResponse
	315, // 502: blueapi.cover.v1.Cover.ListUnitMetrics:output_type -> blueapi.cover.v1.ListUnitMetricsResponse
	317, // 503: blueapi.cover.v1.Cover.CreateUnitMetric:output_type -> blueapi.cover.v1.CreateUnitMetricResponse
	319, // 504: blueapi.cover.v1.Cover.GetUnitMetric:output_type -> blueapi.cover.v1.GetUnitMetricResponse
	321, // 505: blueapi.cover.v1.Cover.UpdateUnitMetric:output_type -> blueapi.cover.v1.UpdateUnitMetricResponse
	323, // 506: blueapi.cover.v1.Cover.DeleteUnitMetric:output_type -> blueapi.cover.v1.DeleteUnitMetricResponse
	4,   // 507: blueapi.cover.v1.Cover.VerifyAPIAccess:output_type -> blueapi.cover.v1.VerifyAPIAccessResponse
	333, // [333:508] is the sub-list for method output_type
	158, // [158:333] is the sub-list for method input_type
...
func file_cover_v1_cover_proto_init() {
	...
	file_cover_v1_cover_proto_msgTypes[266].OneofWrappers = []any{
