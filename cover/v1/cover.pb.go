...
var file_cover_v1_cover_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xff, 0x01, 0x0a, 0x16, 0x47, 0x65,
	...
	0x6e, 0x63, 0x65, 0x73, 0x32, 0xf1, 0x40, 0x0a, 0x05, 0x43, 0x6f, 0x76, 0x65, 0x72, 0x12, 0x7c,
	...
	0x7d, 0x12, 0x89, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x45, 0x43, 0x32, 0x49, 0x6e, 0x73, 0x74,
	...
	0x61, 0x6e, 0x63, 0x65, 0x73, 0x3a, 0x72, 0x65, 0x61, 0x64, 0x3a, 0x01, 0x2a, 0x1a, 0x98, 0x01,
...
var file_cover_v1_cover_proto_msgTypes = make([]protoimpl.MessageInfo, 115)
var file_cover_v1_cover_proto_goTypes = []interface{}{
	...
	(*GetEC2InstancesRequest)(nil),               // 111: blueapi.cover.v1.GetEC2InstancesRequest
	(*GetEC2InstancesResponse)(nil),              // 112: blueapi.cover.v1.GetEC2InstancesResponse
	nil,                                          // 113: blueapi.cover.v1.ReadCostsRequestAwsOptionsFilters.AndFiltersEntry
	nil,                                          // 114: blueapi.cover.v1.GetEC2InstancesRequest.FiltersEntry
	(*cover.UserData)(nil),                       // 115: blueapi.api.cover.UserData
	(*cover.MemberCostGroup)(nil),                // 116: blueapi.api.cover.MemberCostGroup
	(*cover.ViewData)(nil),                       // 117: blueapi.api.cover.ViewData
	(*cover.ViewList)(nil),                       // 118: blueapi.api.cover.ViewList
	(*cover.Favorites)(nil),                      // 119: blueapi.api.cover.Favorites
	(*cover.WidgetData)(nil),                     // 120: blueapi.api.cover.WidgetData
	(*cover.ViewLayout)(nil),                     // 121: blueapi.api.cover.ViewLayout
	(*cover.LayoutOptions)(nil),                  // 122: blueapi.api.cover.LayoutOptions
	(*cover.LayoutRequests)(nil),                 // 123: blueapi.api.cover.LayoutRequests
	(*cover.SideMenuState)(nil),                  // 124: blueapi.api.cover.SideMenuState
	(*cover.Combinations)(nil),                   // 125: blueapi.api.cover.Combinations
	(*cover.CostGroupData)(nil),                  // 126: blueapi.api.cover.CostGroupData
	(*cover.RegistrationStatus)(nil),             // 127: blueapi.api.cover.RegistrationStatus
	(*cover.Asset)(nil),                          // 128: blueapi.api.cover.Asset
	(*cover.Account)(nil),                        // 129: blueapi.api.cover.Account
	(*aws.Cost)(nil),                             // 130: blueapi.api.aws.Cost
	(*gcp.Cost)(nil),                             // 131: blueapi.api.gcp.Cost
	(*azure.Cost)(nil),                           // 132: blueapi.api.azure.Cost
	(*cover.AccountData)(nil),                    // 133: blueapi.api.cover.AccountData
	(*cover.EC2Instance)(nil),                    // 134: blueapi.api.cover.EC2Instance
	(*api.Operation)(nil),                        // 135: blueapi.api.Operation
	(*emptypb.Empty)(nil),                        // 136: google.protobuf.Empty
}
var file_cover_v1_cover_proto_depIdxs = []int32{
	115, // 0: blueapi.cover.v1.CreateMemberResponse.userData:type_name -> blueapi.api.cover.UserData
	115, // 1: blueapi.cover.v1.GetMembersResponse.userData:type_name -> blueapi.api.cover.UserData
	115, // 2: blueapi.cover.v1.GetMemberDetailsResponse.userData:type_name -> blueapi.api.cover.UserData
	116, // 3: blueapi.cover.v1.GetMemberCostGroupResponse.costGroups:type_name -> blueapi.api.cover.MemberCostGroup
	115, // 4: blueapi.cover.v1.GetUserDetailsResponse.userData:type_name -> blueapi.api.cover.UserData
	117, // 5: blueapi.cover.v1.CreateViewResponse.viewData:type_name -> blueapi.api.cover.ViewData
	118, // 6: blueapi.cover.v1.GetViewsResponse.viewList:type_name -> blueapi.api.cover.ViewList
	117, // 7: blueapi.cover.v1.GetCurrentViewResponse.viewData:type_name -> blueapi.api.cover.ViewData
	119, // 8: blueapi.cover.v1.GetFavoriteViewsResponse.favorites:type_name -> blueapi.api.cover.Favorites
	120, // 9: blueapi.cover.v1.UpdateViewLayoutRequest.layout:type_name -> blueapi.api.cover.WidgetData
	121, // 10: blueapi.cover.v1.UpdateViewLayoutResponse.layout:type_name -> blueapi.api.cover.ViewLayout
	122, // 11: blueapi.cover.v1.UpdateViewWidgetRequest.options:type_name -> blueapi.api.cover.LayoutOptions
	123, // 12: blueapi.cover.v1.UpdateViewWidgetRequest.requests:type_name -> blueapi.api.cover.LayoutRequests
	120, // 13: blueapi.cover.v1.UpdateViewWidgetResponse.widgetData:type_name -> blueapi.api.cover.WidgetData
	124, // 14: blueapi.cover.v1.UpdateSideMenuStateRequest.sidemenustate:type_name -> blueapi.api.cover.SideMenuState
	125, // 15: blueapi.cover.v1.CreateCostGroupRequest.combinations:type_name -> blueapi.api.cover.Combinations
	126, // 16: blueapi.cover.v1.CreateCostGroupResponse.costGroupData:type_name -> blueapi.api.cover.CostGroupData
	126, // 17: blueapi.cover.v1.GetCostGroupsResponse.costGroupData:type_name -> blueapi.api.cover.CostGroupData
	126, // 18: blueapi.cover.v1.GetCostGroupDetailsResponse.costGroupData:type_name -> blueapi.api.cover.CostGroupData
	125, // 19: blueapi.cover.v1.UpdateCostGroupCombinationsRequest.combinations:type_name -> blueapi.api.cover.Combinations
	125, // 20: blueapi.cover.v1.UpdateCostGroupCombinationsResponse.combinations:type_name -> blueapi.api.cover.Combinations
	127, // 21: blueapi.cover.v1.AccountAccess.registrationStatus:type_name -> blueapi.api.cover.RegistrationStatus
	101, // 22: blueapi.cover.v1.ListAssetsRequest.awsOptions:type_name -> blueapi.cover.v1.ListAssetsAwsFilterOptions
	128, // 23: blueapi.cover.v1.Asset.asset:type_name -> blueapi.api.cover.Asset
	129, // 24: blueapi.cover.v1.ResolveCostGroupCombinationsResponse.accounts:type_name -> blueapi.api.cover.Account
	...
	113, // 27: blueapi.cover.v1.ReadCostsRequestAwsOptionsFilters.andFilters:type_name -> blueapi.cover.v1.ReadCostsRequestAwsOptionsFilters.AndFiltersEntry
	130, // 28: blueapi.cover.v1.CostItem.aws:type_name -> blueapi.api.aws.Cost
	131, // 29: blueapi.cover.v1.CostItem.gcp:type_name -> blueapi.api.gcp.Cost
	132, // 30: blueapi.cover.v1.CostItem.azure:type_name -> blueapi.api.azure.Cost
	133, // 31: blueapi.cover.v1.GetRightSizingRecommendationResponse.account:type_name -> blueapi.api.cover.AccountData
	114, // 32: blueapi.cover.v1.GetEC2InstancesRequest.filters:type_name -> blueapi.cover.v1.GetEC2InstancesRequest.FiltersEntry
	134, // 33: blueapi.cover.v1.GetEC2InstancesResponse.instances:type_name -> blueapi.api.cover.EC2Instance
	...
	111, // 90: blueapi.cover.v1.Cover.GetEC2Instances:input_type -> blueapi.cover.v1.GetEC2InstancesRequest
	1,   // 91: blueapi.cover.v1.Cover.InviteMember:output_type -> blueapi.cover.v1.InviteMemberResponse
	3,   // 92: blueapi.cover.v1.Cover.CreateMember:output_type -> blueapi.cover.v1.CreateMemberResponse
	5,   // 93: blueapi.cover.v1.Cover.GetMembers:output_type -> blueapi.cover.v1.GetMembersResponse
	7,   // 94: blueapi.cover.v1.Cover.GetMemberDetails:output_type -> blueapi.cover.v1.GetMemberDetailsResponse
	9,   // 95: blueapi.cover.v1.Cover.GetMemberCostGroup:output_type -> blueapi.cover.v1.GetMemberCostGroupResponse
	11,  // 96: blueapi.cover.v1.Cover.GetUserDetails:output_type -> blueapi.cover.v1.GetUserDetailsResponse
	13,  // 97: blueapi.cover.v1.Cover.UpdateUserAvatar:output_type -> blueapi.cover.v1.UpdateUserAvatarResponse
	15,  // 98: blueapi.cover.v1.Cover.UpdateUserIcon:output_type -> blueapi.cover.v1.UpdateUserIconResponse
	17,  // 99: blueapi.cover.v1.Cover.UpdateUserColorTheme:output_type -> blueapi.cover.v1.UpdateUserColorThemeResponse
	19,  // 100: blueapi.cover.v1.Cover.UpdateUserName:output_type -> blueapi.cover.v1.UpdateUserNameResponse
	21,  // 101: blueapi.cover.v1.Cover.UpdateUserEmail:output_type -> blueapi.cover.v1.UpdateUserEmailResponse
	23,  // 102: blueapi.cover.v1.Cover.UpdateUserMainView:output_type -> blueapi.cover.v1.UpdateUserMainViewResponse
	25,  // 103: blueapi.cover.v1.Cover.ResetUserPassword:output_type -> blueapi.cover.v1.ResetUserPasswordResponse
	27,  // 104: blueapi.cover.v1.Cover.UpdateUserLocale:output_type -> blueapi.cover.v1.UpdateUserLocaleResponse
	29,  // 105: blueapi.cover.v1.Cover.UpdateUserAppTheme:output_type -> blueapi.cover.v1.UpdateUserAppThemeResponse
	31,  // 106: blueapi.cover.v1.Cover.UpdateUserTimezone:output_type -> blueapi.cover.v1.UpdateUserTimezoneResponse
	33,  // 107: blueapi.cover.v1.Cover.UpdateUserAttributes:output_type -> blueapi.cover.v1.UpdateUserAttributesResponse
	35,  // 108: blueapi.cover.v1.Cover.DeleteMember:output_type -> blueapi.cover.v1.DeleteMemberResponse
	37,  // 109: blueapi.cover.v1.Cover.ResetPassword:output_type -> blueapi.cover.v1.ResetPasswordResponse
	39,  // 110: blueapi.cover.v1.Cover.CreateView:output_type -> blueapi.cover.v1.CreateViewResponse
	41,  // 111: blueapi.cover.v1.Cover.GetViews:output_type -> blueapi.cover.v1.GetViewsResponse
	43,  // 112: blueapi.cover.v1.Cover.GetCurrentView:output_type -> blueapi.cover.v1.GetCurrentViewResponse
	45,  // 113: blueapi.cover.v1.Cover.GetFavoriteViews:output_type -> blueapi.cover.v1.GetFavoriteViewsResponse
	47,  // 114: blueapi.cover.v1.Cover.PublishView:output_type -> blueapi.cover.v1.PublishViewResponse
	49,  // 115: blueapi.cover.v1.Cover.AddFavorite:output_type -> blueapi.cover.v1.AddFavoriteResponse
	51,  // 116: blueapi.cover.v1.Cover.RemoveFavorite:output_type -> blueapi.cover.v1.RemoveFavoriteResponse
	53,  // 117: blueapi.cover.v1.Cover.UpdateView:output_type -> blueapi.cover.v1.UpdateViewResponse
	55,  // 118: blueapi.cover.v1.Cover.UpdateViewLayout:output_type -> blueapi.cover.v1.UpdateViewLayoutResponse
	57,  // 119: blueapi.cover.v1.Cover.UpdateViewWidget:output_type -> blueapi.cover.v1.UpdateViewWidgetResponse
	59,  // 120: blueapi.cover.v1.Cover.DeleteView:output_type -> blueapi.cover.v1.DeleteViewResponse
	61,  // 121: blueapi.cover.v1.Cover.UpdateSideMenuState:output_type -> blueapi.cover.v1.UpdateSideMenuStateResponse
	63,  // 122: blueapi.cover.v1.Cover.AddSideMenuFavorite:output_type -> blueapi.cover.v1.AddSideMenuFavoriteResponse
	65,  // 123: blueapi.cover.v1.Cover.RemoveSideMenuFavorite:output_type -> blueapi.cover.v1.RemoveSideMenuFavoriteResponse
	67,  // 124: blueapi.cover.v1.Cover.CreateCostGroup:output_type -> blueapi.cover.v1.CreateCostGroupResponse
	69,  // 125: blueapi.cover.v1.Cover.GetCostGroups:output_type -> blueapi.cover.v1.GetCostGroupsResponse
	71,  // 126: blueapi.cover.v1.Cover.GetCostGroupDetails:output_type -> blueapi.cover.v1.GetCostGroupDetailsResponse
	73,  // 127: blueapi.cover.v1.Cover.UpdateCostGroupName:output_type -> blueapi.cover.v1.UpdateCostGroupNameResponse
	75,  // 128: blueapi.cover.v1.Cover.UpdateCostGroupDescription:output_type -> blueapi.cover.v1.UpdateCostGroupDescriptionResponse
	77,  // 129: blueapi.cover.v1.Cover.UpdateCostGroupImage:output_type -> blueapi.cover.v1.UpdateCostGroupImageResponse
	79,  // 130: blueapi.cover.v1.Cover.UpdateCostGroupIcon:output_type -> blueapi.cover.v1.UpdateCostGroupIconResponse
	81,  // 131: blueapi.cover.v1.Cover.UpdateCostGroupColorTheme:output_type -> blueapi.cover.v1.UpdateCostGroupColorThemeResponse
	83,  // 132: blueapi.cover.v1.Cover.UpdateCostGroupCombinations:output_type -> blueapi.cover.v1.UpdateCostGroupCombinationsResponse
	104, // 133: blueapi.cover.v1.Cover.ResolveCostGroupCombinations:output_type -> blueapi.cover.v1.ResolveCostGroupCombinationsResponse
	85,  // 134: blueapi.cover.v1.Cover.AssignCostGroupMember:output_type -> blueapi.cover.v1.AssignCostGroupMemberResponse
	87,  // 135: blueapi.cover.v1.Cover.RemoveCostGroupMember:output_type -> blueapi.cover.v1.RemoveCostGroupMemberResponse
	89,  // 136: blueapi.cover.v1.Cover.DeleteCostGroup:output_type -> blueapi.cover.v1.DeleteCostGroupResponse
	91,  // 137: blueapi.cover.v1.Cover.GetAccountAccessTemplateUrl:output_type -> blueapi.cover.v1.GetAccountAccessTemplateUrlResponse
	94,  // 138: blueapi.cover.v1.Cover.ListAccountAccess:output_type -> blueapi.cover.v1.AccountAccess
	94,  // 139: blueapi.cover.v1.Cover.GetAccountAccess:output_type -> blueapi.cover.v1.AccountAccess
	94,  // 140: blueapi.cover.v1.Cover.CreateAccountAccess:output_type -> blueapi.cover.v1.AccountAccess
	135, // 141: blueapi.cover.v1.Cover.UpdateAccountAccess:output_type -> blueapi.api.Operation
	98,  // 142: blueapi.cover.v1.Cover.DeleteAccountAccess:output_type -> blueapi.cover.v1.DeleteAccountAccessResponse
	136, // 143: blueapi.cover.v1.Cover.RegisterAccount:output_type -> google.protobuf.Empty
	102, // 144: blueapi.cover.v1.Cover.ListAssets:output_type -> blueapi.cover.v1.Asset
	108, // 145: blueapi.cover.v1.Cover.GetCostUsage:output_type -> blueapi.cover.v1.CostItem
	110, // 146: blueapi.cover.v1.Cover.GetRightSizingRecommendation:output_type -> blueapi.cover.v1.GetRightSizingRecommendationResponse
	112, // 147: blueapi.cover.v1.Cover.GetEC2Instances:output_type -> blueapi.cover.v1.GetEC2InstancesResponse
