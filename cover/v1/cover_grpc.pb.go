...
func (c *coverClient) GetContainerCostUsage(ctx context.Context, in *ContainerCostUsageRequest, opts ...grpc.CallOption) (*ContainerCostUsageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ContainerCostUsageResponse)
	err := c.cc.Invoke(ctx, Cover_GetContainerCostUsage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coverClient) ListNonperformingRate(ctx context.Context, in *ListNonperformingRateRequest, opts ...grpc.CallOption) (*ListNonperformingRateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListNonperformingRateResponse)
	err := c.cc.Invoke(ctx, Cover_ListNonperformingRate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coverClient) ExecuteRecommendationV3(ctx context.Context, in *ExecuteRecommendationV3Request, opts ...grpc.CallOption) (*ExecuteRecommendationV3Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExecuteRecommendationV3Response)
	err := c.cc.Invoke(ctx, Cover_ExecuteRecommendationV3_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Cover_GetContainerCostUsage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ContainerCostUsageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoverServer).GetContainerCostUsage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cover_GetContainerCostUsage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoverServer).GetContainerCostUsage(ctx, req.(*ContainerCostUsageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Cover_ListNonperformingRate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListNonperformingRateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoverServer).ListNonperformingRate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cover_ListNonperformingRate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoverServer).ListNonperformingRate(ctx, req.(*ListNonperformingRateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Cover_ExecuteRecommendationV3_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExecuteRecommendationV3Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoverServer).ExecuteRecommendationV3(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cover_ExecuteRecommendationV3_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoverServer).ExecuteRecommendationV3(ctx, req.(*ExecuteRecommendationV3Request))
	}
	return interceptor(ctx, in, info, handler)
}
