...
var file_iam_v1_iam_proto_rawDesc = []byte{
	...
	0x52, 0x02, 0x69, 0x64, 0x32, 0xf4, 0x09, 0x0a, 0x03, 0x49, 0x61, 0x6d, 0x12, 0x52, 0x0a, 0x06,
	...
	0x69, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12, 0x6c, 0x0a,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x62, 0x6c, 0x75, 0x65, 0x61, 0x70, 0x69, 0x2e, 0x69,
	0x61, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x70, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0x19,
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x13, 0x12, 0x11, 0x2f, 0x69, 0x61, 0x6d, 0x2f, 0x76, 0x31, 0x2f,
	0x69, 0x70, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x30, 0x01, 0x12, 0x6f, 0x0a, 0x0e, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x70, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x25, 0x2e,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x62, 0x6c, 0x75, 0x65, 0x61, 0x70, 0x69, 0x2e, 0x69,
	0x61, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x70, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0x1c,
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x16, 0x22, 0x11, 0x2f, 0x69, 0x61, 0x6d, 0x2f, 0x76, 0x31, 0x2f,
	0x69, 0x70, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x6f, 0x0a, 0x0e,
	0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x49, 0x70, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x25,
	0x2e, 0x62, 0x6c, 0x75, 0x65, 0x61, 0x70, 0x69, 0x2e, 0x69, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x2e,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x18, 0x2a, 0x16, 0x2f, 0x69, 0x61, 0x6d, 0x2f, 0x76, 0x31, 0x2f, 0x69,
	0x70, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x1a, 0x7c, 0x92,
	0x41, 0x79, 0x12, 0x2a, 0x42, 0x61, 0x73, 0x65, 0x20, 0x55, 0x52, 0x4c, 0x3a, 0x20, 0x68, 0x74,
...
var file_iam_v1_iam_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_iam_v1_iam_proto_goTypes = []interface{}{
	...
	(*ListIpFiltersRequest)(nil),   // 9: blueapi.iam.v1.ListIpFiltersRequest
	(*CreateIpFilterRequest)(nil),  // 10: blueapi.iam.v1.CreateIpFilterRequest
	(*DeleteIpFilterRequest)(nil),  // 11: blueapi.iam.v1.DeleteIpFilterRequest
	(*api.User)(nil),               // 12: blueapi.api.User
	(*emptypb.Empty)(nil),          // 13: google.protobuf.Empty
	(*api.ApiClient)(nil),          // 14: blueapi.api.ApiClient
}
var file_iam_v1_iam_proto_depIdxs = []int32{
	0,  // 0: blueapi.iam.v1.Iam.WhoAmI:input_type -> blueapi.iam.v1.WhoAmIRequest
	1,  // 1: blueapi.iam.v1.Iam.ListUsers:input_type -> blueapi.iam.v1.ListUsersRequest
	2,  // 2: blueapi.iam.v1.Iam.GetUser:input_type -> blueapi.iam.v1.GetUserRequest
	3,  // 3: blueapi.iam.v1.Iam.CreateUser:input_type -> blueapi.iam.v1.CreateUserRequest
	4,  // 4: blueapi.iam.v1.Iam.DeleteUser:input_type -> blueapi.iam.v1.DeleteUserRequest
	5,  // 5: blueapi.iam.v1.Iam.ListApiClients:input_type -> blueapi.iam.v1.ListApiClientsRequest
	6,  // 6: blueapi.iam.v1.Iam.CreateApiClient:input_type -> blueapi.iam.v1.CreateApiClientRequest
	7,  // 7: blueapi.iam.v1.Iam.DeleteApiClient:input_type -> blueapi.iam.v1.DeleteApiClientRequest
	9,  // 8: blueapi.iam.v1.Iam.ListIpFilters:input_type -> blueapi.iam.v1.ListIpFiltersRequest
	10, // 9: blueapi.iam.v1.Iam.CreateIpFilter:input_type -> blueapi.iam.v1.CreateIpFilterRequest
	11, // 10: blueapi.iam.v1.Iam.DeleteIpFilter:input_type -> blueapi.iam.v1.DeleteIpFilterRequest
	12, // 11: blueapi.iam.v1.Iam.WhoAmI:output_type -> blueapi.api.User
	12, // 12: blueapi.iam.v1.Iam.ListUsers:output_type -> blueapi.api.User
	12, // 13: blueapi.iam.v1.Iam.GetUser:output_type -> blueapi.api.User
	12, // 14: blueapi.iam.v1.Iam.CreateUser:output_type -> blueapi.api.User
	13, // 15: blueapi.iam.v1.Iam.DeleteUser:output_type -> google.protobuf.Empty
	14, // 16: blueapi.iam.v1.Iam.ListApiClients:output_type -> blueapi.api.ApiClient
	14, // 17: blueapi.iam.v1.Iam.CreateApiClient:output_type -> blueapi.api.ApiClient
	13, // 18: blueapi.iam.v1.Iam.DeleteApiClient:output_type -> google.protobuf.Empty
	8,  // 19: blueapi.iam.v1.Iam.ListIpFilters:output_type -> blueapi.iam.v1.IpFilter
	8,  // 20: blueapi.iam.v1.Iam.CreateIpFilter:output_type -> blueapi.iam.v1.IpFilter
	13, // 21: blueapi.iam.v1.Iam.DeleteIpFilter:output_type -> google.protobuf.Empty
