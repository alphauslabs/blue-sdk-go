...
var file_flow_v1_flow_proto_rawDesc = string([]byte{
	...
	0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x2d, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x49,
	...
	0x0a, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x32, 0xd7, 0x07, 0x0a, 0x04,
	...
	0x69, 0x64, 0x7d, 0x12, 0xb7, 0x01, 0x0a, 0x20, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x73, 0x74, 0x45,
	...
	0x74, 0x65, 0x55, 0x72, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x1e, 0x82,
	0xd3, 0xe4, 0x93, 0x02, 0x18, 0x12, 0x16, 0x2f, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x76, 0x31, 0x2f,
	0x61, 0x77, 0x73, 0x2f, 0x78, 0x61, 0x63, 0x63, 0x74, 0x2f, 0x63, 0x65, 0x61, 0x1a, 0x95, 0x01,
...
var file_flow_v1_flow_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_flow_v1_flow_proto_goTypes = []any{
	...
	(*GetInfoResponse)(nil),                          // 6: blueapi.flow.v1.GetInfoResponse
	(*CreateSettingsResponse)(nil),                   // 7: blueapi.flow.v1.CreateSettingsResponse
	(*UpdateSettingsResponse)(nil),                   // 8: blueapi.flow.v1.UpdateSettingsResponse
	(*GetSettingsResponse)(nil),                      // 9: blueapi.flow.v1.GetSettingsResponse
	(*GetRecommendationDetailsResponse)(nil),         // 10: blueapi.flow.v1.GetRecommendationDetailsResponse
	(*GetCostExplorerAccessTemplateUrlResponse)(nil), // 11: blueapi.flow.v1.GetCostExplorerAccessTemplateUrlResponse
}
var file_flow_v1_flow_proto_depIdxs = []int32{
	...
	4,  // 4: blueapi.flow.v1.Flow.GetRecommendationDetails:input_type -> blueapi.flow.v1.GetRecommendationDetailsRequest
	5,  // 5: blueapi.flow.v1.Flow.GetCostExplorerAccessTemplateUrl:input_type -> blueapi.flow.v1.GetCostExplorerAccessTemplateUrlRequest
	6,  // 6: blueapi.flow.v1.Flow.GetInfo:output_type -> blueapi.flow.v1.GetInfoResponse
	7,  // 7: blueapi.flow.v1.Flow.CreateSettings:output_type -> blueapi.flow.v1.CreateSettingsResponse
	8,  // 8: blueapi.flow.v1.Flow.UpdateSettings:output_type -> blueapi.flow.v1.UpdateSettingsResponse
	9,  // 9: blueapi.flow.v1.Flow.GetSettings:output_type -> blueapi.flow.v1.GetSettingsResponse
	10, // 10: blueapi.flow.v1.Flow.GetRecommendationDetails:output_type -> blueapi.flow.v1.GetRecommendationDetailsResponse
	11, // 11: blueapi.flow.v1.Flow.GetCostExplorerAccessTemplateUrl:output_type -> blueapi.flow.v1.GetCostExplorerAccessTemplateUrlResponse
