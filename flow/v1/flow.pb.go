...
const file_flow_v1_flow_proto_rawDesc = "" +
	"\n" +
	"\x12flow/v1/flow.proto\x12\x0fblueapi.flow.v1\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x10\n" +
	"\x0eGetInfoRequest\"\xc3\x02\n" +
	"\x15CreateSettingsRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\"\n" +
	"\faccountScope\x18\x02 \x01(\tR\faccountScope\x12$\n" +
	"\rcustomization\x18\x03 \x01(\tR\rcustomization\x12\x1a\n" +
	"\bplanTerm\x18\x04 \x01(\tR\bplanTerm\x12$\n" +
	"\rpaymentOption\x18\x05 \x01(\tR\rpaymentOption\x12&\n" +
	"\x0elookBackPeriod\x18\x06 \x01(\tR\x0elookBackPeriod\x12&\n" +
	"\x0einstanceFamily\x18\a \x01(\tR\x0einstanceFamily\x12\"\n" +
	"\fannualBudget\x18\b \x01(\x01R\fannualBudget\x12\x1a\n" +
	"\bapproval\x18\t \x01(\bR\bapproval\"-\n" +
	"\x0fGetInfoResponse\x12\x1a\n" +
	"\bresponse\x18\x01 \x01(\tR\bresponse\"4\n" +
	"\x16CreateSettingsResponse\x12\x1a\n" +
	"\bresponse\x18\x01 \x01(\tR\bresponse2\xfa\x02\n" +
	"\x04Flow\x12^\n" +
	"\aGetInfo\x12\x1f.blueapi.flow.v1.GetInfoRequest\x1a .blueapi.flow.v1.GetInfoResponse\"\x10\x82\xd3\xe4\x93\x02\n" +
	"\x12\b/v1/info\x12z\n" +
	"\x0eCreateSettings\x12&.blueapi.flow.v1.CreateSettingsRequest\x1a'.blueapi.flow.v1.CreateSettingsResponse\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/v1/settings\x1a\x95\x01\x92A\x91\x01\x12A(ALPHA) Flow API. Base URL: https://api.alphaus.cloud/m/blue/flow\x1aL\n" +
	"\x12Service definition\x126https://github.com/alphauslabs/blueapi/tree/main/flow/BH\n" +
	"\x16cloud.alphaus.api.flowB\tFlowProtoZ#github.com/alphauslabs/blueapi/flowb\x06proto3"
