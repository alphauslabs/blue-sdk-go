...
type GetDailyUsageCostDetailsResponse struct {
	...
	SpDetails *SpDetails `protobuf:"bytes,2,opt,name=spDetails,proto3" json:"spDetails,omitempty"`
	// Monthly aggregated cost summary for the Savings Plan.
	MonthlyCosts *MonthlyCosts `protobuf:"bytes,3,opt,name=monthlyCosts,proto3" json:"monthlyCosts,omitempty"`
...
// Response message for the Flow.GetDailyUsageCostDetails rpc.
type GetDailyUsageCostDetailsResponses struct {
	state         protoimpl.MessageState              `protogen:"open.v1"`
	Responses     []*GetDailyUsageCostDetailsResponse `protobuf:"bytes,1,rep,name=responses,proto3" json:"responses,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetDailyUsageCostDetailsResponses) Reset() {
	*x = GetDailyUsageCostDetailsResponses{}
	mi := &file_flow_v1_flow_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetDailyUsageCostDetailsResponses) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDailyUsageCostDetailsResponses) ProtoMessage() {}

func (x *GetDailyUsageCostDetailsResponses) ProtoReflect() protoreflect.Message {
	mi := &file_flow_v1_flow_proto_msgTypes[24]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetDailyUsageCostDetailsResponses.ProtoReflect.Descriptor instead.
func (*GetDailyUsageCostDetailsResponses) Descriptor() ([]byte, []int) {
	return file_flow_v1_flow_proto_rawDescGZIP(), []int{24}
}

func (x *GetDailyUsageCostDetailsResponses) GetResponses() []*GetDailyUsageCostDetailsResponse {
	if x != nil {
		return x.Responses
	}
	return nil
...
var file_flow_v1_flow_proto_rawDesc = string([]byte{
	...
	0x61, 0x79, 0x65, 0x72, 0x49, 0x64, 0x12, 0x38, 0x0a, 0x09, 0x73, 0x70, 0x44, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x62, 0x6c, 0x75, 0x65,
	0x61, 0x70, 0x69, 0x2e, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x70, 0x44, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x52, 0x09, 0x73, 0x70, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73,
	...
	0x73, 0x74, 0x73, 0x12, 0x4d, 0x0a, 0x10, 0x75, 0x73, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x73, 0x74,
	...
	0x6c, 0x73, 0x22, 0x74, 0x0a, 0x21, 0x47, 0x65, 0x74, 0x44, 0x61, 0x69, 0x6c, 0x79, 0x55, 0x73,
	0x61, 0x67, 0x65, 0x43, 0x6f, 0x73, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x73, 0x12, 0x4f, 0x0a, 0x09, 0x72, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x62, 0x6c, 0x75,
	...
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x09, 0x72,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x73, 0x22, 0x45, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x41,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xff, 0x0e, 0x0a,
	...
	,
	...
	0x77, 0x73, 0x2f, 0x78, 0x61, 0x63, 0x63, 0x74, 0x2f, 0x73, 0x70, 0x61, 0x12, 0x97, 0x01, 0x0a,
	0x16, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x50, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73,
	0x65, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x2e, 0x2e, 0x62, 0x6c, 0x75, 0x65, 0x61, 0x70,
	0x69, 0x2e, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x63, 0x74, 0x2f, 0x73, 0x70, 0x61, 0x1a, 0x95, 0x01, 0x92, 0x41, 0x91, 0x01, 0x12, 0x41, 0x28,
...
var file_flow_v1_flow_proto_goTypes = []any{
	...
	(*GetDailyUsageCostDetailsResponses)(nil),        // 24: blueapi.flow.v1.GetDailyUsageCostDetailsResponses
...
var file_flow_v1_flow_proto_depIdxs = []int32{
	...
	21, // 1: blueapi.flow.v1.GetDailyUsageCostDetailsResponse.spDetails:type_name -> blueapi.flow.v1.SpDetails
	...
	23, // 4: blueapi.flow.v1.GetDailyUsageCostDetailsResponses.responses:type_name -> blueapi.flow.v1.GetDailyUsageCostDetailsResponse
	...
	23, // 26: blueapi.flow.v1.Flow.GetDailyUsageCostDetails:output_type -> blueapi.flow.v1.GetDailyUsageCostDetailsResponse
