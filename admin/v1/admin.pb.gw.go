...
var (
	...
	pattern_Admin_GetDefaultBillingInfoTemplateUrl_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"admin", "v1", "aws", "crossacctaccess", "cfn"}, ""))
)
