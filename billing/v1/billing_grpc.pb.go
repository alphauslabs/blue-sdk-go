...
const (
	...
	Billing_CreateCustomFee_FullMethodName                                     = "/blueapi.billing.v1.Billing/CreateCustomFee"
	Billing_ListAdjustmentEntryItems_FullMethodName                            = "/blueapi.billing.v1.Billing/ListAdjustmentEntryItems"
...
type BillingClient interface {
	...
	CreateCustomFee(ctx context.Context, in *CreateCustomFeeRequest, opts ...grpc.CallOption) (*CreateCustomFeeResponse, error)
	...
	ListAdjustmentEntryItems(ctx context.Context, in *ListAdjustmentEntryItemsRequest, opts ...grpc.CallOption) (Billing_ListAdjustmentEntryItemsClient, error)
	...
	DeleteChildBillingGroup(ctx context.Context, in *DeleteChildBillingGroupRequest, opts ...grpc.CallOption) (*DeleteChildBillingGroupResponse, error)
...
func (c *billingClient) CreateCustomFee(ctx context.Context, in *CreateCustomFeeRequest, opts ...grpc.CallOption) (*CreateCustomFeeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateCustomFeeResponse)
	err := c.cc.Invoke(ctx, Billing_CreateCustomFee_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *billingClient) ListAdjustmentEntryItems(ctx context.Context, in *ListAdjustmentEntryItemsRequest, opts ...grpc.CallOption) (Billing_ListAdjustmentEntryItemsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[15], Billing_ListAdjustmentEntryItems_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &billingListAdjustmentEntryItemsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Billing_ListAdjustmentEntryItemsClient interface {
	Recv() (*AdjustmentEntryItem, error)
	grpc.ClientStream
}

type billingListAdjustmentEntryItemsClient struct {
	grpc.ClientStream
}

func (x *billingListAdjustmentEntryItemsClient) Recv() (*AdjustmentEntryItem, error) {
	m := new(AdjustmentEntryItem)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *billingClient) ListAccountResources(ctx context.Context, in *ListAccountResourcesRequest, opts ...grpc.CallOption) (Billing_ListAccountResourcesClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[16], Billing_ListAccountResources_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) ReadUntaggedGroups(ctx context.Context, in *ReadUntaggedGroupsRequest, opts ...grpc.CallOption) (Billing_ReadUntaggedGroupsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[17], Billing_ReadUntaggedGroups_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) ReadCustomizedBillingServices(ctx context.Context, in *ReadCustomizedBillingServicesRequest, opts ...grpc.CallOption) (Billing_ReadCustomizedBillingServicesClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[18], Billing_ReadCustomizedBillingServices_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) GetCustomizedBillingServiceBillingGroup(ctx context.Context, in *GetCustomizedBillingServiceBillingGroupRequest, opts ...grpc.CallOption) (Billing_GetCustomizedBillingServiceBillingGroupClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[19], Billing_GetCustomizedBillingServiceBillingGroup_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) GetTags(ctx context.Context, in *GetTagsRequest, opts ...grpc.CallOption) (Billing_GetTagsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[20], Billing_GetTags_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) ListCustomField(ctx context.Context, in *ListCustomFieldRequest, opts ...grpc.CallOption) (Billing_ListCustomFieldClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[21], Billing_ListCustomField_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) ListBillingGroupCustomField(ctx context.Context, in *ListBillingGroupCustomFieldRequest, opts ...grpc.CallOption) (Billing_ListBillingGroupCustomFieldClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[22], Billing_ListBillingGroupCustomField_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) GetFreeFormat(ctx context.Context, in *GetFreeFormatRequest, opts ...grpc.CallOption) (Billing_GetFreeFormatClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[23], Billing_GetFreeFormat_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) BulkImportMonthlyMiscFees(ctx context.Context, in *BulkImportMonthlyMiscFeesRequest, opts ...grpc.CallOption) (*MonthlyMiscFeeImportResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *billingClient) GetAnnouncements(ctx context.Context, in *GetAnnouncementsRequest, opts ...grpc.CallOption) (Billing_GetAnnouncementsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[25], Billing_GetAnnouncements_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) GetBillingGroupAnnouncements(ctx context.Context, in *GetBillingGroupAnnouncementsRequest, opts ...grpc.CallOption) (Billing_GetBillingGroupAnnouncementsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[26], Billing_GetBillingGroupAnnouncements_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) GetCredits(ctx context.Context, in *GetCreditsRequest, opts ...grpc.CallOption) (Billing_GetCreditsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[27], Billing_GetCredits_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) GetCsvSettings(ctx context.Context, in *GetCsvSettingsRequest, opts ...grpc.CallOption) (Billing_GetCsvSettingsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[28], Billing_GetCsvSettings_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) GetChildBillingGroup(ctx context.Context, in *GetChildBillingGroupRequest, opts ...grpc.CallOption) (*GetChildBillingGroupResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetChildBillingGroupResponse)
	err := c.cc.Invoke(ctx, Billing_GetChildBillingGroup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *billingClient) ReadChildBillingGroups(ctx context.Context, in *ReadChildBillingGroupsRequest, opts ...grpc.CallOption) (Billing_ReadChildBillingGroupsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[29], Billing_ReadChildBillingGroups_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) DeleteChildBillingGroup(ctx context.Context, in *DeleteChildBillingGroupRequest, opts ...grpc.CallOption) (*DeleteChildBillingGroupResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteChildBillingGroupResponse)
	err := c.cc.Invoke(ctx, Billing_DeleteChildBillingGroup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *billingClient) UpdateChildBillingGroupInvoiceSettings(ctx context.Context, in *UpdateChildBillingGroupInvoiceSettingsRequest, opts ...grpc.CallOption) (*UpdateChildBillingGroupInvoiceSettingsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateChildBillingGroupInvoiceSettingsResponse)
	err := c.cc.Invoke(ctx, Billing_UpdateChildBillingGroupInvoiceSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *billingClient) SetChildBillingGroupInvoiceServiceDiscounts(ctx context.Context, in *SetChildBillingGroupInvoiceServiceDiscountsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Billing_SetChildBillingGroupInvoiceServiceDiscounts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *billingClient) SetChildBillingGroupAccountInvoiceServiceDiscounts(ctx context.Context, in *SetChildBillingGroupAccountInvoiceServiceDiscountsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Billing_SetChildBillingGroupAccountInvoiceServiceDiscounts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *billingClient) SetChildBillingGroupCustomizedBillingService(ctx context.Context, in *SetChildBillingGroupCustomizedBillingServiceRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Billing_SetChildBillingGroupCustomizedBillingService_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *billingClient) GetChildBillingGroupCustomizedBillingService(ctx context.Context, in *GetChildBillingGroupCustomizedBillingServiceRequest, opts ...grpc.CallOption) (Billing_GetChildBillingGroupCustomizedBillingServiceClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[30], Billing_GetChildBillingGroupCustomizedBillingService_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) ReadChildBillingGroupAccountInvoiceServiceDiscounts(ctx context.Context, in *ReadChildBillingGroupAccountInvoiceServiceDiscountsRequest, opts ...grpc.CallOption) (Billing_ReadChildBillingGroupAccountInvoiceServiceDiscountsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Billing_ServiceDesc.Streams[31], Billing_ReadChildBillingGroupAccountInvoiceServiceDiscounts_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *billingClient) DeleteBillingGroupInvoiceLayoutConfig(ctx context.Context, in *DeleteBillingGroupInvoiceLayoutConfigRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Billing_DeleteBillingGroupInvoiceLayoutConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *billingClient) DeleteInvoiceLayoutConfig(ctx context.Context, in *DeleteInvoiceLayoutConfigRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Billing_DeleteInvoiceLayoutConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BillingServer interface {
	...
	// Creates custom fee entries in the RIPPLE_FEES table.
	// Used to write Guaranteed Commitment entries and Custom Fee entries directly to the fee table. Only available in Ripple.
	CreateCustomFee(context.Context, *CreateCustomFeeRequest) (*CreateCustomFeeResponse, error)
	// Lists adjustment entry items from the fee table.
	// Reads fee entries from the RIPPLE_FEES table, optionally filtered by mobingi_type.
	// Note: Commitment entries (mobingi_type="COMMITMENT") are excluded from ReadAdjustmentEntries to avoid duplication with the Adjusting Entries UI. Only available in Ripple.
	ListAdjustmentEntryItems(*ListAdjustmentEntryItemsRequest, Billing_ListAdjustmentEntryItemsServer) error
	// WORK-IN-PROGRESS: Returns all registered accounts that are not associated to any billing groups and accounts found in CUR for the specified month. For Ripple only
	...
	// Deletes all child billing group info
	DeleteChildBillingGroup(context.Context, *DeleteChildBillingGroupRequest) (*DeleteChildBillingGroupResponse, error)
	// Updates child billing group's invoice settings
...
func (UnimplementedBillingServer) CreateCustomFee(context.Context, *CreateCustomFeeRequest) (*CreateCustomFeeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateCustomFee not implemented")
}
func (UnimplementedBillingServer) ListAdjustmentEntryItems(*ListAdjustmentEntryItemsRequest, Billing_ListAdjustmentEntryItemsServer) error {
	return status.Errorf(codes.Unimplemented, "method ListAdjustmentEntryItems not implemented")
}
...
func (UnimplementedBillingServer) BulkImportMonthlyMiscFees(context.Context, *BulkImportMonthlyMiscFeesRequest) (*MonthlyMiscFeeImportResult, error) {
...
func (UnimplementedBillingServer) DeleteChildBillingGroup(context.Context, *DeleteChildBillingGroupRequest) (*DeleteChildBillingGroupResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteChildBillingGroup not implemented")
}
func (UnimplementedBillingServer) UpdateChildBillingGroupInvoiceSettings(context.Context, *UpdateChildBillingGroupInvoiceSettingsRequest) (*UpdateChildBillingGroupInvoiceSettingsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateChildBillingGroupInvoiceSettings not implemented")
}
func (UnimplementedBillingServer) SetChildBillingGroupInvoiceServiceDiscounts(context.Context, *SetChildBillingGroupInvoiceServiceDiscountsRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetChildBillingGroupInvoiceServiceDiscounts not implemented")
}
func (UnimplementedBillingServer) SetChildBillingGroupAccountInvoiceServiceDiscounts(context.Context, *SetChildBillingGroupAccountInvoiceServiceDiscountsRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetChildBillingGroupAccountInvoiceServiceDiscounts not implemented")
}
...
func (UnimplementedBillingServer) DeleteBillingGroupInvoiceLayoutConfig(context.Context, *DeleteBillingGroupInvoiceLayoutConfigRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteBillingGroupInvoiceLayoutConfig not implemented")
}
...
func _Billing_CreateCustomFee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateCustomFeeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BillingServer).CreateCustomFee(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Billing_CreateCustomFee_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BillingServer).CreateCustomFee(ctx, req.(*CreateCustomFeeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Billing_ListAdjustmentEntryItems_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ListAdjustmentEntryItemsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BillingServer).ListAdjustmentEntryItems(m, &billingListAdjustmentEntryItemsServer{ServerStream: stream})
}

type Billing_ListAdjustmentEntryItemsServer interface {
	Send(*AdjustmentEntryItem) error
	grpc.ServerStream
}

type billingListAdjustmentEntryItemsServer struct {
	grpc.ServerStream
}

func (x *billingListAdjustmentEntryItemsServer) Send(m *AdjustmentEntryItem) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Billing_GetChildBillingGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetChildBillingGroupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BillingServer).GetChildBillingGroup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Billing_GetChildBillingGroup_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BillingServer).GetChildBillingGroup(ctx, req.(*GetChildBillingGroupRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Billing_DeleteChildBillingGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteChildBillingGroupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BillingServer).DeleteChildBillingGroup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Billing_DeleteChildBillingGroup_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BillingServer).DeleteChildBillingGroup(ctx, req.(*DeleteChildBillingGroupRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Billing_UpdateChildBillingGroupInvoiceSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateChildBillingGroupInvoiceSettingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BillingServer).UpdateChildBillingGroupInvoiceSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Billing_UpdateChildBillingGroupInvoiceSettings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BillingServer).UpdateChildBillingGroupInvoiceSettings(ctx, req.(*UpdateChildBillingGroupInvoiceSettingsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Billing_SetChildBillingGroupInvoiceServiceDiscounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetChildBillingGroupInvoiceServiceDiscountsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BillingServer).SetChildBillingGroupInvoiceServiceDiscounts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Billing_SetChildBillingGroupInvoiceServiceDiscounts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BillingServer).SetChildBillingGroupInvoiceServiceDiscounts(ctx, req.(*SetChildBillingGroupInvoiceServiceDiscountsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Billing_SetChildBillingGroupAccountInvoiceServiceDiscounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetChildBillingGroupAccountInvoiceServiceDiscountsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BillingServer).SetChildBillingGroupAccountInvoiceServiceDiscounts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Billing_SetChildBillingGroupAccountInvoiceServiceDiscounts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BillingServer).SetChildBillingGroupAccountInvoiceServiceDiscounts(ctx, req.(*SetChildBillingGroupAccountInvoiceServiceDiscountsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Billing_SetChildBillingGroupCustomizedBillingService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetChildBillingGroupCustomizedBillingServiceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BillingServer).SetChildBillingGroupCustomizedBillingService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Billing_SetChildBillingGroupCustomizedBillingService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BillingServer).SetChildBillingGroupCustomizedBillingService(ctx, req.(*SetChildBillingGroupCustomizedBillingServiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Billing_DeleteBillingGroupInvoiceLayoutConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteBillingGroupInvoiceLayoutConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BillingServer).DeleteBillingGroupInvoiceLayoutConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Billing_DeleteBillingGroupInvoiceLayoutConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BillingServer).DeleteBillingGroupInvoiceLayoutConfig(ctx, req.(*DeleteBillingGroupInvoiceLayoutConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Billing_DeleteInvoiceLayoutConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteInvoiceLayoutConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BillingServer).DeleteInvoiceLayoutConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Billing_DeleteInvoiceLayoutConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BillingServer).DeleteInvoiceLayoutConfig(ctx, req.(*DeleteInvoiceLayoutConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Billing_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateCustomFee",
			Handler:    _Billing_CreateCustomFee_Handler,
		},
		{
		...
		{
			MethodName: "GetChildBillingGroup",
		...
		{
			MethodName: "DeleteChildBillingGroup",
			Handler:    _Billing_DeleteChildBillingGroup_Handler,
		},
		{
		...
		{
			MethodName: "SetChildBillingGroupInvoiceServiceDiscounts",
			Handler:    _Billing_SetChildBillingGroupInvoiceServiceDiscounts_Handler,
		},
		{
			MethodName: "SetChildBillingGroupAccountInvoiceServiceDiscounts",
			Handler:    _Billing_SetChildBillingGroupAccountInvoiceServiceDiscounts_Handler,
		},
		{
			MethodName: "SetChildBillingGroupCustomizedBillingService",
		...
		{
			MethodName: "DeleteBillingGroupInvoiceLayoutConfig",
			Handler:    _Billing_DeleteBillingGroupInvoiceLayoutConfig_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ListAdjustmentEntryItems",
			Handler:       _Billing_ListAdjustmentEntryItems_Handler,
			ServerStreams: true,
		},
		{
