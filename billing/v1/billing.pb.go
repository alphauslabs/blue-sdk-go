...
var file_billing_v1_billing_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xf3, 0x3a, 0x0a, 0x07, 0x42, 0x69, 0x6c, 0x6c, 0x69,
...
var file_billing_v1_billing_proto_msgTypes = make([]protoimpl.MessageInfo, 76)
var file_billing_v1_billing_proto_goTypes = []any{
	...
	(*AwsDailyRunHistory_Account)(nil),                   // 74: blueapi.billing.v1.AwsDailyRunHistory.Account
	(*AwsDailyRunHistory_Account_History)(nil),           // 75: blueapi.billing.v1.AwsDailyRunHistory.Account.History
	(*ripple.BillingGroupInfo)(nil),                      // 76: blueapi.api.ripple.BillingGroupInfo
	(*api.Account)(nil),                                  // 77: blueapi.api.Account
	(*api.CostTag)(nil),                                  // 78: blueapi.api.CostTag
	(*api.AdditionalItems)(nil),                          // 79: blueapi.api.AdditionalItems
	(*fieldmaskpb.FieldMask)(nil),                        // 80: google.protobuf.FieldMask
	(*ripple.ResellerConfig)(nil),                        // 81: blueapi.api.ripple.ResellerConfig
	(*ripple.YearMonth)(nil),                             // 82: blueapi.api.ripple.YearMonth
	(*ripple.Rounding)(nil),                              // 83: blueapi.api.ripple.Rounding
	(*ripple.InvoiceLayout)(nil),                         // 84: blueapi.api.ripple.InvoiceLayout
	(*ripple.DueDate)(nil),                               // 85: blueapi.api.ripple.DueDate
	(*ripple.CommonExchangeRate)(nil),                    // 86: blueapi.api.ripple.CommonExchangeRate
	(*ripple.BillingGroupExchangeRate)(nil),              // 87: blueapi.api.ripple.BillingGroupExchangeRate
	(*ripple.VendorPayerExchangeRate)(nil),               // 88: blueapi.api.ripple.VendorPayerExchangeRate
	(*api.ConfigFilters)(nil),                            // 89: blueapi.api.ConfigFilters
	(*api.ManagementAccount)(nil),                        // 90: blueapi.api.ManagementAccount
	(*ripple.MethodConfig)(nil),                          // 91: blueapi.api.ripple.MethodConfig
	(*ripple.CustomizedBillingService)(nil),              // 92: blueapi.api.ripple.CustomizedBillingService
	(*v1.InvoiceServiceDiscountsSetting)(nil),            // 93: blueapi.api.ripple.v1.InvoiceServiceDiscountsSetting
	(*v1.InvoiceServiceDiscounts)(nil),                   // 94: blueapi.api.ripple.v1.InvoiceServiceDiscounts
	(*api.InvoiceMessage)(nil),                           // 95: blueapi.api.InvoiceMessage
	(*api.Invoice)(nil),                                  // 96: blueapi.api.Invoice
	(*emptypb.Empty)(nil),                                // 97: google.protobuf.Empty
	(*v1.Service)(nil),                                   // 98: blueapi.api.ripple.v1.Service
	(*ripple.Reseller)(nil),                              // 99: blueapi.api.ripple.Reseller
	(*ripple.AccessGroup)(nil),                           // 100: blueapi.api.ripple.AccessGroup
	(*wave.Adjustment)(nil),                              // 101: blueapi.api.wave.Adjustment
	(*api.AdjustmentConfig)(nil),                         // 102: blueapi.api.AdjustmentConfig
	(*ripple.UntaggedGroup)(nil),                         // 103: blueapi.api.ripple.UntaggedGroup
}
var file_billing_v1_billing_proto_depIdxs = []int32{
	76,  // 0: blueapi.billing.v1.BillingGroup.billingGroupInfo:type_name -> blueapi.api.ripple.BillingGroupInfo
	7,   // 1: blueapi.billing.v1.BillingGroup.accountOptions:type_name -> blueapi.billing.v1.AccountOptions
	77,  // 2: blueapi.billing.v1.BillingGroup.accounts:type_name -> blueapi.api.Account
	78,  // 3: blueapi.billing.v1.BillingGroup.tags:type_name -> blueapi.api.CostTag
	...
	79,  // 7: blueapi.billing.v1.BillingGroupAdditionalItems.aws:type_name -> blueapi.api.AdditionalItems
	79,  // 8: blueapi.billing.v1.BillingGroupAdditionalItems.azure:type_name -> blueapi.api.AdditionalItems
	79,  // 9: blueapi.billing.v1.BillingGroupAdditionalItems.gcp:type_name -> blueapi.api.AdditionalItems
	...
	80,  // 13: blueapi.billing.v1.ListBillingGroupsRequest.field_mask:type_name -> google.protobuf.FieldMask
	...
	80,  // 23: blueapi.billing.v1.GetBillingGroupRequest.field_mask:type_name -> google.protobuf.FieldMask
	...
	80,  // 26: blueapi.billing.v1.GetAccessGroupRequest.field_mask:type_name -> google.protobuf.FieldMask
	13,  // 27: blueapi.billing.v1.GetAccessGroupResponse.accessGroup:type_name -> blueapi.billing.v1.AccessGroup
	74,  // 28: blueapi.billing.v1.AwsDailyRunHistory.accounts:type_name -> blueapi.billing.v1.AwsDailyRunHistory.Account
	...
	81,  // 34: blueapi.billing.v1.CreateResellerRequest.waveConfig:type_name -> blueapi.api.ripple.ResellerConfig
	81,  // 35: blueapi.billing.v1.CreateResellerRequest.aquaConfig:type_name -> blueapi.api.ripple.ResellerConfig
	80,  // 36: blueapi.billing.v1.ListResellersRequest.field_mask:type_name -> google.protobuf.FieldMask
	80,  // 37: blueapi.billing.v1.GetResellerRequest.field_mask:type_name -> google.protobuf.FieldMask
	81,  // 38: blueapi.billing.v1.UpdateResellerRequest.waveConfig:type_name -> blueapi.api.ripple.ResellerConfig
	81,  // 39: blueapi.billing.v1.UpdateResellerRequest.aquaConfig:type_name -> blueapi.api.ripple.ResellerConfig
	80,  // 40: blueapi.billing.v1.UpdateResellerRequest.updateMask:type_name -> google.protobuf.FieldMask
	80,  // 41: blueapi.billing.v1.GetBillingSettingRequest.field_mask:type_name -> google.protobuf.FieldMask
	82,  // 42: blueapi.billing.v1.GetBillingSettingResponse.yearMonth:type_name -> blueapi.api.ripple.YearMonth
	83,  // 43: blueapi.billing.v1.GetBillingSettingResponse.roundingMethod:type_name -> blueapi.api.ripple.Rounding
	83,  // 44: blueapi.billing.v1.GetBillingSettingResponse.exportRoundingMethod:type_name -> blueapi.api.ripple.Rounding
	84,  // 45: blueapi.billing.v1.GetBillingSettingResponse.invoiceLayout:type_name -> blueapi.api.ripple.InvoiceLayout
	85,  // 46: blueapi.billing.v1.GetBillingSettingResponse.invoiceDueDate:type_name -> blueapi.api.ripple.DueDate
	86,  // 47: blueapi.billing.v1.ListExchangeRatesResponse.common:type_name -> blueapi.api.ripple.CommonExchangeRate
	87,  // 48: blueapi.billing.v1.ListExchangeRatesResponse.billingGroup:type_name -> blueapi.api.ripple.BillingGroupExchangeRate
	88,  // 49: blueapi.billing.v1.ListExchangeRatesResponse.payer:type_name -> blueapi.api.ripple.VendorPayerExchangeRate
	80,  // 50: blueapi.billing.v1.ListAccessGroupsRequest.field_mask:type_name -> google.protobuf.FieldMask
	89,  // 51: blueapi.billing.v1.CreateAdjustmentConfigRequest.config:type_name -> blueapi.api.ConfigFilters
	90,  // 52: blueapi.billing.v1.CreateAdjustmentConfigRequest.accounts:type_name -> blueapi.api.ManagementAccount
	89,  // 53: blueapi.billing.v1.UpdateAdjustmentConfigRequest.config:type_name -> blueapi.api.ConfigFilters
	90,  // 54: blueapi.billing.v1.UpdateAdjustmentConfigRequest.accounts:type_name -> blueapi.api.ManagementAccount
	80,  // 55: blueapi.billing.v1.ReadUntaggedGroupsRequest.field_mask:type_name -> google.protobuf.FieldMask
	80,  // 56: blueapi.billing.v1.ReadCustomizedBillingServicesRequest.field_mask:type_name -> google.protobuf.FieldMask
	80,  // 57: blueapi.billing.v1.GetCustomizedBillingServiceRequest.field_mask:type_name -> google.protobuf.FieldMask
	91,  // 58: blueapi.billing.v1.CreateCustomizedBillingServiceRequest.config:type_name -> blueapi.api.ripple.MethodConfig
	92,  // 59: blueapi.billing.v1.UpdateCustomizedBillingServiceRequest.customizedBillingService:type_name -> blueapi.api.ripple.CustomizedBillingService
	80,  // 60: blueapi.billing.v1.UpdateCustomizedBillingServiceRequest.update_mask:type_name -> google.protobuf.FieldMask
	93,  // 61: blueapi.billing.v1.CreateInvoiceServiceDiscountsRequest.setting:type_name -> blueapi.api.ripple.v1.InvoiceServiceDiscountsSetting
	94,  // 62: blueapi.billing.v1.UpdateInvoiceServiceDiscountsRequest.invoiceServiceDiscounts:type_name -> blueapi.api.ripple.v1.InvoiceServiceDiscounts
	80,  // 63: blueapi.billing.v1.UpdateInvoiceServiceDiscountsRequest.update_mask:type_name -> google.protobuf.FieldMask
	75,  // 64: blueapi.billing.v1.AwsDailyRunHistory.Account.history:type_name -> blueapi.billing.v1.AwsDailyRunHistory.Account.History
	4,   // 65: blueapi.billing.v1.Billing.ListBillingGroups:input_type -> blueapi.billing.v1.ListBillingGroupsRequest
	5,   // 66: blueapi.billing.v1.Billing.CreateBillingGroup:input_type -> blueapi.billing.v1.CreateBillingGroupRequest
	11,  // 67: blueapi.billing.v1.Billing.GetBillingGroup:input_type -> blueapi.billing.v1.GetBillingGroupRequest
	14,  // 68: blueapi.billing.v1.Billing.GetAccessGroup:input_type -> blueapi.billing.v1.GetAccessGroupRequest
	17,  // 69: blueapi.billing.v1.Billing.ListAwsDailyRunHistory:input_type -> blueapi.billing.v1.ListAwsDailyRunHistoryRequest
	18,  // 70: blueapi.billing.v1.Billing.ListUsageCostsDrift:input_type -> blueapi.billing.v1.ListUsageCostsDriftRequest
	35,  // 71: blueapi.billing.v1.Billing.CreateInvoice:input_type -> blueapi.billing.v1.CreateInvoiceRequest
	36,  // 72: blueapi.billing.v1.Billing.GetInvoiceStatus:input_type -> blueapi.billing.v1.GetInvoiceStatusRequest
	37,  // 73: blueapi.billing.v1.Billing.ListInvoiceStatus:input_type -> blueapi.billing.v1.ListInvoiceStatusRequest
	20,  // 74: blueapi.billing.v1.Billing.GetInvoice:input_type -> blueapi.billing.v1.GetInvoiceRequest
	52,  // 75: blueapi.billing.v1.Billing.ListInvoice:input_type -> blueapi.billing.v1.ListInvoiceRequest
	38,  // 76: blueapi.billing.v1.Billing.UpdateInvoicePreviews:input_type -> blueapi.billing.v1.UpdateInvoicePreviewsRequest
	21,  // 77: blueapi.billing.v1.Billing.ExportInvoiceFile:input_type -> blueapi.billing.v1.ExportInvoiceFileRequest
	23,  // 78: blueapi.billing.v1.Billing.ReadServiceDiscountsServices:input_type -> blueapi.billing.v1.ReadServiceDiscountsServicesRequest
	71,  // 79: blueapi.billing.v1.Billing.CreateInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.CreateInvoiceServiceDiscountsRequest
	72,  // 80: blueapi.billing.v1.Billing.UpdateInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.UpdateInvoiceServiceDiscountsRequest
	73,  // 81: blueapi.billing.v1.Billing.DeleteInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.DeleteInvoiceServiceDiscountsRequest
	24,  // 82: blueapi.billing.v1.Billing.ListInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.ListInvoiceServiceDiscountsRequest
	26,  // 83: blueapi.billing.v1.Billing.ListAccountInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.ListAccountInvoiceServiceDiscountsRequest
	29,  // 84: blueapi.billing.v1.Billing.CreateAccountInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.CreateAccountInvoiceServiceDiscountsRequest
	31,  // 85: blueapi.billing.v1.Billing.UpdateAccountInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.UpdateAccountInvoiceServiceDiscountsRequest
	34,  // 86: blueapi.billing.v1.Billing.RemoveAccountInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.RemoveAccountInvoiceServiceDiscountsRequest
	33,  // 87: blueapi.billing.v1.Billing.DeleteAccountInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.DeleteAccountInvoiceServiceDiscountsRequest
	39,  // 88: blueapi.billing.v1.Billing.CreateReseller:input_type -> blueapi.billing.v1.CreateResellerRequest
	40,  // 89: blueapi.billing.v1.Billing.ListResellers:input_type -> blueapi.billing.v1.ListResellersRequest
	41,  // 90: blueapi.billing.v1.Billing.GetReseller:input_type -> blueapi.billing.v1.GetResellerRequest
	42,  // 91: blueapi.billing.v1.Billing.UpdateReseller:input_type -> blueapi.billing.v1.UpdateResellerRequest
	43,  // 92: blueapi.billing.v1.Billing.DeleteReseller:input_type -> blueapi.billing.v1.DeleteResellerRequest
	44,  // 93: blueapi.billing.v1.Billing.GetBillingSetting:input_type -> blueapi.billing.v1.GetBillingSettingRequest
	46,  // 94: blueapi.billing.v1.Billing.ListExchangeRates:input_type -> blueapi.billing.v1.ListExchangeRatesRequest
	48,  // 95: blueapi.billing.v1.Billing.ListAccessGroups:input_type -> blueapi.billing.v1.ListAccessGroupsRequest
	49,  // 96: blueapi.billing.v1.Billing.CreateAccessGroup:input_type -> blueapi.billing.v1.CreateAccessGroupRequest
	50,  // 97: blueapi.billing.v1.Billing.UpdateAccessGroup:input_type -> blueapi.billing.v1.UpdateAccessGroupRequest
	51,  // 98: blueapi.billing.v1.Billing.DeleteAccessGroup:input_type -> blueapi.billing.v1.DeleteAccessGroupRequest
	54,  // 99: blueapi.billing.v1.Billing.ListAbcBillingGroups:input_type -> blueapi.billing.v1.ListAbcBillingGroupsRequest
	55,  // 100: blueapi.billing.v1.Billing.ListAbcBillingGroupAccounts:input_type -> blueapi.billing.v1.ListAbcBillingGroupAccountsRequest
	58,  // 101: blueapi.billing.v1.Billing.ReadInvoiceAdjustments:input_type -> blueapi.billing.v1.ReadInvoiceAdjustmentsRequest
	59,  // 102: blueapi.billing.v1.Billing.ListAccountResources:input_type -> blueapi.billing.v1.ListAccountResourcesRequest
	61,  // 103: blueapi.billing.v1.Billing.GetAdjustmentConfig:input_type -> blueapi.billing.v1.GetAdjustmentConfigRequest
	62,  // 104: blueapi.billing.v1.Billing.CreateAdjustmentConfig:input_type -> blueapi.billing.v1.CreateAdjustmentConfigRequest
	63,  // 105: blueapi.billing.v1.Billing.UpdateAdjustmentConfig:input_type -> blueapi.billing.v1.UpdateAdjustmentConfigRequest
	64,  // 106: blueapi.billing.v1.Billing.DeleteAdjustmentConfig:input_type -> blueapi.billing.v1.DeleteAdjustmentConfigRequest
	65,  // 107: blueapi.billing.v1.Billing.ReadUntaggedGroups:input_type -> blueapi.billing.v1.ReadUntaggedGroupsRequest
	66,  // 108: blueapi.billing.v1.Billing.ReadCustomizedBillingServices:input_type -> blueapi.billing.v1.ReadCustomizedBillingServicesRequest
	67,  // 109: blueapi.billing.v1.Billing.GetCustomizedBillingService:input_type -> blueapi.billing.v1.GetCustomizedBillingServiceRequest
	68,  // 110: blueapi.billing.v1.Billing.CreateCustomizedBillingService:input_type -> blueapi.billing.v1.CreateCustomizedBillingServiceRequest
	69,  // 111: blueapi.billing.v1.Billing.UpdateCustomizedBillingService:input_type -> blueapi.billing.v1.UpdateCustomizedBillingServiceRequest
	70,  // 112: blueapi.billing.v1.Billing.DeleteCustomizedBillingService:input_type -> blueapi.billing.v1.DeleteCustomizedBillingServiceRequest
	0,   // 113: blueapi.billing.v1.Billing.ListBillingGroups:output_type -> blueapi.billing.v1.BillingGroup
	0,   // 114: blueapi.billing.v1.Billing.CreateBillingGroup:output_type -> blueapi.billing.v1.BillingGroup
	12,  // 115: blueapi.billing.v1.Billing.GetBillingGroup:output_type -> blueapi.billing.v1.GetBillingGroupResponse
	15,  // 116: blueapi.billing.v1.Billing.GetAccessGroup:output_type -> blueapi.billing.v1.GetAccessGroupResponse
	16,  // 117: blueapi.billing.v1.Billing.ListAwsDailyRunHistory:output_type -> blueapi.billing.v1.AwsDailyRunHistory
	19,  // 118: blueapi.billing.v1.Billing.ListUsageCostsDrift:output_type -> blueapi.billing.v1.UsageCostsDrift
	95,  // 119: blueapi.billing.v1.Billing.CreateInvoice:output_type -> blueapi.api.InvoiceMessage
	95,  // 120: blueapi.billing.v1.Billing.GetInvoiceStatus:output_type -> blueapi.api.InvoiceMessage
	95,  // 121: blueapi.billing.v1.Billing.ListInvoiceStatus:output_type -> blueapi.api.InvoiceMessage
	96,  // 122: blueapi.billing.v1.Billing.GetInvoice:output_type -> blueapi.api.Invoice
	53,  // 123: blueapi.billing.v1.Billing.ListInvoice:output_type -> blueapi.billing.v1.ListInvoiceResponse
	97,  // 124: blueapi.billing.v1.Billing.UpdateInvoicePreviews:output_type -> google.protobuf.Empty
	22,  // 125: blueapi.billing.v1.Billing.ExportInvoiceFile:output_type -> blueapi.billing.v1.ExportInvoiceFileResponse
	98,  // 126: blueapi.billing.v1.Billing.ReadServiceDiscountsServices:output_type -> blueapi.api.ripple.v1.Service
	94,  // 127: blueapi.billing.v1.Billing.CreateInvoiceServiceDiscounts:output_type -> blueapi.api.ripple.v1.InvoiceServiceDiscounts
	94,  // 128: blueapi.billing.v1.Billing.UpdateInvoiceServiceDiscounts:output_type -> blueapi.api.ripple.v1.InvoiceServiceDiscounts
	97,  // 129: blueapi.billing.v1.Billing.DeleteInvoiceServiceDiscounts:output_type -> google.protobuf.Empty
	25,  // 130: blueapi.billing.v1.Billing.ListInvoiceServiceDiscounts:output_type -> blueapi.billing.v1.InvoiceServiceDiscounts
	27,  // 131: blueapi.billing.v1.Billing.ListAccountInvoiceServiceDiscounts:output_type -> blueapi.billing.v1.AccountInvoiceServiceDiscounts
	30,  // 132: blueapi.billing.v1.Billing.CreateAccountInvoiceServiceDiscounts:output_type -> blueapi.billing.v1.CreateAccountInvoiceServiceDiscountsResponse
	32,  // 133: blueapi.billing.v1.Billing.UpdateAccountInvoiceServiceDiscounts:output_type -> blueapi.billing.v1.UpdateAccountInvoiceServiceDiscountsResponse
	97,  // 134: blueapi.billing.v1.Billing.RemoveAccountInvoiceServiceDiscounts:output_type -> google.protobuf.Empty
	97,  // 135: blueapi.billing.v1.Billing.DeleteAccountInvoiceServiceDiscounts:output_type -> google.protobuf.Empty
	99,  // 136: blueapi.billing.v1.Billing.CreateReseller:output_type -> blueapi.api.ripple.Reseller
	99,  // 137: blueapi.billing.v1.Billing.ListResellers:output_type -> blueapi.api.ripple.Reseller
	99,  // 138: blueapi.billing.v1.Billing.GetReseller:output_type -> blueapi.api.ripple.Reseller
	99,  // 139: blueapi.billing.v1.Billing.UpdateReseller:output_type -> blueapi.api.ripple.Reseller
	97,  // 140: blueapi.billing.v1.Billing.DeleteReseller:output_type -> google.protobuf.Empty
	45,  // 141: blueapi.billing.v1.Billing.GetBillingSetting:output_type -> blueapi.billing.v1.GetBillingSettingResponse
	47,  // 142: blueapi.billing.v1.Billing.ListExchangeRates:output_type -> blueapi.billing.v1.ListExchangeRatesResponse
	100, // 143: blueapi.billing.v1.Billing.ListAccessGroups:output_type -> blueapi.api.ripple.AccessGroup
	100, // 144: blueapi.billing.v1.Billing.CreateAccessGroup:output_type -> blueapi.api.ripple.AccessGroup
	100, // 145: blueapi.billing.v1.Billing.UpdateAccessGroup:output_type -> blueapi.api.ripple.AccessGroup
	97,  // 146: blueapi.billing.v1.Billing.DeleteAccessGroup:output_type -> google.protobuf.Empty
	56,  // 147: blueapi.billing.v1.Billing.ListAbcBillingGroups:output_type -> blueapi.billing.v1.AbcBillingGroup
	57,  // 148: blueapi.billing.v1.Billing.ListAbcBillingGroupAccounts:output_type -> blueapi.billing.v1.AbcAccount
	101, // 149: blueapi.billing.v1.Billing.ReadInvoiceAdjustments:output_type -> blueapi.api.wave.Adjustment
	60,  // 150: blueapi.billing.v1.Billing.ListAccountResources:output_type -> blueapi.billing.v1.ResourceAccount
	102, // 151: blueapi.billing.v1.Billing.GetAdjustmentConfig:output_type -> blueapi.api.AdjustmentConfig
	102, // 152: blueapi.billing.v1.Billing.CreateAdjustmentConfig:output_type -> blueapi.api.AdjustmentConfig
	102, // 153: blueapi.billing.v1.Billing.UpdateAdjustmentConfig:output_type -> blueapi.api.AdjustmentConfig
	97,  // 154: blueapi.billing.v1.Billing.DeleteAdjustmentConfig:output_type -> google.protobuf.Empty
	103, // 155: blueapi.billing.v1.Billing.ReadUntaggedGroups:output_type -> blueapi.api.ripple.UntaggedGroup
	92,  // 156: blueapi.billing.v1.Billing.ReadCustomizedBillingServices:output_type -> blueapi.api.ripple.CustomizedBillingService
	92,  // 157: blueapi.billing.v1.Billing.GetCustomizedBillingService:output_type -> blueapi.api.ripple.CustomizedBillingService
	92,  // 158: blueapi.billing.v1.Billing.CreateCustomizedBillingService:output_type -> blueapi.api.ripple.CustomizedBillingService
	92,  // 159: blueapi.billing.v1.Billing.UpdateCustomizedBillingService:output_type -> blueapi.api.ripple.CustomizedBillingService
	97,  // 160: blueapi.billing.v1.Billing.DeleteCustomizedBillingService:output_type -> google.protobuf.Empty
