...
type ListAwsDailyRunHistoryRequest struct {
	...
	// Optional. If set, query for this group id. At the moment, only `billingInternalId`s are supported.
	GroupId string `protobuf:"bytes,2,opt,name=groupId,proto3" json:"groupId,omitempty"`
	// Optional. If set, query for this account id. Overrides `groupId`.
...
func (x *ListAwsDailyRunHistoryRequest) GetAccountId() string {
	if x != nil {
		return x.AccountId
	}
	return ""
...
var file_billing_v1_billing_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x67, 0x65, 0x72, 0x22, 0x6d, 0x0a, 0x1d, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x77, 0x73,
	...
	0x6e, 0x74, 0x49, 0x64, 0x22, 0x78, 0x0a, 0x1a, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x73, 0x61, 0x67,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x01, 0x52, 0x04, 0x64, 0x69, 0x66, 0x66, 0x32, 0xa0, 0x08, 0x0a,
	...
	0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x22, 0x27, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x21, 0x22,
	0x1c, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x77, 0x73, 0x2f, 0x64, 0x61, 0x69, 0x6c, 0x79, 0x72, 0x75,
	0x6e, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x3a, 0x72, 0x65, 0x61, 0x64, 0x3a, 0x01, 0x2a,
	...
	0x2c, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x26, 0x22, 0x21, 0x2f, 0x76, 0x31, 0x2f, 0x7b, 0x76, 0x65,
	0x6e, 0x64, 0x6f, 0x72, 0x7d, 0x2f, 0x75, 0x73, 0x61, 0x67, 0x65, 0x63, 0x6f, 0x73, 0x74, 0x73,
	0x64, 0x72, 0x69, 0x66, 0x74, 0x3a, 0x72, 0x65, 0x61, 0x64, 0x3a, 0x01, 0x2a, 0x30, 0x01, 0x1a,
...
var file_billing_v1_billing_proto_goTypes = []interface{}{
	...
	(*AwsDailyRunHistory_Account)(nil),             // 16: blueapi.billing.v1.AwsDailyRunHistory.Account
	(*AwsDailyRunHistory_Account_History)(nil),     // 17: blueapi.billing.v1.AwsDailyRunHistory.Account.History
...
var file_billing_v1_billing_proto_depIdxs = []int32{
	...
	16, // 12: blueapi.billing.v1.AwsDailyRunHistory.accounts:type_name -> blueapi.billing.v1.AwsDailyRunHistory.Account
	17, // 13: blueapi.billing.v1.AwsDailyRunHistory.Account.history:type_name -> blueapi.billing.v1.AwsDailyRunHistory.Account.History
	...
	12, // 24: blueapi.billing.v1.Billing.ListAwsDailyRunHistory:output_type -> blueapi.billing.v1.AwsDailyRunHistory
