...
var file_billing_v1_billing_proto_rawDesc = []byte{
	...
	0x73, 0x6b, 0x32, 0x80, 0x30, 0x0a, 0x07, 0x42, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x12, 0x80,
	...
	0x64, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x3a, 0x72, 0x65, 0x61, 0x64, 0x30, 0x01, 0x12, 0xb4,
	0x01, 0x0a, 0x1c, 0x52, 0x65, 0x61, 0x64, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x65,
	...
	0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x65, 0x42, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x2c, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x26, 0x3a, 0x01, 0x2a,
	0x22, 0x21, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x65, 0x62,
	0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x3a, 0x72,
	0x65, 0x61, 0x64, 0x30, 0x01, 0x1a, 0x9d, 0x01, 0x92, 0x41, 0x99, 0x01, 0x12, 0x46, 0x28, 0x42,
...
var file_billing_v1_billing_proto_msgTypes = make([]protoimpl.MessageInfo, 68)
var file_billing_v1_billing_proto_goTypes = []any{
	...
	(*AwsDailyRunHistory_Account)(nil),                   // 66: blueapi.billing.v1.AwsDailyRunHistory.Account
	(*AwsDailyRunHistory_Account_History)(nil),           // 67: blueapi.billing.v1.AwsDailyRunHistory.Account.History
	(*ripple.BillingGroupInfo)(nil),                      // 68: blueapi.api.ripple.BillingGroupInfo
	(*api.Account)(nil),                                  // 69: blueapi.api.Account
	(*api.CostTag)(nil),                                  // 70: blueapi.api.CostTag
	(*api.AdditionalItems)(nil),                          // 71: blueapi.api.AdditionalItems
	(*fieldmaskpb.FieldMask)(nil),                        // 72: google.protobuf.FieldMask
	(*ripple.ResellerConfig)(nil),                        // 73: blueapi.api.ripple.ResellerConfig
	(*ripple.YearMonth)(nil),                             // 74: blueapi.api.ripple.YearMonth
	(*ripple.Rounding)(nil),                              // 75: blueapi.api.ripple.Rounding
	(*ripple.InvoiceLayout)(nil),                         // 76: blueapi.api.ripple.InvoiceLayout
	(*ripple.DueDate)(nil),                               // 77: blueapi.api.ripple.DueDate
	(*ripple.CommonExchangeRate)(nil),                    // 78: blueapi.api.ripple.CommonExchangeRate
	(*ripple.BillingGroupExchangeRate)(nil),              // 79: blueapi.api.ripple.BillingGroupExchangeRate
	(*ripple.VendorPayerExchangeRate)(nil),               // 80: blueapi.api.ripple.VendorPayerExchangeRate
	(*api.ConfigFilters)(nil),                            // 81: blueapi.api.ConfigFilters
	(*api.ManagementAccount)(nil),                        // 82: blueapi.api.ManagementAccount
	(*api.InvoiceMessage)(nil),                           // 83: blueapi.api.InvoiceMessage
	(*api.Invoice)(nil),                                  // 84: blueapi.api.Invoice
	(*emptypb.Empty)(nil),                                // 85: google.protobuf.Empty
	(*ripple.Reseller)(nil),                              // 86: blueapi.api.ripple.Reseller
	(*ripple.AccessGroup)(nil),                           // 87: blueapi.api.ripple.AccessGroup
	(*wave.Adjustment)(nil),                              // 88: blueapi.api.wave.Adjustment
	(*api.AdjustmentConfig)(nil),                         // 89: blueapi.api.AdjustmentConfig
	(*ripple.UntaggedGroup)(nil),                         // 90: blueapi.api.ripple.UntaggedGroup
	(*ripple.CustomizeBillingService)(nil),               // 91: blueapi.api.ripple.CustomizeBillingService
}
var file_billing_v1_billing_proto_depIdxs = []int32{
	68, // 0: blueapi.billing.v1.BillingGroup.billingGroupInfo:type_name -> blueapi.api.ripple.BillingGroupInfo
	7,  // 1: blueapi.billing.v1.BillingGroup.accountOptions:type_name -> blueapi.billing.v1.AccountOptions
	69, // 2: blueapi.billing.v1.BillingGroup.accounts:type_name -> blueapi.api.Account
	70, // 3: blueapi.billing.v1.BillingGroup.tags:type_name -> blueapi.api.CostTag
	...
	71, // 7: blueapi.billing.v1.BillingGroupAdditionalItems.aws:type_name -> blueapi.api.AdditionalItems
	71, // 8: blueapi.billing.v1.BillingGroupAdditionalItems.azure:type_name -> blueapi.api.AdditionalItems
	71, // 9: blueapi.billing.v1.BillingGroupAdditionalItems.gcp:type_name -> blueapi.api.AdditionalItems
	...
	72, // 13: blueapi.billing.v1.ListBillingGroupsRequest.field_mask:type_name -> google.protobuf.FieldMask
	...
	72, // 23: blueapi.billing.v1.GetBillingGroupRequest.field_mask:type_name -> google.protobuf.FieldMask
	...
	72, // 26: blueapi.billing.v1.GetAccessGroupRequest.field_mask:type_name -> google.protobuf.FieldMask
	13, // 27: blueapi.billing.v1.GetAccessGroupResponse.accessGroup:type_name -> blueapi.billing.v1.AccessGroup
	66, // 28: blueapi.billing.v1.AwsDailyRunHistory.accounts:type_name -> blueapi.billing.v1.AwsDailyRunHistory.Account
	...
	73, // 34: blueapi.billing.v1.CreateResellerRequest.waveConfig:type_name -> blueapi.api.ripple.ResellerConfig
	73, // 35: blueapi.billing.v1.CreateResellerRequest.aquaConfig:type_name -> blueapi.api.ripple.ResellerConfig
	72, // 36: blueapi.billing.v1.ListResellersRequest.field_mask:type_name -> google.protobuf.FieldMask
	72, // 37: blueapi.billing.v1.GetResellerRequest.field_mask:type_name -> google.protobuf.FieldMask
	73, // 38: blueapi.billing.v1.UpdateResellerRequest.waveConfig:type_name -> blueapi.api.ripple.ResellerConfig
	73, // 39: blueapi.billing.v1.UpdateResellerRequest.aquaConfig:type_name -> blueapi.api.ripple.ResellerConfig
	72, // 40: blueapi.billing.v1.UpdateResellerRequest.updateMask:type_name -> google.protobuf.FieldMask
	72, // 41: blueapi.billing.v1.GetBillingSettingRequest.field_mask:type_name -> google.protobuf.FieldMask
	74, // 42: blueapi.billing.v1.GetBillingSettingResponse.yearMonth:type_name -> blueapi.api.ripple.YearMonth
	75, // 43: blueapi.billing.v1.GetBillingSettingResponse.roundingMethod:type_name -> blueapi.api.ripple.Rounding
	75, // 44: blueapi.billing.v1.GetBillingSettingResponse.exportRoundingMethod:type_name -> blueapi.api.ripple.Rounding
	76, // 45: blueapi.billing.v1.GetBillingSettingResponse.invoiceLayout:type_name -> blueapi.api.ripple.InvoiceLayout
	77, // 46: blueapi.billing.v1.GetBillingSettingResponse.invoiceDueDate:type_name -> blueapi.api.ripple.DueDate
	78, // 47: blueapi.billing.v1.ListExchangeRatesResponse.common:type_name -> blueapi.api.ripple.CommonExchangeRate
	79, // 48: blueapi.billing.v1.ListExchangeRatesResponse.billingGroup:type_name -> blueapi.api.ripple.BillingGroupExchangeRate
	80, // 49: blueapi.billing.v1.ListExchangeRatesResponse.payer:type_name -> blueapi.api.ripple.VendorPayerExchangeRate
	72, // 50: blueapi.billing.v1.ListAccessGroupsRequest.field_mask:type_name -> google.protobuf.FieldMask
	81, // 51: blueapi.billing.v1.CreateAdjustmentConfigRequest.config:type_name -> blueapi.api.ConfigFilters
	82, // 52: blueapi.billing.v1.CreateAdjustmentConfigRequest.accounts:type_name -> blueapi.api.ManagementAccount
	81, // 53: blueapi.billing.v1.UpdateAdjustmentConfigRequest.config:type_name -> blueapi.api.ConfigFilters
	82, // 54: blueapi.billing.v1.UpdateAdjustmentConfigRequest.accounts:type_name -> blueapi.api.ManagementAccount
	72, // 55: blueapi.billing.v1.ReadUntaggedGroupsRequest.field_mask:type_name -> google.protobuf.FieldMask
	72, // 56: blueapi.billing.v1.ReadCustomizeBillingServicesRequest.field_mask:type_name -> google.protobuf.FieldMask
	67, // 57: blueapi.billing.v1.AwsDailyRunHistory.Account.history:type_name -> blueapi.billing.v1.AwsDailyRunHistory.Account.History
	4,  // 58: blueapi.billing.v1.Billing.ListBillingGroups:input_type -> blueapi.billing.v1.ListBillingGroupsRequest
	5,  // 59: blueapi.billing.v1.Billing.CreateBillingGroup:input_type -> blueapi.billing.v1.CreateBillingGroupRequest
	11, // 60: blueapi.billing.v1.Billing.GetBillingGroup:input_type -> blueapi.billing.v1.GetBillingGroupRequest
	14, // 61: blueapi.billing.v1.Billing.GetAccessGroup:input_type -> blueapi.billing.v1.GetAccessGroupRequest
	17, // 62: blueapi.billing.v1.Billing.ListAwsDailyRunHistory:input_type -> blueapi.billing.v1.ListAwsDailyRunHistoryRequest
	18, // 63: blueapi.billing.v1.Billing.ListUsageCostsDrift:input_type -> blueapi.billing.v1.ListUsageCostsDriftRequest
	34, // 64: blueapi.billing.v1.Billing.CreateInvoice:input_type -> blueapi.billing.v1.CreateInvoiceRequest
	35, // 65: blueapi.billing.v1.Billing.GetInvoiceStatus:input_type -> blueapi.billing.v1.GetInvoiceStatusRequest
	36, // 66: blueapi.billing.v1.Billing.ListInvoiceStatus:input_type -> blueapi.billing.v1.ListInvoiceStatusRequest
	20, // 67: blueapi.billing.v1.Billing.GetInvoice:input_type -> blueapi.billing.v1.GetInvoiceRequest
	51, // 68: blueapi.billing.v1.Billing.ListInvoice:input_type -> blueapi.billing.v1.ListInvoiceRequest
	37, // 69: blueapi.billing.v1.Billing.UpdateInvoicePreviews:input_type -> blueapi.billing.v1.UpdateInvoicePreviewsRequest
	21, // 70: blueapi.billing.v1.Billing.ExportInvoiceFile:input_type -> blueapi.billing.v1.ExportInvoiceFileRequest
	23, // 71: blueapi.billing.v1.Billing.ListInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.ListInvoiceServiceDiscountsRequest
	25, // 72: blueapi.billing.v1.Billing.ListAccountInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.ListAccountInvoiceServiceDiscountsRequest
	28, // 73: blueapi.billing.v1.Billing.CreateAccountInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.CreateAccountInvoiceServiceDiscountsRequest
	30, // 74: blueapi.billing.v1.Billing.UpdateAccountInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.UpdateAccountInvoiceServiceDiscountsRequest
	33, // 75: blueapi.billing.v1.Billing.RemoveAccountInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.RemoveAccountInvoiceServiceDiscountsRequest
	32, // 76: blueapi.billing.v1.Billing.DeleteAccountInvoiceServiceDiscounts:input_type -> blueapi.billing.v1.DeleteAccountInvoiceServiceDiscountsRequest
	38, // 77: blueapi.billing.v1.Billing.CreateReseller:input_type -> blueapi.billing.v1.CreateResellerRequest
	39, // 78: blueapi.billing.v1.Billing.ListResellers:input_type -> blueapi.billing.v1.ListResellersRequest
	40, // 79: blueapi.billing.v1.Billing.GetReseller:input_type -> blueapi.billing.v1.GetResellerRequest
	41, // 80: blueapi.billing.v1.Billing.UpdateReseller:input_type -> blueapi.billing.v1.UpdateResellerRequest
	42, // 81: blueapi.billing.v1.Billing.DeleteReseller:input_type -> blueapi.billing.v1.DeleteResellerRequest
	43, // 82: blueapi.billing.v1.Billing.GetBillingSetting:input_type -> blueapi.billing.v1.GetBillingSettingRequest
	45, // 83: blueapi.billing.v1.Billing.ListExchangeRates:input_type -> blueapi.billing.v1.ListExchangeRatesRequest
	47, // 84: blueapi.billing.v1.Billing.ListAccessGroups:input_type -> blueapi.billing.v1.ListAccessGroupsRequest
	48, // 85: blueapi.billing.v1.Billing.CreateAccessGroup:input_type -> blueapi.billing.v1.CreateAccessGroupRequest
	49, // 86: blueapi.billing.v1.Billing.UpdateAccessGroup:input_type -> blueapi.billing.v1.UpdateAccessGroupRequest
	50, // 87: blueapi.billing.v1.Billing.DeleteAccessGroup:input_type -> blueapi.billing.v1.DeleteAccessGroupRequest
	53, // 88: blueapi.billing.v1.Billing.ListAbcBillingGroups:input_type -> blueapi.billing.v1.ListAbcBillingGroupsRequest
	54, // 89: blueapi.billing.v1.Billing.ListAbcBillingGroupAccounts:input_type -> blueapi.billing.v1.ListAbcBillingGroupAccountsRequest
	57, // 90: blueapi.billing.v1.Billing.ReadInvoiceAdjustments:input_type -> blueapi.billing.v1.ReadInvoiceAdjustmentsRequest
	58, // 91: blueapi.billing.v1.Billing.ListAccountResources:input_type -> blueapi.billing.v1.ListAccountResourcesRequest
	60, // 92: blueapi.billing.v1.Billing.GetAdjustmentConfig:input_type -> blueapi.billing.v1.GetAdjustmentConfigRequest
	61, // 93: blueapi.billing.v1.Billing.CreateAdjustmentConfig:input_type -> blueapi.billing.v1.CreateAdjustmentConfigRequest
	62, // 94: blueapi.billing.v1.Billing.UpdateAdjustmentConfig:input_type -> blueapi.billing.v1.UpdateAdjustmentConfigRequest
	63, // 95: blueapi.billing.v1.Billing.DeleteAdjustmentConfig:input_type -> blueapi.billing.v1.DeleteAdjustmentConfigRequest
	64, // 96: blueapi.billing.v1.Billing.ReadUntaggedGroups:input_type -> blueapi.billing.v1.ReadUntaggedGroupsRequest
	65, // 97: blueapi.billing.v1.Billing.ReadCustomizeBillingServices:input_type -> blueapi.billing.v1.ReadCustomizeBillingServicesRequest
	0,  // 98: blueapi.billing.v1.Billing.ListBillingGroups:output_type -> blueapi.billing.v1.BillingGroup
	0,  // 99: blueapi.billing.v1.Billing.CreateBillingGroup:output_type -> blueapi.billing.v1.BillingGroup
	12, // 100: blueapi.billing.v1.Billing.GetBillingGroup:output_type -> blueapi.billing.v1.GetBillingGroupResponse
	15, // 101: blueapi.billing.v1.Billing.GetAccessGroup:output_type -> blueapi.billing.v1.GetAccessGroupResponse
	16, // 102: blueapi.billing.v1.Billing.ListAwsDailyRunHistory:output_type -> blueapi.billing.v1.AwsDailyRunHistory
	19, // 103: blueapi.billing.v1.Billing.ListUsageCostsDrift:output_type -> blueapi.billing.v1.UsageCostsDrift
	83, // 104: blueapi.billing.v1.Billing.CreateInvoice:output_type -> blueapi.api.InvoiceMessage
	83, // 105: blueapi.billing.v1.Billing.GetInvoiceStatus:output_type -> blueapi.api.InvoiceMessage
	83, // 106: blueapi.billing.v1.Billing.ListInvoiceStatus:output_type -> blueapi.api.InvoiceMessage
	84, // 107: blueapi.billing.v1.Billing.GetInvoice:output_type -> blueapi.api.Invoice
	52, // 108: blueapi.billing.v1.Billing.ListInvoice:output_type -> blueapi.billing.v1.ListInvoiceResponse
	85, // 109: blueapi.billing.v1.Billing.UpdateInvoicePreviews:output_type -> google.protobuf.Empty
	22, // 110: blueapi.billing.v1.Billing.ExportInvoiceFile:output_type -> blueapi.billing.v1.ExportInvoiceFileResponse
	24, // 111: blueapi.billing.v1.Billing.ListInvoiceServiceDiscounts:output_type -> blueapi.billing.v1.InvoiceServiceDiscounts
	26, // 112: blueapi.billing.v1.Billing.ListAccountInvoiceServiceDiscounts:output_type -> blueapi.billing.v1.AccountInvoiceServiceDiscounts
	29, // 113: blueapi.billing.v1.Billing.CreateAccountInvoiceServiceDiscounts:output_type -> blueapi.billing.v1.CreateAccountInvoiceServiceDiscountsResponse
	31, // 114: blueapi.billing.v1.Billing.UpdateAccountInvoiceServiceDiscounts:output_type -> blueapi.billing.v1.UpdateAccountInvoiceServiceDiscountsResponse
	85, // 115: blueapi.billing.v1.Billing.RemoveAccountInvoiceServiceDiscounts:output_type -> google.protobuf.Empty
	85, // 116: blueapi.billing.v1.Billing.DeleteAccountInvoiceServiceDiscounts:output_type -> google.protobuf.Empty
	86, // 117: blueapi.billing.v1.Billing.CreateReseller:output_type -> blueapi.api.ripple.Reseller
	86, // 118: blueapi.billing.v1.Billing.ListResellers:output_type -> blueapi.api.ripple.Reseller
	86, // 119: blueapi.billing.v1.Billing.GetReseller:output_type -> blueapi.api.ripple.Reseller
	86, // 120: blueapi.billing.v1.Billing.UpdateReseller:output_type -> blueapi.api.ripple.Reseller
	85, // 121: blueapi.billing.v1.Billing.DeleteReseller:output_type -> google.protobuf.Empty
	44, // 122: blueapi.billing.v1.Billing.GetBillingSetting:output_type -> blueapi.billing.v1.GetBillingSettingResponse
	46, // 123: blueapi.billing.v1.Billing.ListExchangeRates:output_type -> blueapi.billing.v1.ListExchangeRatesResponse
	87, // 124: blueapi.billing.v1.Billing.ListAccessGroups:output_type -> blueapi.api.ripple.AccessGroup
	87, // 125: blueapi.billing.v1.Billing.CreateAccessGroup:output_type -> blueapi.api.ripple.AccessGroup
	87, // 126: blueapi.billing.v1.Billing.UpdateAccessGroup:output_type -> blueapi.api.ripple.AccessGroup
	85, // 127: blueapi.billing.v1.Billing.DeleteAccessGroup:output_type -> google.protobuf.Empty
	55, // 128: blueapi.billing.v1.Billing.ListAbcBillingGroups:output_type -> blueapi.billing.v1.AbcBillingGroup
	56, // 129: blueapi.billing.v1.Billing.ListAbcBillingGroupAccounts:output_type -> blueapi.billing.v1.AbcAccount
	88, // 130: blueapi.billing.v1.Billing.ReadInvoiceAdjustments:output_type -> blueapi.api.wave.Adjustment
	59, // 131: blueapi.billing.v1.Billing.ListAccountResources:output_type -> blueapi.billing.v1.ResourceAccount
	89, // 132: blueapi.billing.v1.Billing.GetAdjustmentConfig:output_type -> blueapi.api.AdjustmentConfig
	89, // 133: blueapi.billing.v1.Billing.CreateAdjustmentConfig:output_type -> blueapi.api.AdjustmentConfig
	89, // 134: blueapi.billing.v1.Billing.UpdateAdjustmentConfig:output_type -> blueapi.api.AdjustmentConfig
	85, // 135: blueapi.billing.v1.Billing.DeleteAdjustmentConfig:output_type -> google.protobuf.Empty
	90, // 136: blueapi.billing.v1.Billing.ReadUntaggedGroups:output_type -> blueapi.api.ripple.UntaggedGroup
	91, // 137: blueapi.billing.v1.Billing.ReadCustomizeBillingServices:output_type -> blueapi.api.ripple.CustomizeBillingService
