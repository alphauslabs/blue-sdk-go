...
func request_Billing_CreateInvoiceServiceDiscounts_0(ctx context.Context, marshaler runtime.Marshaler, client BillingClient, req *http.Request, pathParams map[string]string) (Billing_CreateInvoiceServiceDiscountsClient, runtime.ServerMetadata, error) {
	...
	stream, err := client.CreateInvoiceServiceDiscounts(ctx, &protoReq)
	if err != nil {
		return nil, metadata, err
	}
	header, err := stream.Header()
...
func request_Billing_UpdateInvoiceServiceDiscounts_0(ctx context.Context, marshaler runtime.Marshaler, client BillingClient, req *http.Request, pathParams map[string]string) (Billing_UpdateInvoiceServiceDiscountsClient, runtime.ServerMetadata, error) {
	...
	stream, err := client.UpdateInvoiceServiceDiscounts(ctx, &protoReq)
	if err != nil {
		return nil, metadata, err
	}
	header, err := stream.Header()
...
func RegisterBillingHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BillingClient) error {
	...
	mux.Handle("POST", pattern_Billing_CreateInvoiceServiceDiscounts_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Billing_CreateInvoiceServiceDiscounts_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("PUT", pattern_Billing_UpdateInvoiceServiceDiscounts_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Billing_UpdateInvoiceServiceDiscounts_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	forward_Billing_CreateInvoiceServiceDiscounts_0 = runtime.ForwardResponseStream

	forward_Billing_UpdateInvoiceServiceDiscounts_0 = runtime.ForwardResponseStream
