...
var (
	filter_Billing_GetBillingGroup_0 = &utilities.DoubleArray{Encoding: map[string]int{"billingInternalId": 0}, Base: []int{1, 2, 0, 0}, Check: []int{0, 1, 2, 2}}
)
...
var (
	filter_Billing_GetAccessGroup_0 = &utilities.DoubleArray{Encoding: map[string]int{"accessGroupId": 0}, Base: []int{1, 2, 0, 0}, Check: []int{0, 1, 2, 2}}
)
...
var (
	filter_Billing_GetReseller_0 = &utilities.DoubleArray{Encoding: map[string]int{"id": 0}, Base: []int{1, 2, 0, 0}, Check: []int{0, 1, 2, 2}}
)
...
var (
	filter_Billing_UpdateReseller_0 = &utilities.DoubleArray{Encoding: map[string]int{"reseller": 0, "name": 1}, Base: []int{1, 4, 5, 2, 0, 0, 0, 0}, Check: []int{0, 1, 1, 2, 4, 2, 2, 3}}
)
...
func request_Billing_UpdateReseller_0(ctx context.Context, marshaler runtime.Marshaler, client BillingClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := marshaler.NewDecoder(newReader()).Decode(&protoReq.Reseller); err != nil && err != io.EOF {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	...
	val, ok = pathParams["reseller.name"]
	if !ok {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "missing parameter %s", "reseller.name")
	}

	err = runtime.PopulateFieldFromPath(&protoReq, "reseller.name", val)
	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "reseller.name", err)
	}

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Billing_UpdateReseller_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	filter_Billing_ListAbcBillingGroupAccounts_0 = &utilities.DoubleArray{Encoding: map[string]int{"payerId": 0}, Base: []int{1, 2, 0, 0}, Check: []int{0, 1, 2, 2}}
)
...
var (
	filter_Billing_ListAccountResources_0 = &utilities.DoubleArray{Encoding: map[string]int{"vendor": 0}, Base: []int{1, 2, 0, 0}, Check: []int{0, 1, 2, 2}}
)
...
func RegisterBillingHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BillingServer) error {
	...
	mux.Handle("PUT", pattern_Billing_UpdateReseller_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/blueapi.billing.v1.Billing/UpdateReseller", runtime.WithHTTPPathPattern("/v1/{reseller.name=resellers/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterBillingHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BillingClient) error {
	...
	mux.Handle("PUT", pattern_Billing_UpdateReseller_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/blueapi.billing.v1.Billing/UpdateReseller", runtime.WithHTTPPathPattern("/v1/{reseller.name=resellers/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_Billing_UpdateReseller_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 2, 5, 2}, []string{"v1", "resellers", "reseller.name"}, ""))
