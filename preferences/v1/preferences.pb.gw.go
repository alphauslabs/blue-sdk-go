...
func RegisterPreferencesHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PreferencesServer) error {
	...
	mux.Handle("GET", pattern_Preferences_GetPreferences_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/blueapi.preferences.v1.Preferences/GetPreferences")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Preferences_GetPreferences_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Preferences_GetPreferences_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPreferencesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PreferencesClient) error {
	...
	mux.Handle("GET", pattern_Preferences_GetPreferences_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/blueapi.preferences.v1.Preferences/GetPreferences")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Preferences_GetPreferences_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
