...
// Request message for the Cost.GetCalculatorStatus rpc.
type GetCalculatorStatusRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetCalculatorStatusRequest) Reset() {
	*x = GetCalculatorStatusRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetCalculatorStatusRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCalculatorStatusRequest) ProtoMessage() {}

func (x *GetCalculatorStatusRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cost_v1_cost_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCalculatorStatusRequest.ProtoReflect.Descriptor instead.
func (*GetCalculatorStatusRequest) Descriptor() ([]byte, []int) {
	return file_cost_v1_cost_proto_rawDescGZIP(), []int{12}
}

func (x *GetCalculatorStatusRequest) GetVendor() string {
	if x != nil {
		return x.Vendor
	}
	return ""
...
func (x *GetCalculatorStatusRequest) GetMonth() string {
	if x != nil {
		return x.Month
	}
	return ""
...
// Response message for the Cost.GetCalculatorStatus rpc.
type GetCalculatorStatusResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// AWS-specific calculator status.
	Aws *GetCalculatorStatusResponse_AwsStatus `protobuf:"bytes,1,opt,name=aws,proto3" json:"aws,omitempty"`
}

func (x *GetCalculatorStatusResponse) Reset() {
	*x = GetCalculatorStatusResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetCalculatorStatusResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCalculatorStatusResponse) ProtoMessage() {}

func (x *GetCalculatorStatusResponse) ProtoReflect() protoreflect.Message {
	mi := &file_cost_v1_cost_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCalculatorStatusResponse.ProtoReflect.Descriptor instead.
func (*GetCalculatorStatusResponse) Descriptor() ([]byte, []int) {
	return file_cost_v1_cost_proto_rawDescGZIP(), []int{13}
}

func (x *GetCalculatorStatusResponse) GetAws() *GetCalculatorStatusResponse_AwsStatus {
	if x != nil {
		return x.Aws
	}
	return nil
...
type GetCalculatorStatusResponse_AwsStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Month string `protobuf:"bytes,1,opt,name=month,proto3" json:"month,omitempty"`
	// List of accounts that are still actively processing.
	Active []*GetCalculatorStatusResponse_AwsStatus_Running `protobuf:"bytes,2,rep,name=active,proto3" json:"active,omitempty"`
}

func (x *GetCalculatorStatusResponse_AwsStatus) Reset() {
	*x = GetCalculatorStatusResponse_AwsStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetCalculatorStatusResponse_AwsStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCalculatorStatusResponse_AwsStatus) ProtoMessage() {}

func (x *GetCalculatorStatusResponse_AwsStatus) ProtoReflect() protoreflect.Message {
	mi := &file_cost_v1_cost_proto_msgTypes[58]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCalculatorStatusResponse_AwsStatus.ProtoReflect.Descriptor instead.
func (*GetCalculatorStatusResponse_AwsStatus) Descriptor() ([]byte, []int) {
	return file_cost_v1_cost_proto_rawDescGZIP(), []int{13, 0}
}

func (x *GetCalculatorStatusResponse_AwsStatus) GetMonth() string {
	if x != nil {
		return x.Month
	}
	return ""
...
func (x *GetCalculatorStatusResponse_AwsStatus) GetActive() []*GetCalculatorStatusResponse_AwsStatus_Running {
	if x != nil {
		return x.Active
	}
	return nil
...
type GetCalculatorStatusResponse_AwsStatus_Running struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// The dates the account is processing for.
	Date []string `protobuf:"bytes,2,rep,name=date,proto3" json:"date,omitempty"`
}

func (x *GetCalculatorStatusResponse_AwsStatus_Running) Reset() {
	*x = GetCalculatorStatusResponse_AwsStatus_Running{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetCalculatorStatusResponse_AwsStatus_Running) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCalculatorStatusResponse_AwsStatus_Running) ProtoMessage() {}

func (x *GetCalculatorStatusResponse_AwsStatus_Running) ProtoReflect() protoreflect.Message {
	mi := &file_cost_v1_cost_proto_msgTypes[59]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCalculatorStatusResponse_AwsStatus_Running.ProtoReflect.Descriptor instead.
func (*GetCalculatorStatusResponse_AwsStatus_Running) Descriptor() ([]byte, []int) {
	return file_cost_v1_cost_proto_rawDescGZIP(), []int{13, 0, 0}
}

func (x *GetCalculatorStatusResponse_AwsStatus_Running) GetAccount() string {
	if x != nil {
		return x.Account
	}
	return ""
...
func (x *GetCalculatorStatusResponse_AwsStatus_Running) GetDate() []string {
	if x != nil {
		return x.Date
	}
	return nil
...
var file_cost_v1_cost_proto_rawDesc = []byte{
	...
	0x06, 0x76, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x76,
	0x65, 0x6e, 0x64, 0x6f, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x4a, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x43, 0x61, 0x6c, 0x63,
	0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x03, 0x61, 0x77, 0x73, 0x22, 0x45, 0x0a, 0x15, 0x49, 0x6d,
	...
	0x72, 0x22, 0x33, 0x0a, 0x08, 0x43, 0x6f, 0x73, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x27, 0x0a,
	...
	,
	...
	,
	...
	0x04, 0x61, 0x73, 0x4f, 0x66, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x61, 0x73, 0x4f,
	0x66, 0x12, 0x20, 0x0a, 0x0b, 0x65, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x44, 0x6f, 0x6e, 0x65,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x65, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x44,
	0x6f, 0x6e, 0x65, 0x22, 0x5c, 0x0a, 0x22, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x61, 0x6c, 0x63, 0x75,
	0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x41, 0x77,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x36, 0x0a, 0x0a, 0x6f, 0x70, 0x65,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e,
	...
	0x73, 0x22, 0x68, 0x0a, 0x1f, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x45, 0x0a, 0x03, 0x61, 0x77, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x33, 0x2e, 0x62, 0x6c, 0x75, 0x65, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x73, 0x74,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x03, 0x61, 0x77, 0x73, 0x22, 0xc6, 0x01, 0x0a, 0x21,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xd0, 0x02, 0x0a, 0x1a, 0x52, 0x65, 0x61, 0x64, 0x43, 0x6f, 0x73,
	...
	0x74, 0x65, 0x72, 0x73, 0x52, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x12, 0x20, 0x0a,
	...
	0x65, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x22, 0xe7, 0x01, 0x0a, 0x10, 0x52, 0x65, 0x61, 0x64,
	...
	0x0a, 0x61, 0x77, 0x73, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x35, 0x0a, 0x1d, 0x52,
	...
	0x49, 0x64, 0x22, 0x89, 0x02, 0x0a, 0x13, 0x52, 0x65, 0x61, 0x64, 0x54, 0x61, 0x67, 0x43, 0x6f,
	...
	0x65, 0x61, 0x6b, 0x65, 0x76, 0x65, 0x6e, 0x32, 0xe3, 0x24, 0x0a, 0x04, 0x43, 0x6f, 0x73, 0x74,
	...
	0x64, 0x7d, 0x12, 0x6b, 0x0a, 0x0c, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x70, 0x69, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x1d,
	...
	0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x2b, 0x2e, 0x62, 0x6c, 0x75, 0x65, 0x61, 0x70,
	0x69, 0x2e, 0x63, 0x6f, 0x73, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x61, 0x6c,
	0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71,
	...
	0x74, 0x6f, 0x72, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x98, 0x01, 0x0a, 0x13, 0x47,
	...
	0x6f, 0x6e, 0x73, 0x2f, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x6f, 0x0a, 0x09, 0x52,
	...
	0x6f, 0x72, 0x67, 0x49, 0x64, 0x7d, 0x1a, 0x94, 0x01, 0x92, 0x41, 0x90, 0x01, 0x12, 0x40, 0x28,
	0x42, 0x45, 0x54, 0x41, 0x29, 0x20, 0x43, 0x6f, 0x73, 0x74, 0x20, 0x41, 0x50, 0x49, 0x2e, 0x20,
...
var file_cost_v1_cost_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_cost_v1_cost_proto_goTypes = []interface{}{
	...
	(*GetCalculatorStatusRequest)(nil),                    // 12: blueapi.cost.v1.GetCalculatorStatusRequest
	(*GetCalculatorStatusResponse)(nil),                   // 13: blueapi.cost.v1.GetCalculatorStatusResponse
	...
	(*GetCalculatorStatusResponse_AwsStatus)(nil),         // 58: blueapi.cost.v1.GetCalculatorStatusResponse.AwsStatus
	(*GetCalculatorStatusResponse_AwsStatus_Running)(nil), // 59: blueapi.cost.v1.GetCalculatorStatusResponse.AwsStatus.Running
	nil,                                  // 60: blueapi.cost.v1.ReadCostsRequestAwsOptionsFilters.AndFiltersEntry
	(*aws.CalculatorConfig)(nil),         // 61: blueapi.api.aws.CalculatorConfig
	(*aws.Cost)(nil),                     // 62: blueapi.api.aws.Cost
	(*api.Operation)(nil),                // 63: blueapi.api.Operation
	(*api.BillingGroupForecast)(nil),     // 64: blueapi.api.BillingGroupForecast
	(*api.MonthlyCostForecast)(nil),      // 65: blueapi.api.MonthlyCostForecast
	(*api.MonthOnMonthCostForecast)(nil), // 66: blueapi.api.MonthOnMonthCostForecast
	(*api.MonthToDateCostForecast)(nil),  // 67: blueapi.api.MonthToDateCostForecast
	(*api.Budget)(nil),                   // 68: blueapi.api.Budget
	(*aws.AwsRecommendations)(nil),       // 69: blueapi.api.aws.AwsRecommendations
	(*aws.AwsCostReductions)(nil),        // 70: blueapi.api.aws.AwsCostReductions
	(*api.UtilizationData)(nil),          // 71: blueapi.api.UtilizationData
	(*api.OptionsData)(nil),              // 72: blueapi.api.OptionsData
	(*api.OndemandData)(nil),             // 73: blueapi.api.OndemandData
	(*aws.AwsCostBreakeven)(nil),         // 74: blueapi.api.aws.AwsCostBreakeven
	(*api.Account)(nil),                  // 75: blueapi.api.Account
	(*ripple.Payer)(nil),                 // 76: blueapi.api.ripple.Payer
...
var file_cost_v1_cost_proto_depIdxs = []int32{
	...
	58, // 2: blueapi.cost.v1.GetCalculatorStatusResponse.aws:type_name -> blueapi.cost.v1.GetCalculatorStatusResponse.AwsStatus
	61, // 3: blueapi.cost.v1.GetCalculatorConfigResponse.aws:type_name -> blueapi.api.aws.CalculatorConfig
	62, // 4: blueapi.cost.v1.CostItem.aws:type_name -> blueapi.api.aws.Cost
	18, // 5: blueapi.cost.v1.CalculateCostsRequest.awsOptions:type_name -> blueapi.cost.v1.CalculateCostsRequestAwsOptions
	63, // 6: blueapi.cost.v1.ListCalculationsHistoryAwsResponse.operations:type_name -> blueapi.api.Operation
	21, // 7: blueapi.cost.v1.ListCalculationsHistoryResponse.aws:type_name -> blueapi.cost.v1.ListCalculationsHistoryAwsResponse
	60, // 8: blueapi.cost.v1.ReadCostsRequestAwsOptionsFilters.andFilters:type_name -> blueapi.cost.v1.ReadCostsRequestAwsOptionsFilters.AndFiltersEntry
	...
	64, // 13: blueapi.cost.v1.GetForecastsResponse.data:type_name -> blueapi.api.BillingGroupForecast
	65, // 14: blueapi.cost.v1.GetMonthlyCostForecastResponse.data:type_name -> blueapi.api.MonthlyCostForecast
	66, // 15: blueapi.cost.v1.GetMonthOnMonthCostForecastResponse.data:type_name -> blueapi.api.MonthOnMonthCostForecast
	67, // 16: blueapi.cost.v1.GetMonthToDateCostForecastResponse.data:type_name -> blueapi.api.MonthToDateCostForecast
	68, // 17: blueapi.cost.v1.GetAccountBudgetResponse.data:type_name -> blueapi.api.Budget
	68, // 18: blueapi.cost.v1.CreateAccountBudgetRequest.data:type_name -> blueapi.api.Budget
	68, // 19: blueapi.cost.v1.UpdateAccountBudgetRequest.data:type_name -> blueapi.api.Budget
	45, // 20: blueapi.cost.v1.GetRecommendationsRequest.awsOptions:type_name -> blueapi.cost.v1.GetRecommendationsRequestAwsOptions
	69, // 21: blueapi.cost.v1.GetRecommendationsResponse.awsRecommendations:type_name -> blueapi.api.aws.AwsRecommendations
	70, // 22: blueapi.cost.v1.GetCostReductionResponse.awsCostReductions:type_name -> blueapi.api.aws.AwsCostReductions
	71, // 23: blueapi.cost.v1.GetUtilizationResponse.utilizationData:type_name -> blueapi.api.UtilizationData
	72, // 24: blueapi.cost.v1.GetCoverageOptionsResponse.optionsData:type_name -> blueapi.api.OptionsData
	73, // 25: blueapi.cost.v1.GetCoverageOndemandResponse.ondemandData:type_name -> blueapi.api.OndemandData
	74, // 26: blueapi.cost.v1.GetBreakevenPointResponse.awsCostBreakeven:type_name -> blueapi.api.aws.AwsCostBreakeven
	59, // 27: blueapi.cost.v1.GetCalculatorStatusResponse.AwsStatus.active:type_name -> blueapi.cost.v1.GetCalculatorStatusResponse.AwsStatus.Running
	0,  // 28: blueapi.cost.v1.Cost.ListPayerAccounts:input_type -> blueapi.cost.v1.ListPayerAccountsRequest
	1,  // 29: blueapi.cost.v1.Cost.GetPayerAccount:input_type -> blueapi.cost.v1.GetPayerAccountRequest
	2,  // 30: blueapi.cost.v1.Cost.GetPayerAccountImportHistory:input_type -> blueapi.cost.v1.GetPayerAccountImportHistoryRequest
	5,  // 31: blueapi.cost.v1.Cost.CreatePayerAccount:input_type -> blueapi.cost.v1.CreatePayerAccountRequest
	6,  // 32: blueapi.cost.v1.Cost.DeletePayerAccount:input_type -> blueapi.cost.v1.DeletePayerAccountRequest
	7,  // 33: blueapi.cost.v1.Cost.ListAccounts:input_type -> blueapi.cost.v1.ListAccountsRequest
	8,  // 34: blueapi.cost.v1.Cost.GetAccount:input_type -> blueapi.cost.v1.GetAccountRequest
	10, // 35: blueapi.cost.v1.Cost.CreateAccount:input_type -> blueapi.cost.v1.CreateAccountRequest
	11, // 36: blueapi.cost.v1.Cost.DeleteAccount:input_type -> blueapi.cost.v1.DeleteAccountRequest
	12, // 37: blueapi.cost.v1.Cost.GetCalculatorStatus:input_type -> blueapi.cost.v1.GetCalculatorStatusRequest
	14, // 38: blueapi.cost.v1.Cost.GetCalculatorConfig:input_type -> blueapi.cost.v1.GetCalculatorConfigRequest
	16, // 39: blueapi.cost.v1.Cost.ImportCurFiles:input_type -> blueapi.cost.v1.ImportCurFilesRequest
	19, // 40: blueapi.cost.v1.Cost.CalculateCosts:input_type -> blueapi.cost.v1.CalculateCostsRequest
	20, // 41: blueapi.cost.v1.Cost.ListCalculationsHistory:input_type -> blueapi.cost.v1.ListCalculationsHistoryRequest
	25, // 42: blueapi.cost.v1.Cost.ReadCosts:input_type -> blueapi.cost.v1.ReadCostsRequest
	27, // 43: blueapi.cost.v1.Cost.ReadAdjustments:input_type -> blueapi.cost.v1.ReadAdjustmentsRequest
	29, // 44: blueapi.cost.v1.Cost.ReadTagCosts:input_type -> blueapi.cost.v1.ReadTagCostsRequest
	30, // 45: blueapi.cost.v1.Cost.ReadNonTagCosts:input_type -> blueapi.cost.v1.ReadNonTagCostsRequest
	31, // 46: blueapi.cost.v1.Cost.GetForecasts:input_type -> blueapi.cost.v1.GetForecastsRequest
	33, // 47: blueapi.cost.v1.Cost.GetMonthlyCostForecast:input_type -> blueapi.cost.v1.GetMonthlyCostForecastRequest
	35, // 48: blueapi.cost.v1.Cost.GetMonthOnMonthCostForecast:input_type -> blueapi.cost.v1.GetMonthOnMonthCostForecastRequest
	37, // 49: blueapi.cost.v1.Cost.GetMonthToDateCostForecast:input_type -> blueapi.cost.v1.GetMonthToDateCostForecastRequest
	39, // 50: blueapi.cost.v1.Cost.GetAccountBudget:input_type -> blueapi.cost.v1.GetAccountBudgetRequest
	41, // 51: blueapi.cost.v1.Cost.CreateAccountBudget:input_type -> blueapi.cost.v1.CreateAccountBudgetRequest
	43, // 52: blueapi.cost.v1.Cost.UpdateAccountBudget:input_type -> blueapi.cost.v1.UpdateAccountBudgetRequest
	44, // 53: blueapi.cost.v1.Cost.DeleteAccountBudget:input_type -> blueapi.cost.v1.DeleteAccountBudgetRequest
	46, // 54: blueapi.cost.v1.Cost.GetRecommendations:input_type -> blueapi.cost.v1.GetRecommendationsRequest
	48, // 55: blueapi.cost.v1.Cost.GetCostReduction:input_type -> blueapi.cost.v1.GetCostReductionRequest
	50, // 56: blueapi.cost.v1.Cost.GetUtilization:input_type -> blueapi.cost.v1.GetUtilizationRequest
	52, // 57: blueapi.cost.v1.Cost.GetCoverageOptions:input_type -> blueapi.cost.v1.GetCoverageOptionsRequest
	54, // 58: blueapi.cost.v1.Cost.GetCoverageOndemand:input_type -> blueapi.cost.v1.GetCoverageOndemandRequest
	56, // 59: blueapi.cost.v1.Cost.GetBreakevenPoint:input_type -> blueapi.cost.v1.GetBreakevenPointRequest
	75, // 60: blueapi.cost.v1.Cost.ListPayerAccounts:output_type -> blueapi.api.Account
	76, // 61: blueapi.cost.v1.Cost.GetPayerAccount:output_type -> blueapi.api.ripple.Payer
	3,  // 62: blueapi.cost.v1.Cost.GetPayerAccountImportHistory:output_type -> blueapi.cost.v1.GetPayerAccountImportHistoryResponse
	75, // 63: blueapi.cost.v1.Cost.CreatePayerAccount:output_type -> blueapi.api.Account
	77, // 64: blueapi.cost.v1.Cost.DeletePayerAccount:output_type -> google.protobuf.Empty
	75, // 65: blueapi.cost.v1.Cost.ListAccounts:output_type -> blueapi.api.Account
	75, // 66: blueapi.cost.v1.Cost.GetAccount:output_type -> blueapi.api.Account
	75, // 67: blueapi.cost.v1.Cost.CreateAccount:output_type -> blueapi.api.Account
	77, // 68: blueapi.cost.v1.Cost.DeleteAccount:output_type -> google.protobuf.Empty
	13, // 69: blueapi.cost.v1.Cost.GetCalculatorStatus:output_type -> blueapi.cost.v1.GetCalculatorStatusResponse
	15, // 70: blueapi.cost.v1.Cost.GetCalculatorConfig:output_type -> blueapi.cost.v1.GetCalculatorConfigResponse
	63, // 71: blueapi.cost.v1.Cost.ImportCurFiles:output_type -> blueapi.api.Operation
	63, // 72: blueapi.cost.v1.Cost.CalculateCosts:output_type -> blueapi.api.Operation
	22, // 73: blueapi.cost.v1.Cost.ListCalculationsHistory:output_type -> blueapi.cost.v1.ListCalculationsHistoryResponse
	17, // 74: blueapi.cost.v1.Cost.ReadCosts:output_type -> blueapi.cost.v1.CostItem
	17, // 75: blueapi.cost.v1.Cost.ReadAdjustments:output_type -> blueapi.cost.v1.CostItem
	17, // 76: blueapi.cost.v1.Cost.ReadTagCosts:output_type -> blueapi.cost.v1.CostItem
	17, // 77: blueapi.cost.v1.Cost.ReadNonTagCosts:output_type -> blueapi.cost.v1.CostItem
	32, // 78: blueapi.cost.v1.Cost.GetForecasts:output_type -> blueapi.cost.v1.GetForecastsResponse
	34, // 79: blueapi.cost.v1.Cost.GetMonthlyCostForecast:output_type -> blueapi.cost.v1.GetMonthlyCostForecastResponse
	36, // 80: blueapi.cost.v1.Cost.GetMonthOnMonthCostForecast:output_type -> blueapi.cost.v1.GetMonthOnMonthCostForecastResponse
	38, // 81: blueapi.cost.v1.Cost.GetMonthToDateCostForecast:output_type -> blueapi.cost.v1.GetMonthToDateCostForecastResponse
	40, // 82: blueapi.cost.v1.Cost.GetAccountBudget:output_type -> blueapi.cost.v1.GetAccountBudgetResponse
	42, // 83: blueapi.cost.v1.Cost.CreateAccountBudget:output_type -> blueapi.cost.v1.CreateAccountBudgetResponse
	77, // 84: blueapi.cost.v1.Cost.UpdateAccountBudget:output_type -> google.protobuf.Empty
	77, // 85: blueapi.cost.v1.Cost.DeleteAccountBudget:output_type -> google.protobuf.Empty
	47, // 86: blueapi.cost.v1.Cost.GetRecommendations:output_type -> blueapi.cost.v1.GetRecommendationsResponse
	49, // 87: blueapi.cost.v1.Cost.GetCostReduction:output_type -> blueapi.cost.v1.GetCostReductionResponse
	51, // 88: blueapi.cost.v1.Cost.GetUtilization:output_type -> blueapi.cost.v1.GetUtilizationResponse
	53, // 89: blueapi.cost.v1.Cost.GetCoverageOptions:output_type -> blueapi.cost.v1.GetCoverageOptionsResponse
	55, // 90: blueapi.cost.v1.Cost.GetCoverageOndemand:output_type -> blueapi.cost.v1.GetCoverageOndemandResponse
	57, // 91: blueapi.cost.v1.Cost.GetBreakevenPoint:output_type -> blueapi.cost.v1.GetBreakevenPointResponse
...
func file_cost_v1_cost_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cost_v1_cost_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCalculatorStatusRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cost_v1_cost_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCalculatorStatusResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cost_v1_cost_proto_msgTypes[58].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCalculatorStatusResponse_AwsStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cost_v1_cost_proto_msgTypes[59].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCalculatorStatusResponse_AwsStatus_Running); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
