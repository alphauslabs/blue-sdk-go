...
var file_cost_v1_cost_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x08, 0x62, 0x75, 0x64, 0x67, 0x65, 0x74, 0x49, 0x64, 0x32, 0xe4, 0x1e, 0x0a,
	...
	0x72, 0x12, 0x73, 0x0a, 0x0e, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x43, 0x75, 0x72, 0x46, 0x69,
	...
	0x2f, 0x61, 0x77, 0x73, 0x3a, 0x69, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x43, 0x75, 0x72, 0x46, 0x69,
	0x6c, 0x65, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x79, 0x0a, 0x0e, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c,
	...
	0x74, 0x73, 0x3a, 0x72, 0x65, 0x61, 0x64, 0x3a, 0x01, 0x2a, 0x30, 0x01, 0x12, 0x87, 0x01, 0x0a,
	...
	0x73, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x22, 0x28, 0x82, 0xd3, 0xe4, 0x93,
	...
	0x64, 0x3a, 0x01, 0x2a, 0x30, 0x01, 0x12, 0xa0, 0x01, 0x0a, 0x18, 0x52, 0x65, 0x61, 0x64, 0x42,
	0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x54, 0x61, 0x67, 0x43, 0x6f,
	0x73, 0x74, 0x73, 0x12, 0x30, 0x2e, 0x62, 0x6c, 0x75, 0x65, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f,
	0x73, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x61, 0x64, 0x42, 0x69, 0x6c, 0x6c, 0x69, 0x6e,
	0x67, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x54, 0x61, 0x67, 0x43, 0x6f, 0x73, 0x74, 0x73, 0x52, 0x65,
	...
	0x22, 0x35, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2f, 0x22, 0x2d, 0x2f, 0x76, 0x31, 0x2f, 0x7b, 0x76,
	0x65, 0x6e, 0x64, 0x6f, 0x72, 0x7d, 0x2f, 0x62, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x67, 0x72,
	0x6f, 0x75, 0x70, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x2f, 0x74, 0x61, 0x67, 0x63, 0x6f, 0x73,
	0x74, 0x73, 0x3a, 0x72, 0x65, 0x61, 0x64, 0x30, 0x01, 0x12, 0xa9, 0x01, 0x0a, 0x1b, 0x52, 0x65,
	0x61, 0x64, 0x42, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x4e, 0x6f,
	0x6e, 0x54, 0x61, 0x67, 0x43, 0x6f, 0x73, 0x74, 0x73, 0x12, 0x33, 0x2e, 0x62, 0x6c, 0x75, 0x65,
	...
	0x2e, 0x62, 0x6c, 0x75, 0x65, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x73, 0x74, 0x2e, 0x76, 0x31,
	0x2e, 0x43, 0x6f, 0x73, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x22, 0x38, 0x82, 0xd3, 0xe4, 0x93, 0x02,
	0x32, 0x22, 0x30, 0x2f, 0x76, 0x31, 0x2f, 0x7b, 0x76, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x7d, 0x2f,
	0x62, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x2f, 0x7b, 0x69,
	0x64, 0x7d, 0x2f, 0x6e, 0x6f, 0x6e, 0x74, 0x61, 0x67, 0x63, 0x6f, 0x73, 0x74, 0x73, 0x3a, 0x72,
	...
	0x74, 0x2f, 0x7b, 0x62, 0x75, 0x64, 0x67, 0x65, 0x74, 0x49, 0x64, 0x7d, 0x1a, 0x94, 0x01, 0x92,
...
var file_cost_v1_cost_proto_goTypes = []interface{}{
	...
	(*aws.Adjustment)(nil),                       // 47: blueapi.api.aws.Adjustment
	(*api.BillingGroupForecast)(nil),             // 48: blueapi.api.BillingGroupForecast
	(*api.MonthlyCostForecast)(nil),              // 49: blueapi.api.MonthlyCostForecast
	(*api.MonthOnMonthCostForecast)(nil),         // 50: blueapi.api.MonthOnMonthCostForecast
	(*api.MonthToDateCostForecast)(nil),          // 51: blueapi.api.MonthToDateCostForecast
	(*api.Budget)(nil),                           // 52: blueapi.api.Budget
...
var file_cost_v1_cost_proto_depIdxs = []int32{
	...
	47, // 8: blueapi.cost.v1.AdjustmentItem.aws:type_name -> blueapi.api.aws.Adjustment
	24, // 9: blueapi.cost.v1.ReadAdjustmentsRequest.awsOptions:type_name -> blueapi.cost.v1.ReadAdjustmentsRequestAwsOptions
	48, // 10: blueapi.cost.v1.GetForecastsResponse.data:type_name -> blueapi.api.BillingGroupForecast
	49, // 11: blueapi.cost.v1.GetMonthlyCostForecastResponse.data:type_name -> blueapi.api.MonthlyCostForecast
	50, // 12: blueapi.cost.v1.GetMonthOnMonthCostForecastResponse.data:type_name -> blueapi.api.MonthOnMonthCostForecast
	51, // 13: blueapi.cost.v1.GetMonthToDateCostForecastResponse.data:type_name -> blueapi.api.MonthToDateCostForecast
	52, // 14: blueapi.cost.v1.GetAccountBudgetResponse.data:type_name -> blueapi.api.Budget
	52, // 15: blueapi.cost.v1.CreateAccountBudgetRequest.data:type_name -> blueapi.api.Budget
	52, // 16: blueapi.cost.v1.UpdateAccountBudgetRequest.data:type_name -> blueapi.api.Budget
	0,  // 17: blueapi.cost.v1.Cost.ListPayerAccounts:input_type -> blueapi.cost.v1.ListPayerAccountsRequest
	1,  // 18: blueapi.cost.v1.Cost.GetPayerAccount:input_type -> blueapi.cost.v1.GetPayerAccountRequest
	2,  // 19: blueapi.cost.v1.Cost.GetPayerAccountImportHistory:input_type -> blueapi.cost.v1.GetPayerAccountImportHistoryRequest
	5,  // 20: blueapi.cost.v1.Cost.CreatePayerAccount:input_type -> blueapi.cost.v1.CreatePayerAccountRequest
	6,  // 21: blueapi.cost.v1.Cost.DeletePayerAccount:input_type -> blueapi.cost.v1.DeletePayerAccountRequest
	7,  // 22: blueapi.cost.v1.Cost.ListAccounts:input_type -> blueapi.cost.v1.ListAccountsRequest
	8,  // 23: blueapi.cost.v1.Cost.GetAccount:input_type -> blueapi.cost.v1.GetAccountRequest
	10, // 24: blueapi.cost.v1.Cost.CreateAccount:input_type -> blueapi.cost.v1.CreateAccountRequest
	11, // 25: blueapi.cost.v1.Cost.DeleteAccount:input_type -> blueapi.cost.v1.DeleteAccountRequest
	12, // 26: blueapi.cost.v1.Cost.GetCalculatorConfig:input_type -> blueapi.cost.v1.GetCalculatorConfigRequest
	14, // 27: blueapi.cost.v1.Cost.ImportCurFiles:input_type -> blueapi.cost.v1.ImportCurFilesRequest
	17, // 28: blueapi.cost.v1.Cost.CalculateCosts:input_type -> blueapi.cost.v1.CalculateCostsRequest
	18, // 29: blueapi.cost.v1.Cost.ListCalculationsHistory:input_type -> blueapi.cost.v1.ListCalculationsHistoryRequest
	22, // 30: blueapi.cost.v1.Cost.ReadCosts:input_type -> blueapi.cost.v1.ReadCostsRequest
	25, // 31: blueapi.cost.v1.Cost.ReadAdjustments:input_type -> blueapi.cost.v1.ReadAdjustmentsRequest
	26, // 32: blueapi.cost.v1.Cost.ReadBillingGroupTagCosts:input_type -> blueapi.cost.v1.ReadBillingGroupTagCostsRequest
	27, // 33: blueapi.cost.v1.Cost.ReadBillingGroupNonTagCosts:input_type -> blueapi.cost.v1.ReadBillingGroupNonTagCostsRequest
	28, // 34: blueapi.cost.v1.Cost.ReadTagCosts:input_type -> blueapi.cost.v1.ReadTagCostsRequest
	29, // 35: blueapi.cost.v1.Cost.ReadNonTagCosts:input_type -> blueapi.cost.v1.ReadNonTagCostsRequest
	30, // 36: blueapi.cost.v1.Cost.GetForecasts:input_type -> blueapi.cost.v1.GetForecastsRequest
	32, // 37: blueapi.cost.v1.Cost.GetMonthlyCostForecast:input_type -> blueapi.cost.v1.GetMonthlyCostForecastRequest
	34, // 38: blueapi.cost.v1.Cost.GetMonthOnMonthCostForecast:input_type -> blueapi.cost.v1.GetMonthOnMonthCostForecastRequest
	36, // 39: blueapi.cost.v1.Cost.GetMonthToDateCostForecast:input_type -> blueapi.cost.v1.GetMonthToDateCostForecastRequest
	38, // 40: blueapi.cost.v1.Cost.GetAccountBudget:input_type -> blueapi.cost.v1.GetAccountBudgetRequest
	40, // 41: blueapi.cost.v1.Cost.CreateAccountBudget:input_type -> blueapi.cost.v1.CreateAccountBudgetRequest
	42, // 42: blueapi.cost.v1.Cost.UpdateAccountBudget:input_type -> blueapi.cost.v1.UpdateAccountBudgetRequest
	43, // 43: blueapi.cost.v1.Cost.DeleteAccountBudget:input_type -> blueapi.cost.v1.DeleteAccountBudgetRequest
	53, // 44: blueapi.cost.v1.Cost.ListPayerAccounts:output_type -> blueapi.api.Account
	53, // 45: blueapi.cost.v1.Cost.GetPayerAccount:output_type -> blueapi.api.Account
	3,  // 46: blueapi.cost.v1.Cost.GetPayerAccountImportHistory:output_type -> blueapi.cost.v1.GetPayerAccountImportHistoryResponse
	53, // 47: blueapi.cost.v1.Cost.CreatePayerAccount:output_type -> blueapi.api.Account
	54, // 48: blueapi.cost.v1.Cost.DeletePayerAccount:output_type -> google.protobuf.Empty
	53, // 49: blueapi.cost.v1.Cost.ListAccounts:output_type -> blueapi.api.Account
	53, // 50: blueapi.cost.v1.Cost.GetAccount:output_type -> blueapi.api.Account
	53, // 51: blueapi.cost.v1.Cost.CreateAccount:output_type -> blueapi.api.Account
	54, // 52: blueapi.cost.v1.Cost.DeleteAccount:output_type -> google.protobuf.Empty
	13, // 53: blueapi.cost.v1.Cost.GetCalculatorConfig:output_type -> blueapi.cost.v1.GetCalculatorConfigResponse
	46, // 54: blueapi.cost.v1.Cost.ImportCurFiles:output_type -> blueapi.api.Operation
	46, // 55: blueapi.cost.v1.Cost.CalculateCosts:output_type -> blueapi.api.Operation
	20, // 56: blueapi.cost.v1.Cost.ListCalculationsHistory:output_type -> blueapi.cost.v1.ListCalculationsHistoryResponse
	15, // 57: blueapi.cost.v1.Cost.ReadCosts:output_type -> blueapi.cost.v1.CostItem
	23, // 58: blueapi.cost.v1.Cost.ReadAdjustments:output_type -> blueapi.cost.v1.AdjustmentItem
	15, // 59: blueapi.cost.v1.Cost.ReadBillingGroupTagCosts:output_type -> blueapi.cost.v1.CostItem
	15, // 60: blueapi.cost.v1.Cost.ReadBillingGroupNonTagCosts:output_type -> blueapi.cost.v1.CostItem
	15, // 61: blueapi.cost.v1.Cost.ReadTagCosts:output_type -> blueapi.cost.v1.CostItem
	15, // 62: blueapi.cost.v1.Cost.ReadNonTagCosts:output_type -> blueapi.cost.v1.CostItem
	31, // 63: blueapi.cost.v1.Cost.GetForecasts:output_type -> blueapi.cost.v1.GetForecastsResponse
	33, // 64: blueapi.cost.v1.Cost.GetMonthlyCostForecast:output_type -> blueapi.cost.v1.GetMonthlyCostForecastResponse
	35, // 65: blueapi.cost.v1.Cost.GetMonthOnMonthCostForecast:output_type -> blueapi.cost.v1.GetMonthOnMonthCostForecastResponse
	37, // 66: blueapi.cost.v1.Cost.GetMonthToDateCostForecast:output_type -> blueapi.cost.v1.GetMonthToDateCostForecastResponse
	39, // 67: blueapi.cost.v1.Cost.GetAccountBudget:output_type -> blueapi.cost.v1.GetAccountBudgetResponse
	41, // 68: blueapi.cost.v1.Cost.CreateAccountBudget:output_type -> blueapi.cost.v1.CreateAccountBudgetResponse
	54, // 69: blueapi.cost.v1.Cost.UpdateAccountBudget:output_type -> google.protobuf.Empty
	54, // 70: blueapi.cost.v1.Cost.DeleteAccountBudget:output_type -> google.protobuf.Empty
