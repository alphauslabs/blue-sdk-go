...
var file_cost_v1_cost_proto_rawDesc = []byte{
	...
	0x12, 0x16, 0x0a, 0x06, 0x76, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x76, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x34, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x43,
	...
	0x09, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0x33, 0x0a, 0x08, 0x43, 0x6f, 0x73,
	...
	0x2e, 0x61, 0x77, 0x73, 0x2e, 0x43, 0x6f, 0x73, 0x74, 0x52, 0x03, 0x61, 0x77, 0x73, 0x22, 0x77,
	...
	0x28, 0x08, 0x52, 0x0b, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x22,
	...
	0x6f, 0x6e, 0x74, 0x68, 0x73, 0x22, 0xb3, 0x01, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x46, 0x6f, 0x72,
	...
	0x28, 0x09, 0x52, 0x08, 0x62, 0x75, 0x64, 0x67, 0x65, 0x74, 0x49, 0x64, 0x32, 0x8d, 0x1c, 0x0a,
	...
	0x91, 0x01, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f,
	...
	0x74, 0x6f, 0x72, 0x12, 0x6f, 0x0a, 0x0e, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x43, 0x75, 0x72,
	...
	0x65, 0x74, 0x49, 0x64, 0x7d, 0x1a, 0x94, 0x01, 0x92, 0x41, 0x90, 0x01, 0x12, 0x40, 0x28, 0x42,
	0x45, 0x54, 0x41, 0x29, 0x20, 0x43, 0x6f, 0x73, 0x74, 0x20, 0x41, 0x50, 0x49, 0x2e, 0x20, 0x42,
...
var file_cost_v1_cost_proto_goTypes = []interface{}{
	...
	(*api.BillingGroupForecast)(nil),             // 47: blueapi.api.BillingGroupForecast
	(*api.MonthlyCostForecast)(nil),              // 48: blueapi.api.MonthlyCostForecast
	(*api.MonthOnMonthCostForecast)(nil),         // 49: blueapi.api.MonthOnMonthCostForecast
	(*api.MonthToDateCostForecast)(nil),          // 50: blueapi.api.MonthToDateCostForecast
	(*api.Budget)(nil),                           // 51: blueapi.api.Budget
...
var file_cost_v1_cost_proto_depIdxs = []int32{
	...
	47, // 12: blueapi.cost.v1.GetForecastsResponse.data:type_name -> blueapi.api.BillingGroupForecast
	48, // 13: blueapi.cost.v1.GetMonthlyCostForecastResponse.data:type_name -> blueapi.api.MonthlyCostForecast
	49, // 14: blueapi.cost.v1.GetMonthOnMonthCostForecastResponse.data:type_name -> blueapi.api.MonthOnMonthCostForecast
	50, // 15: blueapi.cost.v1.GetMonthToDateCostForecastResponse.data:type_name -> blueapi.api.MonthToDateCostForecast
	51, // 16: blueapi.cost.v1.GetAccountBudgetResponse.data:type_name -> blueapi.api.Budget
	51, // 17: blueapi.cost.v1.CreateAccountBudgetRequest.data:type_name -> blueapi.api.Budget
	51, // 18: blueapi.cost.v1.UpdateAccountBudgetRequest.data:type_name -> blueapi.api.Budget
	...
	25, // 33: blueapi.cost.v1.Cost.ReadAdjustments:input_type -> blueapi.cost.v1.ReadAdjustmentsRequest
	...
	52, // 44: blueapi.cost.v1.Cost.ListPayerAccounts:output_type -> blueapi.api.Account
	52, // 45: blueapi.cost.v1.Cost.GetPayerAccount:output_type -> blueapi.api.Account
	3,  // 46: blueapi.cost.v1.Cost.GetPayerAccountImportHistory:output_type -> blueapi.cost.v1.GetPayerAccountImportHistoryResponse
	52, // 47: blueapi.cost.v1.Cost.CreatePayerAccount:output_type -> blueapi.api.Account
	53, // 48: blueapi.cost.v1.Cost.DeletePayerAccount:output_type -> google.protobuf.Empty
	52, // 49: blueapi.cost.v1.Cost.ListAccounts:output_type -> blueapi.api.Account
	52, // 50: blueapi.cost.v1.Cost.GetAccount:output_type -> blueapi.api.Account
	52, // 51: blueapi.cost.v1.Cost.CreateAccount:output_type -> blueapi.api.Account
	53, // 52: blueapi.cost.v1.Cost.DeleteAccount:output_type -> google.protobuf.Empty
	...
	15, // 58: blueapi.cost.v1.Cost.ReadAdjustments:output_type -> blueapi.cost.v1.CostItem
	...
	53, // 67: blueapi.cost.v1.Cost.UpdateAccountBudget:output_type -> google.protobuf.Empty
	53, // 68: blueapi.cost.v1.Cost.DeleteAccountBudget:output_type -> google.protobuf.Empty
