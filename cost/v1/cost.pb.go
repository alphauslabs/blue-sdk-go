...
var file_cost_v1_cost_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x0a, 0x61, 0x77, 0x73, 0x4f, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x22, 0xb9, 0x01, 0x0a, 0x13, 0x52, 0x65, 0x61, 0x64, 0x54, 0x61, 0x67, 0x43, 0x6f,
	...
	0x67, 0x72, 0x6f, 0x75, 0x70, 0x42, 0x79, 0x4d, 0x6f, 0x6e, 0x74, 0x68, 0x73, 0x22, 0xb3, 0x01,
	...
	0x52, 0x09, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x66,
	...
	0x65, 0x74, 0x49, 0x64, 0x32, 0x91, 0x1c, 0x0a, 0x04, 0x43, 0x6f, 0x73, 0x74, 0x12, 0x73, 0x0a,
	...
	0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12, 0xbb, 0x01, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x50, 0x61,
	0x79, 0x65, 0x72, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74,
	...
	0x74, 0x6f, 0x72, 0x79, 0x12, 0x76, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x61,
	...
	0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12, 0x91, 0x01, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x43, 0x61, 0x6c,
	...
	0x12, 0x17, 0x2f, 0x76, 0x31, 0x2f, 0x7b, 0x76, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x7d, 0x2f, 0x63,
	0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x6f, 0x0a, 0x0e, 0x49, 0x6d, 0x70,
	...
	0x12, 0x87, 0x01, 0x0a, 0x0f, 0x52, 0x65, 0x61, 0x64, 0x41, 0x64, 0x6a, 0x75, 0x73, 0x74, 0x6d,
	...
	0x62, 0x6c, 0x75, 0x65, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6f, 0x73, 0x74, 0x2e, 0x76, 0x31, 0x2e,
	0x41, 0x64, 0x6a, 0x75, 0x73, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x22, 0x28,
...
var file_cost_v1_cost_proto_goTypes = []interface{}{
	...
	nil,                                          // 43: blueapi.cost.v1.ReadCostsRequestAwsOptionsFilters.AndFiltersEntry
...
var file_cost_v1_cost_proto_depIdxs = []int32{
	...
	43, // 7: blueapi.cost.v1.ReadCostsRequestAwsOptionsFilters.andFilters:type_name -> blueapi.cost.v1.ReadCostsRequestAwsOptionsFilters.AndFiltersEntry
	...
	47, // 10: blueapi.cost.v1.AdjustmentItem.aws:type_name -> blueapi.api.aws.Adjustment
	25, // 11: blueapi.cost.v1.ReadAdjustmentsRequest.awsOptions:type_name -> blueapi.cost.v1.ReadAdjustmentsRequestAwsOptions
	48, // 12: blueapi.cost.v1.GetForecastsResponse.data:type_name -> blueapi.api.BillingGroupForecast
	49, // 13: blueapi.cost.v1.GetMonthlyCostForecastResponse.data:type_name -> blueapi.api.MonthlyCostForecast
	50, // 14: blueapi.cost.v1.GetMonthOnMonthCostForecastResponse.data:type_name -> blueapi.api.MonthOnMonthCostForecast
	51, // 15: blueapi.cost.v1.GetMonthToDateCostForecastResponse.data:type_name -> blueapi.api.MonthToDateCostForecast
	52, // 16: blueapi.cost.v1.GetAccountBudgetResponse.data:type_name -> blueapi.api.Budget
	52, // 17: blueapi.cost.v1.CreateAccountBudgetRequest.data:type_name -> blueapi.api.Budget
	52, // 18: blueapi.cost.v1.UpdateAccountBudgetRequest.data:type_name -> blueapi.api.Budget
	...
	27, // 34: blueapi.cost.v1.Cost.ReadTagCosts:input_type -> blueapi.cost.v1.ReadTagCostsRequest
	28, // 35: blueapi.cost.v1.Cost.ReadNonTagCosts:input_type -> blueapi.cost.v1.ReadNonTagCostsRequest
	29, // 36: blueapi.cost.v1.Cost.GetForecasts:input_type -> blueapi.cost.v1.GetForecastsRequest
	31, // 37: blueapi.cost.v1.Cost.GetMonthlyCostForecast:input_type -> blueapi.cost.v1.GetMonthlyCostForecastRequest
	33, // 38: blueapi.cost.v1.Cost.GetMonthOnMonthCostForecast:input_type -> blueapi.cost.v1.GetMonthOnMonthCostForecastRequest
	35, // 39: blueapi.cost.v1.Cost.GetMonthToDateCostForecast:input_type -> blueapi.cost.v1.GetMonthToDateCostForecastRequest
	37, // 40: blueapi.cost.v1.Cost.GetAccountBudget:input_type -> blueapi.cost.v1.GetAccountBudgetRequest
	39, // 41: blueapi.cost.v1.Cost.CreateAccountBudget:input_type -> blueapi.cost.v1.CreateAccountBudgetRequest
	41, // 42: blueapi.cost.v1.Cost.UpdateAccountBudget:input_type -> blueapi.cost.v1.UpdateAccountBudgetRequest
	42, // 43: blueapi.cost.v1.Cost.DeleteAccountBudget:input_type -> blueapi.cost.v1.DeleteAccountBudgetRequest
	...
	24, // 58: blueapi.cost.v1.Cost.ReadAdjustments:output_type -> blueapi.cost.v1.AdjustmentItem
	15, // 59: blueapi.cost.v1.Cost.ReadTagCosts:output_type -> blueapi.cost.v1.CostItem
	15, // 60: blueapi.cost.v1.Cost.ReadNonTagCosts:output_type -> blueapi.cost.v1.CostItem
	30, // 61: blueapi.cost.v1.Cost.GetForecasts:output_type -> blueapi.cost.v1.GetForecastsResponse
	32, // 62: blueapi.cost.v1.Cost.GetMonthlyCostForecast:output_type -> blueapi.cost.v1.GetMonthlyCostForecastResponse
	34, // 63: blueapi.cost.v1.Cost.GetMonthOnMonthCostForecast:output_type -> blueapi.cost.v1.GetMonthOnMonthCostForecastResponse
	36, // 64: blueapi.cost.v1.Cost.GetMonthToDateCostForecast:output_type -> blueapi.cost.v1.GetMonthToDateCostForecastResponse
	38, // 65: blueapi.cost.v1.Cost.GetAccountBudget:output_type -> blueapi.cost.v1.GetAccountBudgetResponse
	40, // 66: blueapi.cost.v1.Cost.CreateAccountBudget:output_type -> blueapi.cost.v1.CreateAccountBudgetResponse
	54, // 67: blueapi.cost.v1.Cost.UpdateAccountBudget:output_type -> google.protobuf.Empty
	54, // 68: blueapi.cost.v1.Cost.DeleteAccountBudget:output_type -> google.protobuf.Empty
