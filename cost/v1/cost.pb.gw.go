...
func request_Cost_ListCalculationsSchedule_0(ctx context.Context, marshaler runtime.Marshaler, client CostClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListCalculationsScheduleRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ListCalculationsSchedule(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Cost_ListCalculationsSchedule_0(ctx context.Context, marshaler runtime.Marshaler, server CostServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListCalculationsScheduleRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ListCalculationsSchedule(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterCostHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CostServer) error {
	...
	mux.Handle("GET", pattern_Cost_ListCalculationsSchedule_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/blueapi.cost.v1.Cost/ListCalculationsSchedule")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Cost_ListCalculationsSchedule_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_Cost_ListCalculationsSchedule_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterCostHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CostClient) error {
	...
	mux.Handle("GET", pattern_Cost_ListCalculationsSchedule_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/blueapi.cost.v1.Cost/ListCalculationsSchedule")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Cost_ListCalculationsSchedule_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Cost_ListCalculationsSchedule_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3}, []string{"v1", "vendor", "calculations", "schedule"}, ""))

	pattern_Cost_CreateCalculationsSchedule_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3}, []string{"v1", "vendor", "calculations", "schedule"}, ""))

	pattern_Cost_DeleteCalculationsSchedule_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3}, []string{"v1", "vendor", "calculations", "schedule"}, ""))
...
var (
	...
	forward_Cost_ListCalculationsSchedule_0 = runtime.ForwardResponseMessage
